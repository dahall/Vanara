...
public static partial class Macros
{
	...
	/// <remarks>Although the return value of the <c>MAKEINTATOM</c> macro is cast as an <c>StrPtrAuto</c> value, it cannot be used as a string pointer except when it is passed to atom-management functions that require an <c>StrPtrAuto</c> argument.</remarks>
