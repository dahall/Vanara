...
public struct CY : IEquatable<CY>, IComparable<CY>, IEquatable<decimal>, IComparable<decimal>, IConvertible, IComparable
{
	...
	public readonly decimal Value => decimal.FromOACurrency(int64);

	/// <summary>Performs an implicit conversion from <see cref="System.Byte"/> to <see cref="CY"/>.</summary>
	/// <param name="value">The value.</param>
	/// <returns>The result of the conversion.</returns>
	public static implicit operator CY(decimal value) => new(value);
	...
	/// <inheritdoc/>
	public readonly int CompareTo(CY other) => Value.CompareTo(other.Value);

	/// <inheritdoc/>
	public readonly int CompareTo(decimal other) => Value.CompareTo(other);

	/// <inheritdoc/>
	public override readonly bool Equals(object? obj) => obj is CY s ? Equals(s) : (obj is decimal b ? Value.Equals(b) : Value.Equals(obj));

	/// <inheritdoc/>
	public readonly bool Equals(CY other) => Value.Equals(other.Value);
	...
	internal class CYTypeConverter : DecimalConverter
	{
		public override object? ConvertTo(ITypeDescriptorContext? context, CultureInfo? culture, object? value, Type destinationType) =>
			value is CY b ? base.ConvertTo(context, culture, b.Value, destinationType) : throw new NotSupportedException();
