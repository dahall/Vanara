...
/// <para>
/// This parameter can include any combination of the available file attributes ( <b>FILE_ATTRIBUTE_*</b>). All other file attributes
/// override <b>FILE_ATTRIBUTE_NORMAL</b>.
/// </para>
/// <note type="note">When <c>CreateFile3</c> opens an existing file, it generally combines the file flags with the file attributes of the
/// existing file, and ignores any file attributes supplied as part of dwFlagsAndAttributes. Special cases are detailed in <c>Creating and
/// Opening Files</c>.</note>
/// <para>
...
/// <c>CreateFile3</c> can open. For additional information, see the <b>Remarks</b> section of the <b>CreateFile3</b> reference page and
/// <c>Creating and Opening Files</c>.
/// </para>
/// <para>
/// For more advanced access to file attributes, see <c>SetFileAttributes</c>. For a complete list of all file attributes with their values
/// and descriptions, see <c>File Attribute Constants</c>.
/// </para>
/// </summary>
[Flags]
[PInvokeData("winnt.h")]
...
/// <summary>
/// Flags that control of file or device caching behavior, access modes, and other special-purpose flags that can be specified when creating
/// or opening a file or device.
/// </summary>
[Flags]
[PInvokeData("winnt.h")]
...
/// <summary>Specifies SQOS information during file creation. For more information, see Impersonation Levels.</summary>
[Flags]
[PInvokeData("winnt.h")]
public enum FILE_SECURITY : uint
{
	/// <summary>Impersonates a client at the Anonymous impersonation level.</summary>
	SECURITY_ANONYMOUS = 0x00000000,
