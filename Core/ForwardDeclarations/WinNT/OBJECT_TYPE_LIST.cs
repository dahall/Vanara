...
/// sets and properties.
/// </summary>
/// <remarks>Initializes a new instance of the <see cref="OBJECT_TYPE_LIST"/> struct.</remarks>
...
public struct OBJECT_TYPE_LIST(ObjectTypeListLevel level, in GuidPtr objType = default)
{
	/// <summary>
