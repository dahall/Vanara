...
public struct SIZE(int width, int height) : IEquatable<SIZE>
{
	...
	/// <summary>Specifies the rectangle's height. The units depend on which function uses this.</summary>
	public int Height { readonly get => cy; set => cy = value; }
	...
	/// <summary>Specifies the rectangle's width. The units depend on which function uses this.</summary>
	public int Width { readonly get => cx; set => cx = value; }
	...
	public override readonly int GetHashCode() => IsEmpty ? 0 : cx.GetHashCode() ^ cy.GetHashCode();
	...
	public readonly Size ToSize() => this;

	/// <summary>Returns a <see cref="string"/> that represents this instance.</summary>
	/// <returns>A <see cref="string"/> that represents this instance.</returns>
	public override readonly string ToString() => $"{{cx={cx}, cy={cy}}}";
