...
public class CorrespondingTypeAttribute : Attribute
{
	...
	/// <param name="typeRef">The type supplied by the user to validate.</param>
	/// <returns><c>true</c> if this instance can get the specified type; otherwise, <c>false</c>.</returns>
	public static bool CanGet<TEnum>(TEnum value, Type typeRef) where TEnum : Enum => GetAttrForEnum(value, CorrespondingAction.Get).Any(a => a.TypeRef == typeRef);
	...
	public static bool CanGet<T, TEnum>(out TEnum value) where TEnum : struct, Enum => CanGet(typeof(T), out value);
	...
	/// <returns><see langword="true"/> if this instance can get the specified value; otherwise, <see langword="false"/>.</returns>
	public static bool CanGet<TEnum>(Type typeRef, out TEnum value) where TEnum : struct, Enum
	{
		foreach (TEnum v in Enum.GetValues(typeof(TEnum)).OfType<TEnum>())
		{
			if (CanGet(v, typeRef))
			{
				value = v;
	...
	/// <param name="value">The value of type <typeparamref name="TEnum"/> that has the corresponding type <typeparamref name="T"/>.</param>
	/// <returns><see langword="true"/> if this instance can get the specified value; otherwise, <see langword="false"/>.</returns>
	public static bool CanGet<T, TEnum>(TEnum? input, out TEnum value) where TEnum : struct, Enum =>
	...
	/// <param name="typeRef">The type supplied by the user to validate.</param>
	/// <returns><c>true</c> if this instance can set the specified type; otherwise, <c>false</c>.</returns>
	public static bool CanSet<TEnum>(TEnum value, Type typeRef) where TEnum : Enum => GetAttrForEnum(value, CorrespondingAction.Set).Any(a => a.TypeRef == typeRef);
	...
	/// <param name="value">The value of type <typeparamref name="TEnum"/> that has the corresponding type <paramref name="typeRef"/>.</param>
	/// <returns><see langword="true"/> if this instance can get the specified value; otherwise, <see langword="false"/>.</returns>
	public static bool CanSet<TEnum>(Type typeRef, out TEnum value) where TEnum : struct, Enum
	{
		foreach (TEnum v in Enum.GetValues(typeof(TEnum)).OfType<TEnum>())
		{
			if (CanSet(v, typeRef))
