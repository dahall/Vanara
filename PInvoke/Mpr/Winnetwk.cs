...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
	...
	/// </para>
	/// </returns>
	// DWORD WNetAddConnection3( _In_ HWND hwndOwner, _In_ LPNETRESOURCE lpNetResource, _In_ PTSTR lpPassword, _In_ PTSTR lpUserName,
	...
	/// </para>
	/// </returns>
	// DWORD WNetGetConnection( _In_ LPCTSTR lpLocalName, _Out_ PTSTR lpRemoteName, _Inout_ LPDWORD lpnLength); https://msdn.microsoft.com/en-us/library/windows/desktop/aa385453(v=vs.85).aspx
	[DllImport(Lib.Mpr, SetLastError = true, CharSet = CharSet.Auto)]
	...
	/// </returns>
	// DWORD WNetGetLastError( _Out_ LPDWORD lpError, _Out_ PTSTR lpErrorBuf, _In_ DWORD nErrorBufSize, _Out_ PTSTR lpNameBuf, _In_
	...
	/// </para>
	/// </returns>
	// DWORD WNetGetProviderName( _In_ DWORD dwNetType, _Out_ PTSTR lpProviderName, _Inout_ LPDWORD lpBufferSize); https://msdn.microsoft.com/en-us/library/windows/desktop/aa385464(v=vs.85).aspx
	[DllImport(Lib.Mpr, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// PTSTR *lplpSystem); https://msdn.microsoft.com/en-us/library/windows/desktop/aa385469(v=vs.85).aspx
	[DllImport(Lib.Mpr, SetLastError = true, CharSet = CharSet.Auto)]
	[PInvokeData("Winnetwk.h", MSDNShortId = "aa385469")]
	public static extern Win32Error WNetGetResourceInformation(NETRESOURCE lpNetResource, IntPtr lpBuffer, ref uint lpcbBuffer, out PTSTR lplpSystem);
	...
	/// </para>
	/// </returns>
	// DWORD WNetGetUser( _In_ LPCTSTR lpName, _Out_ PTSTR lpUserName, _Inout_ LPDWORD lpnLength); https://msdn.microsoft.com/en-us/library/windows/desktop/aa385476(v=vs.85).aspx
	[DllImport(Lib.Mpr, SetLastError = true, CharSet = CharSet.Auto)]
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/desktop/api/npapi/nf-npapi-wnetsetlasterrora void WNetSetLastErrorA( DWORD err, PSTR
	// lpError, PSTR lpProviders );
	[DllImport(Lib.Mpr, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// _In_ DWORD dwFlags, _Out_ PTSTR lpAccessName, _Inout_ LPDWORD lpBufferSize, _Out_ LPDWORD lpResult); https://msdn.microsoft.com/en-us/library/windows/desktop/aa385482(v=vs.85).aspx
	[DllImport(Lib.Mpr, SetLastError = true, CharSet = CharSet.Auto)]
	...
	/// </summary>
	// typedef struct _DISCDLGSTRUCT { DWORD cbStructure; HWND hwndOwner; PTSTR lpLocalName; PTSTR lpRemoteName; DWORD dwFlags;}
	...
	// typedef struct _NETRESOURCE { DWORD dwScope; DWORD dwType; DWORD dwDisplayType; DWORD dwUsage; PTSTR lpLocalName; PTSTR
	// lpRemoteName; PTSTR lpComment; PTSTR lpProvider;} NETRESOURCE; https://msdn.microsoft.com/en-us/library/windows/desktop/aa385353(v=vs.85).aspx
	...
	/// </summary>
	// typedef struct _REMOTE_NAME_INFO { PTSTR lpUniversalName; PTSTR lpConnectionName; PTSTR lpRemainingPath;} REMOTE_NAME_INFO; https://msdn.microsoft.com/en-us/library/windows/desktop/aa385366(v=vs.85).aspx
	...
	/// </summary>
	// typedef struct _UNIVERSAL_NAME_INFO { PTSTR lpUniversalName;} UNIVERSAL_NAME_INFO; https://msdn.microsoft.com/en-us/library/windows/desktop/aa385379(v=vs.85).aspx
