...
public static partial class VersionDll
{
	...
	// szFileName, LPCSTR szWinDir, LPCSTR szAppDir, PSTR szCurDir, PUINT puCurDirLen, PSTR szDestDir, PUINT puDestDirLen );
	...
	// szSrcFileName, LPCSTR szDestFileName, LPCSTR szSrcDir, LPCSTR szDestDir, LPCSTR szCurDir, PSTR szTmpFile, PUINT puTmpFileLen );
	[DllImport(Lib_Version, SetLastError = false, CharSet = CharSet.Auto)]
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/api/winver/nf-winver-verlanguagenamea DWORD VerLanguageNameA( DWORD wLang, PSTR
