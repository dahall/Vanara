...
public static partial class OleDlg
{
	...
	public interface IOleUILinkContainer
	{
		...
		// DWORD dwLink, StrPtrAnsi lpszDisplayName, ULONG lenFileName, ULONG *pchEaten, BOOL fValidateSource );
		[PreserveSig]
		...
		// DWORD dwLink, StrPtrAnsi *lplpszDisplayName, ULONG *lplenFileName, StrPtrAnsi *lplpszFullLinkType, StrPtrAnsi *lplpszShortLinkType, BOOL
	...
	public interface IOleUIObjInfo
	{
		...
		// dwObject, DWORD *lpdwObjSize, StrPtrAnsi *lplpszLabel, StrPtrAnsi *lplpszType, StrPtrAnsi *lplpszShortType, StrPtrAnsi *lplpszLocation );
		[PreserveSig]
	...
	// LPOLEUILINKCONTAINERA lpOleUILinkCntr, HWND hwndParent, StrPtrAnsi lpszTitle, int cLinks );
	[DllImport(Lib_OleDlg, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// DWORD dwLink; StrPtrAnsi lpszDisplayName; ULONG nFileLength; StrPtrAnsi lpszFrom; StrPtrAnsi lpszTo; } OLEUICHANGESOURCEA, *POLEUICHANGESOURCEA, *LPOLEUICHANGESOURCEA;
	[PInvokeData("oledlg.h", MSDNShortId = "NS:oledlg.tagOLEUICHANGESOURCEA")]
	[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
	...
	// dvAspect; WORD wFormat; BOOL fIsLinkedObject; HGLOBAL hMetaPict; StrPtrAnsi lpszUserType; BOOL fObjectsIconChanged; StrPtrAnsi
	...
	// DWORD cbStruct; DWORD dwFlags; HWND hWndOwner; LPCSTR lpszCaption; LPFNOLEUIHOOK lpfnHook; LPARAM lCustData; HINSTANCE hInstance;
	// LPCSTR lpszTemplate; HRSRC hResource; CLSID clsid; StrPtrAnsi lpszFile; UINT cchFile; UINT cClsidExclude; LPCLSID lpClsidExclude; IID
