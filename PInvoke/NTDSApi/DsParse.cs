...
public static partial class NTDSApi
{
	...
	// LPDWORD pcServiceClass, StrPtrAnsi ServiceClass, LPDWORD pcServiceName, StrPtrAnsi ServiceName, LPDWORD pcInstanceName, StrPtrAnsi InstanceName,
	...
	// LPCWSTR ServiceName, LPCWSTR InstanceName, USHORT InstancePort, LPCWSTR Referrer, DWORD *pcSpnLength, StrPtrUni pszSpn );
	[DllImport(Lib.NTDSApi, SetLastError = false, CharSet = CharSet.Auto)]
