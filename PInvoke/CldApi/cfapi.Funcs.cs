...
namespace Vanara.PInvoke
{
	...
	public static partial class CldApi
	{
		...
		public struct HCFFILE : IHandle
		{
			...
			/// <summary>Initializes a new instance of the <see cref="HCFFILE"/> struct.</summary>
			...
			/// <summary>Performs an explicit conversion from <see cref="HCFFILE"/> to <see cref="IntPtr"/>.</summary>
		...
		/// <summary>Provides a <see cref="SafeHandle"/> for <see cref="HCFFILE"/> that is disposed using <see cref="CfCloseHandle"/>.</summary>
		public class SafeHCFFILE : SafeHANDLE
		{
			/// <summary>Initializes a new instance of the <see cref="SafeHCFFILE"/> class and assigns an existing handle.</summary>
			/// <param name="preexistingHandle">An <see cref="IntPtr"/> object that represents the pre-existing handle to use.</param>
			...
			/// <summary>Initializes a new instance of the <see cref="SafeHCFFILE"/> class.</summary>
			private SafeHCFFILE() : base() { }

			/// <summary>Performs an implicit conversion from <see cref="SafeHCFFILE"/> to <see cref="HCFFILE"/>.</summary>
