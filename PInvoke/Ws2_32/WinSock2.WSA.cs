...
public static partial class Ws2_32
{
	...
	// LPSOCKADDR lpsaAddress, DWORD dwAddressLength, LPWSAPROTOCOL_INFOA lpProtocolInfo, StrPtrAnsi lpszAddressString, LPDWORD
	...
	// WSAGetServiceClassNameByClassIdA( LPGUID lpServiceClassId, StrPtrAnsi lpszServiceClassName, LPDWORD lpdwBufferLength );
	[DllImport(Lib.Ws2_32, SetLastError = false, CharSet = CharSet.Auto)]
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/api/winsock2/nf-winsock2-wsastringtoaddressa INT WSAAPI WSAStringToAddressA( StrPtrAnsi
