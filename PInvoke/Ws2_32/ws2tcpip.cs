...
public static partial class Ws2_32
{
	...
	[PInvokeData("ws2tcpip.h", MSDNShortId = "cc4ccb2d-ea5a-48bd-a3ae-f70432ab2c39")]
	public static unsafe extern WSRESULT GetAddrInfoExW([Optional, MarshalAs(UnmanagedType.LPWStr)] string? pName,
		[Optional, MarshalAs(UnmanagedType.LPWStr)] string? pServiceName, [Optional] NS dwNameSpace, [In, Optional] Guid* lpNspId,
		[In, Optional] ADDRINFOEXW* hints, out SafeADDRINFOEXWArray ppResult, [In, Optional] TIMEVAL* timeout,
		[In, Optional] NativeOverlapped* lpOverlapped, [In, Optional] LPLOOKUPSERVICE_COMPLETION_ROUTINE? lpCompletionRoutine,
	...
	public static extern WSRESULT GetAddrInfoW([Optional] string? pNodeName, [Optional] string? pServiceName, in ADDRINFOW pHints, out SafeADDRINFOWArray ppResult);
	...
	[DllImport(Lib.Ws2_32, SetLastError = true, ExactSpelling = true, CharSet = CharSet.Unicode)]
	[PInvokeData("ws2tcpip.h", MSDNShortId = "82436a88-5b37-4758-a5c9-b60dd1cbc36c")]
	public static extern WSRESULT GetAddrInfoW([Optional] string? pNodeName, [Optional] string? pServiceName, [In, Optional] IntPtr pHints, out SafeADDRINFOWArray ppResult);
	...
	public static WSRESULT getsourcefilter(SOCKET Socket, uint Interface, [In] SOCKADDR Group, int GroupLength, out MULTICAST_MODE_TYPE FilterMode, ref int SourceCount, SOCKADDR_STORAGE[]? SourceList)
	{
		...
		if (SourceCount > (SourceList?.Length ?? 0) || GroupLength > Group.Size)
		{
			WSASetLastError(WSRESULT.WSAENOBUFS);
			return SOCKET_ERROR;
		}
	...
	public static extern LPSTR inet_ntop(ADDRESS_FAMILY Family, in IN_ADDR pAddr, StringBuilder pStringBuf, SIZE_T StringBufSize);
	...
	[DllImport(Lib.Ws2_32, SetLastError = true, ExactSpelling = true, CharSet = CharSet.Ansi)]
	[PInvokeData("ws2tcpip.h", MSDNShortId = "1e26b88c-808f-4807-8641-e5c6b10853ad")]
	public static extern LPSTR inet_ntop(ADDRESS_FAMILY Family, in IN6_ADDR pAddr, StringBuilder pStringBuf, SIZE_T StringBufSize);
	...
	[DllImport(Lib.Ws2_32, SetLastError = true, ExactSpelling = true, CharSet = CharSet.Unicode)]
	[PInvokeData("ws2tcpip.h", MSDNShortId = "1e26b88c-808f-4807-8641-e5c6b10853ad")]
	public static extern LPWSTR InetNtopW(ADDRESS_FAMILY Family, in IN_ADDR pAddr, [MarshalAs(UnmanagedType.LPWStr)] StringBuilder pStringBuf, SIZE_T StringBufSize);
	...
	[DllImport(Lib.Ws2_32, SetLastError = true, ExactSpelling = true, CharSet = CharSet.Unicode)]
	[PInvokeData("ws2tcpip.h", MSDNShortId = "1e26b88c-808f-4807-8641-e5c6b10853ad")]
	public static extern LPWSTR InetNtopW(ADDRESS_FAMILY Family, in IN6_ADDR pAddr, [MarshalAs(UnmanagedType.LPWStr)] StringBuilder pStringBuf, SIZE_T StringBufSize);
