...
public static partial class ComDlg32
{
	...
	public interface IPrintDialogServices
	{
		...
		// GetCurrentPrinterName( StrPtrUni pPrinterName, UINT *pcchSize );
		[PreserveSig]
		...
		// GetCurrentPortName( StrPtrUni pPortName, UINT *pcchSize );
		[PreserveSig]
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/api/commdlg/nf-commdlg-getfiletitlea short GetFileTitleA( LPCSTR , StrPtrAnsi Buf, WORD
	// cchSize );
	[DllImport(Lib_ComDlg32, SetLastError = false, CharSet = CharSet.Auto)]
