...
namespace Vanara.PInvoke
{
	public static class NetListMgr
	{
		...
		[ComImport, Guid("DCB00000-570F-4A9B-8D69-199FDBA5723B"), InterfaceType(ComInterfaceType.InterfaceIsDual), CoClass(typeof(NetworkListManager))]
		...
		/// </summary>
		[ComImport, Guid("DCB00007-570F-4A9B-8D69-199FDBA5723B"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown), CoClass(typeof(NetworkListManager))]
		...
		/// </summary>
		[ComImport, Guid("DCB00004-570F-4A9B-8D69-199FDBA5723B"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown), CoClass(typeof(NetworkListManager))]
		...
		/// </summary>
		[ComImport, Guid("DCB00001-570F-4A9B-8D69-199FDBA5723B"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown), CoClass(typeof(NetworkListManager))]
		...
		public struct NLM_DATAPLAN_STATUS
		{
			...
			public bool IsDefined
			{
				get
				{
					...
					if (UsageData.UsageInMegabytes != NLM_UNKNOWN_DATAPLAN_STATUS && (UsageData.LastSyncTime.dwHighDateTime != 0 || UsageData.LastSyncTime.dwLowDateTime != 0))
						return true;
					if (DataLimitInMegabytes != NLM_UNKNOWN_DATAPLAN_STATUS)
						return true;
					if (InboundBandwidthInKbps != NLM_UNKNOWN_DATAPLAN_STATUS)
						return true;
					if (OutboundBandwidthInKbps != NLM_UNKNOWN_DATAPLAN_STATUS)
						return true;
					if (NextBillingCycle.dwHighDateTime != 0 || NextBillingCycle.dwLowDateTime != 0)
						return true;
					if (MaxTransferSizeInMegabytes != NLM_UNKNOWN_DATAPLAN_STATUS)
						return true;
					return false;
				}
			}
		...
		/// <seealso cref="NetworkListManager"/>
