...
public static partial class Wer
{
	...
	public struct HREPORT : IHandle
	{
		...
		public static HREPORT NULL => new(IntPtr.Zero);
		...
		/// <returns>The result of the conversion.</returns>
		public static implicit operator HREPORT(IntPtr h) => new(h);
	...
	public struct HREPORTSTORE : IHandle
	{
		...
		public static HREPORTSTORE NULL => new(IntPtr.Zero);
		...
		/// <param name="h">The pointer to a handle.</param>
		/// <returns>The result of the conversion.</returns>
		public static implicit operator HREPORTSTORE(IntPtr h) => new(h);
