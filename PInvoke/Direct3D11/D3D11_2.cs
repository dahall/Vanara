...
public static partial class D3D11
{
	...
	public interface ID3D11DeviceContext2 : ID3D11DeviceContext1, ID3D11DeviceContext, ID3D11DeviceChild
	{
		...
		[PreserveSig]
		new void UpdateSubresource([In] ID3D11Resource pDstResource, uint DstSubresource, [In, Optional, StructPointer(typeof(D3D11_BOX))] IntPtr pDstBox,
		...
		[PreserveSig]
		new void ClearUnorderedAccessViewFloat([In] ID3D11UnorderedAccessView pUnorderedAccessView, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] float[] Values);
		...
		new void CopySubresourceRegion1([In] ID3D11Resource pDstResource, uint DstSubresource, uint DstX, uint DstY, uint DstZ, [In] ID3D11Resource pSrcResource,
			uint SrcSubresource, [In, Optional, StructPointer(typeof(D3D11_BOX))] IntPtr pSrcBox, D3D11_COPY_FLAGS CopyFlags);
		...
		[PreserveSig]
		new void UpdateSubresource1([In] ID3D11Resource pDstResource, uint DstSubresource, [In, Optional, StructPointer(typeof(D3D11_BOX))] IntPtr pDstBox,
