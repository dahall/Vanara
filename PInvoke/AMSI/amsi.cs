...
public static partial class AMSI
{
	...
	{
		/// <summary>Return the name, version, or GUID string of the calling application, copied from a <c>StrPtrUni</c>.</summary>
		[CorrespondingType(typeof(string))]
		AMSI_ATTRIBUTE_APP_NAME = 0,

		/// <summary>Return the filename, URL, unique script ID, or similar of the content, copied from a <c>StrPtrUni</c>.</summary>
		[CorrespondingType(typeof(string))]
