...
public static partial class Imm32
{
	...
	public enum IMEPADREQ
	{
		...
		/// <para>wParam: Pointer to the NULL-terminated string (StrPtrUni) to be inserted into the app.</para>
		...
		/// <para>wParam: Points to the buffer (StrPtrUni) that is to receive the current composition string text.</para>
		...
		/// <para>wParam: Pointer to the replacement string (StrPtrUni).</para>
		/// <para>
		...
		/// <para>wParam = (WPARAM)(StrPtrUni)lpwstrFontFace; //FontFace name</para>
