...
public static partial class Dwrite
{
	...
	public interface IDWriteTextAnalysisSource
	{
		...
		void GetTextAtPosition(uint textPosition, out LPWSTR textString, out uint textLength);
		...
		void GetTextBeforePosition(uint textPosition, out LPWSTR textString, out uint textLength);
		...
		void GetLocaleName(uint textPosition, out uint textLength, out LPWSTR localeName);
