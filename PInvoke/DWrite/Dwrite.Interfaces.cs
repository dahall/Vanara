...
public static partial class Dwrite
{
	...
	public interface IDWriteTextLayout : IDWriteTextFormat
	{
		...
		[PreserveSig]
		HRESULT GetLineMetrics([Out, Optional, MarshalAs(UnmanagedType.LPArray), SizeDef(nameof(maxLineCount), SizingMethod.CheckLastError, OutVarName = nameof(actualLineCount))] DWRITE_LINE_METRICS[]? lineMetrics, uint maxLineCount, out uint actualLineCount);
		...
		[PreserveSig]
		HRESULT GetClusterMetrics([Out, MarshalAs(UnmanagedType.LPArray), SizeDef(nameof(maxClusterCount), SizingMethod.CheckLastError, OutVarName = nameof(actualClusterCount))] DWRITE_CLUSTER_METRICS[]? clusterMetrics, uint maxClusterCount, out uint actualClusterCount);
