...
public static partial class Dwrite
{
	...
	public interface IDWriteTextAnalysisSource1 : IDWriteTextAnalysisSource
	{
		...
		new void GetTextAtPosition(uint textPosition, out LPWSTR textString, out uint textLength);
		...
		new void GetTextBeforePosition(uint textPosition, out LPWSTR textString, out uint textLength);
		...
		new void GetLocaleName(uint textPosition, out uint textLength, out LPWSTR localeName);
