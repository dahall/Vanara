...
public static partial class WinBio
{
	...
	// UnitId, PWINBIO_BIR Sample, SizeT SampleSize, WINBIO_REJECT_DETAIL RejectDetail ) {...}
	...
	// WINBIO_BIOMETRIC_TYPE Factor, WINBIO_POOL_TYPE PoolType, WINBIO_SESSION_FLAGS Flags, WINBIO_UNIT_ID *UnitArray, SizeT UnitCount,
	...
	/// A pointer to a <c>SizeT</c> value that contains the size, in bytes, of the WINBIO_BIR structure returned in the Sample parameter.
	/// </param>
	/// <param name="RejectDetail">
	/// <para>
	...
	// *Sample, SizeT *SampleSize, WINBIO_REJECT_DETAIL *RejectDetail );
	[DllImport(Lib_Winbio, SetLastError = false, ExactSpelling = true)]
	...
	/// <para>
	/// <code>VOID CALLBACK CaptureCallback( __in_opt PVOID CaptureCallbackContext, __in HRESULT OperationStatus, __in WINBIO_UNIT_ID UnitId, __in_bcount(SampleSize) PWINBIO_BIR Sample, __in SizeT SampleSize, __in WINBIO_REJECT_DETAIL RejectDetail );</code>
	/// </para>
	/// <para>Examples</para>
	/// <para>
	...
	/// Pointer to a <c>SizeT</c> value that contains the size, in bytes, of the data written to the buffer specified by the
	...
	// SizeT SendBufferSize, PUCHAR ReceiveBuffer, SizeT ReceiveBufferSize, SizeT *ReceiveDataSize, ULONG *OperationStatus );
	[DllImport(Lib_Winbio, SetLastError = false, ExactSpelling = true)]
	...
	// ControlCode, PUCHAR SendBuffer, SizeT SendBufferSize, PUCHAR ReceiveBuffer, SizeT ReceiveBufferSize, SizeT *ReceiveDataSize,
	...
	// WINBIO_BIOMETRIC_TYPE Factor, WINBIO_UNIT_SCHEMA **UnitSchemaArray, SizeT *UnitCount );
	[DllImport(Lib_Winbio, SetLastError = false, ExactSpelling = true)]
	...
	/// </list>
	/// <para>
	/// <code>HRESULT EnumerateSensors( ) { HRESULT hr = S_OK; PWINBIO_UNIT_SCHEMA unitSchema = NULL; SizeT unitCount = 0; // Enumerate the installed biometric units. hr = WinBioEnumBiometricUnits( WINBIO_TYPE_FINGERPRINT, // Type of biometric unit &amp;unitSchema, // Array of unit schemas &amp;unitCount ); // Count of unit schemas if (FAILED(hr)) { wprintf_s(L"\nWinBioEnumBiometricUnits failed. hr = 0x%x\n", hr); goto e_Exit; } e_Exit: // Free memory. if (unitSchema != NULL) { WinBioFree(unitSchema); unitSchema = NULL; } return hr; }</code>
	/// </para>
	/// </remarks>
	...
	// WINBIO_CREDENTIAL_TYPE Type, PUCHAR Credential, SizeT CredentialSize, WINBIO_CREDENTIAL_FORMAT Format );
	[DllImport(Lib_Winbio, SetLastError = true, ExactSpelling = true)]
	...
	// WINBIO_IDENTITY *Identity, WINBIO_BIOMETRIC_SUBTYPE SubFactor, PVOID PropertyBuffer, SizeT PropertyBufferSize );
	[DllImport(Lib_Winbio, SetLastError = false, ExactSpelling = true)]
	...
	// WINBIO_IDENTITY Identity; BOOLEAN IsNewTemplate; } EnrollCommit; struct { WINBIO_IDENTITY Identity; SizeT SubFactorCount;
	// WINBIO_BIOMETRIC_SUBTYPE *SubFactorArray; } EnumEnrollments; struct { PWINBIO_BIR Sample; SizeT SampleSize; WINBIO_REJECT_DETAIL
	...
	// SizeT PropertyBufferSize; PVOID PropertyBuffer; } GetProperty; struct { WINBIO_PROPERTY_TYPE PropertyType; WINBIO_PROPERTY_ID
	// PropertyId; WINBIO_IDENTITY Identity; WINBIO_BIOMETRIC_SUBTYPE SubFactor; SizeT PropertyBufferSize; PVOID PropertyBuffer; }
	// SetProperty; struct { WINBIO_EVENT Event; } GetEvent; struct { WINBIO_COMPONENT Component; ULONG ControlCode; ULONG
	// OperationStatus; PUCHAR SendBuffer; SizeT SendBufferSize; PUCHAR ReceiveBuffer; SizeT ReceiveBufferSize; SizeT
	// ReceiveDataSize; } ControlUnit; struct { SizeT BspCount; WINBIO_BSP_SCHEMA *BspSchemaArray; } EnumServiceProviders; struct {
	// SizeT UnitCount; WINBIO_UNIT_SCHEMA *UnitSchemaArray; } EnumBiometricUnits; struct { SizeT StorageCount; WINBIO_STORAGE_SCHEMA
	...
	// struct { WINBIO_PRESENCE_CHANGE ChangeType; SizeT PresenceCount; WINBIO_PRESENCE *PresenceArray; } MonitorPresence; struct {
