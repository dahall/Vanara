...
public static partial class SearchApi
{
	...
	public interface IEntity
	{
		...
		// https://docs.microsoft.com/en-us/windows/desktop/api/structuredquery/nf-structuredquery-ientity-name HRESULT Name( PWSTR
		// *ppszName );
		...
		// DefaultPhrase( PWSTR *ppszPhrase );
		[return: MarshalAs(UnmanagedType.LPWStr)]
	...
	public interface IQueryParser
	{
		...
		// RestateToString( ICondition *pCondition, BOOL fUseEnglish, PWSTR *ppszQueryString );
		[return: MarshalAs(UnmanagedType.LPWStr)]
		...
		// HRESULT RestatePropertyValueToString( ICondition *pCondition, BOOL fUseEnglish, PWSTR *ppszPropertyName, PWSTR
		// *ppszQueryString );
	...
	public interface IQuerySolution : IConditionFactory
	{
		...
		// GetLexicalData( PWSTR *ppszInputString, ITokenCollection **ppTokens, LCID *plcid, IUnknown **ppWordBreaker );
	...
	public interface ISchemaLocalizerSupport
	{
		...
		// HRESULT Localize( LPCWSTR pszGlobalString, PWSTR *ppszLocalString );
		[PreserveSig]
	...
	public interface ISchemaProvider
	{
		...
		// cTokensBegin, ULONG *pcTokensLength, PWSTR *ppszValue );
	...
	public interface ITokenCollection
	{
		...
		// GetToken( ULONG i, ULONG *pBegin, ULONG *pLength, PWSTR *ppsz );
