...
public static partial class WinSpool
{
	...
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/addmonitor BOOL AddMonitor( _In_ PTSTR pName, _In_ DWORD Level, _In_
	// LPBYTE pMonitors );
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/addport BOOL AddPort( _In_ PTSTR pName, _In_ HWND hWnd, _In_ PTSTR
	// pMonitorName );
	[DllImport(Lib.Winspool, SetLastError = false, CharSet = CharSet.Auto)]
	...
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/addprinterdriver BOOL AddPrinterDriver( _In_ PTSTR pName, _In_ DWORD
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/addprinterdriverex BOOL AddPrinterDriverEx( _In_ PTSTR pName, _In_
	...
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/addprintprocessor BOOL AddPrintProcessor( _In_ PTSTR pName, _In_ PTSTR
	// pEnvironment, _In_ PTSTR pPathName, _In_ PTSTR pPrintProcessorName );
	[DllImport(Lib.Winspool, SetLastError = false, CharSet = CharSet.Auto)]
	...
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/addprintprovidor BOOL AddPrintProvidor( _In_ PTSTR pName, _In_ DWORD
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/deletemonitor BOOL DeleteMonitor( _In_ PTSTR pName, _In_ PTSTR
	// pEnvironment, _In_ PTSTR pMonitorName );
	[DllImport(Lib.Winspool, SetLastError = false, CharSet = CharSet.Auto)]
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/deleteport BOOL DeletePort( _In_ PTSTR pName, _In_ HWND hWnd, _In_
	// PTSTR pPortName );
	[DllImport(Lib.Winspool, SetLastError = false, CharSet = CharSet.Auto)]
	...
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/deleteprinterdriver BOOL DeletePrinterDriver( _In_ PTSTR pName, _In_
	// PTSTR pEnvironment, _In_ PTSTR pDriverName );
	[DllImport(Lib.Winspool, SetLastError = false, CharSet = CharSet.Auto)]
	...
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/deleteprinterdriverex BOOL DeletePrinterDriverEx( _In_ PTSTR pName,
	// _In_ PTSTR pEnvironment, _In_ PTSTR pDriverName, _In_ DWORD dwDeleteFlag, _In_ DWORD dwVersionFlag );
	[DllImport(Lib.Winspool, SetLastError = false, CharSet = CharSet.Auto)]
	[PInvokeData("winspool.h", MSDNShortId = "1a3d7c7f-1d45-4877-a8f7-a77f40e3c319")]
	[return: MarshalAs(UnmanagedType.Bool)]
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/deleteprintprocessor BOOL DeletePrintProcessor( _In_ PTSTR pName, _In_
	// PTSTR pEnvironment, _In_ PTSTR pPrintProcessorName );
	[DllImport(Lib.Winspool, SetLastError = false, CharSet = CharSet.Auto)]
	...
	/// </returns>
	/// <remarks/>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/deleteprintprovidor BOOL DeletePrintProvidor( _In_ PTSTR pName, _In_
	// PTSTR pEnvironment, _In_ PTSTR pPrintProviderName );
	[DllImport(Lib.Winspool, SetLastError = false, CharSet = CharSet.Auto)]
	...
	/// </returns>
	/// <remarks/>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/enummonitors BOOL EnumMonitors( _In_ PTSTR pName, _In_ DWORD Level,
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/enumports BOOL EnumPorts( _In_ PTSTR pName, _In_ DWORD Level, _Out_
	...
	/// </returns>
	/// <remarks/>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/enumprinterdrivers BOOL EnumPrinterDrivers( _In_ PTSTR pName, _In_
	// PTSTR pEnvironment, _In_ DWORD Level, _Out_ LPBYTE pDriverInfo, _In_ DWORD cbBuf, _Out_ LPDWORD pcbNeeded, _Out_ LPDWORD
	// pcReturned );
	[DllImport(Lib.Winspool, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// PTSTR pName, _In_ PTSTR pPrintProcessorName, _In_ DWORD Level, _Out_ LPBYTE pDatatypes, _In_ DWORD cbBuf, _Out_ LPDWORD
	...
	/// </returns>
	/// <remarks/>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/enumprintprocessors BOOL EnumPrintProcessors( _In_ PTSTR pName, _In_
	// PTSTR pEnvironment, _In_ DWORD Level, _Out_ LPBYTE pPrintProcessorInfo, _In_ DWORD cbBuf, _Out_ LPDWORD pcbNeeded, _Out_ LPDWORD
	// pcReturned );
	[DllImport(Lib.Winspool, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// PTSTR pEnvironment, _In_ DWORD Level, _Out_ LPBYTE pDriverInfo, _In_ DWORD cbBuf, _Out_ LPDWORD pcbNeeded );
	[DllImport(Lib.Winspool, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// HANDLE hPrinter, _In_opt_ PTSTR pEnvironment, _In_ DWORD Level, _Out_ LPBYTE pDriverInfo, _In_ DWORD cbBuf, _Out_ LPDWORD
	// pcbNeeded );
	[DllImport(Lib.Winspool, SetLastError = true, CharSet = CharSet.Auto)]
	...
	/// </returns>
	/// <remarks/>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/getprinterdriverdirectory BOOL GetPrinterDriverDirectory( _In_ PTSTR
	// pName, _In_ PTSTR pEnvironment, _In_ DWORD Level, _Out_ LPBYTE pDriverDirectory, _In_ DWORD cbBuf, _Out_ LPDWORD pcbNeeded );
	[DllImport(Lib.Winspool, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// LPCTSTR pszServer, _In_ LPCTSTR pszEnvironment, _In_ LPCTSTR pszLanguage, _In_ LPCTSTR pszPackageID, _Inout_ PTSTR
	...
	/// </returns>
	/// <remarks/>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/getprintprocessordirectory BOOL GetPrintProcessorDirectory( _In_ PTSTR
	// pName, _In_ PTSTR pEnvironment, _In_ DWORD Level, _Out_ LPBYTE pPrintProcessorInfo, _In_ DWORD cbBuf, _Out_ LPDWORD pcbNeeded );
	[DllImport(Lib.Winspool, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// LPCTSTR pszServer, _In_ LPCTSTR pszInfPath, _In_ LPCTSTR pszEnvironment, _In_ DWORD dwFlags, _In_ HWND hwnd, _Out_ PTSTR
