...
public static partial class WinSpool
{
	...
	/// that job.
	/// </summary>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/addjob-info-1 typedef struct _ADDJOB_INFO_1 { StrPtrAuto Path; DWORD JobId;
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/datatypes-info-1 typedef struct _DATATYPES_INFO_1 { StrPtrAuto pName; }
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/doc-info-1 typedef struct _DOC_INFO_1 { StrPtrAuto pDocName; StrPtrAuto
	// pOutputFile; StrPtrAuto pDatatype; } DOC_INFO_1;
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/doc-info-2 typedef struct _DOC_INFO_2 { StrPtrAuto pDocName; StrPtrAuto
	// pOutputFile; StrPtrAuto pDatatype; DWORD dwMode; DWORD JobId; } DOC_INFO_2, *PDOC_INFO_2;
	...
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/doc-info-3 typedef struct _DOC_INFO_3 { StrPtrAuto pDocName; StrPtrAuto
	// pOutputFile; StrPtrAuto pDatatype; DWORD dwFlags; } DOC_INFO_3, *PDOC_INFO_3;
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/driver-info-1 typedef struct _DRIVER_INFO_1 { StrPtrAuto pName; }
	...
	/// </summary>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/driver-info-2 typedef struct _DRIVER_INFO_2 { DWORD cVersion; StrPtrAuto
	// pName; StrPtrAuto pEnvironment; StrPtrAuto pDriverPath; StrPtrAuto pDataFile; StrPtrAuto pConfigFile; } DRIVER_INFO_2, *PDRIVER_INFO_2;
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/driver-info-3 typedef struct _DRIVER_INFO_3 { DWORD cVersion; StrPtrAuto
	// pName; StrPtrAuto pEnvironment; StrPtrAuto pDriverPath; StrPtrAuto pDataFile; StrPtrAuto pConfigFile; StrPtrAuto pHelpFile; StrPtrAuto pDependentFiles;
	// StrPtrAuto pMonitorName; StrPtrAuto pDefaultDataType; } DRIVER_INFO_3, *PDRIVER_INFO_3;
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/driver-info-4 typedef struct _DRIVER_INFO_4 { DWORD cVersion; StrPtrAuto
	// pName; StrPtrAuto pEnvironment; StrPtrAuto pDriverPath; StrPtrAuto pDataFile; StrPtrAuto pConfigFile; StrPtrAuto pHelpFile; StrPtrAuto pDependentFiles;
	// StrPtrAuto pMonitorName; StrPtrAuto pDefaultDataType; StrPtrAuto pszzPreviousNames; } DRIVER_INFO_4, *PDRIVER_INFO_4;
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/driver-info-5 typedef struct _DRIVER_INFO_5 { DWORD cVersion; StrPtrAuto
	// pName; StrPtrAuto pEnvironment; StrPtrAuto pDriverPath; StrPtrAuto pDataFile; StrPtrAuto pConfigFile; DWORD dwDriverAttributes; DWORD
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/driver-info-6 typedef struct _DRIVER_INFO_6 { DWORD cVersion; StrPtrAuto
	// pName; StrPtrAuto pEnvironment; StrPtrAuto pDriverPath; StrPtrAuto pDataFile; StrPtrAuto pConfigFile; StrPtrAuto pHelpFile; StrPtrAuto pDependentFiles;
	// StrPtrAuto pMonitorName; StrPtrAuto pDefaultDataType; StrPtrAuto pszzPreviousNames; FILETIME ftDriverDate; DWORDLONG dwlDriverVersion; StrPtrAuto
	// pszMfgName; StrPtrAuto pszOEMUrl; StrPtrAuto pszHardwareID; StrPtrAuto pszProvider; } DRIVER_INFO_6, *PDRIVER_INFO_6, *LPDRIVER_INFO_6;
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/driver-info-8 typedef struct _DRIVER_INFO_8 { DWORD cVersion; StrPtrAuto
	// pName; StrPtrAuto pEnvironment; StrPtrAuto pDriverPath; StrPtrAuto pDataFile; StrPtrAuto pConfigFile; StrPtrAuto pHelpFile; StrPtrAuto pDependentFiles;
	// StrPtrAuto pMonitorName; StrPtrAuto pDefaultDataType; StrPtrAuto pszzPreviousNames; FILETIME ftDriverDate; DWORDLONG dwlDriverVersion; StrPtrAuto
	// pszMfgName; StrPtrAuto pszOEMUrl; StrPtrAuto pszHardwareID; StrPtrAuto pszProvider; StrPtrAuto pszPrintProcessor; StrPtrAuto pszVendorSetup; StrPtrAuto
	// pszzColorProfiles; StrPtrAuto pszInfPath; DWORD dwPrinterDriverAttributes; StrPtrAuto pszzCoreDriverDependencies; FILETIME
	...
	/// </summary>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/form-info-1 typedef struct _FORM_INFO_1 { DWORD Flags; StrPtrAuto pName;
	...
	/// </list>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/form-info-2 typedef struct _FORM_INFO_2 { DWORD Flags; StrPtrAuto pName;
	...
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/job-info-1 typedef struct _JOB_INFO_1 { DWORD JobId; StrPtrAuto
	// pPrinterName; StrPtrAuto pMachineName; StrPtrAuto pUserName; StrPtrAuto pDocument; StrPtrAuto pDatatype; StrPtrAuto pStatus; DWORD Status; DWORD
	...
	/// Port monitors that do not support TrueEndOfJob will set the job as JOB_STATUS_PRINTED right after the job is submitted to the printer.
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/job-info-2 typedef struct _JOB_INFO_2 { DWORD JobId; StrPtrAuto
	// pPrinterName; StrPtrAuto pMachineName; StrPtrAuto pUserName; StrPtrAuto pDocument; StrPtrAuto pNotifyName; StrPtrAuto pDatatype; StrPtrAuto
	// pPrintProcessor; StrPtrAuto pParameters; StrPtrAuto pDriverName; LPDEVMODE pDevMode; StrPtrAuto pStatus; PSECURITY_DESCRIPTOR
	...
	/// the printer.
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/job-info-4 typedef struct _JOB_INFO_4 { DWORD JobId; StrPtrAuto
	// pPrinterName; StrPtrAuto pMachineName; StrPtrAuto pUserName; StrPtrAuto pDocument; StrPtrAuto pNotifyName; StrPtrAuto pDatatype; StrPtrAuto
	// pPrintProcessor; StrPtrAuto pParameters; StrPtrAuto pDriverName; LPDEVMODE pDevMode; StrPtrAuto pStatus; PSECURITY_DESCRIPTOR
	// pSecurityDescriptor; DWORD Status; DWORD Priority; DWORD Position; DWORD StartTime; DWORD UntilTime; DWORD TotalPages; DWORD
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/monitor-info-1 typedef struct _MONITOR_INFO_1 { StrPtrAuto pName; }
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/monitor-info-2 typedef struct _MONITOR_INFO_2 { StrPtrAuto pName; StrPtrAuto
	// pEnvironment; StrPtrAuto pDLLName; } MONITOR_INFO_2, *PMONITOR_INFO_2;
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/port-info-1 typedef struct _PORT_INFO_1 { StrPtrAuto pName; } PORT_INFO_1, *PPORT_INFO_1;
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/port-info-2 typedef struct _PORT_INFO_2 { StrPtrAuto pPortName; StrPtrAuto
	// pMonitorName; StrPtrAuto pDescription; DWORD fPortType; DWORD Reserved; } PORT_INFO_2, *PPORT_INFO_2;
	...
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/port-info-3 typedef struct _PORT_INFO_3 { DWORD dwStatus; StrPtrAuto
	...
	// DWORD dwFlags; StrPtrAuto pszDriverName; } PRINTER_CONNECTION_INFO_1, *PPRINTER_CONNECTION_INFO_1;
	...
	/// </summary>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/printer-enum-values typedef struct _PRINTER_ENUM_VALUES { StrPtrAuto
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/printer-info-1 typedef struct _PRINTER_INFO_1 { DWORD Flags; StrPtrAuto
	// pDescription; StrPtrAuto pName; StrPtrAuto pComment; } PRINTER_INFO_1, *PPRINTER_INFO_1;
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/printer-info-2 typedef struct _PRINTER_INFO_2 { StrPtrAuto pServerName;
	// StrPtrAuto pPrinterName; StrPtrAuto pShareName; StrPtrAuto pPortName; StrPtrAuto pDriverName; StrPtrAuto pComment; StrPtrAuto pLocation; LPDEVMODE
	// pDevMode; StrPtrAuto pSepFile; StrPtrAuto pPrintProcessor; StrPtrAuto pDatatype; StrPtrAuto pParameters; PSECURITY_DESCRIPTOR
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/printer-info-4 typedef struct _PRINTER_INFO_4 { StrPtrAuto pPrinterName;
	// StrPtrAuto pServerName; DWORD Attributes; } PRINTER_INFO_4, *PPRINTER_INFO_4;
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/printer-info-5 typedef struct _PRINTER_INFO_5 { StrPtrAuto pPrinterName;
	// StrPtrAuto pPortName; DWORD Attributes; DWORD DeviceNotSelectedTimeout; DWORD TransmissionRetryTimeout; } PRINTER_INFO_5, *PPRINTER_INFO_5;
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/printer-info-7 typedef struct _PRINTER_INFO_7 { StrPtrAuto pszObjectGUID;
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/printprocessor-info-1 typedef struct _PRINTPROCESSOR_INFO_1 { StrPtrAuto
	...
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/providor-info-1 typedef struct _PROVIDOR_INFO_1 { StrPtrAuto pName; StrPtrAuto
	// pEnvironment; StrPtrAuto pDLLName; } PROVIDOR_INFO_1, *PPROVIDOR_INFO_1;
	...
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/providor-info-2 typedef struct _PROVIDOR_INFO_2 { StrPtrAuto pOrder; }
	...
	/// </summary>
	// https://docs.microsoft.com/en-us/windows/win32/printdocs/printer-defaults typedef struct _PRINTER_DEFAULTS { StrPtrAuto pDatatype;
	...
	public partial class SafeHSPOOLFILE
	{
