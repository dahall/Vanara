...
public static partial class WinSCard
{
	...
	// SCardGetReaderDeviceInstanceIdA( [in] SCARDCONTEXT hContext, [in] LPCSTR szReaderName, [out, optional] StrPtrAnsi szDeviceInstanceId, [in,
	...
	// SCARDCONTEXT hContext, [out] StrPtrAnsi mszGroups, [in, out] LPDWORD pcchGroups );
	[DllImport(Lib_Winscard, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// hContext, [in, optional] LPCSTR mszGroups, [out] StrPtrAnsi mszReaders, [in, out] LPDWORD pcchReaders );
	[DllImport(Lib_Winscard, SetLastError = false, CharSet = CharSet.Auto)]
	...
	/// 
	/// StrPtrAuto   pmszReaders = NULL;
	/// StrPtrAuto   pReader = NULL;WCHAR
	...
	// SCardListReadersWithDeviceInstanceIdA( [in] SCARDCONTEXT hContext, [in] LPCSTR szDeviceInstanceId, [out, optional] StrPtrAnsi mszReaders,
	...
	// hContext, [in] UUID *CardIdentifier, [in] DWORD FreshnessCounter, [in] StrPtrAnsi LookupName, [out] PBYTE Data, [out] DWORD *DataLen );
	[DllImport(Lib_Winscard, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// StrPtrAnsi mszReaderNames, [in, out, optional] LPDWORD pcchReaderLen, [out, optional] LPDWORD pdwState, [out, optional] LPDWORD
	...
	// hContext, [in] UUID *CardIdentifier, [in] DWORD FreshnessCounter, [in] StrPtrAnsi LookupName, [in] PBYTE Data, [in] DWORD DataLen );
	[DllImport(Lib_Winscard, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// StrPtrAnsi lpstrGroupNames; DWORD nMaxGroupNames; LPCGUID rgguidInterfaces; DWORD cguidInterfaces; StrPtrAnsi lpstrCardNames; DWORD
	...
	// hwndOwner; SCARDCONTEXT hSCardContext; StrPtrAnsi lpstrGroupNames; DWORD nMaxGroupNames; StrPtrAnsi lpstrCardNames; DWORD nMaxCardNames; LPCGUID
	// rgguidInterfaces; DWORD cguidInterfaces; StrPtrAnsi lpstrRdr; DWORD nMaxRdr; StrPtrAnsi lpstrCard; DWORD nMaxCard; LPCSTR lpstrTitle; DWORD
	...
	// dwPreferredProtocols; StrPtrAnsi lpstrRdr; DWORD nMaxRdr; StrPtrAnsi lpstrCard; DWORD nMaxCard; DWORD dwActiveProtocol; SCARDHANDLE hCardHandle;
