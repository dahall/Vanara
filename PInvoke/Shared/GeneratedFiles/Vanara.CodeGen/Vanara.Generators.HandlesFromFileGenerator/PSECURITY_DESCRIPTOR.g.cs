...
public partial struct PSECURITY_DESCRIPTOR : ISecurityObject
{
	...
	/// <returns>The result of the operator.</returns>
	public static bool operator !(PSECURITY_DESCRIPTOR h1) => h1.IsNull;

#if !NETSTANDARD
	/// <summary>Implements the operator <see langword="true"/>.</summary>
	/// <param name="h">The value.</param>
	/// <returns>The result of the operator.</returns>
	public static bool operator true(PSECURITY_DESCRIPTOR h) => !h.IsInvalid;

	/// <summary>Implements the operator <see langword="false"/>.</summary>
	/// <param name="h">The value.</param>
	/// <returns>The result of the operator.</returns>
	public static bool operator false(PSECURITY_DESCRIPTOR h) => h.IsInvalid;
#endif

	/// <inheritdoc/>
	public readonly override bool Equals(object obj) => obj is PSECURITY_DESCRIPTOR h && handle == h.handle;
