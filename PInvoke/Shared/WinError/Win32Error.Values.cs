...
public partial struct Win32Error
{
	...
	public const uint ERROR_FILE_NOT_FOUND = 0x00000002;

	/// <summary>The system cannot find the path specified.</summary>
	public const uint ERROR_PATH_NOT_FOUND = 0x00000003;

	/// <summary>The system cannot open the file.</summary>
	public const uint ERROR_TOO_MANY_OPEN_FILES = 0x00000004;
	...
	public const uint ERROR_REM_NOT_LIST = 0x00000033;
	...
	public const uint ERROR_REQ_NOT_ACCEP = 0x00000047;

	/// <summary>The specified printer or disk device has been paused.</summary>
	public const uint ERROR_REDIR_PAUSED = 0x00000048;

	/// <summary>The file exists.</summary>
	public const uint ERROR_FILE_EXISTS = 0x00000050;

	/// <summary>The directory or file cannot be created.</summary>
	public const uint ERROR_CANNOT_MAKE = 0x00000052;

	/// <summary>Fail on INT 24.</summary>
	public const uint ERROR_FAIL_I24 = 0x00000053;

	/// <summary>Storage to process this request is not available.</summary>
	public const uint ERROR_OUT_OF_STRUCTURES = 0x00000054;
	...
	public const uint ERROR_INVALID_FLAG_NUMBER = 0x000000BA;

	/// <summary>The specified system semaphore name was not found.</summary>
	public const uint ERROR_SEM_NOT_FOUND = 0x000000BB;

	/// <summary>The operating system cannot run %1.</summary>
	public const uint ERROR_INVALID_STARTING_CODESEG = 0x000000BC;

	/// <summary>The operating system cannot run %1.</summary>
	public const uint ERROR_INVALID_STACKSEG = 0x000000BD;

	/// <summary>The operating system cannot run %1.</summary>
	public const uint ERROR_INVALID_MODULETYPE = 0x000000BE;

	/// <summary>Cannot run %1 in Win32 mode.</summary>
	public const uint ERROR_INVALID_EXE_SIGNATURE = 0x000000BF;

	/// <summary>The operating system cannot run %1.</summary>
	public const uint ERROR_EXE_MARKED_INVALID = 0x000000C0;

	/// <summary>%1 is not a valid Win32 application.</summary>
	public const uint ERROR_BAD_EXE_FORMAT = 0x000000C1;

	/// <summary>The operating system cannot run %1.</summary>
	public const uint ERROR_ITERATED_DATA_EXCEEDS_64k = 0x000000C2;

	/// <summary>The operating system cannot run %1.</summary>
	public const uint ERROR_INVALID_MINALLOCSIZE = 0x000000C3;

	/// <summary>The operating system cannot run this application program.</summary>
	public const uint ERROR_DYNLINK_FROM_INVALID_RING = 0x000000C4;

	/// <summary>The operating system is not presently configured to run this application.</summary>
	public const uint ERROR_IOPL_NOT_ENABLED = 0x000000C5;

	/// <summary>The operating system cannot run %1.</summary>
	public const uint ERROR_INVALID_SEGDPL = 0x000000C6;

	/// <summary>The operating system cannot run this application program.</summary>
	public const uint ERROR_AUTODATASEG_EXCEEDS_64k = 0x000000C7;

	/// <summary>The code segment cannot be greater than or equal to 64 KB.</summary>
	public const uint ERROR_RING2SEG_MUST_BE_MOVABLE = 0x000000C8;

	/// <summary>The operating system cannot run %1.</summary>
	public const uint ERROR_RELOC_CHAIN_XEEDS_SEGLIM = 0x000000C9;

	/// <summary>The operating system cannot run %1.</summary>
	public const uint ERROR_INFLOOP_IN_RELOC_CHAIN = 0x000000CA;

	/// <summary>The system could not find the environment option that was entered.</summary>
	public const uint ERROR_ENVVAR_NOT_FOUND = 0x000000CB;

	/// <summary>No process in the command subtree has a signal handler.</summary>
	public const uint ERROR_NO_SIGNAL_SENT = 0x000000CD;

	/// <summary>The file name or extension is too long.</summary>
	public const uint ERROR_FILENAME_EXCED_RANGE = 0x000000CE;

	/// <summary>The ring 2 stack is in use.</summary>
	public const uint ERROR_RING2_STACK_IN_USE = 0x000000CF;
	...
	public const uint ERROR_META_EXPANSION_TOO_LONG = 0x000000D0;

	/// <summary>The signal being posted is not correct.</summary>
	public const uint ERROR_INVALID_SIGNAL_NUMBER = 0x000000D1;

	/// <summary>The signal handler cannot be set.</summary>
	public const uint ERROR_THREAD_1_INACTIVE = 0x000000D2;

	/// <summary>The segment is locked and cannot be reallocated.</summary>
	public const uint ERROR_LOCKED = 0x000000D4;

	/// <summary>Too many dynamic-link modules are attached to this program or dynamic-link module.</summary>
	public const uint ERROR_TOO_MANY_MODULES = 0x000000D6;

	/// <summary>Cannot nest calls to LoadModule.</summary>
	public const uint ERROR_NESTING_NOT_ALLOWED = 0x000000D7;
	...
	public const uint ERROR_FORMS_AUTH_REQUIRED = 0x000000E0;

	/// <summary>Operation did not complete successfully because the file contains a virus.</summary>
	public const uint ERROR_VIRUS_INFECTED = 0x000000E1;
	...
	public const uint ERROR_VIRUS_DELETED = 0x000000E2;

	/// <summary>The pipe is local.</summary>
	public const uint ERROR_PIPE_LOCAL = 0x000000E5;

	/// <summary>The pipe state is invalid.</summary>
	public const uint ERROR_BAD_PIPE = 0x000000E6;

	/// <summary>All pipe instances are busy.</summary>
	public const uint ERROR_PIPE_BUSY = 0x000000E7;

	/// <summary>The pipe is being closed.</summary>
	public const uint ERROR_NO_DATA = 0x000000E8;

	/// <summary>No process is on the other end of the pipe.</summary>
	public const uint ERROR_PIPE_NOT_CONNECTED = 0x000000E9;
	...
	public const uint ERROR_VC_DISCONNECTED = 0x000000F0;

	/// <summary>The specified extended attribute name was invalid.</summary>
	public const uint ERROR_INVALID_EA_NAME = 0x000000FE;

	/// <summary>The extended attributes are inconsistent.</summary>
	public const uint ERROR_EA_LIST_INCONSISTENT = 0x000000FF;
	...
	public const uint ERROR_INVALID_PORT_ATTRIBUTES = 0x00000221;
	...
	public const uint ERROR_CANT_TERMINATE_SELF = 0x0000022B;
	...
	public const uint ERROR_UNEXPECTED_MM_CREATE_ERR = 0x0000022C;

	/// <summary>If an MM error is returned that is not defined in the standard FsRtl filter, it is converted to one of the following errors that is guaranteed to be in the filter. In this case, information is lost; however, the filter correctly handles the exception.</summary>
	public const uint ERROR_UNEXPECTED_MM_MAP_ERROR = 0x0000022D;

	/// <summary>If an MM error is returned that is not defined in the standard FsRtl filter, it is converted to one of the following errors that is guaranteed to be in the filter. In this case, information is lost; however, the filter correctly handles the exception.</summary>
	public const uint ERROR_UNEXPECTED_MM_EXTEND_ERR = 0x0000022E;

	/// <summary>A malformed function table was encountered during an unwind operation.</summary>
	public const uint ERROR_BAD_FUNCTION_TABLE = 0x0000022F;
	...
	public const uint ERROR_NO_GUID_TRANSLATION = 0x00000230;
	...
	public const uint ERROR_INVALID_LDT_SIZE = 0x00000231;
	...
	public const uint ERROR_INVALID_LDT_OFFSET = 0x00000233;

	/// <summary>Indicates that the user supplied an invalid descriptor when trying to set up LDT descriptors.</summary>
	public const uint ERROR_INVALID_LDT_DESCRIPTOR = 0x00000234;
	...
	public const uint ERROR_TOO_MANY_THREADS = 0x00000235;
	...
	public const uint ERROR_THREAD_NOT_IN_PROCESS = 0x00000236;

	/// <summary>Page file quota was exceeded.</summary>
	public const uint ERROR_PAGEFILE_QUOTA_EXCEEDED = 0x00000237;
	...
	public const uint ERROR_LOGON_SERVER_CONFLICT = 0x00000238;
	...
	public const uint ERROR_SYNCHRONIZATION_REQUIRED = 0x00000239;
	...
	public const uint ERROR_INVALID_IMAGE_HASH = 0x00000241;

	/// <summary>{No Paging File Specified} No paging file was specified in the system configuration.</summary>
	public const uint ERROR_NO_PAGEFILE = 0x00000242;
	...
	public const uint ERROR_ILLEGAL_FLOAT_CONTEXT = 0x00000243;
	...
	public const uint ERROR_NO_EVENT_PAIR = 0x00000244;

	/// <summary>A Windows Server has an incorrect configuration.</summary>
	public const uint ERROR_DOMAIN_CTRLR_CONFIG_ERROR = 0x00000245;
	...
	public const uint ERROR_CANNOT_LOAD_REGISTRY_FILE = 0x0000024D;
	...
	public const uint ERROR_DEBUG_ATTACH_FAILED = 0x0000024E;
	...
	public const uint ERROR_SYSTEM_PROCESS_TERMINATED = 0x0000024F;
	...
	public const uint ERROR_REPLY_MESSAGE_MISMATCH = 0x00000253;
	...
	public const uint ERROR_LOST_WRITEBEHIND_DATA = 0x00000254;
	...
	public const uint ERROR_CLIENT_SERVER_PARAMETERS_INVALID = 0x00000255;

	/// <summary>The stream is not a tiny stream.</summary>
	public const uint ERROR_NOT_TINY_STREAM = 0x00000256;

	/// <summary>The request must be handled by the stack overflow code.</summary>
	public const uint ERROR_STACK_OVERFLOW_READ = 0x00000257;
	...
	public const uint ERROR_CONVERT_TO_LARGE = 0x00000258;
	...
	public const uint ERROR_BAD_DLL_ENTRYPOINT = 0x00000261;
	...
	public const uint ERROR_BAD_SERVICE_ENTRYPOINT = 0x00000262;

	/// <summary>There is an IP address conflict with another system on the network.</summary>
	public const uint ERROR_IP_ADDRESS_CONFLICT1 = 0x00000263;

	/// <summary>There is an IP address conflict with another system on the network.</summary>
	public const uint ERROR_IP_ADDRESS_CONFLICT2 = 0x00000264;
	...
	public const uint ERROR_PWD_TOO_RECENT = 0x00000268;
	...
	public const uint ERROR_EVALUATION_EXPIRATION = 0x0000026E;
	...
	public const uint ERROR_ILLEGAL_DLL_RELOCATION = 0x0000026F;
	...
	public const uint ERROR_DRIVER_FAILED_SLEEP = 0x00000279;

	/// <summary>The system file %1 has become corrupt and has been replaced.</summary>
	public const uint ERROR_CORRUPT_SYSTEM_FILE = 0x0000027A;
	...
	public const uint ERROR_COMMITMENT_MINIMUM = 0x0000027B;

	/// <summary>A device was removed so enumeration must be restarted.</summary>
	public const uint ERROR_PNP_RESTART_ENUMERATION = 0x0000027C;
	...
	public const uint ERROR_DEVICE_ENUMERATION_ERROR = 0x00000288;
	...
	public const uint ERROR_MOUNT_POINT_NOT_RESOLVED = 0x00000289;
	...
	public const uint ERROR_RXACT_COMMIT_NECESSARY = 0x000002A6;

	/// <summary>{Media Changed} The media might have changed.</summary>
	public const uint ERROR_MEDIA_CHECK = 0x000002A7;
	...
	public const uint ERROR_GUID_SUBSTITUTION_MADE = 0x000002A8;

	/// <summary>The create operation stopped after reaching a symbolic link.</summary>
	public const uint ERROR_STOPPED_ON_SYMLINK = 0x000002A9;

	/// <summary>A long jump has been executed.</summary>
	public const uint ERROR_LONGJUMP = 0x000002AA;

	/// <summary>The Plug and Play query operation was not successful.</summary>
	public const uint ERROR_PLUGPLAY_QUERY_VETOED = 0x000002AB;

	/// <summary>A frame consolidation has been executed.</summary>
	public const uint ERROR_UNWIND_CONSOLIDATE = 0x000002AC;
	...
	public const uint ERROR_REGISTRY_HIVE_RECOVERED = 0x000002AD;
	...
	public const uint ERROR_DLL_MIGHT_BE_INSECURE = 0x000002AE;
	...
	public const uint ERROR_DLL_MIGHT_BE_INCOMPATIBLE = 0x000002AF;

	/// <summary>Debugger did not handle the exception.</summary>
	public const uint ERROR_DBG_EXCEPTION_NOT_HANDLED = 0x000002B0;

	/// <summary>Debugger will reply later.</summary>
	public const uint ERROR_DBG_REPLY_LATER = 0x000002B1;

	/// <summary>Debugger cannot provide handle.</summary>
	public const uint ERROR_DBG_UNABLE_TO_PROVIDE_HANDLE = 0x000002B2;

	/// <summary>Debugger terminated thread.</summary>
	public const uint ERROR_DBG_TERMINATE_THREAD = 0x000002B3;

	/// <summary>Debugger terminated process.</summary>
	public const uint ERROR_DBG_TERMINATE_PROCESS = 0x000002B4;

	/// <summary>Debugger got control C.</summary>
	public const uint ERROR_DBG_CONTROL_C = 0x000002B5;

	/// <summary>Debugger printed exception on control C.</summary>
	public const uint ERROR_DBG_PRINTEXCEPTION_C = 0x000002B6;

	/// <summary>Debugger received Routing Information Protocol (RIP) exception.</summary>
	public const uint ERROR_DBG_RIPEXCEPTION = 0x000002B7;

	/// <summary>Debugger received control break.</summary>
	public const uint ERROR_DBG_CONTROL_BREAK = 0x000002B8;

	/// <summary>Debugger command communication exception.</summary>
	public const uint ERROR_DBG_COMMAND_EXCEPTION = 0x000002B9;

	/// <summary>{Object Exists} An attempt was made to create an object and the object name already existed.</summary>
	public const uint ERROR_OBJECT_NAME_EXISTS = 0x000002BA;
	...
	public const uint ERROR_THREAD_WAS_SUSPENDED = 0x000002BB;
	...
	public const uint ERROR_IMAGE_NOT_AT_BASE = 0x000002BC;
	...
	public const uint ERROR_RXACT_STATE_CREATED = 0x000002BD;
	...
	public const uint ERROR_SEGMENT_NOTIFICATION = 0x000002BE;
	...
	public const uint ERROR_BAD_CURRENT_DIRECTORY = 0x000002BF;
	...
	public const uint ERROR_FT_READ_RECOVERY_FROM_BACKUP = 0x000002C0;
	...
	public const uint ERROR_FT_WRITE_RECOVERY = 0x000002C1;
	...
	public const uint ERROR_IMAGE_MACHINE_TYPE_MISMATCH = 0x000002C2;
	...
	public const uint ERROR_RECEIVE_PARTIAL = 0x000002C3;
	...
	public const uint ERROR_RECEIVE_EXPEDITED = 0x000002C4;
	...
	public const uint ERROR_MP_PROCESSOR_MISMATCH = 0x000002D5;

	/// <summary>The system was put into hibernation.</summary>
	public const uint ERROR_HIBERNATED = 0x000002D6;

	/// <summary>The system was resumed from hibernation.</summary>
	public const uint ERROR_RESUME_HIBERNATION = 0x000002D7;
	...
	public const uint ERROR_FIRMWARE_UPDATED = 0x000002D8;
	...
	public const uint ERROR_DRIVERS_LEAKING_LOCKED_PAGES = 0x000002D9;

	/// <summary>The system has awoken.</summary>
	public const uint ERROR_WAKE_SYSTEM = 0x000002DA;

	/// <summary>The call failed because the handle associated with it was closed.</summary>
	public const uint ERROR_ABANDONED_WAIT_0 = 0x000002DF;

	/// <summary>The requested operation requires elevation.</summary>
	public const uint ERROR_ELEVATION_REQUIRED = 0x000002E4;
	...
	public const uint ERROR_REPARSE = 0x000002E5;

	/// <summary>An open/create operation completed while an oplock break is underway.</summary>
	public const uint ERROR_OPLOCK_BREAK_IN_PROGRESS = 0x000002E6;

	/// <summary>A new volume has been mounted by a file system.</summary>
	public const uint ERROR_VOLUME_MOUNTED = 0x000002E7;
	...
	public const uint ERROR_RXACT_COMMITTED = 0x000002E8;
	...
	public const uint ERROR_NOTIFY_CLEANUP = 0x000002E9;
	...
	public const uint ERROR_PRIMARY_TRANSPORT_CONNECT_FAILED = 0x000002EA;

	/// <summary>Page fault was a transition fault.</summary>
	public const uint ERROR_PAGE_FAULT_TRANSITION = 0x000002EB;

	/// <summary>Page fault was a demand zero fault.</summary>
	public const uint ERROR_PAGE_FAULT_DEMAND_ZERO = 0x000002EC;

	/// <summary>Page fault was a demand zero fault.</summary>
	public const uint ERROR_PAGE_FAULT_COPY_ON_WRITE = 0x000002ED;

	/// <summary>Page fault was a demand zero fault.</summary>
	public const uint ERROR_PAGE_FAULT_GUARD_PAGE = 0x000002EE;

	/// <summary>Page fault was satisfied by reading from a secondary storage device.</summary>
	public const uint ERROR_PAGE_FAULT_PAGING_FILE = 0x000002EF;

	/// <summary>Cached page was locked during operation.</summary>
	public const uint ERROR_CACHE_PAGE_LOCKED = 0x000002F0;

	/// <summary>Crash dump exists in paging file.</summary>
	public const uint ERROR_CRASH_DUMP = 0x000002F1;

	/// <summary>Specified buffer contains all zeros.</summary>
	public const uint ERROR_BUFFER_ALL_ZEROS = 0x000002F2;

	/// <summary>A reparse should be performed by the object manager because the name of the file resulted in a symbolic link.</summary>
	public const uint ERROR_REPARSE_OBJECT = 0x000002F3;

	/// <summary>The device has succeeded a query-stop and its resource requirements have changed.</summary>
	public const uint ERROR_RESOURCE_REQUIREMENTS_CHANGED = 0x000002F4;
	...
	public const uint ERROR_REQUEST_OUT_OF_SEQUENCE = 0x00000308;

	/// <summary>A version number could not be parsed.</summary>
	public const uint ERROR_VERSION_PARSE_ERROR = 0x00000309;

	/// <summary>The iterator's start position is invalid.</summary>
	public const uint ERROR_BADSTARTPOSITION = 0x0000030A;

	/// <summary>The hardware has reported an uncorrectable memory error.</summary>
	public const uint ERROR_MEMORY_HARDWARE = 0x0000030B;

	/// <summary>The attempted operation required self-healing to be enabled.</summary>
	public const uint ERROR_DISK_REPAIR_DISABLED = 0x0000030C;
	...
	public const uint ERROR_LOST_WRITEBEHIND_DATA_NETWORK_DISCONNECTED = 0x00000314;
	...
	public const uint ERROR_LOST_WRITEBEHIND_DATA_NETWORK_SERVER_ERROR = 0x00000315;
	...
	public const uint ERROR_REGISTRY_RECOVERED = 0x000003F6;
	...
	public const uint ERROR_REGISTRY_CORRUPT = 0x000003F7;
	...
	public const uint ERROR_REGISTRY_IO_FAILED = 0x000003F8;
	...
	public const uint ERROR_DIFFERENT_SERVICE_ACCOUNT = 0x00000437;

	/// <summary>Failure actions can only be set for Win32 services, not for drivers.</summary>
	public const uint ERROR_CANNOT_DETECT_DRIVER_FAILURE = 0x00000438;
	...
	public const uint ERROR_IRQ_BUSY = 0x0000045F;
	...
	public const uint ERROR_MORE_WRITES = 0x00000460;
	...
	public const uint ERROR_UNABLE_TO_MOVE_REPLACEMENT = 0x00000498;
	...
	public const uint ERROR_SESSION_CREDENTIAL_CONFLICT = 0x000004C3;
	...
	public const uint ERROR_NOT_LOGGED_ON = 0x000004DD;

	/// <summary>Continue with work in progress.</summary>
	public const uint ERROR_CONTINUE = 0x000004DE;
	...
	public const uint ERROR_REG_NAT_CONSUMPTION = 0x000004ED;

	/// <summary>The share is currently offline or does not exist.</summary>
	public const uint ERROR_CSCSHARE_OFFLINE = 0x000004EE;
	...
	public const uint ERROR_PKINIT_FAILURE = 0x000004EF;

	/// <summary>The Kerberos protocol encountered an error while attempting to utilize the smartcard subsystem.</summary>
	public const uint ERROR_SMARTCARD_SUBSYSTEM_FAILURE = 0x000004F0;
	...
	public const uint ERROR_ACCESS_DISABLED_WEBBLADE_TAMPER = 0x000004FE;

	/// <summary>A transaction recover failed.</summary>
	public const uint ERROR_RECOVERY_FAILURE = 0x000004FF;

	/// <summary>The current thread has already been converted to a fiber.</summary>
	public const uint ERROR_ALREADY_FIBER = 0x00000500;

	/// <summary>The current thread has already been converted from a fiber.</summary>
	public const uint ERROR_ALREADY_THREAD = 0x00000501;
	...
	public const uint ERROR_STACK_BUFFER_OVERRUN = 0x00000502;

	/// <summary>Data present in one of the parameters is more than the function can operate on.</summary>
	public const uint ERROR_PARAMETER_QUOTA_EXCEEDED = 0x00000503;
	...
	public const uint ERROR_DEBUGGER_INACTIVE = 0x00000504;

	/// <summary>An attempt to delay-load a .dll or get a function address in a delay-loaded .dll failed.</summary>
	public const uint ERROR_DELAY_LOAD_FAILED = 0x00000505;
	...
	public const uint ERROR_NULL_LM_PASSWORD = 0x00000518;

	/// <summary>The revision level is unknown.</summary>
	public const uint ERROR_UNKNOWN_REVISION = 0x00000519;

	/// <summary>Indicates two revision levels are incompatible.</summary>
	public const uint ERROR_REVISION_MISMATCH = 0x0000051A;

	/// <summary>This SID cannot be assigned as the owner of this object.</summary>
	public const uint ERROR_INVALID_OWNER = 0x0000051B;

	/// <summary>This SID cannot be assigned as the primary group of an object.</summary>
	public const uint ERROR_INVALID_PRIMARY_GROUP = 0x0000051C;
	...
	public const uint ERROR_ILL_FORMED_PASSWORD = 0x0000052C;
	...
	public const uint ERROR_PASSWORD_RESTRICTION = 0x0000052D;

	/// <summary>Logon failure: Unknown user name or bad password.</summary>
	public const uint ERROR_LOGON_FAILURE = 0x0000052E;
	...
	public const uint ERROR_LICENSE_QUOTA_EXCEEDED = 0x00000573;

	/// <summary>Logon failure: The target account name is incorrect.</summary>
	public const uint ERROR_WRONG_TARGET_NAME = 0x00000574;

	/// <summary>Mutual authentication failed. The server's password is out of date at the domain controller.</summary>
	public const uint ERROR_MUTUAL_AUTH_FAILED = 0x00000575;

	/// <summary>There is a time and/or date difference between the client and server.</summary>
	public const uint ERROR_TIME_SKEW = 0x00000576;

	/// <summary>This operation cannot be performed on the current domain.</summary>
	public const uint ERROR_CURRENT_DOMAIN_NOT_ALLOWED = 0x00000577;

	/// <summary>Invalid window handle.</summary>
	public const uint ERROR_INVALID_WINDOW_HANDLE = 0x00000578;

	/// <summary>Invalid menu handle.</summary>
	public const uint ERROR_INVALID_MENU_HANDLE = 0x00000579;

	/// <summary>Invalid cursor handle.</summary>
	public const uint ERROR_INVALID_CURSOR_HANDLE = 0x0000057A;

	/// <summary>Invalid accelerator table handle.</summary>
	public const uint ERROR_INVALID_ACCEL_HANDLE = 0x0000057B;

	/// <summary>Invalid hook handle.</summary>
	public const uint ERROR_INVALID_HOOK_HANDLE = 0x0000057C;

	/// <summary>Invalid handle to a multiple-window position structure.</summary>
	public const uint ERROR_INVALID_DWP_HANDLE = 0x0000057D;

	/// <summary>Cannot create a top-level child window.</summary>
	public const uint ERROR_TLW_WITH_WSCHILD = 0x0000057E;

	/// <summary>Cannot find window class.</summary>
	public const uint ERROR_CANNOT_FIND_WND_CLASS = 0x0000057F;

	/// <summary>Invalid window; it belongs to other thread.</summary>
	public const uint ERROR_WINDOW_OF_OTHER_THREAD = 0x00000580;

	/// <summary>Hot key is already registered.</summary>
	public const uint ERROR_HOTKEY_ALREADY_REGISTERED = 0x00000581;

	/// <summary>Class already exists.</summary>
	public const uint ERROR_CLASS_ALREADY_EXISTS = 0x00000582;

	/// <summary>Class does not exist.</summary>
	public const uint ERROR_CLASS_DOES_NOT_EXIST = 0x00000583;

	/// <summary>Class still has open windows.</summary>
	public const uint ERROR_CLASS_HAS_WINDOWS = 0x00000584;

	/// <summary>Invalid index.</summary>
	public const uint ERROR_INVALID_INDEX = 0x00000585;

	/// <summary>Invalid icon handle.</summary>
	public const uint ERROR_INVALID_ICON_HANDLE = 0x00000586;

	/// <summary>Using private DIALOG window words.</summary>
	public const uint ERROR_PRIVATE_DIALOG_INDEX = 0x00000587;

	/// <summary>The list box identifier was not found.</summary>
	public const uint ERROR_LISTBOX_ID_NOT_FOUND = 0x00000588;

	/// <summary>No wildcards were found.</summary>
	public const uint ERROR_NO_WILDCARD_CHARACTERS = 0x00000589;

	/// <summary>Thread does not have a clipboard open.</summary>
	public const uint ERROR_CLIPBOARD_NOT_OPEN = 0x0000058A;

	/// <summary>Hot key is not registered.</summary>
	public const uint ERROR_HOTKEY_NOT_REGISTERED = 0x0000058B;

	/// <summary>The window is not a valid dialog window.</summary>
	public const uint ERROR_WINDOW_NOT_DIALOG = 0x0000058C;

	/// <summary>Control ID not found.</summary>
	public const uint ERROR_CONTROL_ID_NOT_FOUND = 0x0000058D;

	/// <summary>Invalid message for a combo box because it does not have an edit control.</summary>
	public const uint ERROR_INVALID_COMBOBOX_MESSAGE = 0x0000058E;

	/// <summary>The window is not a combo box.</summary>
	public const uint ERROR_WINDOW_NOT_COMBOBOX = 0x0000058F;

	/// <summary>Height must be less than 256.</summary>
	public const uint ERROR_INVALID_EDIT_HEIGHT = 0x00000590;

	/// <summary>Invalid device context (DC) handle.</summary>
	public const uint ERROR_DC_NOT_FOUND = 0x00000591;

	/// <summary>Invalid hook procedure type.</summary>
	public const uint ERROR_INVALID_HOOK_FILTER = 0x00000592;

	/// <summary>Invalid hook procedure.</summary>
	public const uint ERROR_INVALID_FILTER_PROC = 0x00000593;

	/// <summary>Cannot set nonlocal hook without a module handle.</summary>
	public const uint ERROR_HOOK_NEEDS_HMOD = 0x00000594;

	/// <summary>This hook procedure can only be set globally.</summary>
	public const uint ERROR_GLOBAL_ONLY_HOOK = 0x00000595;

	/// <summary>The journal hook procedure is already installed.</summary>
	public const uint ERROR_JOURNAL_HOOK_SET = 0x00000596;

	/// <summary>The hook procedure is not installed.</summary>
	public const uint ERROR_HOOK_NOT_INSTALLED = 0x00000597;

	/// <summary>Invalid message for single-selection list box.</summary>
	public const uint ERROR_INVALID_LB_MESSAGE = 0x00000598;

	/// <summary>LB_SETCOUNT sent to non-lazy list box.</summary>
	public const uint ERROR_SETCOUNT_ON_BAD_LB = 0x00000599;

	/// <summary>This list box does not support tab stops.</summary>
	public const uint ERROR_LB_WITHOUT_TABSTOPS = 0x0000059A;

	/// <summary>Cannot destroy object created by another thread.</summary>
	public const uint ERROR_DESTROY_OBJECT_OF_OTHER_THREAD = 0x0000059B;

	/// <summary>Child windows cannot have menus.</summary>
	public const uint ERROR_CHILD_WINDOW_MENU = 0x0000059C;

	/// <summary>The window does not have a system menu.</summary>
	public const uint ERROR_NO_SYSTEM_MENU = 0x0000059D;

	/// <summary>Invalid message box style.</summary>
	public const uint ERROR_INVALID_MSGBOX_STYLE = 0x0000059E;

	/// <summary>Invalid system-wide (SPI_*) parameter.</summary>
	public const uint ERROR_INVALID_SPI_VALUE = 0x0000059F;

	/// <summary>Screen already locked.</summary>
	public const uint ERROR_SCREEN_ALREADY_LOCKED = 0x000005A0;

	/// <summary>All handles to windows in a multiple-window position structure must have the same parent.</summary>
	public const uint ERROR_HWNDS_HAVE_DIFF_PARENT = 0x000005A1;

	/// <summary>The window is not a child window.</summary>
	public const uint ERROR_NOT_CHILD_WINDOW = 0x000005A2;

	/// <summary>Invalid GW_* command.</summary>
	public const uint ERROR_INVALID_GW_COMMAND = 0x000005A3;

	/// <summary>Invalid thread identifier.</summary>
	public const uint ERROR_INVALID_THREAD_ID = 0x000005A4;

	/// <summary>Cannot process a message from a window that is not a multiple document interface (MDI) window.</summary>
	public const uint ERROR_NON_MDICHILD_WINDOW = 0x000005A5;

	/// <summary>Pop-up menu already active.</summary>
	public const uint ERROR_POPUP_ALREADY_ACTIVE = 0x000005A6;

	/// <summary>The window does not have scroll bars.</summary>
	public const uint ERROR_NO_SCROLLBARS = 0x000005A7;

	/// <summary>Scroll bar range cannot be greater than MAXLONG.</summary>
	public const uint ERROR_INVALID_SCROLLBAR_RANGE = 0x000005A8;

	/// <summary>Cannot show or remove the window in the way specified.</summary>
	public const uint ERROR_INVALID_SHOWWIN_COMMAND = 0x000005A9;

	/// <summary>Insufficient system resources exist to complete the requested service.</summary>
	public const uint ERROR_NO_SYSTEM_RESOURCES = 0x000005AA;

	/// <summary>Insufficient system resources exist to complete the requested service.</summary>
	public const uint ERROR_NONPAGED_SYSTEM_RESOURCES = 0x000005AB;

	/// <summary>Insufficient system resources exist to complete the requested service.</summary>
	public const uint ERROR_PAGED_SYSTEM_RESOURCES = 0x000005AC;

	/// <summary>Insufficient quota to complete the requested service.</summary>
	public const uint ERROR_WORKING_SET_QUOTA = 0x000005AD;

	/// <summary>Insufficient quota to complete the requested service.</summary>
	public const uint ERROR_PAGEFILE_QUOTA = 0x000005AE;

	/// <summary>The paging file is too small for this operation to complete.</summary>
	public const uint ERROR_COMMITMENT_LIMIT = 0x000005AF;

	/// <summary>A menu item was not found.</summary>
	public const uint ERROR_MENU_ITEM_NOT_FOUND = 0x000005B0;

	/// <summary>Invalid keyboard layout handle.</summary>
	public const uint ERROR_INVALID_KEYBOARD_HANDLE = 0x000005B1;

	/// <summary>Hook type not allowed.</summary>
	public const uint ERROR_HOOK_TYPE_NOT_ALLOWED = 0x000005B2;

	/// <summary>This operation requires an interactive window station.</summary>
	public const uint ERROR_REQUIRES_INTERACTIVE_WINDOWSTATION = 0x000005B3;

	/// <summary>This operation returned because the time-out period expired.</summary>
	public const uint ERROR_TIMEOUT = 0x000005B4;

	/// <summary>Invalid monitor handle.</summary>
	public const uint ERROR_INVALID_MONITOR_HANDLE = 0x000005B5;

	/// <summary>Incorrect size argument.</summary>
	public const uint ERROR_INCORRECT_SIZE = 0x000005B6;

	/// <summary>The symbolic link cannot be followed because its type is disabled.</summary>
	public const uint ERROR_SYMLINK_CLASS_DISABLED = 0x000005B7;

	/// <summary>This application does not support the current operation on symbolic links.</summary>
	public const uint ERROR_SYMLINK_NOT_SUPPORTED = 0x000005B8;

	/// <summary>The event log file is corrupted.</summary>
	public const uint ERROR_EVENTLOG_FILE_CORRUPT = 0x000005DC;

	/// <summary>No event log file could be opened, so the event logging service did not start.</summary>
	public const uint ERROR_EVENTLOG_CANT_START = 0x000005DD;

	/// <summary>The event log file is full.</summary>
	public const uint ERROR_LOG_FILE_FULL = 0x000005DE;

	/// <summary>The event log file has changed between read operations.</summary>
	public const uint ERROR_EVENTLOG_FILE_CHANGED = 0x000005DF;

	/// <summary>The specified task name is invalid.</summary>
	public const uint ERROR_INVALID_TASK_NAME = 0x0000060E;

	/// <summary>The specified task index is invalid.</summary>
	public const uint ERROR_INVALID_TASK_INDEX = 0x0000060F;

	/// <summary>The specified thread is already joining a task.</summary>
	public const uint ERROR_THREAD_ALREADY_IN_TASK = 0x00000610;
	...
	public const uint ERROR_INSTALL_SERVICE_FAILURE = 0x00000641;

	/// <summary>User canceled installation.</summary>
	public const uint ERROR_INSTALL_USEREXIT = 0x00000642;

	/// <summary>Fatal error during installation.</summary>
	public const uint ERROR_INSTALL_FAILURE = 0x00000643;

	/// <summary>Installation suspended, incomplete.</summary>
	public const uint ERROR_INSTALL_SUSPEND = 0x00000644;

	/// <summary>This action is valid only for products that are currently installed.</summary>
	public const uint ERROR_UNKNOWN_PRODUCT = 0x00000645;

	/// <summary>Feature ID not registered.</summary>
	public const uint ERROR_UNKNOWN_FEATURE = 0x00000646;

	/// <summary>Component ID not registered.</summary>
	public const uint ERROR_UNKNOWN_COMPONENT = 0x00000647;

	/// <summary>Unknown property.</summary>
	public const uint ERROR_UNKNOWN_PROPERTY = 0x00000648;

	/// <summary>Handle is in an invalid state.</summary>
	public const uint ERROR_INVALID_HANDLE_STATE = 0x00000649;

	/// <summary>The configuration data for this product is corrupt. Contact your support personnel.</summary>
	public const uint ERROR_BAD_CONFIGURATION = 0x0000064A;

	/// <summary>Component qualifier not present.</summary>
	public const uint ERROR_INDEX_ABSENT = 0x0000064B;
	...
	public const uint ERROR_INSTALL_SOURCE_ABSENT = 0x0000064C;
	...
	public const uint ERROR_INSTALL_PACKAGE_VERSION = 0x0000064D;

	/// <summary>Product is uninstalled.</summary>
	public const uint ERROR_PRODUCT_UNINSTALLED = 0x0000064E;

	/// <summary>SQL query syntax invalid or unsupported.</summary>
	public const uint ERROR_BAD_QUERY_SYNTAX = 0x0000064F;

	/// <summary>Record field does not exist.</summary>
	public const uint ERROR_INVALID_FIELD = 0x00000650;

	/// <summary>The device has been removed.</summary>
	public const uint ERROR_DEVICE_REMOVED = 0x00000651;
	...
	public const uint ERROR_INSTALL_ALREADY_RUNNING = 0x00000652;
	...
	public const uint ERROR_INSTALL_PACKAGE_OPEN_FAILED = 0x00000653;
	...
	public const uint ERROR_INSTALL_TEMP_UNWRITABLE = 0x00000660;

	/// <summary>This installation package is not supported by this processor type. Contact your product vendor.</summary>
	public const uint ERROR_INSTALL_PLATFORM_UNSUPPORTED = 0x00000661;

	/// <summary>Component not used on this computer.</summary>
	public const uint ERROR_INSTALL_NOTUSED = 0x00000662;
	...
	public const uint ERROR_PATCH_PACKAGE_OPEN_FAILED = 0x00000663;
	...
	public const uint ERROR_PATCH_PACKAGE_INVALID = 0x00000664;
	...
	public const uint ERROR_PATCH_PACKAGE_UNSUPPORTED = 0x00000665;
	...
	public const uint ERROR_INSTALL_REMOTE_DISALLOWED = 0x00000668;
	...
	public const uint ERROR_SUCCESS_REBOOT_INITIATED = 0x00000669;
	...
	public const uint ERROR_PATCH_MANAGED_ADVERTISED_PRODUCT = 0x00000673;
	...
	public const uint ERROR_NO_TRUST_SAM_ACCOUNT = 0x000006FB;

	/// <summary>The trust relationship between the primary domain and the trusted domain failed.</summary>
	public const uint ERROR_TRUSTED_DOMAIN_FAILURE = 0x000006FC;

	/// <summary>The trust relationship between this workstation and the primary domain failed.</summary>
	public const uint ERROR_TRUSTED_RELATIONSHIP_FAILURE = 0x000006FD;

	/// <summary>The network logon failed.</summary>
	public const uint ERROR_TRUST_FAILURE = 0x000006FE;

	/// <summary>An RPC is already in progress for this thread.</summary>
	public const uint RPC_S_CALL_IN_PROGRESS = 0x000006FF;

	/// <summary>An attempt was made to log on, but the network logon service was not started.</summary>
	public const uint ERROR_NETLOGON_NOT_STARTED = 0x00000700;

	/// <summary>The user's account has expired.</summary>
	public const uint ERROR_ACCOUNT_EXPIRED = 0x00000701;

	/// <summary>The redirector is in use and cannot be unloaded.</summary>
	public const uint ERROR_REDIRECTOR_HAS_OPEN_HANDLES = 0x00000702;

	/// <summary>The specified printer driver is already installed.</summary>
	public const uint ERROR_PRINTER_DRIVER_ALREADY_INSTALLED = 0x00000703;

	/// <summary>The specified port is unknown.</summary>
	public const uint ERROR_UNKNOWN_PORT = 0x00000704;

	/// <summary>The printer driver is unknown.</summary>
	public const uint ERROR_UNKNOWN_PRINTER_DRIVER = 0x00000705;

	/// <summary>The print processor is unknown.</summary>
	public const uint ERROR_UNKNOWN_PRINTPROCESSOR = 0x00000706;

	/// <summary>The specified separator file is invalid.</summary>
	public const uint ERROR_INVALID_SEPARATOR_FILE = 0x00000707;

	/// <summary>The specified priority is invalid.</summary>
	public const uint ERROR_INVALID_PRIORITY = 0x00000708;

	/// <summary>The printer name is invalid.</summary>
	public const uint ERROR_INVALID_PRINTER_NAME = 0x00000709;

	/// <summary>The printer already exists.</summary>
	public const uint ERROR_PRINTER_ALREADY_EXISTS = 0x0000070A;

	/// <summary>The printer command is invalid.</summary>
	public const uint ERROR_INVALID_PRINTER_COMMAND = 0x0000070B;

	/// <summary>The specified data type is invalid.</summary>
	public const uint ERROR_INVALID_DATATYPE = 0x0000070C;

	/// <summary>The environment specified is invalid.</summary>
	public const uint ERROR_INVALID_ENVIRONMENT = 0x0000070D;

	/// <summary>There are no more bindings.</summary>
	public const uint RPC_S_NO_MORE_BINDINGS = 0x0000070E;
	...
	public const uint ERROR_NOLOGON_INTERDOMAIN_TRUST_ACCOUNT = 0x0000070F;
	...
	public const uint ERROR_NOLOGON_WORKSTATION_TRUST_ACCOUNT = 0x00000710;
	...
	public const uint NERR_DfsVolumeAlreadyExists = 0x00000A67;

	/// <summary>The server share specified is already shared in the DFS.</summary>
	public const uint NERR_DfsAlreadyShared = 0x00000A68;
	...
	public const uint NERR_DfsNotALeafVolume = 0x00000A6A;

	/// <summary>The operation is not valid in this portion of the namespace.</summary>
	public const uint NERR_DfsLeafVolume = 0x00000A6B;

	/// <summary>The operation is ambiguous because the link has multiple servers.</summary>
	public const uint NERR_DfsVolumeHasMultipleServers = 0x00000A6C;

	/// <summary>Unable to create a link.</summary>
	public const uint NERR_DfsCantCreateJunctionPoint = 0x00000A6D;

	/// <summary>The server is not DFS-aware.</summary>
	public const uint NERR_DfsServerNotDfsAware = 0x00000A6E;

	/// <summary>The specified rename target path is invalid.</summary>
	public const uint NERR_DfsBadRenamePath = 0x00000A6F;

	/// <summary>The specified DFS link is offline.</summary>
	public const uint NERR_DfsVolumeIsOffline = 0x00000A70;
	...
	public const uint ERROR_INDIGENOUS_TYPE = 0x000010F2;
	...
	public const uint ERROR_HOST_NODE_NOT_RESOURCE_OWNER = 0x00001397;
	...
	public const uint ERROR_NOT_QUORUM_CAPABLE = 0x0000139D;

	/// <summary>The cluster software is shutting down.</summary>
	public const uint ERROR_CLUSTER_SHUTTING_DOWN = 0x0000139E;

	/// <summary>The group or resource is not in the correct state to perform the requested operation.</summary>
	public const uint ERROR_INVALID_STATE = 0x0000139F;
	...
	public const uint ERROR_RESOURCE_PROPERTIES_STORED = 0x000013A0;
	...
	public const uint ERROR_QUORUM_OWNER_ALIVE = 0x000013AA;

	/// <summary>A cluster network is not available for this operation.</summary>
	public const uint ERROR_NETWORK_NOT_AVAILABLE = 0x000013AB;

	/// <summary>A cluster node is not available for this operation.</summary>
	public const uint ERROR_NODE_NOT_AVAILABLE = 0x000013AC;

	/// <summary>All cluster nodes must be running to perform this operation.</summary>
	public const uint ERROR_ALL_NODES_NOT_AVAILABLE = 0x000013AD;

	/// <summary>A cluster resource failed.</summary>
	public const uint ERROR_RESOURCE_FAILED = 0x000013AE;

	/// <summary>The cluster node is not valid.</summary>
	public const uint ERROR_CLUSTER_INVALID_NODE = 0x000013AF;

	/// <summary>The cluster node already exists.</summary>
	public const uint ERROR_CLUSTER_NODE_EXISTS = 0x000013B0;

	/// <summary>A node is in the process of joining the cluster.</summary>
	public const uint ERROR_CLUSTER_JOIN_IN_PROGRESS = 0x000013B1;

	/// <summary>The cluster node was not found.</summary>
	public const uint ERROR_CLUSTER_NODE_NOT_FOUND = 0x000013B2;

	/// <summary>The cluster local node information was not found.</summary>
	public const uint ERROR_CLUSTER_LOCAL_NODE_NOT_FOUND = 0x000013B3;

	/// <summary>The cluster network already exists.</summary>
	public const uint ERROR_CLUSTER_NETWORK_EXISTS = 0x000013B4;

	/// <summary>The cluster network was not found.</summary>
	public const uint ERROR_CLUSTER_NETWORK_NOT_FOUND = 0x000013B5;

	/// <summary>The cluster network interface already exists.</summary>
	public const uint ERROR_CLUSTER_NETINTERFACE_EXISTS = 0x000013B6;

	/// <summary>The cluster network interface was not found.</summary>
	public const uint ERROR_CLUSTER_NETINTERFACE_NOT_FOUND = 0x000013B7;

	/// <summary>The cluster request is not valid for this object.</summary>
	public const uint ERROR_CLUSTER_INVALID_REQUEST = 0x000013B8;

	/// <summary>The cluster network provider is not valid.</summary>
	public const uint ERROR_CLUSTER_INVALID_NETWORK_PROVIDER = 0x000013B9;

	/// <summary>The cluster node is down.</summary>
	public const uint ERROR_CLUSTER_NODE_DOWN = 0x000013BA;

	/// <summary>The cluster node is not reachable.</summary>
	public const uint ERROR_CLUSTER_NODE_UNREACHABLE = 0x000013BB;

	/// <summary>The cluster node is not a member of the cluster.</summary>
	public const uint ERROR_CLUSTER_NODE_NOT_MEMBER = 0x000013BC;

	/// <summary>A cluster join operation is not in progress.</summary>
	public const uint ERROR_CLUSTER_JOIN_NOT_IN_PROGRESS = 0x000013BD;

	/// <summary>The cluster network is not valid.</summary>
	public const uint ERROR_CLUSTER_INVALID_NETWORK = 0x000013BE;

	/// <summary>The cluster node is up.</summary>
	public const uint ERROR_CLUSTER_NODE_UP = 0x000013C0;

	/// <summary>The cluster IP address is already in use.</summary>
	public const uint ERROR_CLUSTER_IPADDR_IN_USE = 0x000013C1;

	/// <summary>The cluster node is not paused.</summary>
	public const uint ERROR_CLUSTER_NODE_NOT_PAUSED = 0x000013C2;

	/// <summary>No cluster security context is available.</summary>
	public const uint ERROR_CLUSTER_NO_SECURITY_CONTEXT = 0x000013C3;

	/// <summary>The cluster network is not configured for internal cluster communication.</summary>
	public const uint ERROR_CLUSTER_NETWORK_NOT_INTERNAL = 0x000013C4;

	/// <summary>The cluster node is already up.</summary>
	public const uint ERROR_CLUSTER_NODE_ALREADY_UP = 0x000013C5;

	/// <summary>The cluster node is already down.</summary>
	public const uint ERROR_CLUSTER_NODE_ALREADY_DOWN = 0x000013C6;

	/// <summary>The cluster network is already online.</summary>
	public const uint ERROR_CLUSTER_NETWORK_ALREADY_ONLINE = 0x000013C7;

	/// <summary>The cluster network is already offline.</summary>
	public const uint ERROR_CLUSTER_NETWORK_ALREADY_OFFLINE = 0x000013C8;

	/// <summary>The cluster node is already a member of the cluster.</summary>
	public const uint ERROR_CLUSTER_NODE_ALREADY_MEMBER = 0x000013C9;
	...
	public const uint ERROR_CLUSTER_LAST_INTERNAL_NETWORK = 0x000013CA;
	...
	public const uint ERROR_CLUSTER_NETWORK_HAS_DEPENDENTS = 0x000013CB;
	...
	public const uint ERROR_CLUSTER_INCOMPATIBLE_VERSIONS = 0x000013D3;
	...
	public const uint ERROR_CLUSTER_MAXNUM_OF_RESOURCES_EXCEEDED = 0x000013D4;
	...
	public const uint ERROR_CLUSTER_SYSTEM_CONFIG_CHANGED = 0x000013D5;

	/// <summary>The specified resource type was not found.</summary>
	public const uint ERROR_CLUSTER_RESOURCE_TYPE_NOT_FOUND = 0x000013D6;
	...
	public const uint ERROR_CLUSTER_RESTYPE_NOT_SUPPORTED = 0x000013D7;
	...
	public const uint ERROR_CLUSTER_RESNAME_NOT_FOUND = 0x000013D8;

	/// <summary>No authentication package could be registered with the RPC server.</summary>
	public const uint ERROR_CLUSTER_NO_RPC_PACKAGES_REGISTERED = 0x000013D9;
	...
	public const uint ERROR_CLUSTER_OWNER_NOT_IN_PREFLIST = 0x000013DA;
	...
	public const uint ERROR_CLUSTER_DATABASE_SEQMISMATCH = 0x000013DB;
	...
	public const uint ERROR_CLUSTER_INSTANCE_ID_MISMATCH = 0x00001705;

	/// <summary>A matching cluster network for the specified IP address could not be found.</summary>
	public const uint ERROR_CLUSTER_NETWORK_NOT_FOUND_FOR_IP = 0x00001706;

	/// <summary>The actual data type of the property did not match the expected data type of the property.</summary>
	public const uint ERROR_CLUSTER_PROPERTY_DATA_TYPE_MISMATCH = 0x00001707;
	...
	public const uint ERROR_CLUSTER_EVICT_WITHOUT_CLEANUP = 0x00001708;

	/// <summary>Two or more parameter values specified for a resource's properties are in conflict.</summary>
	public const uint ERROR_CLUSTER_PARAMETER_MISMATCH = 0x00001709;

	/// <summary>This computer cannot be made a member of a cluster.</summary>
	public const uint ERROR_NODE_CANNOT_BE_CLUSTERED = 0x0000170A;
	...
	public const uint ERROR_CLUSTER_WRONG_OS_VERSION = 0x0000170B;
	...
	public const uint ERROR_CLUSTER_CANT_CREATE_DUP_CLUSTER_NAME = 0x0000170C;

	/// <summary>The cluster configuration action has already been committed.</summary>
	public const uint ERROR_CLUSCFG_ALREADY_COMMITTED = 0x0000170D;

	/// <summary>The cluster configuration action could not be rolled back.</summary>
	public const uint ERROR_CLUSCFG_ROLLBACK_FAILED = 0x0000170E;
	...
	public const uint ERROR_INVALID_CLUSTER_IPV6_ADDRESS = 0x00001717;

	/// <summary>An internal cluster error occurred. A call to an invalid function was attempted.</summary>
	public const uint ERROR_CLUSTER_INTERNAL_INVALID_FUNCTION = 0x00001718;

	/// <summary>A parameter value is out of acceptable range.</summary>
	public const uint ERROR_CLUSTER_PARAMETER_OUT_OF_BOUNDS = 0x00001719;
	...
	public const uint ERROR_CLUSTER_PARTIAL_SEND = 0x0000171A;

	/// <summary>An invalid cluster registry operation was attempted.</summary>
	public const uint ERROR_CLUSTER_REGISTRY_INVALID_FUNCTION = 0x0000171B;

	/// <summary>An input string of characters is not properly terminated.</summary>
	public const uint ERROR_CLUSTER_INVALID_STRING_TERMINATION = 0x0000171C;

	/// <summary>An input string of characters is not in a valid format for the data it represents.</summary>
	public const uint ERROR_CLUSTER_INVALID_STRING_FORMAT = 0x0000171D;
	...
	public const uint ERROR_CLUSTER_DATABASE_TRANSACTION_IN_PROGRESS = 0x0000171E;
	...
	public const uint ERROR_DEPENDENT_RESOURCE_PROPERTY_CONFLICT = 0x00001724;

	/// <summary>A quorum of cluster nodes was not present to form a cluster.</summary>
	public const uint ERROR_CLUSTER_NO_QUORUM = 0x00001725;
	...
	public const uint ERROR_CLUSTER_INVALID_IPV6_NETWORK = 0x00001726;
	...
	public const uint ERROR_TRANSACTIONMANAGER_NOT_ONLINE = 0x00001A3F;
	...
	public const uint ERROR_TRANSACTIONMANAGER_RECOVERY_NAME_COLLISION = 0x00001A40;

	/// <summary>The function attempted to use a name that is reserved for use by another transaction.</summary>
	public const uint ERROR_TRANSACTIONAL_CONFLICT = 0x00001A90;
	...
	public const uint ERROR_OBJECT_NO_LONGER_EXISTS = 0x00001A97;

	/// <summary>The specified file miniversion was not found for this transacted file open.</summary>
	public const uint ERROR_STREAM_MINIVERSION_NOT_FOUND = 0x00001A98;
	...
	public const uint ERROR_FILE_IDENTITY_NOT_PERSISTENT = 0x00001AA7;
	...
	public const uint ERROR_CANT_BREAK_TRANSACTIONAL_DEPENDENCY = 0x00001AA8;
	...
	public const uint ERROR_CANT_CROSS_RM_BOUNDARY = 0x00001AA9;

	/// <summary>The $Txf directory must be empty for this operation to succeed.</summary>
	public const uint ERROR_TXF_DIR_NOT_EMPTY = 0x00001AAA;
	...
	public const uint ERROR_INDOUBT_TRANSACTIONS_EXIST = 0x00001AAB;

	/// <summary>The operation could not be completed because the transaction manager does not have a log.</summary>
	public const uint ERROR_TM_VOLATILE = 0x00001AAC;
	...
	public const uint ERROR_TRANSACTION_REQUIRED_PROMOTION = 0x00001AB5;
	...
	public const uint ERROR_NOT_SNAPSHOT_VOLUME = 0x00001AB9;

	/// <summary>The savepoint operation failed because files are open on the transaction. This is not permitted.</summary>
	public const uint ERROR_NO_SAVEPOINT_WITH_OPEN_FILES = 0x00001ABA;
	...
	public const uint ERROR_DATA_LOST_REPAIR = 0x00001ABB;

	/// <summary>The sparse operation could not be completed because a transaction is active on the file.</summary>
	public const uint ERROR_SPARSE_NOT_ALLOWED_IN_TRANSACTION = 0x00001ABC;
	...
	public const uint ERROR_TM_IDENTITY_MISMATCH = 0x00001ABD;
	...
	public const uint ERROR_FLOATED_SECTION = 0x00001ABE;
	...
	public const uint ERROR_CANNOT_ACCEPT_TRANSACTED_WORK = 0x00001ABF;
	...
	public const uint ERROR_CTX_MODEM_RESPONSE_ERROR = 0x00001B63;
	...
	public const uint ERROR_CTX_MODEM_RESPONSE_TIMEOUT = 0x00001B64;

	/// <summary>Carrier detect has failed or carrier has been dropped due to disconnect.</summary>
	public const uint ERROR_CTX_MODEM_RESPONSE_NO_CARRIER = 0x00001B65;
	...
	public const uint ERROR_CTX_MODEM_RESPONSE_NO_DIALTONE = 0x00001B66;

	/// <summary>Busy signal detected at remote site on callback.</summary>
	public const uint ERROR_CTX_MODEM_RESPONSE_BUSY = 0x00001B67;

	/// <summary>Voice detected at remote site on callback.</summary>
	public const uint ERROR_CTX_MODEM_RESPONSE_VOICE = 0x00001B68;

	/// <summary>Transport driver error.</summary>
	public const uint ERROR_CTX_TD_ERROR = 0x00001B69;

	/// <summary>The specified session cannot be found.</summary>
	public const uint ERROR_CTX_WINSTATION_NOT_FOUND = 0x00001B6E;

	/// <summary>The specified session name is already in use.</summary>
	public const uint ERROR_CTX_WINSTATION_ALREADY_EXISTS = 0x00001B6F;
	...
	public const uint ERROR_CTX_SHADOW_INVALID = 0x00001B8A;

	/// <summary>The requested session is not configured to allow remote control.</summary>
	public const uint ERROR_CTX_SHADOW_DISABLED = 0x00001B8B;
	...
	public const uint ERROR_CTX_CLIENT_LICENSE_IN_USE = 0x00001B8C;
	...
	public const uint ERROR_CTX_CLIENT_LICENSE_NOT_SET = 0x00001B8D;
	...
	public const uint ERROR_CTX_SHADOW_NOT_RUNNING = 0x00001B91;
	...
	public const uint ERROR_CTX_SHADOW_ENDED_BY_MODE_CHANGE = 0x00001B92;
	...
	public const uint ERROR_ACTIVATION_COUNT_EXCEEDED = 0x00001B93;

	/// <summary>Remote logons are currently disabled.</summary>
	public const uint ERROR_CTX_WINSTATIONS_DISABLED = 0x00001B94;

	/// <summary>You do not have the proper encryption level to access this session.</summary>
	public const uint ERROR_CTX_ENCRYPTION_LEVEL_REQUIRED = 0x00001B95;
	...
	public const uint ERROR_CTX_SESSION_IN_USE = 0x00001B96;
	...
	public const uint FRS_ERR_INSUFFICIENT_PRIV = 0x00001F47;
	...
	public const uint FRS_ERR_AUTHENTICATION = 0x00001F48;
	...
	public const uint FRS_ERR_PARENT_INSUFFICIENT_PRIV = 0x00001F49;
	...
	public const uint FRS_ERR_PARENT_AUTHENTICATION = 0x00001F4A;
	...
	public const uint FRS_ERR_CHILD_TO_PARENT_COMM = 0x00001F4B;
	...
	public const uint FRS_ERR_PARENT_TO_CHILD_COMM = 0x00001F4C;
	...
	public const uint FRS_ERR_SYSVOL_POPULATE = 0x00001F4D;
	...
	public const uint FRS_ERR_SYSVOL_POPULATE_TIMEOUT = 0x00001F4E;
	...
	public const uint FRS_ERR_SYSVOL_IS_BUSY = 0x00001F4F;
	...
	public const uint ERROR_DS_MISSING_SUPREF = 0x000020D6;

	/// <summary>The instance type attribute could not be retrieved.</summary>
	public const uint ERROR_DS_CANT_RETRIEVE_INSTANCE = 0x000020D7;

	/// <summary>An internal error has occurred.</summary>
	public const uint ERROR_DS_CODE_INCONSISTENCY = 0x000020D8;

	/// <summary>A database error has occurred.</summary>
	public const uint ERROR_DS_DATABASE_ERROR = 0x000020D9;

	/// <summary>The governsID attribute is missing.</summary>
	public const uint ERROR_DS_GOVERNSID_MISSING = 0x000020DA;

	/// <summary>An expected attribute is missing.</summary>
	public const uint ERROR_DS_MISSING_EXPECTED_ATT = 0x000020DB;

	/// <summary>The specified naming context is missing a cross-reference.</summary>
	public const uint ERROR_DS_NCNAME_MISSING_CR_REF = 0x000020DC;

	/// <summary>A security checking error has occurred.</summary>
	public const uint ERROR_DS_SECURITY_CHECKING_ERROR = 0x000020DD;

	/// <summary>The schema is not loaded.</summary>
	public const uint ERROR_DS_SCHEMA_NOT_LOADED = 0x000020DE;

	/// <summary>Schema allocation failed. Check if the machine is running low on memory.</summary>
	public const uint ERROR_DS_SCHEMA_ALLOC_FAILED = 0x000020DF;

	/// <summary>Failed to obtain the required syntax for the attribute schema.</summary>
	public const uint ERROR_DS_ATT_SCHEMA_REQ_SYNTAX = 0x000020E0;
	...
	public const uint ERROR_DS_REFUSING_FSMO_ROLES = 0x000020F1;
	...
	public const uint ERROR_DS_MISSING_FSMO_SETTINGS = 0x000020F2;
	...
	public const uint ERROR_DS_DRA_INCOMPATIBLE_PARTIAL_SET = 0x00002110;
	...
	public const uint ERROR_DS_DRA_SOURCE_IS_PARTIAL_REPLICA = 0x00002111;
	...
	public const uint ERROR_DS_DRA_EXTN_CONNECTION_FAILED = 0x00002112;
	...
	public const uint ERROR_DS_BACKLINK_WITHOUT_LINK = 0x00002122;
	...
	public const uint ERROR_DS_EPOCH_MISMATCH = 0x00002123;
	...
	public const uint ERROR_DS_SRC_NAME_MISMATCH = 0x00002124;
	...
	public const uint ERROR_DS_SRC_AND_DST_NC_IDENTICAL = 0x00002125;
	...
	public const uint ERROR_DS_DST_NC_MISMATCH = 0x00002126;

	/// <summary>The destination of a cross-domain move is not authoritative for the destination naming context.</summary>
	public const uint ERROR_DS_NOT_AUTHORITIVE_FOR_DST_NC = 0x00002127;
	...
	public const uint ERROR_DS_SRC_GUID_MISMATCH = 0x00002128;
	...
	public const uint ERROR_DS_CANT_MOVE_DELETED_OBJECT = 0x00002129;
	...
	public const uint ERROR_DS_ILLEGAL_XDOM_MOVE_OPERATION = 0x0000212C;
	...
	public const uint ERROR_DS_CANT_WITH_ACCT_GROUP_MEMBERSHPS = 0x0000212D;

	/// <summary>A naming context head must be the immediate child of another naming context head, not of an interior node.</summary>
	public const uint ERROR_DS_NC_MUST_HAVE_NC_PARENT = 0x0000212E;
	...
	public const uint ERROR_DS_CR_IMPOSSIBLE_TO_VALIDATE = 0x0000212F;

	/// <summary>Destination domain must be in native mode.</summary>
	public const uint ERROR_DS_DST_DOMAIN_NOT_NATIVE = 0x00002130;
	...
	public const uint ERROR_DS_MISSING_INFRASTRUCTURE_CONTAINER = 0x00002131;

	/// <summary>Cross-domain moves of nonempty account groups is not allowed.</summary>
	public const uint ERROR_DS_CANT_MOVE_ACCOUNT_GROUP = 0x00002132;

	/// <summary>Cross-domain moves of nonempty resource groups is not allowed.</summary>
	public const uint ERROR_DS_CANT_MOVE_RESOURCE_GROUP = 0x00002133;
	...
	public const uint ERROR_DS_INVALID_SEARCH_FLAG = 0x00002134;

	/// <summary>Tree deletions starting at an object that has an NC head as a descendant are not allowed.</summary>
	public const uint ERROR_DS_NO_TREE_DELETE_ABOVE_NC = 0x00002135;
	...
	public const uint ERROR_DS_COULDNT_LOCK_TREE_FOR_DELETE = 0x00002136;

	/// <summary>The directory service failed to identify the list of objects to delete while attempting a tree deletion.</summary>
	public const uint ERROR_DS_COULDNT_IDENTIFY_OBJECTS_FOR_TREE_DELETE = 0x00002137;
	...
	public const uint ERROR_DS_SAM_INIT_FAILURE = 0x00002138;

	/// <summary>Only an administrator can modify the membership list of an administrative group.</summary>
	public const uint ERROR_DS_SENSITIVE_GROUP_VIOLATION = 0x00002139;

	/// <summary>Cannot change the primary group ID of a domain controller account.</summary>
	public const uint ERROR_DS_CANT_MOD_PRIMARYGROUPID = 0x0000213A;

	/// <summary>An attempt was made to modify the base schema.</summary>
	public const uint ERROR_DS_ILLEGAL_BASE_SCHEMA_MOD = 0x0000213B;
	...
	public const uint ERROR_DS_NONSAFE_SCHEMA_CHANGE = 0x0000213C;

	/// <summary>Schema update is not allowed on this DC because the DC is not the schema FSMO role owner.</summary>
	public const uint ERROR_DS_SCHEMA_UPDATE_DISALLOWED = 0x0000213D;
	...
	public const uint ERROR_DS_CANT_CREATE_UNDER_SCHEMA = 0x0000213E;
	...
	public const uint ERROR_DS_INSTALL_NO_SRC_SCH_VERSION = 0x0000213F;
	...
	public const uint ERROR_DS_STRING_SD_CONVERSION_FAILED = 0x0000214A;
	...
	public const uint ERROR_DS_WRONG_LINKED_ATT_SYNTAX = 0x00002150;

	/// <summary>SAM needs to get the boot password.</summary>
	public const uint ERROR_DS_SAM_NEED_BOOTKEY_PASSWORD = 0x00002151;

	/// <summary>SAM needs to get the boot key from the floppy disk.</summary>
	public const uint ERROR_DS_SAM_NEED_BOOTKEY_FLOPPY = 0x00002152;

	/// <summary>Directory Service cannot start.</summary>
	public const uint ERROR_DS_CANT_START = 0x00002153;

	/// <summary>Directory Services could not start.</summary>
	public const uint ERROR_DS_INIT_FAILURE = 0x00002154;

	/// <summary>The connection between client and server requires packet privacy or better.</summary>
	public const uint ERROR_DS_NO_PKT_PRIVACY_ON_CONNECTION = 0x00002155;

	/// <summary>The source domain cannot be in the same forest as the destination.</summary>
	public const uint ERROR_DS_SOURCE_DOMAIN_IN_FOREST = 0x00002156;

	/// <summary>The destination domain MUST be in the forest.</summary>
	public const uint ERROR_DS_DESTINATION_DOMAIN_NOT_IN_FOREST = 0x00002157;

	/// <summary>The operation requires that destination domain auditing be enabled.</summary>
	public const uint ERROR_DS_DESTINATION_AUDITING_NOT_ENABLED = 0x00002158;

	/// <summary>The operation could not locate a DC for the source domain.</summary>
	public const uint ERROR_DS_CANT_FIND_DC_FOR_SRC_DOMAIN = 0x00002159;

	/// <summary>The source object must be a group or user.</summary>
	public const uint ERROR_DS_SRC_OBJ_NOT_GROUP_OR_USER = 0x0000215A;

	/// <summary>The source object's SID already exists in the destination forest.</summary>
	public const uint ERROR_DS_SRC_SID_EXISTS_IN_FOREST = 0x0000215B;

	/// <summary>The source and destination object must be of the same type.</summary>
	public const uint ERROR_DS_SRC_AND_DST_OBJECT_CLASS_MISMATCH = 0x0000215C;
	...
	public const uint ERROR_DS_DRA_OBJ_NC_MISMATCH = 0x00002161;
	...
	public const uint ERROR_DS_MACHINE_ACCOUNT_QUOTA_EXCEEDED = 0x0000216D;

	/// <summary>For security reasons, the operation must be run on the destination DC.</summary>
	public const uint ERROR_DS_MUST_BE_RUN_ON_DST_DC = 0x0000216E;

	/// <summary>For security reasons, the source DC must be NT4SP4 or greater.</summary>
	public const uint ERROR_DS_SRC_DC_MUST_BE_SP4_OR_GREATER = 0x0000216F;
	...
	public const uint ERROR_DS_CANT_TREE_DELETE_CRITICAL_OBJ = 0x00002170;
	...
	public const uint ERROR_DS_INIT_FAILURE_CONSOLE = 0x00002171;
	...
	public const uint ERROR_DS_SAM_INIT_FAILURE_CONSOLE = 0x00002172;
	...
	public const uint ERROR_DS_FOREST_VERSION_TOO_HIGH = 0x00002173;
	...
	public const uint ERROR_DS_DOMAIN_VERSION_TOO_HIGH = 0x00002174;
	...
	public const uint ERROR_DS_FOREST_VERSION_TOO_LOW = 0x00002175;
	...
	public const uint ERROR_DS_DOMAIN_VERSION_TOO_LOW = 0x00002176;
	...
	public const uint ERROR_DS_INCOMPATIBLE_VERSION = 0x00002177;
	...
	public const uint ERROR_DS_LOW_DSA_VERSION = 0x00002178;
	...
	public const uint ERROR_DS_MODIFYDN_WRONG_GRANDPARENT = 0x00002186;

	/// <summary>Unable to resolve completely; a referral to another forest was generated.</summary>
	public const uint ERROR_DS_NAME_ERROR_TRUST_REFERRAL = 0x00002187;

	/// <summary>The requested action is not supported on a standard server.</summary>
	public const uint ERROR_NOT_SUPPORTED_ON_STANDARD_SERVER = 0x00002188;
	...
	public const uint ERROR_DS_CANT_ACCESS_REMOTE_PART_OF_AD = 0x00002189;
	...
	public const uint ERROR_DS_CR_IMPOSSIBLE_TO_VALIDATE_V2 = 0x0000218A;

	/// <summary>The thread limit for this request was exceeded.</summary>
	public const uint ERROR_DS_THREAD_LIMIT_EXCEEDED = 0x0000218B;

	/// <summary>The GC server is not in the closest site.</summary>
	public const uint ERROR_DS_NOT_CLOSEST = 0x0000218C;
	...
	public const uint ERROR_DS_CANT_DERIVE_SPN_WITHOUT_SERVER_REF = 0x0000218D;

	/// <summary>The directory service failed to enter single-user mode.</summary>
	public const uint ERROR_DS_SINGLE_USER_MODE_FAILED = 0x0000218E;

	/// <summary>The directory service cannot parse the script because of a syntax error.</summary>
	public const uint ERROR_DS_NTDSCRIPT_SYNTAX_ERROR = 0x0000218F;

	/// <summary>The directory service cannot process the script because of an error.</summary>
	public const uint ERROR_DS_NTDSCRIPT_PROCESS_ERROR = 0x00002190;
	...
	public const uint ERROR_DS_REMOTE_CROSSREF_OP_FAILED = 0x00002199;

	/// <summary>A cross-reference is in use locally with the same name.</summary>
	public const uint ERROR_DS_CROSS_REF_BUSY = 0x0000219A;
	...
	public const uint ERROR_DS_CANT_DERIVE_SPN_FOR_DELETED_DOMAIN = 0x0000219B;

	/// <summary>Writable NCs prevent this DC from demoting.</summary>
	public const uint ERROR_DS_CANT_DEMOTE_WITH_WRITEABLE_NC = 0x0000219C;

	/// <summary>The requested object has a nonunique identifier and cannot be retrieved.</summary>
	public const uint ERROR_DS_DUPLICATE_ID_FOUND = 0x0000219D;
	...
	public const uint ERROR_DS_ROLE_NOT_VERIFIED = 0x000021A2;
	...
	public const uint ERROR_DS_WKO_CONTAINER_CANNOT_BE_SPECIAL = 0x000021A3;
	...
	public const uint ERROR_DS_DOMAIN_RENAME_IN_PROGRESS = 0x000021A4;
	...
	public const uint ERROR_DS_EXISTING_AD_CHILD_NC = 0x000021A5;
	...
	public const uint ERROR_DS_REPL_LIFETIME_EXCEEDED = 0x000021A6;

	/// <summary>The requested operation is not allowed on an object under the system container.</summary>
	public const uint ERROR_DS_DISALLOWED_IN_SYSTEM_CONTAINER = 0x000021A7;
	...
	public const uint ERROR_DS_LDAP_SEND_QUEUE_FULL = 0x000021A8;
	...
	public const uint ERROR_DS_DRA_OUT_SCHEDULE_WINDOW = 0x000021A9;
	...
	public const uint ERROR_DS_INVALID_SEARCH_FLAG_SUBTREE = 0x000021B2;
	...
	public const uint ERROR_DS_INVALID_SEARCH_FLAG_TUPLE = 0x000021B3;

	/// <summary>The functional level of the domain (or forest) cannot be lowered to the requested value.</summary>
	public const uint ERROR_DS_HIGH_DSA_VERSION = 0x000021C2;

	/// <summary>The operation failed because the SPN value provided for addition/modification is not unique forest-wide.</summary>
	public const uint ERROR_DS_SPN_VALUE_NOT_UNIQUE_IN_FOREST = 0x000021C7;

	/// <summary>The operation failed because the UPN value provided for addition/modification is not unique forest-wide.</summary>
	public const uint ERROR_DS_UPN_VALUE_NOT_UNIQUE_IN_FOREST = 0x000021C8;

	/// <summary>DNS server unable to interpret format.</summary>
	public const uint DNS_ERROR_RCODE_FORMAT_ERROR = 0x00002329;

	/// <summary>DNS server failure.</summary>
	public const uint DNS_ERROR_RCODE_SERVER_FAILURE = 0x0000232A;

	/// <summary>DNS name does not exist.</summary>
	public const uint DNS_ERROR_RCODE_NAME_ERROR = 0x0000232B;

	/// <summary>DNS request not supported by name server.</summary>
	public const uint DNS_ERROR_RCODE_NOT_IMPLEMENTED = 0x0000232C;

	/// <summary>DNS operation refused.</summary>
	public const uint DNS_ERROR_RCODE_REFUSED = 0x0000232D;

	/// <summary>DNS name that should not exist, does exist.</summary>
	public const uint DNS_ERROR_RCODE_YXDOMAIN = 0x0000232E;

	/// <summary>DNS resource record (RR) set that should not exist, does exist.</summary>
	public const uint DNS_ERROR_RCODE_YXRRSET = 0x0000232F;

	/// <summary>DNS RR set that should to exist, does not exist.</summary>
	public const uint DNS_ERROR_RCODE_NXRRSET = 0x00002330;

	/// <summary>DNS server not authoritative for zone.</summary>
	public const uint DNS_ERROR_RCODE_NOTAUTH = 0x00002331;

	/// <summary>DNS name in update or prereq is not in zone.</summary>
	public const uint DNS_ERROR_RCODE_NOTZONE = 0x00002332;

	/// <summary>DNS signature failed to verify.</summary>
	public const uint DNS_ERROR_RCODE_BADSIG = 0x00002338;

	/// <summary>DNS bad key.</summary>
	public const uint DNS_ERROR_RCODE_BADKEY = 0x00002339;

	/// <summary>DNS signature validity expired.</summary>
	public const uint DNS_ERROR_RCODE_BADTIME = 0x0000233A;

	/// <summary>No records found for given DNS query.</summary>
	public const uint DNS_INFO_NO_RECORDS = 0x0000251D;

	/// <summary>Bad DNS packet.</summary>
	public const uint DNS_ERROR_BAD_PACKET = 0x0000251E;

	/// <summary>No DNS packet.</summary>
	public const uint DNS_ERROR_NO_PACKET = 0x0000251F;

	/// <summary>DNS error, check rcode.</summary>
	public const uint DNS_ERROR_RCODE = 0x00002520;

	/// <summary>Unsecured DNS packet.</summary>
	public const uint DNS_ERROR_UNSECURE_PACKET = 0x00002521;

	/// <summary>DNS query request is pending.</summary>
	public const uint DNS_REQUEST_PENDING = 0x00002522;

	/// <summary>Invalid DNS type.</summary>
	public const uint DNS_ERROR_INVALID_TYPE = 0x0000254F;

	/// <summary>Invalid IP address.</summary>
	public const uint DNS_ERROR_INVALID_IP_ADDRESS = 0x00002550;

	/// <summary>Invalid property.</summary>
	public const uint DNS_ERROR_INVALID_PROPERTY = 0x00002551;

	/// <summary>Try DNS operation again later.</summary>
	public const uint DNS_ERROR_TRY_AGAIN_LATER = 0x00002552;

	/// <summary>Record for given name and type is not unique.</summary>
	public const uint DNS_ERROR_NOT_UNIQUE = 0x00002553;

	/// <summary>DNS name does not comply with RFC specifications.</summary>
	public const uint DNS_ERROR_NON_RFC_NAME = 0x00002554;

	/// <summary>DNS name is a fully qualified DNS name.</summary>
	public const uint DNS_STATUS_FQDN = 0x00002555;

	/// <summary>DNS name is dotted (multilabel).</summary>
	public const uint DNS_STATUS_DOTTED_NAME = 0x00002556;

	/// <summary>DNS name is a single-part name.</summary>
	public const uint DNS_STATUS_SINGLE_PART_NAME = 0x00002557;

	/// <summary>DNS name contains an invalid character.</summary>
	public const uint DNS_ERROR_INVALID_NAME_CHAR = 0x00002558;

	/// <summary>DNS name is entirely numeric.</summary>
	public const uint DNS_ERROR_NUMERIC_NAME = 0x00002559;

	/// <summary>The operation requested is not permitted on a DNS root server.</summary>
	public const uint DNS_ERROR_NOT_ALLOWED_ON_ROOT_SERVER = 0x0000255A;
	...
	public const uint DNS_ERROR_NOT_ALLOWED_UNDER_DELEGATION = 0x0000255B;

	/// <summary>The DNS server could not find a set of root hints.</summary>
	public const uint DNS_ERROR_CANNOT_FIND_ROOT_HINTS = 0x0000255C;

	/// <summary>The DNS server found root hints but they were not consistent across all adapters.</summary>
	public const uint DNS_ERROR_INCONSISTENT_ROOT_HINTS = 0x0000255D;

	/// <summary>The specified value is too small for this parameter.</summary>
	public const uint DNS_ERROR_DWORD_VALUE_TOO_SMALL = 0x0000255E;

	/// <summary>The specified value is too large for this parameter.</summary>
	public const uint DNS_ERROR_DWORD_VALUE_TOO_LARGE = 0x0000255F;

	/// <summary>This operation is not allowed while the DNS server is loading zones in the background. Try again later.</summary>
	public const uint DNS_ERROR_BACKGROUND_LOADING = 0x00002560;

	/// <summary>The operation requested is not permitted on against a DNS server running on a read-only DC.</summary>
	public const uint DNS_ERROR_NOT_ALLOWED_ON_RODC = 0x00002561;

	/// <summary>DNS zone does not exist.</summary>
	public const uint DNS_ERROR_ZONE_DOES_NOT_EXIST = 0x00002581;

	/// <summary>DNS zone information not available.</summary>
	public const uint DNS_ERROR_NO_ZONE_INFO = 0x00002582;

	/// <summary>Invalid operation for DNS zone.</summary>
	public const uint DNS_ERROR_INVALID_ZONE_OPERATION = 0x00002583;

	/// <summary>Invalid DNS zone configuration.</summary>
	public const uint DNS_ERROR_ZONE_CONFIGURATION_ERROR = 0x00002584;

	/// <summary>DNS zone has no start of authority (SOA) record.</summary>
	public const uint DNS_ERROR_ZONE_HAS_NO_SOA_RECORD = 0x00002585;

	/// <summary>DNS zone has no Name Server (NS) record.</summary>
	public const uint DNS_ERROR_ZONE_HAS_NO_NS_RECORDS = 0x00002586;

	/// <summary>DNS zone is locked.</summary>
	public const uint DNS_ERROR_ZONE_LOCKED = 0x00002587;

	/// <summary>DNS zone creation failed.</summary>
	public const uint DNS_ERROR_ZONE_CREATION_FAILED = 0x00002588;

	/// <summary>DNS zone already exists.</summary>
	public const uint DNS_ERROR_ZONE_ALREADY_EXISTS = 0x00002589;

	/// <summary>DNS automatic zone already exists.</summary>
	public const uint DNS_ERROR_AUTOZONE_ALREADY_EXISTS = 0x0000258A;

	/// <summary>Invalid DNS zone type.</summary>
	public const uint DNS_ERROR_INVALID_ZONE_TYPE = 0x0000258B;

	/// <summary>Secondary DNS zone requires master IP address.</summary>
	public const uint DNS_ERROR_SECONDARY_REQUIRES_MASTER_IP = 0x0000258C;

	/// <summary>DNS zone not secondary.</summary>
	public const uint DNS_ERROR_ZONE_NOT_SECONDARY = 0x0000258D;

	/// <summary>Need secondary IP address.</summary>
	public const uint DNS_ERROR_NEED_SECONDARY_ADDRESSES = 0x0000258E;

	/// <summary>WINS initialization failed.</summary>
	public const uint DNS_ERROR_WINS_INIT_FAILED = 0x0000258F;

	/// <summary>Need WINS servers.</summary>
	public const uint DNS_ERROR_NEED_WINS_SERVERS = 0x00002590;

	/// <summary>NBTSTAT initialization call failed.</summary>
	public const uint DNS_ERROR_NBSTAT_INIT_FAILED = 0x00002591;

	/// <summary>Invalid delete of SOA.</summary>
	public const uint DNS_ERROR_SOA_DELETE_INVALID = 0x00002592;

	/// <summary>A conditional forwarding zone already exists for that name.</summary>
	public const uint DNS_ERROR_FORWARDER_ALREADY_EXISTS = 0x00002593;

	/// <summary>This zone must be configured with one or more master DNS server IP addresses.</summary>
	public const uint DNS_ERROR_ZONE_REQUIRES_MASTER_IP = 0x00002594;

	/// <summary>The operation cannot be performed because this zone is shut down.</summary>
	public const uint DNS_ERROR_ZONE_IS_SHUTDOWN = 0x00002595;

	/// <summary>The primary DNS zone requires a data file.</summary>
	public const uint DNS_ERROR_PRIMARY_REQUIRES_DATAFILE = 0x000025B3;

	/// <summary>Invalid data file name for the DNS zone.</summary>
	public const uint DNS_ERROR_INVALID_DATAFILE_NAME = 0x000025B4;

	/// <summary>Failed to open the data file for the DNS zone.</summary>
	public const uint DNS_ERROR_DATAFILE_OPEN_FAILURE = 0x000025B5;

	/// <summary>Failed to write the data file for the DNS zone.</summary>
	public const uint DNS_ERROR_FILE_WRITEBACK_FAILED = 0x000025B6;

	/// <summary>Failure while reading datafile for DNS zone.</summary>
	public const uint DNS_ERROR_DATAFILE_PARSING = 0x000025B7;

	/// <summary>DNS record does not exist.</summary>
	public const uint DNS_ERROR_RECORD_DOES_NOT_EXIST = 0x000025E5;

	/// <summary>DNS record format error.</summary>
	public const uint DNS_ERROR_RECORD_FORMAT = 0x000025E6;

	/// <summary>Node creation failure in DNS.</summary>
	public const uint DNS_ERROR_NODE_CREATION_FAILED = 0x000025E7;

	/// <summary>Unknown DNS record type.</summary>
	public const uint DNS_ERROR_UNKNOWN_RECORD_TYPE = 0x000025E8;

	/// <summary>DNS record timed out.</summary>
	public const uint DNS_ERROR_RECORD_TIMED_OUT = 0x000025E9;

	/// <summary>Name not in DNS zone.</summary>
	public const uint DNS_ERROR_NAME_NOT_IN_ZONE = 0x000025EA;

	/// <summary>CNAME loop detected.</summary>
	public const uint DNS_ERROR_CNAME_LOOP = 0x000025EB;

	/// <summary>Node is a CNAME DNS record.</summary>
	public const uint DNS_ERROR_NODE_IS_CNAME = 0x000025EC;

	/// <summary>A CNAME record already exists for the given name.</summary>
	public const uint DNS_ERROR_CNAME_COLLISION = 0x000025ED;

	/// <summary>Record is only at DNS zone root.</summary>
	public const uint DNS_ERROR_RECORD_ONLY_AT_ZONE_ROOT = 0x000025EE;

	/// <summary>DNS record already exists.</summary>
	public const uint DNS_ERROR_RECORD_ALREADY_EXISTS = 0x000025EF;

	/// <summary>Secondary DNS zone data error.</summary>
	public const uint DNS_ERROR_SECONDARY_DATA = 0x000025F0;

	/// <summary>Could not create DNS cache data.</summary>
	public const uint DNS_ERROR_NO_CREATE_CACHE_DATA = 0x000025F1;

	/// <summary>DNS name does not exist.</summary>
	public const uint DNS_ERROR_NAME_DOES_NOT_EXIST = 0x000025F2;

	/// <summary>Could not create pointer (PTR) record.</summary>
	public const uint DNS_WARNING_PTR_CREATE_FAILED = 0x000025F3;

	/// <summary>DNS domain was undeleted.</summary>
	public const uint DNS_WARNING_DOMAIN_UNDELETED = 0x000025F4;

	/// <summary>The directory service is unavailable.</summary>
	public const uint DNS_ERROR_DS_UNAVAILABLE = 0x000025F5;

	/// <summary>DNS zone already exists in the directory service.</summary>
	public const uint DNS_ERROR_DS_ZONE_ALREADY_EXISTS = 0x000025F6;

	/// <summary>DNS server not creating or reading the boot file for the directory service integrated DNS zone.</summary>
	public const uint DNS_ERROR_NO_BOOTFILE_IF_DS_ZONE = 0x000025F7;

	/// <summary>DNS AXFR (zone transfer) complete.</summary>
	public const uint DNS_INFO_AXFR_COMPLETE = 0x00002617;

	/// <summary>DNS zone transfer failed.</summary>
	public const uint DNS_ERROR_AXFR = 0x00002618;

	/// <summary>Added local WINS server.</summary>
	public const uint DNS_INFO_ADDED_LOCAL_WINS = 0x00002619;

	/// <summary>Secure update call needs to continue update request.</summary>
	public const uint DNS_STATUS_CONTINUE_NEEDED = 0x00002649;

	/// <summary>TCP/IP network protocol not installed.</summary>
	public const uint DNS_ERROR_NO_TCPIP = 0x0000267B;

	/// <summary>No DNS servers configured for local system.</summary>
	public const uint DNS_ERROR_NO_DNS_SERVERS = 0x0000267C;

	/// <summary>The specified directory partition does not exist.</summary>
	public const uint DNS_ERROR_DP_DOES_NOT_EXIST = 0x000026AD;

	/// <summary>The specified directory partition already exists.</summary>
	public const uint DNS_ERROR_DP_ALREADY_EXISTS = 0x000026AE;

	/// <summary>This DNS server is not enlisted in the specified directory partition.</summary>
	public const uint DNS_ERROR_DP_NOT_ENLISTED = 0x000026AF;

	/// <summary>This DNS server is already enlisted in the specified directory partition.</summary>
	public const uint DNS_ERROR_DP_ALREADY_ENLISTED = 0x000026B0;

	/// <summary>The directory partition is not available at this time. Wait a few minutes and try again.</summary>
	public const uint DNS_ERROR_DP_NOT_AVAILABLE = 0x000026B1;
	...
	public const uint ERROR_IPSEC_IKE_NO_CERT = 0x000035EE;

	/// <summary>The IKE security association (SA) was deleted by a peer before it was completely established.</summary>
	public const uint ERROR_IPSEC_IKE_SA_DELETED = 0x000035EF;

	/// <summary>The IKE SA was deleted before it was completely established.</summary>
	public const uint ERROR_IPSEC_IKE_SA_REAPED = 0x000035F0;

	/// <summary>The negotiation request sat in the queue too long.</summary>
	public const uint ERROR_IPSEC_IKE_MM_ACQUIRE_DROP = 0x000035F1;

	/// <summary>The negotiation request sat in the queue too long.</summary>
	public const uint ERROR_IPSEC_IKE_QM_ACQUIRE_DROP = 0x000035F2;

	/// <summary>The negotiation request sat in the queue too long.</summary>
	public const uint ERROR_IPSEC_IKE_QUEUE_DROP_MM = 0x000035F3;

	/// <summary>The negotiation request sat in the queue too long.</summary>
	public const uint ERROR_IPSEC_IKE_QUEUE_DROP_NO_MM = 0x000035F4;

	/// <summary>There was no response from a peer.</summary>
	public const uint ERROR_IPSEC_IKE_DROP_NO_RESPONSE = 0x000035F5;

	/// <summary>The negotiation took too long.</summary>
	public const uint ERROR_IPSEC_IKE_MM_DELAY_DROP = 0x000035F6;

	/// <summary>The negotiation took too long.</summary>
	public const uint ERROR_IPSEC_IKE_QM_DELAY_DROP = 0x000035F7;

	/// <summary>An unknown error occurred.</summary>
	public const uint ERROR_IPSEC_IKE_ERROR = 0x000035F8;

	/// <summary>The certificate revocation check failed.</summary>
	public const uint ERROR_IPSEC_IKE_CRL_FAILED = 0x000035F9;

	/// <summary>Invalid certificate key usage.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_KEY_USAGE = 0x000035FA;

	/// <summary>Invalid certificate type.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_CERT_TYPE = 0x000035FB;
	...
	public const uint ERROR_IPSEC_IKE_NO_PRIVATE_KEY = 0x000035FC;

	/// <summary>There was a failure in the Diffie-Hellman computation.</summary>
	public const uint ERROR_IPSEC_IKE_DH_FAIL = 0x000035FE;

	/// <summary>Invalid header.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_HEADER = 0x00003600;

	/// <summary>No policy configured.</summary>
	public const uint ERROR_IPSEC_IKE_NO_POLICY = 0x00003601;

	/// <summary>Failed to verify signature.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_SIGNATURE = 0x00003602;

	/// <summary>Failed to authenticate using Kerberos.</summary>
	public const uint ERROR_IPSEC_IKE_KERBEROS_ERROR = 0x00003603;

	/// <summary>The peer's certificate did not have a public key.</summary>
	public const uint ERROR_IPSEC_IKE_NO_PUBLIC_KEY = 0x00003604;

	/// <summary>Error processing the error payload.</summary>
	public const uint ERROR_IPSEC_IKE_PROCESS_ERR = 0x00003605;

	/// <summary>Error processing the SA payload.</summary>
	public const uint ERROR_IPSEC_IKE_PROCESS_ERR_SA = 0x00003606;

	/// <summary>Error processing the proposal payload.</summary>
	public const uint ERROR_IPSEC_IKE_PROCESS_ERR_PROP = 0x00003607;

	/// <summary>Error processing the transform payload.</summary>
	public const uint ERROR_IPSEC_IKE_PROCESS_ERR_TRANS = 0x00003608;

	/// <summary>Error processing the key exchange payload.</summary>
	public const uint ERROR_IPSEC_IKE_PROCESS_ERR_KE = 0x00003609;

	/// <summary>Error processing the ID payload.</summary>
	public const uint ERROR_IPSEC_IKE_PROCESS_ERR_ID = 0x0000360A;

	/// <summary>Error processing the certification payload.</summary>
	public const uint ERROR_IPSEC_IKE_PROCESS_ERR_CERT = 0x0000360B;

	/// <summary>Error processing the certificate request payload.</summary>
	public const uint ERROR_IPSEC_IKE_PROCESS_ERR_CERT_REQ = 0x0000360C;

	/// <summary>Error processing the hash payload.</summary>
	public const uint ERROR_IPSEC_IKE_PROCESS_ERR_HASH = 0x0000360D;

	/// <summary>Error processing the signature payload.</summary>
	public const uint ERROR_IPSEC_IKE_PROCESS_ERR_SIG = 0x0000360E;

	/// <summary>Error processing the nonce payload.</summary>
	public const uint ERROR_IPSEC_IKE_PROCESS_ERR_NONCE = 0x0000360F;

	/// <summary>Error processing the notify payload.</summary>
	public const uint ERROR_IPSEC_IKE_PROCESS_ERR_NOTIFY = 0x00003610;

	/// <summary>Error processing the delete payload.</summary>
	public const uint ERROR_IPSEC_IKE_PROCESS_ERR_DELETE = 0x00003611;

	/// <summary>Error processing the VendorId payload.</summary>
	public const uint ERROR_IPSEC_IKE_PROCESS_ERR_VENDOR = 0x00003612;

	/// <summary>Invalid payload received.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_PAYLOAD = 0x00003613;

	/// <summary>Soft SA loaded.</summary>
	public const uint ERROR_IPSEC_IKE_LOAD_SOFT_SA = 0x00003614;

	/// <summary>Soft SA torn down.</summary>
	public const uint ERROR_IPSEC_IKE_SOFT_SA_TORN_DOWN = 0x00003615;

	/// <summary>Invalid cookie received.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_COOKIE = 0x00003616;

	/// <summary>Peer failed to send valid machine certificate.</summary>
	public const uint ERROR_IPSEC_IKE_NO_PEER_CERT = 0x00003617;

	/// <summary>Certification revocation check of peer's certificate failed.</summary>
	public const uint ERROR_IPSEC_IKE_PEER_CRL_FAILED = 0x00003618;

	/// <summary>New policy invalidated SAs formed with the old policy.</summary>
	public const uint ERROR_IPSEC_IKE_POLICY_CHANGE = 0x00003619;

	/// <summary>There is no available main mode IKE policy.</summary>
	public const uint ERROR_IPSEC_IKE_NO_MM_POLICY = 0x0000361A;

	/// <summary>Failed to enabled trusted computer base (TCB) privilege.</summary>
	public const uint ERROR_IPSEC_IKE_NOTCBPRIV = 0x0000361B;

	/// <summary>Failed to load SECURITY.DLL.</summary>
	public const uint ERROR_IPSEC_IKE_SECLOADFAIL = 0x0000361C;

	/// <summary>Failed to obtain the security function table dispatch address from the SSPI.</summary>
	public const uint ERROR_IPSEC_IKE_FAILSSPINIT = 0x0000361D;

	/// <summary>Failed to query the Kerberos package to obtain the max token size.</summary>
	public const uint ERROR_IPSEC_IKE_FAILQUERYSSP = 0x0000361E;
	...
	public const uint ERROR_IPSEC_IKE_SRVACQFAIL = 0x0000361F;
	...
	public const uint ERROR_IPSEC_IKE_SRVQUERYCRED = 0x00003620;
	...
	public const uint ERROR_IPSEC_IKE_GETSPIFAIL = 0x00003621;

	/// <summary>Given filter is invalid.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_FILTER = 0x00003622;

	/// <summary>Memory allocation failed.</summary>
	public const uint ERROR_IPSEC_IKE_OUT_OF_MEMORY = 0x00003623;
	...
	public const uint ERROR_IPSEC_IKE_ADD_UPDATE_KEY_FAILED = 0x00003624;

	/// <summary>Invalid policy.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_POLICY = 0x00003625;

	/// <summary>Invalid digital object identifier (DOI).</summary>
	public const uint ERROR_IPSEC_IKE_UNKNOWN_DOI = 0x00003626;

	/// <summary>Invalid situation.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_SITUATION = 0x00003627;

	/// <summary>Diffie-Hellman failure.</summary>
	public const uint ERROR_IPSEC_IKE_DH_FAILURE = 0x00003628;

	/// <summary>Invalid Diffie-Hellman group.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_GROUP = 0x00003629;

	/// <summary>Error encrypting payload.</summary>
	public const uint ERROR_IPSEC_IKE_ENCRYPT = 0x0000362A;

	/// <summary>Error decrypting payload.</summary>
	public const uint ERROR_IPSEC_IKE_DECRYPT = 0x0000362B;

	/// <summary>Policy match error.</summary>
	public const uint ERROR_IPSEC_IKE_POLICY_MATCH = 0x0000362C;

	/// <summary>Unsupported ID.</summary>
	public const uint ERROR_IPSEC_IKE_UNSUPPORTED_ID = 0x0000362D;

	/// <summary>Hash verification failed.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_HASH = 0x0000362E;

	/// <summary>Invalid hash algorithm.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_HASH_ALG = 0x0000362F;

	/// <summary>Invalid hash size.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_HASH_SIZE = 0x00003630;

	/// <summary>Invalid encryption algorithm.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_ENCRYPT_ALG = 0x00003631;

	/// <summary>Invalid authentication algorithm.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_AUTH_ALG = 0x00003632;

	/// <summary>Invalid certificate signature.</summary>
	public const uint ERROR_IPSEC_IKE_INVALID_SIG = 0x00003633;

	/// <summary>Load failed.</summary>
	public const uint ERROR_IPSEC_IKE_LOAD_FAILED = 0x00003634;

	/// <summary>Deleted by using an RPC call.</summary>
	public const uint ERROR_IPSEC_IKE_RPC_DELETE = 0x00003635;

	/// <summary>A temporary state was created to perform reinitialization. This is not a real failure.</summary>
	public const uint ERROR_IPSEC_IKE_BENIGN_REINIT = 0x00003636;
	...
	public const uint ERROR_SXS_THREAD_QUERIES_DISABLED = 0x000036BA;
	...
	public const uint ERROR_SXS_PROCESS_DEFAULT_ALREADY_SET = 0x000036BB;

	/// <summary>The encoding group identifier specified is not recognized.</summary>
	public const uint ERROR_SXS_UNKNOWN_ENCODING_GROUP = 0x000036BC;

	/// <summary>The encoding requested is not recognized.</summary>
	public const uint ERROR_SXS_UNKNOWN_ENCODING = 0x000036BD;

	/// <summary>The manifest contains a reference to an invalid URI.</summary>
	public const uint ERROR_SXS_INVALID_XML_NAMESPACE_URI = 0x000036BE;

	/// <summary>The application manifest contains a reference to a dependent assembly that is not installed.</summary>
	public const uint ERROR_SXS_ROOT_MANIFEST_DEPENDENCY_OT_INSTALLED = 0x000036BF;
	...
	public const uint ERROR_SXS_LEAF_MANIFEST_DEPENDENCY_NOT_INSTALLED = 0x000036C0;

	/// <summary>The manifest contains an attribute for the assembly identity that is not valid.</summary>
	public const uint ERROR_SXS_INVALID_ASSEMBLY_IDENTITY_ATTRIBUTE = 0x000036C1;

	/// <summary>The manifest is missing the required default namespace specification on the assembly element.</summary>
	public const uint ERROR_SXS_MANIFEST_MISSING_REQUIRED_DEFAULT_NAMESPACE = 0x000036C2;
	...
	public const uint ERROR_SXS_MANIFEST_INVALID_REQUIRED_DEFAULT_NAMESPACE = 0x000036C3;

	/// <summary>The private manifest probed has crossed the reparse-point-associated path.</summary>
	public const uint ERROR_SXS_PRIVATE_MANIFEST_CROSS_PATH_WITH_REPARSE_POINT = 0x000036C4;
	...
	public const uint ERROR_SXS_DUPLICATE_DLL_NAME = 0x000036C5;
	...
	public const uint ERROR_SXS_DUPLICATE_WINDOWCLASS_NAME = 0x000036C6;
	...
	public const uint ERROR_SXS_DUPLICATE_CLSID = 0x000036C7;
	...
	public const uint ERROR_SXS_DUPLICATE_IID = 0x000036C8;
	...
	public const uint ERROR_SXS_DUPLICATE_TLBID = 0x000036C9;
	...
	public const uint ERROR_SXS_DUPLICATE_PROGID = 0x000036CA;
	...
	public const uint ERROR_SXS_IDENTITY_PARSE_ERROR = 0x0000370D;
	...
	public const uint ERROR_EVT_SUBSCRIPTION_TO_DIRECT_CHANNEL = 0x00003AA1;

	/// <summary>Configuration error.</summary>
	public const uint ERROR_EVT_CONFIGURATION_ERROR = 0x00003AA2;
	...
	public const uint ERROR_EVT_QUERY_RESULT_STALE = 0x00003AA3;

	/// <summary>Query result is currently at an invalid position.</summary>
	public const uint ERROR_EVT_QUERY_RESULT_INVALID_POSITION = 0x00003AA4;

	/// <summary>Registered Microsoft XML (MSXML) does not support validation.</summary>
	public const uint ERROR_EVT_NON_VALIDATING_MSXML = 0x00003AA5;
	...
	public const uint ERROR_EVT_FILTER_ALREADYSCOPED = 0x00003AA6;

	/// <summary>Cannot perform a step operation from a term that does not represent an element set.</summary>
	public const uint ERROR_EVT_FILTER_NOTELTSET = 0x00003AA7;
	...
	public const uint ERROR_EVT_FILTER_INVARG = 0x00003AA8;
	...
	public const uint ERROR_EVT_FILTER_INVTEST = 0x00003AA9;

	/// <summary>This data type is currently unsupported.</summary>
	public const uint ERROR_EVT_FILTER_INVTYPE = 0x00003AAA;

	/// <summary>A syntax error occurred at position %1!d!</summary>
	public const uint ERROR_EVT_FILTER_PARSEERR = 0x00003AAB;

	/// <summary>This operator is unsupported by this implementation of the filter.</summary>
	public const uint ERROR_EVT_FILTER_UNSUPPORTEDOP = 0x00003AAC;

	/// <summary>The token encountered was unexpected.</summary>
	public const uint ERROR_EVT_FILTER_UNEXPECTEDTOKEN = 0x00003AAD;
	...
	public const uint ERROR_EVT_INVALID_OPERATION_OVER_ENABLED_DIRECT_CHANNEL = 0x00003AAE;
	...
	public const uint ERROR_EVT_INVALID_CHANNEL_PROPERTY_VALUE = 0x00003AAF;
	...
	public const uint ERROR_EVT_INVALID_PUBLISHER_PROPERTY_VALUE = 0x00003AB0;

	/// <summary>The channel fails to activate.</summary>
	public const uint ERROR_EVT_CHANNEL_CANNOT_ACTIVATE = 0x00003AB1;
	...
	public const uint ERROR_EVT_VERSION_TOO_OLD = 0x00003ABA;

	/// <summary>The resource is too new to be compatible.</summary>
	public const uint ERROR_EVT_VERSION_TOO_NEW = 0x00003ABB;

	/// <summary>The channel at index %1 of the query cannot be opened.</summary>
	public const uint ERROR_EVT_CANNOT_OPEN_CHANNEL_OF_QUERY = 0x00003ABC;
	...
	public const uint ERROR_EVT_PUBLISHER_DISABLED = 0x00003ABD;

	/// <summary>The subscription fails to activate.</summary>
	public const uint ERROR_EC_SUBSCRIPTION_CANNOT_ACTIVATE = 0x00003AE8;
	...
	public const uint ERROR_MUI_INVALID_RC_CONFIG = 0x00003AFE;

	/// <summary>The RC manifest has an invalid culture name.</summary>
	public const uint ERROR_MUI_INVALID_LOCALE_NAME = 0x00003AFF;

	/// <summary>The RC Manifest has an invalid ultimate fallback name.</summary>
	public const uint ERROR_MUI_INVALID_ULTIMATEFALLBACK_NAME = 0x00003B00;

	/// <summary>The resource loader cache does not have a loaded MUI entry.</summary>
	public const uint ERROR_MUI_FILE_NOT_LOADED = 0x00003B01;

	/// <summary>The user stopped resource enumeration.</summary>
	public const uint ERROR_RESOURCE_ENUM_USER_STOP = 0x00003B02;

	/// <summary>User interface language installation failed.</summary>
	public const uint ERROR_MUI_INTLSETTINGS_UILANG_NOT_INSTALLED = 0x00003B03;

	/// <summary>Locale installation failed.</summary>
	public const uint ERROR_MUI_INTLSETTINGS_INVALID_LOCALE_NAME = 0x00003B04;
	...
	public const uint ERROR_MCA_INVALID_CAPABILITIES_STRING = 0x00003B60;

	/// <summary>The monitor's VCP version (0xDF) VCP code returned an invalid version value.</summary>
	public const uint ERROR_MCA_INVALID_VCP_VERSION = 0x00003B61;

	/// <summary>The monitor does not comply with the MCCS specification it claims to support.</summary>
	public const uint ERROR_MCA_MONITOR_VIOLATES_MCCS_SPECIFICATION = 0x00003B62;
	...
	public const uint ERROR_MCA_MCCS_VERSION_MISMATCH = 0x00003B63;
	...
	public const uint ERROR_MCA_UNSUPPORTED_MCCS_VERSION = 0x00003B64;

	/// <summary>An internal monitor configuration API error occurred.</summary>
	public const uint ERROR_MCA_INTERNAL_ERROR = 0x00003B65;
	...
	public const uint ERROR_MCA_INVALID_TECHNOLOGY_TYPE_RETURNED = 0x00003B66;
	...
	public const uint ERROR_MCA_UNSUPPORTED_COLOR_TEMPERATURE = 0x00003B67;
	...
	public const uint ERROR_AMBIGUOUS_SYSTEM_DEVICE = 0x00003B92;

	/// <summary>The requested system device cannot be found.</summary>
	public const uint ERROR_SYSTEM_DEVICE_NOT_FOUND = 0x00003BC3;

	/// <summary>No more handles could be generated at this time.</summary>
	public const uint ERROR_INTERNET_OUT_OF_HANDLES = 12001;
	/// <summary>The request has timed out.</summary>
	public const uint ERROR_INTERNET_TIMEOUT = 12002;
	...
	public const uint ERROR_INTERNET_EXTENDED_ERROR = 12003;
	/// <summary>An internal error has occurred.</summary>
	public const uint ERROR_INTERNET_INTERNAL_ERROR = 12004;
	/// <summary>The URL is invalid.</summary>
	public const uint ERROR_INTERNET_INVALID_URL = 12005;
	/// <summary>The URL scheme could not be recognized or is not supported.</summary>
	public const uint ERROR_INTERNET_UNRECOGNIZED_SCHEME = 12006;
	/// <summary>The server name could not be resolved.</summary>
	public const uint ERROR_INTERNET_NAME_NOT_RESOLVED = 12007;
	/// <summary>The requested protocol could not be located.</summary>
	public const uint ERROR_INTERNET_PROTOCOL_NOT_FOUND = 12008;
	/// <summary>A request to InternetQueryOption or InternetSetOption specified an invalid option value.</summary>
	public const uint ERROR_INTERNET_INVALID_OPTION = 12009;
	...
	public const uint ERROR_INTERNET_BAD_OPTION_LENGTH = 12010;
	/// <summary>The request option cannot be set, only queried.</summary>
	public const uint ERROR_INTERNET_OPTION_NOT_SETTABLE = 12011;
	/// <summary>The Win32 Internet function support is being shut down or unloaded.</summary>
	public const uint ERROR_INTERNET_SHUTDOWN = 12012;
	...
	public const uint ERROR_INTERNET_INCORRECT_USER_NAME = 12013;
	...
	public const uint ERROR_INTERNET_INCORRECT_PASSWORD = 12014;
	/// <summary>The request to connect to and log on to an FTP server failed.</summary>
	public const uint ERROR_INTERNET_LOGIN_FAILURE = 12015;
	/// <summary>The requested operation is invalid.</summary>
	public const uint ERROR_INTERNET_INVALID_OPERATION = 12016;
	...
	public const uint ERROR_INTERNET_MIXED_SECURITY = 12041;
	...
	public const uint ERROR_INTERNET_CHG_POST_IS_NON_SECURE = 12042;
	/// <summary>The application is posting data to a server that is not secure.</summary>
	public const uint ERROR_INTERNET_POST_IS_NON_SECURE = 12043;
	...
	public const uint ERROR_GOPHER_NOT_GOPHER_PLUS = 12136;
	/// <summary>The requested attribute could not be located.</summary>
	public const uint ERROR_GOPHER_ATTRIBUTE_NOT_FOUND = 12137;
	/// <summary>The locator type is unknown.</summary>
	public const uint ERROR_GOPHER_UNKNOWN_LOCATOR = 12138;
	/// <summary>The requested header could not be located.</summary>
	public const uint ERROR_HTTP_HEADER_NOT_FOUND = 12150;
	/// <summary>The server did not return any headers.</summary>
	public const uint ERROR_HTTP_DOWNLEVEL_SERVER = 12151;
	/// <summary>The server response could not be parsed.</summary>
	public const uint ERROR_HTTP_INVALID_SERVER_RESPONSE = 12152;
	/// <summary>The supplied header is invalid.</summary>
	public const uint ERROR_HTTP_INVALID_HEADER = 12153;
	/// <summary>The request made to HttpQueryInfo is invalid.</summary>
	public const uint ERROR_HTTP_INVALID_QUERY_REQUEST = 12154;
	/// <summary>The header could not be added because it already exists.</summary>
	public const uint ERROR_HTTP_HEADER_ALREADY_EXISTS = 12155;
	...
	public const uint ERROR_HTTP_REDIRECT_FAILED = 12156;
	...
	public const uint ERROR_DEV_SIDELOAD_LIMIT_EXCEEDED = 15633;
	...
	public const uint ERROR_INSTALL_OPTIONAL_PACKAGE_REQUIRES_MAIN_PACKAGE = 15634;

	/// <summary>This app package type is not supported on this filesystem</summary>
	public const uint ERROR_PACKAGE_NOT_SUPPORTED_ON_FILESYSTEM = 15635;

	/// <summary>Package move operation is blocked until the application has finished streaming</summary>
	public const uint ERROR_PACKAGE_MOVE_BLOCKED_BY_STREAMING = 15636;
	...
	public const uint ERROR_INSTALL_OPTIONAL_PACKAGE_APPLICATIONID_NOT_UNIQUE = 15637;

	/// <summary>This staging session has been held to allow another staging operation to be prioritized.</summary>
	public const uint ERROR_PACKAGE_STAGING_ONHOLD = 15638;
	...
	public const uint ERROR_INSTALL_INVALID_RELATED_SET_UPDATE = 15639;
	...
	public const uint ERROR_INSTALL_OPTIONAL_PACKAGE_REQUIRES_MAIN_PACKAGE_FULLTRUST_CAPABILITY = 15640;

	/// <summary>An error occurred because a user was logged off.</summary>
	public const uint ERROR_DEPLOYMENT_BLOCKED_BY_USER_LOG_OFF = 15641;

	/// <summary>An optional package provision requires the dependency main package to also be provisioned.</summary>
	public const uint ERROR_PROVISION_OPTIONAL_PACKAGE_REQUIRES_MAIN_PACKAGE_PROVISIONED = 15642;

	/// <summary>The packages failed the SmartScreen reputation check.</summary>
	public const uint ERROR_PACKAGES_REPUTATION_CHECK_FAILED = 15643;

	/// <summary>The SmartScreen reputation check operation timed out.</summary>
	public const uint ERROR_PACKAGES_REPUTATION_CHECK_TIMEDOUT = 15644;

	/// <summary>The current deployment option is not supported.</summary>
	public const uint ERROR_DEPLOYMENT_OPTION_NOT_SUPPORTED = 15645;

	/// <summary>Activation is blocked due to the .appinstaller update settings for this app.</summary>
	public const uint ERROR_APPINSTALLER_ACTIVATION_BLOCKED = 15646;

	/// <summary>Remote drives are not supported; use \\server\share to register a remote package.</summary>
	public const uint ERROR_REGISTRATION_FROM_REMOTE_DRIVE_NOT_SUPPORTED = 15647;

	/// <summary>Failed to process and write downloaded APPX package data to disk.</summary>
	public const uint ERROR_APPX_RAW_DATA_WRITE_FAILED = 15648;
	...
	public const uint ERROR_DEPLOYMENT_BLOCKED_BY_VOLUME_POLICY_PACKAGE = 15649;
	...
	public const uint ERROR_DEPLOYMENT_BLOCKED_BY_VOLUME_POLICY_MACHINE = 15650;
	...
	public const uint ERROR_DEPLOYMENT_BLOCKED_BY_PROFILE_POLICY = 15651;
	...
	public const uint ERROR_DEPLOYMENT_FAILED_CONFLICTING_MUTABLE_PACKAGE_DIRECTORY = 15652;
	...
	public const uint ERROR_SINGLETON_RESOURCE_INSTALLED_IN_ACTIVE_USER = 15653;
	...
	public const uint ERROR_DIFFERENT_VERSION_OF_PACKAGED_SERVICE_INSTALLED = 15654;
	...
	public const uint ERROR_SERVICE_EXISTS_AS_NON_PACKAGED_SERVICE = 15655;
	...
	public const uint ERROR_PACKAGED_SERVICE_REQUIRES_ADMIN_PRIVILEGES = 15656;
	...
	public const uint APPMODEL_ERROR_PACKAGE_NOT_AVAILABLE = 15706;

	/// <summary>The package does not have a mutable directory.</summary>
	public const uint APPMODEL_ERROR_NO_MUTABLE_DIRECTORY = 15707;
	...
	public const uint NOT_APPCONTAINER = 4250;
	...
	public const uint ERROR_WINHTTP_BAD_AUTO_PROXY_SCRIPT = 12166;
	...
	public const uint ERROR_WINHTTP_CANNOT_CALL_AFTER_OPEN = 12103;
	...
	public const uint ERROR_WINHTTP_CANNOT_CALL_AFTER_SEND = 12102;
	...
	public const uint ERROR_WINHTTP_CANNOT_CALL_BEFORE_OPEN = 12100;
	...
	public const uint ERROR_WINHTTP_CANNOT_CALL_BEFORE_SEND = 12101;

	/// <summary>Returned if connection to the server failed.</summary>
	public const uint ERROR_WINHTTP_CANNOT_CONNECT = 12029;
	...
	/// <para>Windows Server 2003 with SP1 and Windows XP with SP2: This error is not supported.</para></summary>
	public const uint ERROR_WINHTTP_CLIENT_CERT_NO_ACCESS_PRIVATE_KEY = 12186;
	...
	/// <para>Windows Server 2003 with SP1 and Windows XP with SP2: This error is not supported.</para></summary>
	public const uint ERROR_WINHTTP_CLIENT_CERT_NO_PRIVATE_KEY = 12185;
	...
	public const uint ERROR_WINHTTP_CHUNKED_ENCODING_HEADER_SIZE_OVERFLOW = 12183;
	...
	public const uint ERROR_WINHTTP_HEADER_ALREADY_EXISTS = 12155;
	...
	public const uint ERROR_WINHTTP_HEADER_COUNT_EXCEEDED = 12181;
	...
	public const uint ERROR_WINHTTP_HEADER_SIZE_OVERFLOW = 12182;

	/// <summary>The requested operation cannot be carried out because the handle supplied is not in the correct state.</summary>
	public const uint ERROR_WINHTTP_INCORRECT_HANDLE_STATE = 12019;

	/// <summary>The type of handle supplied is incorrect for this operation.</summary>
	public const uint ERROR_WINHTTP_INCORRECT_HANDLE_TYPE = 12018;

	/// <summary>An internal error has occurred.</summary>
	public const uint ERROR_WINHTTP_INTERNAL_ERROR = 12004;
	...
	/// <summary>Obsolete; no longer used.</summary>
	public const uint ERROR_WINHTTP_INVALID_QUERY_REQUEST = 12154;

	/// <summary>The server response cannot be parsed.</summary>
	public const uint ERROR_WINHTTP_INVALID_SERVER_RESPONSE = 12152;

	/// <summary>The URL is not valid.</summary>
	public const uint ERROR_WINHTTP_INVALID_URL = 12005;
	...
	public const uint ERROR_WINHTTP_NAME_NOT_RESOLVED = 12007;

	/// <summary>Obsolete; no longer used.</summary>
	public const uint ERROR_WINHTTP_NOT_INITIALIZED = 12172;

	/// <summary>The operation was canceled, usually because the handle on which the request was operating was closed before the operation completed.</summary>
	public const uint ERROR_WINHTTP_OPERATION_CANCELLED = 12017;

	/// <summary>The requested option cannot be set, only queried.</summary>
	public const uint ERROR_WINHTTP_OPTION_NOT_SETTABLE = 12011;

	/// <summary>Obsolete; no longer used.</summary>
	public const uint ERROR_WINHTTP_OUT_OF_HANDLES = 12001;
	...
	public const uint ERROR_WINHTTP_REDIRECT_FAILED = 12156;
	...
	public const uint ERROR_WINHTTP_RESPONSE_DRAIN_OVERFLOW = 12184;

	/// <summary>An error was encountered while executing a script.</summary>
	public const uint ERROR_WINHTTP_SCRIPT_EXECUTION_ERROR = 12177;
	...
	public const uint ERROR_WINHTTP_SECURE_CERT_CN_INVALID = 12038;
	...
	public const uint ERROR_WINHTTP_SECURE_CERT_DATE_INVALID = 12037;
	...
	public const uint ERROR_WINHTTP_SECURE_CHANNEL_ERROR = 12157;
	...
	public const uint ERROR_WINHTTP_SECURE_INVALID_CA = 12045;
	...
	public const uint ERROR_WINHTTP_SECURE_INVALID_CERT = 12169;

	/// <summary>The WinHTTP function support is being shut down or unloaded.</summary>
	public const uint ERROR_WINHTTP_SHUTDOWN = 12012;
	...
	public const uint ERROR_WINHTTP_UNABLE_TO_DOWNLOAD_SCRIPT = 12167;

	/// <summary>The script type is not supported.</summary>
	public const uint ERROR_WINHTTP_UNHANDLED_SCRIPT_TYPE = 12176;
	...
	/// <summary>The Target Address type given is not supported.</summary>
	...
	/// <summary>The preshared key for the target or IKE identification payload is not available.</summary>
	public const uint ISDSC_TARGET_PRESHAREDKEY_UNAVAILABLE = 0xEFFF0027;

	/// <summary>The authentication information for the target is not available.</summary>
	...
	/// <summary>The IKE id payload type specified is not supported.</summary>
	public const uint ISDSC_IKE_ID_PAYLOAD_TYPE_NOT_SUPPORTED = 0xEFFF0030;

	/// <summary>The IKE id payload size specified is not correct.</summary>
	public const uint ISDSC_IKE_ID_PAYLOAD_INCORRECT_SIZE = 0xEFFF0031;

	/// <summary>Target Portal Structure Already Exists.</summary>
	public const uint ISDSC_TARGET_PORTAL_ALREADY_EXISTS = 0xEFFF0032;

	/// <summary>Target Address Structure Already Exists.</summary>
	...
	/// <summary>Failed to remove persistent login information.</summary>
	...
	/// <summary>Initiator CHAP secret given is invalid. Maximum size of CHAP secret is 16 bytes. Minimum size is 12 bytes if IPSec is not used.</summary>
	...
	/// <summary>The operation cannot be performed since it does not conform with the group policy assigned to this computer.</summary>
