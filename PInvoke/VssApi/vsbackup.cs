...
namespace Vanara.PInvoke.VssApi
{
	...
	/// object must not be reused. For example, you cannot perform a backup or restore operation with the same <c>IVssBackupComponents</c>
	/// object that you have already used for a <c>Query</c> operation.
	/// </para>
	/// </summary>
	...
	public interface IVssBackupComponents
	{
		...
		/// <para>
		/// <c>GetWriterComponents</c> retrieves component information for a component stored in the Backup Components Document by earlier
	...
	/// <summary>
	/// <para>
	/// The <c>IVssWriterComponentsExt</c> interface is a C++ (not COM) interface used by requesters to access and modify the components of
