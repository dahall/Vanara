...
public static partial class SetupAPI
{
	...
	public static extern bool SetupDiGetClassPropertyKeys(in Guid ClassGuid,
		[Out, Optional, MarshalAs(UnmanagedType.LPArray), SizeDef(nameof(PropertyKeyCount), SizingMethod.CheckLastError, OutVarName = nameof(RequiredPropertyKeyCount))] DEVPROPKEY[]? PropertyKeyArray,
	...
	public static extern bool SetupDiGetClassPropertyKeysEx(in Guid ClassGuid,
		[Out, Optional, MarshalAs(UnmanagedType.LPArray), SizeDef(nameof(PropertyKeyCount), SizingMethod.CheckLastError, OutVarName = nameof(RequiredPropertyKeyCount))] DEVPROPKEY[]? PropertyKeyArray, uint PropertyKeyCount,
	...
	public static extern bool SetupDiGetDeviceInterfacePropertyKeys(HDEVINFO DeviceInfoSet, in SP_DEVICE_INTERFACE_DATA DeviceInterfaceData,
		[Out, MarshalAs(UnmanagedType.LPArray), SizeDef(nameof(PropertyKeyCount), SizingMethod.CheckLastError, OutVarName = nameof(RequiredPropertyKeyCount))] DEVPROPKEY[]? PropertyKeyArray, uint PropertyKeyCount,
	...
	[return: MarshalAs(UnmanagedType.Bool)]
	public static extern bool SetupDiGetHwProfileList([Out, MarshalAs(UnmanagedType.LPArray), SizeDef(nameof(HwProfileListSize), SizingMethod.CheckLastError, OutVarName = nameof(RequiredSize))] uint[]? HwProfileList,
	...
	[return: MarshalAs(UnmanagedType.Bool)]
	public static extern bool SetupDiGetHwProfileListEx([Out, MarshalAs(UnmanagedType.LPArray), SizeDef(nameof(HwProfileListSize), SizingMethod.CheckLastError, OutVarName = nameof(RequiredSize))] uint[]? HwProfileList,
		uint HwProfileListSize, out uint RequiredSize, out uint CurrentlyActiveIndex,
		[Optional, MarshalAs(UnmanagedType.LPTStr)] string? MachineName, [In, Optional] IntPtr Reserved);
