...
public static partial class Msi
{
	...
	// szPatchPath, DWORD dwReserved, PSTR szXMLData, LPDWORD pcchXMLData );
	...
	// szProduct, LPCSTR szComponent, PSTR lpPathBuf, LPDWORD pcchBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// szProductCode, LPCSTR szComponentCode, LPCSTR szUserSid, MSIINSTALLCONTEXT dwContext, PSTR lpOutPathBuffer, LPDWORD
	// pcchOutPathBuffer );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// LPCWSTR szFeature, LPDWORD lpAttributes, PWSTR lpTitleBuf, LPDWORD pcchTitleBuf, PWSTR lpHelpBuf, LPDWORD pcchHelpBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// PSTR lpVersionBuf, LPDWORD pcchVersionBuf, PSTR lpLangBuf, LPDWORD pcchLangBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// szAttribute, PSTR lpValueBuf, LPDWORD pcchValueBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// LPCSTR szProductCode, LPCSTR szUserSid, MSIINSTALLCONTEXT dwContext, LPCSTR szProperty, PSTR lpValue, LPDWORD pcchValue );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// LPCSTR szAttribute, PSTR lpValueBuf, LPDWORD pcchValueBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// szProductCode, LPCSTR szUserSid, MSIINSTALLCONTEXT dwContext, LPCSTR szProperty, PSTR szValue, LPDWORD pcchValue );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// LPCSTR szScriptFile, PSTR lpProductBuf39, LANGID *plgidLanguage, LPDWORD pdwVersion, PSTR lpNameBuf, LPDWORD pcchNameBuf, PSTR
	...
	// hProduct, LPCSTR szProperty, PSTR lpValueBuf, LPDWORD pcchValueBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// szShortcutPath, PSTR szProductCode, PSTR szFeatureId, PSTR szComponentCode );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// PSTR lpUserNameBuf, LPDWORD pcchUserNameBuf, PSTR lpOrgNameBuf, LPDWORD pcchOrgNameBuf, PSTR lpSerialBuf, LPDWORD
	// pcchSerialBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// szComponent, PSTR lpPathBuf, LPDWORD pcchBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// szAssemblyName, LPCSTR szAppContext, DWORD dwInstallMode, DWORD dwAssemblyInfo, PSTR lpPathBuf, LPDWORD pcchPathBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// LPCSTR szFeature, LPCSTR szComponent, DWORD dwInstallMode, PSTR lpPathBuf, LPDWORD pcchPathBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// LPCSTR szCategory, LPCSTR szQualifier, DWORD dwInstallMode, PSTR lpPathBuf, LPDWORD pcchPathBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// DWORD dwUnused2, PSTR lpPathBuf, LPDWORD pcchPathBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// pdwDiskId, PSTR szVolumeLabel, LPDWORD pcchVolumeLabel, PSTR szDiskPrompt, LPDWORD pcchDiskPrompt );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// szProductCodeOrPatchCode, LPCSTR szUserSid, MSIINSTALLCONTEXT dwContext, DWORD dwOptions, DWORD dwIndex, PSTR szSource, LPDWORD
	// pcchSource );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// szProductCodeOrPatchCode, LPCSTR szUserSid, MSIINSTALLCONTEXT dwContext, DWORD dwOptions, LPCSTR szProperty, PSTR szValue,
	// LPDWORD pcchValue );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
