...
public static partial class Msi
{
	...
	// iProductIndex, PSTR lpProductBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// LPCSTR szUserSid, DWORD dwContext, DWORD dwProductIndex, CHAR [39] szProductBuf, MSIINSTALLCONTEXT *pdwInstalledContext, PSTR
	...
	// LPCSTR szComponent, DWORD iIndex, PSTR lpQualifierBuf, LPDWORD pcchQualifierBuf, PSTR lpApplicationDataBuf, LPDWORD
	...
	// DWORD dwContext, DWORD dwIndex, CHAR [39] szInstalledComponentCode, MSIINSTALLCONTEXT *pdwInstalledContext, PSTR szSid, LPDWORD
	// pcchSid );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// iFeatureIndex, PSTR lpFeatureBuf, PSTR lpParentBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// iPatchIndex, PSTR lpPatchBuf, PSTR lpTransformsBuf, LPDWORD pcchTransformsBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// MSIINSTALLCONTEXT *pdwTargetProductContext, PSTR szTargetUserSid, LPDWORD pcchTargetUserSid );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/api/msi/nf-msi-msienumproductsa UINT MsiEnumProductsA( DWORD iProductIndex, PSTR
	// lpProductBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// LPCSTR szUserSid, DWORD dwContext, DWORD dwIndex, CHAR [39] szInstalledProductCode, MSIINSTALLCONTEXT *pdwInstalledContext, PSTR
	// szSid, LPDWORD pcchSid );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// lpUpgradeCode, DWORD dwReserved, DWORD iProductIndex, PSTR lpProductBuf );
	[DllImport(Lib_Msi, SetLastError = false, CharSet = CharSet.Auto)]
