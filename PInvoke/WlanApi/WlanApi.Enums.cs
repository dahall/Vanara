...
public static partial class WlanApi
{
	...
	public enum DOT11_PHY_TYPE : uint
	{
		...
		/// <summary>Specifies a Directional Multi-Gigabit (DMG) 802.11ad PHY.</summary>
		dot11_phy_type_dmg,

		/// <summary>Specifies a High Efficiency (HE) 802.11ax PHY.</summary>
		dot11_phy_type_he,

		/// <summary>Specifies an extremely high-throughput (EHT) 802.11be PHY.</summary>
		dot11_phy_type_eht,
