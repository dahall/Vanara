...
namespace Vanara.PInvoke
{
	public static partial class OleAut32
	{
		...
		public static Dictionary<WIA_PROPID, string> WIA_PROPID_TO_NAME = new Dictionary<WIA_PROPID, string>
		{
			...
			{ WIA_PROPID.WIA_IPA_MIN_BUFFER_SIZE                              , "Buffer Size" },
			...
			{ WIA_PROPID.WIA_IPS_SHEET_FEEDER_REGISTRATION                    , "Sheet Feeder Registration" },
			{ WIA_PROPID.WIA_IPS_DOCUMENT_HANDLING_SELECT                     , "Document Handling Select" },
			{ WIA_PROPID.WIA_IPS_OPTICAL_XRES                                 , "Horizontal Optical Resolution" },
			{ WIA_PROPID.WIA_IPS_OPTICAL_YRES                                 , "Vertical Optical Resolution" },
			{ WIA_PROPID.WIA_IPS_PAGES                                        , "Pages" },
			{ WIA_PROPID.WIA_IPS_PAGE_SIZE                                    , "Page Size" },
			{ WIA_PROPID.WIA_IPS_PAGE_WIDTH                                   , "Page Width" },
			{ WIA_PROPID.WIA_IPS_PAGE_HEIGHT                                  , "Page Height" },
			{ WIA_PROPID.WIA_IPS_PREVIEW                                      , "Preview" },
			{ WIA_PROPID.WIA_IPS_SHOW_PREVIEW_CONTROL                         , "Show preview control" },
			{ WIA_PROPID.WIA_IPS_FILM_SCAN_MODE                               , "Film Scan Mode" },
			{ WIA_PROPID.WIA_IPS_LAMP                                         , "Lamp" },
			{ WIA_PROPID.WIA_IPS_LAMP_AUTO_OFF                                , "Lamp Auto Off" },
			{ WIA_PROPID.WIA_IPS_AUTO_DESKEW                                  , "Automatic Deskew" },
