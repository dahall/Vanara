...
public static partial class Ole32
{
	...
	public interface IAccessControl
	{
		...
		// RevokeAccessRights( PWSTR lpProperty, ULONG cTrustees, TRUSTEEW [] prgTrustees );
		[PreserveSig]
		...
		// GetAllAccessRights( PWSTR lpProperty, PACTRL_ACCESSW_ALLOCATE_ALL_NODES *ppAccessList, PTRUSTEEW *ppOwner, PTRUSTEEW
		// *ppGroup );
		[PreserveSig]
		...
		// PTRUSTEEW pTrustee, PWSTR lpProperty, ACCESS_RIGHTS AccessRights, BOOL *pfAccessAllowed );
		[PreserveSig]
