...
public static partial class Ole32
{
	...
	/// <para>
	/// SHCOLUMNID can be considered a legacy structure with PROPERTYKEY being the new, preferred form. <c>PROPERTYKEY</c> has a broader
	/// purpose than <c>SHCOLUMNID</c>, and the new name is more descriptive of its uses.
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/api/wtypes/ns-wtypes-propertykey typedef struct _tagpropertykey { GUID fmtid; DWORD
	// pid; } PROPERTYKEY;
	...
	public partial struct PROPERTYKEY : IComparable<PROPERTYKEY>, IEquatable<PROPERTYKEY>
	{
		...
		/// <summary>Gets the canonical name of the key.</summary>
		/// <returns>The name returned from PSGetNameFromPropertyKey.</returns>
		public readonly string? GetCanonicalName()
		{
			PROPERTYKEY pk = this;
			return PropSys.PSGetNameFromPropertyKey(pk, out string? str).Succeeded ? str : null;
		}
		...
		public static class System
		{
			...
			public static PROPERTYKEY AcquisitionID
				=> new(new Guid("{65A98875-3C80-40AB-ABBC-EFDAF77DBEE2}"), 100);
			...
			/// <para>
			/// Description: The list of type of items, this item contains. For example, this item contains urls, attachments etc. This is
			/// represented as a vector array of GUIDs where each GUID represents certain type.
			/// </para>
			...
			public static PROPERTYKEY Copyright
				=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 11);
			...
			/// <para>
			/// Description: The time the file entered the system via acquisition. This is not the same as System.DateImported. Examples are
			/// when pictures are acquired from a camera, or when music is purchased online.
			/// </para>
			/// <para>Type:     DateTime -- VT_FILETIME (For variants: VT_DATE)</para>
			/// <para>FormatID: {2CBAA8F5-D81F-47CA-B17A-F8D822300131}, 100</para>
			/// </summary>
			public static PROPERTYKEY DateAcquired
				=> new(new Guid("{2CBAA8F5-D81F-47CA-B17A-F8D822300131}"), 100);
			...
			public static PROPERTYKEY DateArchived
				=> new(new Guid("{43F8D7B7-A444-4F87-9383-52271C9B915C}"), 100);
			...
			public static PROPERTYKEY DateCompleted
				=> new(new Guid("{72FAB781-ACDA-43E5-B155-B2434F85E678}"), 100);
			...
			public static PROPERTYKEY DueDate
				=> new(new Guid("{3F8472B5-E0AF-4DB2-8071-C53FE76AE7CE}"), 100);
			...
			public static PROPERTYKEY EndDate
				=> new(new Guid("{C75FAA05-96FD-49E7-9CB4-9F601082D553}"), 100);
			...
			public static PROPERTYKEY FileDescription
				=> new(new Guid("{0CEF7D53-FA64-11D1-A203-0000F81FEDEE}"), 3);

			/// <summary>
			/// <para>Name:     System.FileExtension -- PKEY_FileExtension</para>
			/// <para>
			/// Description: This is the file extension of the file based item, including the leading period. If System.FileName is VT_EMPTY,
			/// then this property should be too. Otherwise, it should be derived appropriately by the data source from System.FileName. If
			/// System.FileName does not have a file extension, this value should be VT_EMPTY. To obtain the type of any item (including an
			/// item that is not a file), use System.ItemType. Example values: If the path is... The property value is...
			...
			public static PROPERTYKEY FileExtension
				=> new(new Guid("{E4F10A3C-49E6-405D-8288-A23BD4EEAA6C}"), 100);

			/// <summary>
			/// <para>Name:     System.FileFRN -- PKEY_FileFRN</para>
			/// <para>
			/// Description: This is the unique file ID, also known as the File Reference Number. For a given file, this is the same value as
			/// is found in the structure variable FILE_ID_BOTH_DIR_INFO.FileId, via GetFileInformationByHandleEx().
			/// </para>
			/// <para>Type:     UInt64 -- VT_UI8</para>
			...
			/// filesystem (ie, it may not be opened using CreateFile). Nonetheless, if the item is represented as a file from the logical
			/// sense (and its name follows standard Win32 file-naming syntax), then the data source should emit this property. If an item is
			/// not a file, then the value for this property is VT_EMPTY. See System.ItemNameDisplay. This has the same value as
			/// System.ParsingName for items that are provided by the Shell's file folder. Example values: If the path is... The property
			/// value is...
			/// -----------------                     ------------------------ "c:\foo\bar\hello.txt" "hello.txt"
			/// "\\server\share\mydir\goodnews.doc" "goodnews.doc" "\\server\share\numbers.xls" "numbers.xls" "c:\foo\MyFolder" "MyFolder"
			/// (email message) VT_EMPTY (song on portable device) "song.wma"
			/// </para>
			/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
			/// <para>FormatID: {41CF5AE0-F75A-4806-BD87-59C7D9248EB9}, 100</para>
			/// </summary>
			public static PROPERTYKEY FileName
				=> new(new Guid("{41CF5AE0-F75A-4806-BD87-59C7D9248EB9}"), 100);
			...
			public static PROPERTYKEY FileVersion
				=> new(new Guid("{0CEF7D53-FA64-11D1-A203-0000F81FEDEE}"), 4);
			...
			public static PROPERTYKEY FlagColor
				=> new(new Guid("{67DF94DE-0CA7-4D6F-B792-053A3E4F03CF}"), 100);

			/// <summary>
			/// <para>Name:     System.FlagColorText -- PKEY_FlagColorText</para>
			/// <para>Description: This is the user-friendly form of System.FlagColor. Not intended to be parsed programmatically.</para>
			/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
			/// <para>FormatID: {45EAE747-8E2A-40AE-8CBF-CA52ABA6152A}, 100</para>
			/// </summary>
			public static PROPERTYKEY FlagColorText
				=> new(new Guid("{45EAE747-8E2A-40AE-8CBF-CA52ABA6152A}"), 100);
			...
			public static PROPERTYKEY FlagStatus
				=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 12);

			/// <summary>
			/// <para>Name:     System.FlagStatusText -- PKEY_FlagStatusText</para>
			/// <para>Description: This is the user-friendly form of System.FlagStatus. Not intended to be parsed programmatically.</para>
			/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
			/// <para>FormatID: {DC54FD2E-189D-4871-AA01-08C2F57A4ABC}, 100</para>
			/// </summary>
			public static PROPERTYKEY FlagStatusText
				=> new(new Guid("{DC54FD2E-189D-4871-AA01-08C2F57A4ABC}"), 100);
			...
			public static PROPERTYKEY FullText
				=> new(new Guid("{1E3EE840-BC2B-476C-8237-2ACD1A839B22}"), 6);
			...
			public static PROPERTYKEY IdentityProperty
				=> new(new Guid("{A26F4AFC-7346-4299-BE47-EB1AE613139F}"), 100);
			...
			public static PROPERTYKEY ImageParsingName
				=> new(new Guid("{D7750EE0-C6A4-48EC-B53E-B87B52E6D073}"), 100);
			...
			public static PROPERTYKEY Importance
				=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 11);

			/// <summary>
			/// <para>Name:     System.ImportanceText -- PKEY_ImportanceText</para>
			/// <para>Description: This is the user-friendly form of System.Importance. Not intended to be parsed programmatically.</para>
			/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
			/// <para>FormatID: {A3B29791-7713-4E1D-BB40-17DB85F01831}, 100</para>
			/// </summary>
			public static PROPERTYKEY ImportanceText
				=> new(new Guid("{A3B29791-7713-4E1D-BB40-17DB85F01831}"), 100);
			...
			public static PROPERTYKEY InfoTipText
				=> new(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 17);
			...
			public static PROPERTYKEY InternalName
				=> new(new Guid("{0CEF7D53-FA64-11D1-A203-0000F81FEDEE}"), 5);
			...
			public static PROPERTYKEY IsAttachment
				=> new(new Guid("{F23F425C-71A1-4FA8-922F-678EA4A60408}"), 100);
			...
			public static PROPERTYKEY IsDefaultNonOwnerSaveLocation
				=> new(new Guid("{5D76B67F-9B3D-44BB-B6AE-25DA4F638A67}"), 5);
			...
			public static PROPERTYKEY IsDefaultSaveLocation
				=> new(new Guid("{5D76B67F-9B3D-44BB-B6AE-25DA4F638A67}"), 3);
			...
			public static PROPERTYKEY IsEncrypted
				=> new(new Guid("{90E5E14E-648B-4826-B2AA-ACAF790E3513}"), 10);
			...
			public static PROPERTYKEY IsFlagged
				=> new(new Guid("{5DA84765-E3FF-4278-86B0-A27967FBDD03}"), 100);
			...
			public static PROPERTYKEY IsFlaggedComplete
				=> new(new Guid("{A6F360D2-55F9-48DE-B909-620E090A647C}"), 100);
			...
			public static PROPERTYKEY IsIncomplete
				=> new(new Guid("{346C8BD1-2E6A-4C45-89A4-61B78E8E700F}"), 100);
			...
			public static PROPERTYKEY IsLocationSupported
				=> new(new Guid("{5D76B67F-9B3D-44BB-B6AE-25DA4F638A67}"), 8);
			...
			public static PROPERTYKEY IsPinnedToNameSpaceTree
				=> new(new Guid("{5D76B67F-9B3D-44BB-B6AE-25DA4F638A67}"), 2);
			...
			public static PROPERTYKEY IsRead
				=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 10);
			...
			public static PROPERTYKEY IsSearchOnlyItem
				=> new(new Guid("{5D76B67F-9B3D-44BB-B6AE-25DA4F638A67}"), 4);
			...
			public static PROPERTYKEY IsShared
				=> new(new Guid("{EF884C5B-2BFE-41BB-AAE5-76EEDF4F9902}"), 100);
			...
			public static PROPERTYKEY ItemAuthors
				=> new(new Guid("{D0A04F0A-462A-48A4-BB2F-3706E88DBD7D}"), 100);
			...
			public static PROPERTYKEY ItemClassType
				=> new(new Guid("{048658AD-2DB8-41A4-BBB6-AC1EF1207EB1}"), 100);

			/// <summary>
			/// <para>Name:     System.ItemDate -- PKEY_ItemDate</para>
			/// <para>Description: This is the main date for an item. The date of interest. For example, for photos this maps to System.Photo.DateTaken.</para>
			/// <para>Type:     DateTime -- VT_FILETIME (For variants: VT_DATE)</para>
			/// <para>FormatID: {F7DB74B4-4287-4103-AFBA-F1B13DCD75CF}, 100</para>
			/// </summary>
			public static PROPERTYKEY ItemDate
				=> new(new Guid("{F7DB74B4-4287-4103-AFBA-F1B13DCD75CF}"), 100);
			...
			/// System.ItemFolderPathDisplay. If the folder is a file folder, the value will be localized if a localized name is available.
			...
			/// <para>
			/// Description: This is the user-friendly display path of the parent folder of an item. If System.ItemPathDisplay is VT_EMPTY,
			/// then this property should be too. Otherwise, it should be derived appropriately by the data source from
			/// System.ItemPathDisplay. Example values: If the path is... The property value is...
			/// -----------------                     ------------------------ "c:\foo\bar\hello.txt" "c:\foo\bar"
			/// "\\server\share\mydir\goodnews.doc" "\\server\share\mydir" "\\server\share\numbers.xls" "\\server\share" "c:\foo\MyFolder"
			/// "c:\foo" "/Mailbox Account/Inbox/'Re: Hello!'" "/Mailbox Account/Inbox"
			/// </para>
			/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
			/// <para>FormatID: {E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}, 6</para>
			/// </summary>
			public static PROPERTYKEY ItemFolderPathDisplay
				=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 6);
			...
			/// tailored such that the folder name comes first, to optimize for a narrow viewing column. If the folder is a file folder, the
			/// value includes localized names if they are present. If System.ItemFolderPathDisplay is VT_EMPTY, then this property should be
			/// too. Otherwise, it should be derived appropriately by the data source from System.ItemFolderPathDisplay. Example values: If
			/// the path is... The property value is...
			...
			public static PROPERTYKEY ItemFolderPathDisplayNarrow
				=> new(new Guid("{DABD30ED-0043-4789-A7F8-D013A4736622}"), 100);

			/// <summary>
			/// <para>Name:     System.ItemName -- PKEY_ItemName</para>
			/// <para>
			/// Description: This is the base-name of the System.ItemNameDisplay. If the item is a file this property includes the extension
			/// in all cases, and will be localized if a localized name is available. If the item is a message, then the value of this
			/// property does not include the forwarding or reply prefixes (see System.ItemNamePrefix).
			/// </para>
			/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
			/// <para>FormatID: {6B8DA074-3B5C-43BC-886F-0A2CDCE00B6F}, 100</para>
			/// </summary>
			public static PROPERTYKEY ItemName
				=> new(new Guid("{6B8DA074-3B5C-43BC-886F-0A2CDCE00B6F}"), 100);

			/// <summary>
			/// <para>Name:     System.ItemNameDisplay -- PKEY_ItemNameDisplay</para>
			/// <para>
			/// Description: This is the display name in "most complete" form. This is the best effort unique representation of the name of
			/// an item that makes sense for end users to read. It is the concatentation of System.ItemNamePrefix and System.ItemName. If the
			/// item is a file this property includes the extension in all cases, and will be localized if a localized name is available.
			/// There are acceptable cases when System.FileName is not VT_EMPTY, yet the value of this property is completely different.
			/// Email messages are a key example. If the item is an email message, the item name is likely the subject. In that case, the
			/// value must be the concatenation of the System.ItemNamePrefix and System.ItemName. Since the value of System.ItemNamePrefix
			/// excludes any trailing whitespace, the concatenation must include a whitespace when generating System.ItemNameDisplay. Note
			/// that this property is not guaranteed to be unique, but the idea is to promote the most likely candidate that can be unique
			/// and also makes sense for end users. For example, for documents, you might think about using System.Title as the
			/// System.ItemNameDisplay, but in practice the title of the documents may not be useful or unique enough to be of value as the
			/// sole System.ItemNameDisplay. Instead, providing the value of System.FileName as the value of System.ItemNameDisplay is a
			/// better candidate. In Windows Mail, the emails are stored in the file system as .eml files and the System.FileName for those
			/// files are not human-friendly as they contain GUIDs. In this example, promoting System.Subject as System.ItemNameDisplay makes
			/// more sense. Compatibility notes: Shell folder implementations on Vista: use PKEY_ItemNameDisplay for the name column when you
			/// want Explorer to call ISF::GetDisplayNameOf(SHGDN_NORMAL) to get the value of the name. Use another PKEY (like PKEY_ItemName)
			/// when you want Explorer to call either the folder's property store or ISF2::GetDetailsEx in order to get the value of the
			/// name. Shell folder implementations on XP: the first column needs to be the name column, and Explorer will call
			/// ISF::GetDisplayNameOf to get the value of the name. The PKEY/SCID does not matter. Example values:
			/// File:          "hello.txt"
			...
			/// If the item is a file, then the value of this property is VT_EMPTY. If the item is a message, then the value of this property
			/// is the forwarding or reply prefixes (including delimiting colon, but no whitespace), or VT_EMPTY if there is no prefix.
			/// Example values: System.ItemNamePrefix System.ItemName System.ItemNameDisplay
			/// ---------------------    ------------------- ---------------------- VT_EMPTY "Great day" "Great day" "Re:" "Great day" "Re:
			/// Great day" "Fwd: " "Monthly budget" "Fwd: Monthly budget" VT_EMPTY "accounts.xls" "accounts.xls"
			/// </para>
			/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
			/// <para>FormatID: {D7313FF1-A77A-401C-8C99-3DBDD68ADD36}, 100</para>
			/// </summary>
			public static PROPERTYKEY ItemNamePrefix
				=> new(new Guid("{D7313FF1-A77A-401C-8C99-3DBDD68ADD36}"), 100);

			/// <summary>
			/// <para>Name:     System.ItemParticipants -- PKEY_ItemParticipants</para>
			/// <para>
			/// Description: This is the generic list of people associated with an item and who contributed to the item. For example, this is
			/// the combination of people in the To list, Cc list and sender of an email message.
			/// </para>
			/// <para>Type:     Multivalue String -- VT_VECTOR | VT_LPWSTR (For variants: VT_ARRAY | VT_BSTR)</para>
			/// <para>FormatID: {D4D0AA16-9948-41A4-AA85-D97FF9646993}, 100</para>
			/// </summary>
			public static PROPERTYKEY ItemParticipants
				=> new(new Guid("{D4D0AA16-9948-41A4-AA85-D97FF9646993}"), 100);

			/// <summary>
			/// <para>Name:     System.ItemPathDisplay -- PKEY_ItemPathDisplay</para>
			/// <para>
			/// Description: This is the user-friendly display path to the item. If the item is a file or folder this property includes the
			/// extension in all cases, and will be localized if a localized name is available. For other items,this is the user-friendly
			/// equivalent, assuming the item exists in hierarchical storage. Unlike System.ItemUrl, this property value does not include the
			/// URL scheme. To parse an item path, use System.ItemUrl or System.ParsingPath. To reference shell namespace items using shell
			/// APIs, use System.ParsingPath. Example values: If the path is... The property value is...
			...
			public static PROPERTYKEY ItemPathDisplay
				=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 7);

			/// <summary>
			/// <para>Name:     System.ItemPathDisplayNarrow -- PKEY_ItemPathDisplayNarrow</para>
			/// <para>
			/// Description: This is the user-friendly display path to the item. The format of the string should be tailored such that the
			/// name comes first, to optimize for a narrow viewing column. If the item is a file, the value excludes the file extension, and
			/// includes localized names if they are present. If the item is a message, the value includes the System.ItemNamePrefix. To
			/// parse an item path, use System.ItemUrl or System.ParsingPath. Example values: If the path is... The property value is...
			...
			/// <para>
			/// Description: This is the canonical type of the item and is intended to be programmatically parsed. If there is no canonical
			/// type, the value is VT_EMPTY. If the item is a file (ie, System.FileName is not VT_EMPTY), the value is the same as
			/// System.FileExtension. Use System.ItemTypeText when you want to display the type to end users in a view. (If the item is a
			/// file, passing the System.ItemType value to PSFormatForDisplay will result in the same value as System.ItemTypeText.) Example
			...
			/// System.ItemType is VT_EMPTY, the value of this property is also VT_EMPTY. If the item is a file, the value of this property
			/// is the same as if you passed the file's System.ItemType value to PSFormatForDisplay. This property should not be confused
			/// with System.Kind, where System.Kind is a high-level user friendly kind name. For example, for a document, System.Kind =
			/// "Document" and System.Item.Type = ".doc" and System.Item.TypeText = "Microsoft Word Document" Example
			/// values: If the path is... The property value is...
			/// -----------------                     ------------------------ "c:\foo\bar\hello.txt" "Text File"
			/// "\\server\share\mydir\goodnews.doc" "Microsoft Word Document" "\\server\share\folder" "File Folder" "c:\foo\MyFolder" "File
			/// Folder" "/Mailbox Account/Inbox/'Re: Hello!'" "Outlook E-Mail Message"
			/// </para>
			/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
			...
			/// <para>
			/// Description: This always represents a well formed URL that points to the item. To reference shell namespace items using shell
			/// APIs, use System.ParsingPath. Example values:
			...
			public static PROPERTYKEY Kind
				=> new(new Guid("{1E3EE840-BC2B-476C-8237-2ACD1A839B22}"), 3);

			/// <summary>
			/// <para>Name:     System.KindText -- PKEY_KindText</para>
			/// <para>Description: This is the user-friendly form of System.Kind. Not intended to be parsed programmatically.</para>
			/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
			/// <para>FormatID: {F04BEF95-C585-4197-A2B7-DF46FDC9EE6D}, 100</para>
			/// </summary>
			public static PROPERTYKEY KindText
				=> new(new Guid("{F04BEF95-C585-4197-A2B7-DF46FDC9EE6D}"), 100);
			...
			public static PROPERTYKEY MileageInformation
				=> new(new Guid("{FDF84370-031A-4ADD-9E91-0D775F1C6605}"), 100);
			...
			public static PROPERTYKEY MIMEType
				=> new(new Guid("{0B63E350-9CCC-11D0-BCDB-00805FCCCE04}"), 5);

			/// <summary>
			/// <para>Name:     System.NamespaceCLSID -- PKEY_NamespaceCLSID</para>
			/// <para>Description: The CLSID of the name space extension for an item, the object that implements IShellFolder for this item</para>
			...
			public static PROPERTYKEY Null
				=> new(new Guid("{00000000-0000-0000-0000-000000000000}"), 0);
			...
			public static PROPERTYKEY OfflineAvailability
				=> new(new Guid("{A94688B6-7D9F-4570-A648-E3DFC0AB2B3F}"), 100);
			...
			public static PROPERTYKEY OfflineStatus
				=> new(new Guid("{6D24888F-4718-4BDA-AFED-EA0FB4386CD8}"), 100);
			...
			public static PROPERTYKEY OriginalFileName
				=> new(new Guid("{0CEF7D53-FA64-11D1-A203-0000F81FEDEE}"), 6);
			...
			public static PROPERTYKEY OwnerSID
				=> new(new Guid("{5D76B67F-9B3D-44BB-B6AE-25DA4F638A67}"), 6);
			...
			public static PROPERTYKEY ParentalRating
				=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 21);
			...
			public static PROPERTYKEY ParentalRatingReason
				=> new(new Guid("{10984E0A-F9F2-4321-B7EF-BAF195AF4319}"), 100);
			...
			public static PROPERTYKEY ParentalRatingsOrganization
				=> new(new Guid("{A7FE0840-1344-46F0-8D37-52ED712A4BF9}"), 100);
			...
			public static PROPERTYKEY ParsingBindContext
				=> new(new Guid("{DFB9A04D-362F-4CA3-B30B-0254B17B5B84}"), 100);
			...
			/// <para>
			/// Description: This is the shell namespace path to the item. This path may be passed to SHParseDisplayName to parse the path to
			/// the correct shell folder. If the item is a file, the value is identical to System.ItemPathDisplay. If the item cannot be
			/// accessed through the shell namespace, this value is VT_EMPTY.
			/// </para>
			/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
			...
			public static PROPERTYKEY Priority
				=> new(new Guid("{9C1FCF74-2D97-41BA-B4AE-CB2E3661A6E4}"), 5);

			/// <summary>
			/// <para>Name:     System.PriorityText -- PKEY_PriorityText</para>
			/// <para>Description: This is the user-friendly form of System.Priority. Not intended to be parsed programmatically.</para>
			/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
			/// <para>FormatID: {D98BE98B-B86B-4095-BF52-9D23B2E0A752}, 100</para>
			/// </summary>
			public static PROPERTYKEY PriorityText
				=> new(new Guid("{D98BE98B-B86B-4095-BF52-9D23B2E0A752}"), 100);
			...
			public static PROPERTYKEY Project
				=> new(new Guid("{39A7F922-477C-48DE-8BC8-B28441E342E3}"), 100);
			...
			public static PROPERTYKEY ProviderItemID
				=> new(new Guid("{F21D9941-81F0-471A-ADEE-4E74B49217ED}"), 100);

			/// <summary>
			/// <para>Name:     System.Rating -- PKEY_Rating</para>
			/// <para>
			/// Description: Indicates the users preference rating of an item on a scale of 1-99 (1-12 = One Star, 13-37 = Two Stars, 38-62 =
			/// Three Stars, 63-87 = Four Stars, 88-99 = Five Stars).
			/// </para>
			/// <para>Type:     UInt32 -- VT_UI4</para>
			...
			public static PROPERTYKEY Rating
				=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 9);

			/// <summary>
			/// <para>Name:     System.RatingText -- PKEY_RatingText</para>
			/// <para>Description: This is the user-friendly form of System.Rating. Not intended to be parsed programmatically.</para>
			/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
			...
			public static PROPERTYKEY Sensitivity
				=> new(new Guid("{F8D3F6AC-4874-42CB-BE59-AB454B30716A}"), 100);

			/// <summary>
			/// <para>Name:     System.SensitivityText -- PKEY_SensitivityText</para>
			/// <para>Description: This is the user-friendly form of System.Sensitivity. Not intended to be parsed programmatically.</para>
			/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
			/// <para>FormatID: {D0C7F054-3F72-4725-8527-129A577CB269}, 100</para>
			/// </summary>
			public static PROPERTYKEY SensitivityText
				=> new(new Guid("{D0C7F054-3F72-4725-8527-129A577CB269}"), 100);
			...
			public static PROPERTYKEY SharedWith
				=> new(new Guid("{EF884C5B-2BFE-41BB-AAE5-76EEDF4F9902}"), 200);
			...
			public static PROPERTYKEY ShareUserRating
				=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 12);
			...
			public static PROPERTYKEY SharingStatus
				=> new(new Guid("{EF884C5B-2BFE-41BB-AAE5-76EEDF4F9902}"), 300);

			/// <summary>
			/// <para>Name:     System.SimpleRating -- PKEY_SimpleRating</para>
			/// <para>
			/// Description: Indicates the users preference rating of an item on a scale of 0-5 (0=unrated, 1=One Star, 2=Two Stars, 3=Three
			/// Stars, 4=Four Stars, 5=Five Stars)
			/// </para>
			/// <para>Type:     UInt32 -- VT_UI4</para>
			/// <para>FormatID: {A09F084E-AD41-489F-8076-AA5BE3082BCA}, 100</para>
			/// </summary>
			public static PROPERTYKEY SimpleRating
				=> new(new Guid("{A09F084E-AD41-489F-8076-AA5BE3082BCA}"), 100);
			...
			public static PROPERTYKEY SourceItem
				=> new(new Guid("{668CDFA5-7A1B-4323-AE4B-E527393A1D81}"), 100);
			...
			public static PROPERTYKEY StartDate
				=> new(new Guid("{48FD6EC8-8A12-4CDF-A03E-4EC5A511EDDE}"), 100);
			...
			public static PROPERTYKEY Status
				=> new(new Guid("{000214A1-0000-0000-C000-000000000046}"), 9);
			...
			public static PROPERTYKEY SyncTransferStatus
				=> new(new Guid(0xFCEFF153, 0xE839, 0x4CF3, 0xA9, 0xE7, 0xEA, 0x22, 0x83, 0x20, 0x94, 0xB8), 103);
			...
			public static PROPERTYKEY ThumbnailCacheId
				=> new(new Guid("{446D16B1-8DAD-4870-A748-402EA43D788C}"), 100);

			/// <summary>
			/// <para>Name:     System.ThumbnailStream -- PKEY_ThumbnailStream</para>
			/// <para>Description: Data that represents the thumbnail in VT_STREAM format that GDI+/WindowsCodecs supports (jpg, png, etc).</para>
			...
			public static PROPERTYKEY Trademarks
				=> new(new Guid("{0CEF7D53-FA64-11D1-A203-0000F81FEDEE}"), 9);
			...
			public static class AppUserModel
			{
				...
				public static PROPERTYKEY IsDestListSeparator
					=> new(new Guid("{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}"), 6);
				...
				public static PROPERTYKEY IsDualMode
					=> new(new Guid("{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}"), 11);
				...
				public static PROPERTYKEY PreventPinning
					=> new(new Guid("{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}"), 9);
				...
				public static PROPERTYKEY StartPinOption
					=> new(new Guid(0x9F4C2855, 0x9F79, 0x4B39, 0xA8, 0xD0, 0xE1, 0xD4, 0x2D, 0xE1, 0xD5, 0xF3), 12);
				...
				public static PROPERTYKEY ToastActivatorCLSID
					=> new(new Guid(0x9F4C2855, 0x9F79, 0x4B39, 0xA8, 0xD0, 0xE1, 0xD4, 0x2D, 0xE1, 0xD5, 0xF3), 26);
				...
				public static PROPERTYKEY VisualElementsManifestHintPath
					=> new(new Guid(0x9F4C2855, 0x9F79, 0x4B39, 0xA8, 0xD0, 0xE1, 0xD4, 0x2D, 0xE1, 0xD5, 0xF3), 31);
			}
			...
			public static class Audio
			{
				...
				public static PROPERTYKEY IsVariableBitRate
					=> new(new Guid("{E6822FEE-8C17-4D62-823C-8E9CFCBD1D5C}"), 100);
				...
				public static PROPERTYKEY PeakValue
					=> new(new Guid("{2579E5D0-1116-4084-BD9A-9B4F7CB4DF5E}"), 100);
			...
			public static class Calendar
			{
				...
				public static PROPERTYKEY Duration
					=> new(new Guid("{293CA35A-09AA-4DD2-B180-1FE245728A52}"), 100);
				...
				public static PROPERTYKEY IsOnline
					=> new(new Guid("{BFEE9149-E3E2-49A7-A862-C05988145CEC}"), 100);
				...
				public static PROPERTYKEY IsRecurring
					=> new(new Guid("{315B9C8D-80A9-4EF9-AE16-8E746DA51D70}"), 100);
				...
				public static PROPERTYKEY Location
					=> new(new Guid("{F6272D18-CECC-40B1-B26A-3911717AA7BD}"), 100);
				...
				public static PROPERTYKEY OptionalAttendeeAddresses
					=> new(new Guid("{D55BAE5A-3892-417A-A649-C6AC5AAAEAB3}"), 100);
				...
				public static PROPERTYKEY OptionalAttendeeNames
					=> new(new Guid("{09429607-582D-437F-84C3-DE93A2B24C3C}"), 100);
				...
				public static PROPERTYKEY OrganizerAddress
					=> new(new Guid("{744C8242-4DF5-456C-AB9E-014EFB9021E3}"), 100);
				...
				public static PROPERTYKEY OrganizerName
					=> new(new Guid("{AAA660F9-9865-458E-B484-01BC7FE3973E}"), 100);
				...
				public static PROPERTYKEY ReminderTime
					=> new(new Guid("{72FC5BA4-24F9-4011-9F3F-ADD27AFAD818}"), 100);
				...
				public static PROPERTYKEY RequiredAttendeeAddresses
					=> new(new Guid("{0BA7D6C3-568D-4159-AB91-781A91FB71E5}"), 100);
				...
				public static PROPERTYKEY RequiredAttendeeNames
					=> new(new Guid("{B33AF30B-F552-4584-936C-CB93E5CDA29F}"), 100);
				...
				public static PROPERTYKEY Resources
					=> new(new Guid("{00F58A38-C54B-4C40-8696-97235980EAE1}"), 100);
				...
				public static PROPERTYKEY ResponseStatus
					=> new(new Guid("{188C1F91-3C40-4132-9EC5-D8B03B72A8A2}"), 100);
				...
				public static PROPERTYKEY ShowTimeAs
					=> new(new Guid("{5BF396D4-5EB2-466F-BDE9-2FB3F2361D6E}"), 100);

				/// <summary>
				/// <para>Name:     System.Calendar.ShowTimeAsText -- PKEY_Calendar_ShowTimeAsText</para>
				/// <para>Description: This is the user-friendly form of System.Calendar.ShowTimeAs. Not intended to be parsed programmatically.</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {53DA57CF-62C0-45C4-81DE-7610BCEFD7F5}, 100</para>
				/// </summary>
				public static PROPERTYKEY ShowTimeAsText
					=> new(new Guid("{53DA57CF-62C0-45C4-81DE-7610BCEFD7F5}"), 100);
			}
			...
			public static class Communication
			{
				...
				public static PROPERTYKEY AccountName
					=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 9);
				...
				public static PROPERTYKEY DateItemExpires
					=> new(new Guid("{428040AC-A177-4C8A-9760-F6F761227F9A}"), 100);
				...
				public static PROPERTYKEY FollowupIconIndex
					=> new(new Guid("{83A6347E-6FE4-4F40-BA9C-C4865240D1F4}"), 100);

				/// <summary>
				/// <para>Name:     System.Communication.HeaderItem -- PKEY_Communication_HeaderItem</para>
				/// <para>Description: This property will be true if the item is a header item which means the item hasn't been fully downloaded.</para>
				/// <para>Type:     Boolean -- VT_BOOL</para>
				/// <para>FormatID: {C9C34F84-2241-4401-B607-BD20ED75AE7F}, 100</para>
				/// </summary>
				public static PROPERTYKEY HeaderItem
					=> new(new Guid("{C9C34F84-2241-4401-B607-BD20ED75AE7F}"), 100);
				...
				public static PROPERTYKEY PolicyTag
					=> new(new Guid("{EC0B4191-AB0B-4C66-90B6-C6637CDEBBAB}"), 100);
				...
				public static PROPERTYKEY SecurityFlags
					=> new(new Guid("{8619A4B6-9F4D-4429-8C0F-B996CA59E335}"), 100);
				...
				public static PROPERTYKEY Suffix
					=> new(new Guid("{807B653A-9E91-43EF-8F97-11CE04EE20C5}"), 100);
				...
				public static PROPERTYKEY TaskStatus
					=> new(new Guid("{BE1A72C6-9A1D-46B7-AFE7-AFAF8CEF4999}"), 100);

				/// <summary>
				/// <para>Name:     System.Communication.TaskStatusText -- PKEY_Communication_TaskStatusText</para>
				/// <para>Description: This is the user-friendly form of System.Communication.TaskStatus. Not intended to be parsed programmatically.</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
			...
			public static class Contact
			{
				...
				public static PROPERTYKEY Anniversary
					=> new(new Guid("{9AD5BADB-CEA7-4470-A03D-B84E51B9949E}"), 100);
				...
				public static PROPERTYKEY AssistantName
					=> new(new Guid("{CD102C9C-5540-4A88-A6F6-64E4981C8CD1}"), 100);
				...
				public static PROPERTYKEY AssistantTelephone
					=> new(new Guid("{9A93244D-A7AD-4FF8-9B99-45EE4CC09AF6}"), 100);
				...
				public static PROPERTYKEY Birthday
					=> new(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 47);
				...
				public static PROPERTYKEY BusinessAddress
					=> new(new Guid("{730FB6DD-CF7C-426B-A03F-BD166CC9EE24}"), 100);
				...
				public static PROPERTYKEY BusinessAddressCity
					=> new(new Guid("{402B5934-EC5A-48C3-93E6-85E86A2D934E}"), 100);
				...
				public static PROPERTYKEY BusinessAddressCountry
					=> new(new Guid("{B0B87314-FCF6-4FEB-8DFF-A50DA6AF561C}"), 100);
				...
				public static PROPERTYKEY BusinessAddressPostalCode
					=> new(new Guid("{E1D4A09E-D758-4CD1-B6EC-34A8B5A73F80}"), 100);
				...
				public static PROPERTYKEY BusinessAddressPostOfficeBox
					=> new(new Guid("{BC4E71CE-17F9-48D5-BEE9-021DF0EA5409}"), 100);
				...
				public static PROPERTYKEY BusinessAddressState
					=> new(new Guid("{446F787F-10C4-41CB-A6C4-4D0343551597}"), 100);
				...
				public static PROPERTYKEY BusinessAddressStreet
					=> new(new Guid("{DDD1460F-C0BF-4553-8CE4-10433C908FB0}"), 100);
				...
				public static PROPERTYKEY BusinessFaxNumber
					=> new(new Guid("{91EFF6F3-2E27-42CA-933E-7C999FBE310B}"), 100);
				...
				public static PROPERTYKEY BusinessHomePage
					=> new(new Guid("{56310920-2491-4919-99CE-EADB06FAFDB2}"), 100);
				...
				public static PROPERTYKEY BusinessTelephone
					=> new(new Guid("{6A15E5A0-0A1E-4CD7-BB8C-D2F1B0C929BC}"), 100);
				...
				public static PROPERTYKEY CallbackTelephone
					=> new(new Guid("{BF53D1C3-49E0-4F7F-8567-5A821D8AC542}"), 100);
				...
				public static PROPERTYKEY CarTelephone
					=> new(new Guid("{8FDC6DEA-B929-412B-BA90-397A257465FE}"), 100);
				...
				public static PROPERTYKEY Children
					=> new(new Guid("{D4729704-8EF1-43EF-9024-2BD381187FD5}"), 100);
				...
				public static PROPERTYKEY CompanyMainTelephone
					=> new(new Guid("{8589E481-6040-473D-B171-7FA89C2708ED}"), 100);
				...
				public static PROPERTYKEY Department
					=> new(new Guid("{FC9F7306-FF8F-4D49-9FB6-3FFE5C0951EC}"), 100);
				...
				public static PROPERTYKEY EmailAddress
					=> new(new Guid("{F8FA7FA3-D12B-4785-8A4E-691A94F7A3E7}"), 100);
				...
				public static PROPERTYKEY EmailAddress2
					=> new(new Guid("{38965063-EDC8-4268-8491-B7723172CF29}"), 100);
				...
				public static PROPERTYKEY EmailAddress3
					=> new(new Guid("{644D37B4-E1B3-4BAD-B099-7E7C04966ACA}"), 100);
				...
				public static PROPERTYKEY EmailAddresses
					=> new(new Guid("{84D8F337-981D-44B3-9615-C7596DBA17E3}"), 100);
				...
				public static PROPERTYKEY EmailName
					=> new(new Guid("{CC6F4F24-6083-4BD4-8754-674D0DE87AB8}"), 100);
				...
				public static PROPERTYKEY FileAsName
					=> new(new Guid("{F1A24AA7-9CA7-40F6-89EC-97DEF9FFE8DB}"), 100);
				...
				public static PROPERTYKEY FirstName
					=> new(new Guid("{14977844-6B49-4AAD-A714-A4513BF60460}"), 100);
				...
				public static PROPERTYKEY FullName
					=> new(new Guid("{635E9051-50A5-4BA2-B9DB-4ED056C77296}"), 100);
				...
				public static PROPERTYKEY Gender
					=> new(new Guid("{3C8CEE58-D4F0-4CF9-B756-4E5D24447BCD}"), 100);
				...
				public static PROPERTYKEY GenderValue
					=> new(new Guid("{3C8CEE58-D4F0-4CF9-B756-4E5D24447BCD}"), 101);
				...
				public static PROPERTYKEY Hobbies
					=> new(new Guid("{5DC2253F-5E11-4ADF-9CFE-910DD01E3E70}"), 100);
				...
				public static PROPERTYKEY HomeAddress
					=> new(new Guid("{98F98354-617A-46B8-8560-5B1B64BF1F89}"), 100);
				...
				public static PROPERTYKEY HomeAddressCity
					=> new(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 65);
				...
				public static PROPERTYKEY HomeAddressCountry
					=> new(new Guid("{08A65AA1-F4C9-43DD-9DDF-A33D8E7EAD85}"), 100);
				...
				public static PROPERTYKEY HomeAddressPostalCode
					=> new(new Guid("{8AFCC170-8A46-4B53-9EEE-90BAE7151E62}"), 100);
				...
				public static PROPERTYKEY HomeAddressPostOfficeBox
					=> new(new Guid("{7B9F6399-0A3F-4B12-89BD-4ADC51C918AF}"), 100);
				...
				public static PROPERTYKEY HomeAddressState
					=> new(new Guid("{C89A23D0-7D6D-4EB8-87D4-776A82D493E5}"), 100);
				...
				public static PROPERTYKEY HomeAddressStreet
					=> new(new Guid("{0ADEF160-DB3F-4308-9A21-06237B16FA2A}"), 100);
				...
				public static PROPERTYKEY HomeFaxNumber
					=> new(new Guid("{660E04D6-81AB-4977-A09F-82313113AB26}"), 100);
				...
				public static PROPERTYKEY HomeTelephone
					=> new(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 20);
				...
				public static PROPERTYKEY IMAddress
					=> new(new Guid("{D68DBD8A-3374-4B81-9972-3EC30682DB3D}"), 100);
				...
				public static PROPERTYKEY Initials
					=> new(new Guid("{F3D8F40D-50CB-44A2-9718-40CB9119495D}"), 100);
				...
				public static PROPERTYKEY JobTitle
					=> new(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 6);
				...
				public static PROPERTYKEY Label
					=> new(new Guid("{97B0AD89-DF49-49CC-834E-660974FD755B}"), 100);
				...
				public static PROPERTYKEY LastName
					=> new(new Guid("{8F367200-C270-457C-B1D4-E07C5BCD90C7}"), 100);
				...
				public static PROPERTYKEY MailingAddress
					=> new(new Guid("{C0AC206A-827E-4650-95AE-77E2BB74FCC9}"), 100);
				...
				public static PROPERTYKEY MiddleName
					=> new(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 71);
				...
				public static PROPERTYKEY MobileTelephone
					=> new(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 35);
				...
				public static PROPERTYKEY NickName
					=> new(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 74);
				...
				public static PROPERTYKEY OfficeLocation
					=> new(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 7);
				...
				public static PROPERTYKEY OtherAddress
					=> new(new Guid("{508161FA-313B-43D5-83A1-C1ACCF68622C}"), 100);
				...
				public static PROPERTYKEY OtherAddressCity
					=> new(new Guid("{6E682923-7F7B-4F0C-A337-CFCA296687BF}"), 100);
				...
				public static PROPERTYKEY OtherAddressCountry
					=> new(new Guid("{8F167568-0AAE-4322-8ED9-6055B7B0E398}"), 100);
				...
				public static PROPERTYKEY OtherAddressPostalCode
					=> new(new Guid("{95C656C1-2ABF-4148-9ED3-9EC602E3B7CD}"), 100);
				...
				public static PROPERTYKEY OtherAddressPostOfficeBox
					=> new(new Guid("{8B26EA41-058F-43F6-AECC-4035681CE977}"), 100);
				...
				public static PROPERTYKEY OtherAddressState
					=> new(new Guid("{71B377D6-E570-425F-A170-809FAE73E54E}"), 100);
				...
				public static PROPERTYKEY OtherAddressStreet
					=> new(new Guid("{FF962609-B7D6-4999-862D-95180D529AEA}"), 100);
				...
				public static PROPERTYKEY PersonalTitle
					=> new(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 69);
				...
				public static PROPERTYKEY PrimaryAddressCity
					=> new(new Guid("{C8EA94F0-A9E3-4969-A94B-9C62A95324E0}"), 100);
				...
				public static PROPERTYKEY PrimaryAddressCountry
					=> new(new Guid("{E53D799D-0F3F-466E-B2FF-74634A3CB7A4}"), 100);
				...
				public static PROPERTYKEY PrimaryAddressPostalCode
					=> new(new Guid("{18BBD425-ECFD-46EF-B612-7B4A6034EDA0}"), 100);
				...
				public static PROPERTYKEY PrimaryAddressPostOfficeBox
					=> new(new Guid("{DE5EF3C7-46E1-484E-9999-62C5308394C1}"), 100);
				...
				public static PROPERTYKEY PrimaryAddressState
					=> new(new Guid("{F1176DFE-7138-4640-8B4C-AE375DC70A6D}"), 100);
				...
				public static PROPERTYKEY PrimaryAddressStreet
					=> new(new Guid("{63C25B20-96BE-488F-8788-C09C407AD812}"), 100);
				...
				public static PROPERTYKEY PrimaryEmailAddress
					=> new(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 48);
				...
				public static PROPERTYKEY PrimaryTelephone
					=> new(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 25);
				...
				public static PROPERTYKEY Profession
					=> new(new Guid("{7268AF55-1CE4-4F6E-A41F-B6E4EF10E4A9}"), 100);
				...
				public static PROPERTYKEY SpouseName
					=> new(new Guid("{9D2408B6-3167-422B-82B0-F583B7A7CFE3}"), 100);
				...
				/// </summary>
				public static PROPERTYKEY Suffix
					=> new(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 73);
				...
				public static PROPERTYKEY TelexNumber
					=> new(new Guid("{C554493C-C1F7-40C1-A76C-EF8C0614003E}"), 100);
				...
				public static PROPERTYKEY WebPage
					=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 18);
				...
				public static class JA
				{
					...
					public static PROPERTYKEY CompanyNamePhonetic
						=> new(new Guid("{897B3694-FE9E-43E6-8066-260F590C0100}"), 2);
					...
					public static PROPERTYKEY FirstNamePhonetic
						=> new(new Guid("{897B3694-FE9E-43E6-8066-260F590C0100}"), 3);
					...
					public static PROPERTYKEY LastNamePhonetic
						=> new(new Guid("{897B3694-FE9E-43E6-8066-260F590C0100}"), 4);
				}
			}
			...
			public static class Device
			{
				...
				public static PROPERTYKEY PrinterURL
					=> new(new Guid("{0B48F35A-BE6E-4F17-B108-3C4073D1669A}"), 15);
			}
			...
			public static class DeviceInterface
			{
				...
				public static PROPERTYKEY PrinterDriverDirectory
					=> new(new Guid("{847C66DE-B8D6-4AF9-ABC3-6F4F926BC039}"), 14);
				...
				public static PROPERTYKEY PrinterDriverName
					=> new(new Guid("{AFC47170-14F5-498C-8F30-B0D19BE449C6}"), 11);
				...
				public static PROPERTYKEY PrinterName
					=> new(new Guid("{0A7B84EF-0C27-463F-84EF-06C5070001BE}"), 10);
				...
				public static PROPERTYKEY PrinterPortName
					=> new(new Guid("{EEC7B761-6F94-41B1-949F-C729720DD13C}"), 12);
			}
			...
			public static class Devices
			{
				...
				public static PROPERTYKEY BatteryLife
					=> new(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 10);
				...
				public static PROPERTYKEY BatteryPlusCharging
					=> new(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 22);
				...
				public static PROPERTYKEY BatteryPlusChargingText
					=> new(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 23);
				...
				public static PROPERTYKEY CategoryGroup
					=> new(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 94);
				...
				public static PROPERTYKEY CategoryPlural
					=> new(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 92);
				...
				public static PROPERTYKEY ChargingState
					=> new(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 11);

				/// <summary>
				/// <para>Name:     System.Devices.Connected -- PKEY_Devices_IsConnected</para>
				/// <para>Description: Device connection state. If VARIANT_TRUE, indicates the device is currently connected to the computer.</para>
				/// <para>Type:     Boolean -- VT_BOOL</para>
				/// <para>FormatID: {78C34FC8-104A-4ACA-9EA4-524D52996E57}, 55</para>
				/// </summary>
				public static PROPERTYKEY Connected
					=> new(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 55);
				...
				public static PROPERTYKEY DefaultTooltip
					=> new(new Guid("{880F70A2-6082-47AC-8AAB-A739D1A300C3}"), 153);
				...
				public static PROPERTYKEY DeviceDescription1
					=> new(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 81);
				...
				public static PROPERTYKEY DeviceDescription2
					=> new(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 82);

				/// <summary>
				/// <para>Name:     System.Devices.DiscoveryMethod -- PKEY_Devices_DiscoveryMethod</para>
				/// <para>Description: Device discovery method. This indicates on what transport or physical connection the device is discovered.</para>
				/// <para>Type:     Multivalue String -- VT_VECTOR | VT_LPWSTR (For variants: VT_ARRAY | VT_BSTR)</para>
				/// <para>FormatID: {78C34FC8-104A-4ACA-9EA4-524D52996E57}, 52</para>
				/// </summary>
				public static PROPERTYKEY DiscoveryMethod
					=> new(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 52);
				...
				public static PROPERTYKEY FriendlyName
					=> new(new Guid("{656A3BB3-ECC0-43FD-8477-4AE0404A96CD}"), 12288);
				...
				public static PROPERTYKEY FunctionPaths
					=> new(new Guid("{D08DD4C0-3A9E-462E-8290-7B636B2576B9}"), 3);
				...
				public static PROPERTYKEY InterfacePaths
					=> new(new Guid("{D08DD4C0-3A9E-462E-8290-7B636B2576B9}"), 2);
				...
				public static PROPERTYKEY IsDefault
					=> new(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 86);
				...
				/// </summary>
				public static PROPERTYKEY IsShared
					=> new(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 84);
				...
				public static PROPERTYKEY IsSoftwareInstalling
					=> new(new Guid("{83DA6326-97A6-4088-9453-A1923F573B29}"), 9);
				...
				public static PROPERTYKEY LaunchDeviceStageFromExplorer
					=> new(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 77);
				...
				public static PROPERTYKEY LocalMachine
					=> new(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 70);
				...
				public static PROPERTYKEY Manufacturer
					=> new(new Guid("{656A3BB3-ECC0-43FD-8477-4AE0404A96CD}"), 8192);
				...
				public static PROPERTYKEY MissedCalls
					=> new(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 5);
				...
				public static PROPERTYKEY ModelName
					=> new(new Guid("{656A3BB3-ECC0-43FD-8477-4AE0404A96CD}"), 8194);
				...
				public static PROPERTYKEY ModelNumber
					=> new(new Guid("{656A3BB3-ECC0-43FD-8477-4AE0404A96CD}"), 8195);
				...
				public static PROPERTYKEY NetworkedTooltip
					=> new(new Guid("{880F70A2-6082-47AC-8AAB-A739D1A300C3}"), 152);
				...
				public static PROPERTYKEY NetworkName
					=> new(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 7);
				...
				public static PROPERTYKEY NetworkType
					=> new(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 8);
				...
				public static PROPERTYKEY NewPictures
					=> new(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 4);
				...
				public static PROPERTYKEY Notification
					=> new(new Guid("{06704B0C-E830-4C81-9178-91E4E95A80A0}"), 3);
				...
				public static PROPERTYKEY NotificationStore
					=> new(new Guid("{06704B0C-E830-4C81-9178-91E4E95A80A0}"), 2);
				...
				public static PROPERTYKEY NotWorkingProperly
					=> new(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 83);
				...
				public static PROPERTYKEY Paired
					=> new(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 56);
				...
				public static PROPERTYKEY PrimaryCategory
					=> new(new Guid("{D08DD4C0-3A9E-462E-8290-7B636B2576B9}"), 10);
				...
				public static PROPERTYKEY Roaming
					=> new(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 9);
				...
				public static PROPERTYKEY SafeRemovalRequired
					=> new(new Guid("{AFD97640-86A3-4210-B67C-289C41AABE55}"), 2);
				...
				public static PROPERTYKEY SharedTooltip
					=> new(new Guid("{880F70A2-6082-47AC-8AAB-A739D1A300C3}"), 151);
				...
				public static PROPERTYKEY SignalStrength
					=> new(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 2);
				...
				public static PROPERTYKEY Status1
					=> new(new Guid("{D08DD4C0-3A9E-462E-8290-7B636B2576B9}"), 257);
				...
				public static PROPERTYKEY Status2
					=> new(new Guid("{D08DD4C0-3A9E-462E-8290-7B636B2576B9}"), 258);
				...
				public static PROPERTYKEY StorageCapacity
					=> new(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 12);
				...
				public static PROPERTYKEY StorageFreeSpace
					=> new(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 13);
				...
				public static PROPERTYKEY StorageFreeSpacePercent
					=> new(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 14);
				...
				public static PROPERTYKEY TextMessages
					=> new(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 3);
				...
				public static PROPERTYKEY Voicemail
					=> new(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 6);
				...
				public static class Notifications
				{
					...
					public static PROPERTYKEY LowBattery
						=> new(new Guid("{C4C07F2B-8524-4E66-AE3A-A6235F103BEB}"), 2);
					...
					public static PROPERTYKEY MissedCall
						=> new(new Guid("{6614EF48-4EFE-4424-9EDA-C79F404EDF3E}"), 2);
					...
					public static PROPERTYKEY NewMessage
						=> new(new Guid("{2BE9260A-2012-4742-A555-F41B638B7DCB}"), 2);
					...
					public static PROPERTYKEY NewVoicemail
						=> new(new Guid("{59569556-0A08-4212-95B9-FAE2AD6413DB}"), 2);
					...
					public static PROPERTYKEY StorageFull
						=> new(new Guid("{A0E00EE1-F0C7-4D41-B8E7-26A7BD8D38B0}"), 2);
					...
					public static PROPERTYKEY StorageFullLinkText
						=> new(new Guid("{A0E00EE1-F0C7-4D41-B8E7-26A7BD8D38B0}"), 3);
				}
			}
			...
			public static class Document
			{
				...
				public static PROPERTYKEY ClientID
					=> new(new Guid("{276D7BB0-5B34-4FB0-AA4B-158ED12A1809}"), 100);
				...
				public static PROPERTYKEY Contributor
					=> new(new Guid("{F334115E-DA1B-4509-9B3D-119504DC7ABB}"), 100);
				...
				public static PROPERTYKEY Division
					=> new(new Guid("{1E005EE6-BF27-428B-B01C-79676ACD2870}"), 100);
				...
				public static PROPERTYKEY DocumentID
					=> new(new Guid("{E08805C8-E395-40DF-80D2-54F0D6C43154}"), 100);
			...
			public static class GPS
			{
				...
				public static PROPERTYKEY Altitude
					=> new(new Guid("{827EDB4F-5B73-44A7-891D-FDFFABEA35CA}"), 100);
				...
				public static PROPERTYKEY AltitudeDenominator
					=> new(new Guid("{78342DCB-E358-4145-AE9A-6BFE4E0F9F51}"), 100);
				...
				public static PROPERTYKEY AltitudeNumerator
					=> new(new Guid("{2DAD1EB7-816D-40D3-9EC3-C9773BE2AADE}"), 100);
				...
				public static PROPERTYKEY AltitudeRef
					=> new(new Guid("{46AC629D-75EA-4515-867F-6DC4321C5844}"), 100);
				...
				public static PROPERTYKEY AreaInformation
					=> new(new Guid("{972E333E-AC7E-49F1-8ADF-A70D07A9BCAB}"), 100);
				...
				public static PROPERTYKEY Date
					=> new(new Guid("{3602C812-0F3B-45F0-85AD-603468D69423}"), 100);
				...
				public static PROPERTYKEY DestBearing
					=> new(new Guid("{C66D4B3C-E888-47CC-B99F-9DCA3EE34DEA}"), 100);
				...
				public static PROPERTYKEY DestBearingDenominator
					=> new(new Guid("{7ABCF4F8-7C3F-4988-AC91-8D2C2E97ECA5}"), 100);
				...
				public static PROPERTYKEY DestBearingNumerator
					=> new(new Guid("{BA3B1DA9-86EE-4B5D-A2A4-A271A429F0CF}"), 100);
				...
				public static PROPERTYKEY DestBearingRef
					=> new(new Guid("{9AB84393-2A0F-4B75-BB22-7279786977CB}"), 100);
				...
				public static PROPERTYKEY DestDistance
					=> new(new Guid("{A93EAE04-6804-4F24-AC81-09B266452118}"), 100);
				...
				public static PROPERTYKEY DestDistanceDenominator
					=> new(new Guid("{9BC2C99B-AC71-4127-9D1C-2596D0D7DCB7}"), 100);
				...
				public static PROPERTYKEY DestDistanceNumerator
					=> new(new Guid("{2BDA47DA-08C6-4FE1-80BC-A72FC517C5D0}"), 100);

				/// <summary>
				/// <para>Name:     System.GPS.DestDistanceRef -- PKEY_GPS_DestDistanceRef</para>
				/// <para>Description: Indicates the unit used to express the distance to the destination. (eg: kilometers, miles, knots)</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {ED4DF2D3-8695-450B-856F-F5C1C53ACB66}, 100</para>
				/// </summary>
				public static PROPERTYKEY DestDistanceRef
					=> new(new Guid("{ED4DF2D3-8695-450B-856F-F5C1C53ACB66}"), 100);

				/// <summary>
				/// <para>Name:     System.GPS.DestLatitude -- PKEY_GPS_DestLatitude</para>
				/// <para>
				/// Description: Indicates the latitude of the destination point. This is an array of three values. Index 0 is the degrees,
				/// index 1 is the minutes, index 2 is the seconds. Each is calculated from the values in PKEY_GPS_DestLatitudeNumerator and PKEY_GPS_DestLatitudeDenominator.
				/// </para>
				...
				public static PROPERTYKEY DestLatitude
					=> new(new Guid("{9D1D7CC5-5C39-451C-86B3-928E2D18CC47}"), 100);
				...
				public static PROPERTYKEY DestLatitudeDenominator
					=> new(new Guid("{3A372292-7FCA-49A7-99D5-E47BB2D4E7AB}"), 100);
				...
				public static PROPERTYKEY DestLatitudeNumerator
					=> new(new Guid("{ECF4B6F6-D5A6-433C-BB92-4076650FC890}"), 100);
				...
				public static PROPERTYKEY DestLatitudeRef
					=> new(new Guid("{CEA820B9-CE61-4885-A128-005D9087C192}"), 100);

				/// <summary>
				/// <para>Name:     System.GPS.DestLongitude -- PKEY_GPS_DestLongitude</para>
				/// <para>
				/// Description: Indicates the latitude of the destination point. This is an array of three values. Index 0 is the degrees,
				/// index 1 is the minutes, index 2 is the seconds. Each is calculated from the values in PKEY_GPS_DestLongitudeNumerator and PKEY_GPS_DestLongitudeDenominator.
				/// </para>
				/// <para>Type:     Multivalue Double -- VT_VECTOR | VT_R8 (For variants: VT_ARRAY | VT_R8)</para>
				/// <para>FormatID: {47A96261-CB4C-4807-8AD3-40B9D9DBC6BC}, 100</para>
				/// </summary>
				public static PROPERTYKEY DestLongitude
					=> new(new Guid("{47A96261-CB4C-4807-8AD3-40B9D9DBC6BC}"), 100);
				...
				public static PROPERTYKEY DestLongitudeDenominator
					=> new(new Guid("{425D69E5-48AD-4900-8D80-6EB6B8D0AC86}"), 100);
				...
				public static PROPERTYKEY DestLongitudeNumerator
					=> new(new Guid("{A3250282-FB6D-48D5-9A89-DBCACE75CCCF}"), 100);
				...
				public static PROPERTYKEY DestLongitudeRef
					=> new(new Guid("{182C1EA6-7C1C-4083-AB4B-AC6C9F4ED128}"), 100);
				...
				public static PROPERTYKEY Differential
					=> new(new Guid("{AAF4EE25-BD3B-4DD7-BFC4-47F77BB00F6D}"), 100);

				/// <summary>
				/// <para>Name:     System.GPS.DOP -- PKEY_GPS_DOP</para>
				/// <para>Description: Indicates the GPS DOP (data degree of precision). Calculated from PKEY_GPS_DOPNumerator and PKEY_GPS_DOPDenominator</para>
				/// <para>Type:     Double -- VT_R8</para>
				/// <para>FormatID: {0CF8FB02-1837-42F1-A697-A7017AA289B9}, 100</para>
				/// </summary>
				public static PROPERTYKEY DOP
					=> new(new Guid("{0CF8FB02-1837-42F1-A697-A7017AA289B9}"), 100);
				...
				public static PROPERTYKEY DOPDenominator
					=> new(new Guid("{A0BE94C5-50BA-487B-BD35-0654BE8881ED}"), 100);
				...
				public static PROPERTYKEY DOPNumerator
					=> new(new Guid("{47166B16-364F-4AA0-9F31-E2AB3DF449C3}"), 100);
				...
				public static PROPERTYKEY ImgDirection
					=> new(new Guid("{16473C91-D017-4ED9-BA4D-B6BAA55DBCF8}"), 100);
				...
				public static PROPERTYKEY ImgDirectionDenominator
					=> new(new Guid("{10B24595-41A2-4E20-93C2-5761C1395F32}"), 100);
				...
				public static PROPERTYKEY ImgDirectionNumerator
					=> new(new Guid("{DC5877C7-225F-45F7-BAC7-E81334B6130A}"), 100);
				...
				public static PROPERTYKEY ImgDirectionRef
					=> new(new Guid("{A4AAA5B7-1AD0-445F-811A-0F8F6E67F6B5}"), 100);

				/// <summary>
				/// <para>Name:     System.GPS.Latitude -- PKEY_GPS_Latitude</para>
				/// <para>
				/// Description: Indicates the latitude. This is an array of three values. Index 0 is the degrees, index 1 is the minutes,
				/// index 2 is the seconds. Each is calculated from the values in PKEY_GPS_LatitudeNumerator and PKEY_GPS_LatitudeDenominator.
				/// </para>
				/// <para>Type:     Multivalue Double -- VT_VECTOR | VT_R8 (For variants: VT_ARRAY | VT_R8)</para>
				/// <para>FormatID: {8727CFFF-4868-4EC6-AD5B-81B98521D1AB}, 100</para>
				/// </summary>
				public static PROPERTYKEY Latitude
					=> new(new Guid("{8727CFFF-4868-4EC6-AD5B-81B98521D1AB}"), 100);
				...
				public static PROPERTYKEY LatitudeDenominator
					=> new(new Guid("{16E634EE-2BFF-497B-BD8A-4341AD39EEB9}"), 100);
				...
				public static PROPERTYKEY LatitudeNumerator
					=> new(new Guid("{7DDAAAD1-CCC8-41AE-B750-B2CB8031AEA2}"), 100);
				...
				public static PROPERTYKEY LatitudeRef
					=> new(new Guid("{029C0252-5B86-46C7-ACA0-2769FFC8E3D4}"), 100);

				/// <summary>
				/// <para>Name:     System.GPS.Longitude -- PKEY_GPS_Longitude</para>
				/// <para>
				/// Description: Indicates the longitude. This is an array of three values. Index 0 is the degrees, index 1 is the minutes,
				/// index 2 is the seconds. Each is calculated from the values in PKEY_GPS_LongitudeNumerator and PKEY_GPS_LongitudeDenominator.
				/// </para>
				/// <para>Type:     Multivalue Double -- VT_VECTOR | VT_R8 (For variants: VT_ARRAY | VT_R8)</para>
				/// <para>FormatID: {C4C4DBB2-B593-466B-BBDA-D03D27D5E43A}, 100</para>
				/// </summary>
				public static PROPERTYKEY Longitude
					=> new(new Guid("{C4C4DBB2-B593-466B-BBDA-D03D27D5E43A}"), 100);
				...
				public static PROPERTYKEY LongitudeDenominator
					=> new(new Guid("{BE6E176C-4534-4D2C-ACE5-31DEDAC1606B}"), 100);
				...
				public static PROPERTYKEY LongitudeNumerator
					=> new(new Guid("{02B0F689-A914-4E45-821D-1DDA452ED2C4}"), 100);
				...
				public static PROPERTYKEY LongitudeRef
					=> new(new Guid("{33DCF22B-28D5-464C-8035-1EE9EFD25278}"), 100);
				...
				public static PROPERTYKEY MapDatum
					=> new(new Guid("{2CA2DAE6-EDDC-407D-BEF1-773942ABFA95}"), 100);
				...
				public static PROPERTYKEY MeasureMode
					=> new(new Guid("{A015ED5D-AAEA-4D58-8A86-3C586920EA0B}"), 100);
				...
				public static PROPERTYKEY ProcessingMethod
					=> new(new Guid("{59D49E61-840F-4AA9-A939-E2099B7F6399}"), 100);
				...
				public static PROPERTYKEY Satellites
					=> new(new Guid("{467EE575-1F25-4557-AD4E-B8B58B0D9C15}"), 100);

				/// <summary>
				/// <para>Name:     System.GPS.Speed -- PKEY_GPS_Speed</para>
				/// <para>Description: Indicates the speed of the GPS receiver movement. Calculated from PKEY_GPS_SpeedNumerator and PKEY_GPS_SpeedDenominator.</para>
				/// <para>Type:     Double -- VT_R8</para>
				/// <para>FormatID: {DA5D0862-6E76-4E1B-BABD-70021BD25494}, 100</para>
				/// </summary>
				public static PROPERTYKEY Speed
					=> new(new Guid("{DA5D0862-6E76-4E1B-BABD-70021BD25494}"), 100);
				...
				public static PROPERTYKEY SpeedDenominator
					=> new(new Guid("{7D122D5A-AE5E-4335-8841-D71E7CE72F53}"), 100);
				...
				public static PROPERTYKEY SpeedNumerator
					=> new(new Guid("{ACC9CE3D-C213-4942-8B48-6D0820F21C6D}"), 100);

				/// <summary>
				/// <para>Name:     System.GPS.SpeedRef -- PKEY_GPS_SpeedRef</para>
				/// <para>
				/// Description: Indicates the unit used to express the speed of the GPS receiver movement. (eg: kilometers per hour, miles
				/// per hour, knots).
				/// </para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				...
				public static PROPERTYKEY SpeedRef
					=> new(new Guid("{ECF7F4C9-544F-4D6D-9D98-8AD79ADAF453}"), 100);
				...
				/// </summary>
				public static PROPERTYKEY Status
					=> new(new Guid("{125491F4-818F-46B2-91B5-D537753617B2}"), 100);
				...
				public static PROPERTYKEY Track
					=> new(new Guid("{76C09943-7C33-49E3-9E7E-CDBA872CFADA}"), 100);
				...
				public static PROPERTYKEY TrackDenominator
					=> new(new Guid("{C8D1920C-01F6-40C0-AC86-2F3A4AD00770}"), 100);
				...
				public static PROPERTYKEY TrackNumerator
					=> new(new Guid("{702926F4-44A6-43E1-AE71-45627116893B}"), 100);
				...
				public static PROPERTYKEY TrackRef
					=> new(new Guid("{35DBE6FE-44C3-4400-AAAE-D2C799C407E8}"), 100);
				...
				public static PROPERTYKEY VersionID
					=> new(new Guid("{22704DA4-C6B2-4A99-8E56-F16DF8C92599}"), 100);
			}
			...
			public static class Identity
			{
				...
				public static PROPERTYKEY Blob
					=> new(new Guid("{8C3B93A4-BAED-1A83-9A32-102EE313F6EB}"), 100);
				...
				public static PROPERTYKEY DisplayName
					=> new(new Guid("{7D683FC9-D155-45A8-BB1F-89D19BCB792F}"), 100);
				...
				public static PROPERTYKEY IsMeIdentity
					=> new(new Guid("{A4108708-09DF-4377-9DFC-6D99986D5A67}"), 100);
				...
				/// </summary>
				public static PROPERTYKEY PrimaryEmailAddress
					=> new(new Guid("{FCC16823-BAED-4F24-9B32-A0982117F7FA}"), 100);
				...
				public static PROPERTYKEY ProviderID
					=> new(new Guid("{74A7DE49-FA11-4D3D-A006-DB7E08675916}"), 100);
				...
				public static PROPERTYKEY UniqueID
					=> new(new Guid("{E55FC3B0-2B60-4220-918E-B21E8BF16016}"), 100);
			...
			public static class IdentityProvider
			{
				...
				public static PROPERTYKEY Name
					=> new(new Guid("{B96EFF7B-35CA-4A35-8607-29E3A54C46EA}"), 100);
				...
				public static PROPERTYKEY Picture
					=> new(new Guid("{2425166F-5642-4864-992F-98FD98F294C3}"), 100);
			}
			...
			public static class Image
			{
				...
				public static PROPERTYKEY BitDepth
					=> new(new Guid("{6444048F-4C8B-11D1-8B70-080036B11A03}"), 7);
				...
				/// <para>Description: Calculated from PKEY_Image_CompressedBitsPerPixelNumerator and PKEY_Image_CompressedBitsPerPixelDenominator.</para>
				/// <para>Type:     Double -- VT_R8</para>
				/// <para>FormatID: {364B6FA9-37AB-482A-BE2B-AE02F60D4318}, 100</para>
				/// </summary>
				public static PROPERTYKEY CompressedBitsPerPixel
					=> new(new Guid("{364B6FA9-37AB-482A-BE2B-AE02F60D4318}"), 100);
				...
				public static PROPERTYKEY CompressedBitsPerPixelDenominator
					=> new(new Guid("{1F8844E1-24AD-4508-9DFD-5326A415CE02}"), 100);
				...
				public static PROPERTYKEY CompressedBitsPerPixelNumerator
					=> new(new Guid("{D21A7148-D32C-4624-8900-277210F79C0F}"), 100);
				...
				/// <para>Description: This is the user-friendly form of System.Image.Compression. Not intended to be parsed programmatically.</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {3F08E66F-2F44-4BB9-A682-AC35D2562322}, 100</para>
				/// </summary>
				public static PROPERTYKEY CompressionText
					=> new(new Guid("{3F08E66F-2F44-4BB9-A682-AC35D2562322}"), 100);
				...
				public static PROPERTYKEY Dimensions
					=> new(new Guid("{6444048F-4C8B-11D1-8B70-080036B11A03}"), 13);
				...
				public static PROPERTYKEY HorizontalResolution
					=> new(new Guid("{6444048F-4C8B-11D1-8B70-080036B11A03}"), 5);
				...
				public static PROPERTYKEY HorizontalSize
					=> new(new Guid("{6444048F-4C8B-11D1-8B70-080036B11A03}"), 3);
				...
				public static PROPERTYKEY ImageID
					=> new(new Guid("{10DABE05-32AA-4C29-BF1A-63E2D220587F}"), 100);
				...
				public static PROPERTYKEY ResolutionUnit
					=> new(new Guid("{19B51FA6-1F92-4A5C-AB48-7DF0ABD67444}"), 100);
				...
				public static PROPERTYKEY VerticalResolution
					=> new(new Guid("{6444048F-4C8B-11D1-8B70-080036B11A03}"), 6);
				...
				public static PROPERTYKEY VerticalSize
					=> new(new Guid("{6444048F-4C8B-11D1-8B70-080036B11A03}"), 4);
			}
			...
			public static class Journal
			{
				...
				public static PROPERTYKEY Contacts
					=> new(new Guid("{DEA7C82C-1D89-4A66-9427-A4E3DEBABCB1}"), 100);
				...
				public static PROPERTYKEY EntryType
					=> new(new Guid("{95BEB1FC-326D-4644-B396-CD3ED90E6DDF}"), 100);
			}
			...
			public static class LayoutPattern
			{
				...
				public static PROPERTYKEY ContentViewModeForBrowse
					=> new(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 500);
				...
				public static PROPERTYKEY ContentViewModeForSearch
					=> new(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 501);
			}
			...
			public static class Link
			{
				...
				public static PROPERTYKEY Arguments
					=> new(new Guid("{436F2667-14E2-4FEB-B30A-146C53B5B674}"), 100);
				...
				/// </summary>
				public static PROPERTYKEY Comment
					=> new(new Guid("{B9B4B3FC-2B51-4A42-B5D8-324146AFCF25}"), 5);
				...
				public static PROPERTYKEY DateVisited
					=> new(new Guid("{5CBF2787-48CF-4208-B90E-EE5E5D420294}"), 23);
				...
				/// </summary>
				public static PROPERTYKEY Description
					=> new(new Guid("{5CBF2787-48CF-4208-B90E-EE5E5D420294}"), 21);
				...
				/// </summary>
				public static PROPERTYKEY Status
					=> new(new Guid("{B9B4B3FC-2B51-4A42-B5D8-324146AFCF25}"), 3);
				...
				public static PROPERTYKEY TargetExtension
					=> new(new Guid("{7A7D76F4-B630-4BD7-95FF-37CC51A975C9}"), 2);
				...
				/// SHParseDisplayName to parse the path to the correct shell folder. If the target item is a file, the value is identical to
				/// System.ItemPathDisplay. If the target item cannot be accessed through the shell namespace, this value is VT_EMPTY.
				/// </para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				...
				public static PROPERTYKEY TargetSFGAOFlags
					=> new(new Guid("{B9B4B3FC-2B51-4A42-B5D8-324146AFCF25}"), 8);
				...
				public static PROPERTYKEY TargetSFGAOFlagsStrings
					=> new(new Guid("{D6942081-D53B-443D-AD47-5E059D9CD27A}"), 3);
				...
				public static PROPERTYKEY TargetUrl
					=> new(new Guid("{5CBF2787-48CF-4208-B90E-EE5E5D420294}"), 2);
			}
			...
			public static class Media
			{
				...
				public static PROPERTYKEY AuthorUrl
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 32);
				...
				public static PROPERTYKEY AverageLevel
					=> new(new Guid("{09EDD5B6-B301-43C5-9990-D00302EFFD46}"), 100);
				...
				public static PROPERTYKEY ClassPrimaryID
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 13);
				...
				public static PROPERTYKEY ClassSecondaryID
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 14);
				...
				public static PROPERTYKEY CollectionGroupID
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 24);
				...
				public static PROPERTYKEY CollectionID
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 25);
				...
				public static PROPERTYKEY ContentDistributor
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 18);
				...
				public static PROPERTYKEY ContentID
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 26);
				...
				public static PROPERTYKEY CreatorApplication
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 27);
				...
				public static PROPERTYKEY CreatorApplicationVersion
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 28);
				...
				public static PROPERTYKEY DateEncoded
					=> new(new Guid("{2E4B640D-5019-46D8-8881-55414CC5CAA0}"), 100);
				...
				public static PROPERTYKEY DateReleased
					=> new(new Guid("{DE41CC29-6971-4290-B472-F59F2E2F31E2}"), 100);
				...
				public static PROPERTYKEY DVDID
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 15);
				...
				public static PROPERTYKEY EncodedBy
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 36);
				...
				public static PROPERTYKEY EncodingSettings
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 37);
				...
				public static PROPERTYKEY FrameCount
					=> new(new Guid("{6444048F-4C8B-11D1-8B70-080036B11A03}"), 12);
				...
				public static PROPERTYKEY MCDI
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 16);
				...
				public static PROPERTYKEY MetadataContentProvider
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 17);
				...
				public static PROPERTYKEY Producer
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 22);
				...
				public static PROPERTYKEY PromotionUrl
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 33);
				...
				public static PROPERTYKEY ProtectionType
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 38);
				...
				public static PROPERTYKEY ProviderRating
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 39);
				...
				public static PROPERTYKEY ProviderStyle
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 40);
				...
				public static PROPERTYKEY Publisher
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 30);
				...
				public static PROPERTYKEY SubscriptionContentId
					=> new(new Guid("{9AEBAE7A-9644-487D-A92C-657585ED751A}"), 100);
				...
				public static PROPERTYKEY UniqueFileIdentifier
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 35);
				...
				public static PROPERTYKEY UserNoAutoInfo
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 41);
				...
				public static PROPERTYKEY UserWebUrl
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 34);
				...
				public static PROPERTYKEY Writer
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 23);
			...
			public static class Message
			{
				...
				public static PROPERTYKEY AttachmentContents
					=> new(new Guid("{3143BF7C-80A8-4854-8880-E2E40189BDD0}"), 100);
				...
				public static PROPERTYKEY AttachmentNames
					=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 21);
				...
				public static PROPERTYKEY BccAddress
					=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 2);
				...
				public static PROPERTYKEY BccName
					=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 3);
				...
				public static PROPERTYKEY CcAddress
					=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 4);
				...
				public static PROPERTYKEY CcName
					=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 5);
				...
				public static PROPERTYKEY ConversationID
					=> new(new Guid("{DC8F80BD-AF1E-4289-85B6-3DFC1B493992}"), 100);
				...
				public static PROPERTYKEY ConversationIndex
					=> new(new Guid("{DC8F80BD-AF1E-4289-85B6-3DFC1B493992}"), 101);
				...
				public static PROPERTYKEY DateReceived
					=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 20);
				...
				public static PROPERTYKEY DateSent
					=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 19);

				/// <summary>
				/// <para>Name:     System.Message.Flags -- PKEY_Message_Flags</para>
				/// <para>
				/// Description: These are flags associated with email messages to know if a read receipt is pending, etc. The values stored
				/// here by Outlook are defined for PR_MESSAGE_FLAGS on MSDN.
				/// </para>
				/// <para>Type:     Int32 -- VT_I4</para>
				/// <para>FormatID: {A82D9EE7-CA67-4312-965E-226BCEA85023}, 100</para>
				/// </summary>
				public static PROPERTYKEY Flags
					=> new(new Guid("{A82D9EE7-CA67-4312-965E-226BCEA85023}"), 100);
				...
				public static PROPERTYKEY FromAddress
					=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 13);
				...
				public static PROPERTYKEY FromName
					=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 14);
				...
				public static PROPERTYKEY HasAttachments
					=> new(new Guid("{9C1FCF74-2D97-41BA-B4AE-CB2E3661A6E4}"), 8);
				...
				public static PROPERTYKEY IsFwdOrReply
					=> new(new Guid("{9A9BC088-4F6D-469E-9919-E705412040F9}"), 100);
				...
				public static PROPERTYKEY MessageClass
					=> new(new Guid("{CD9ED458-08CE-418F-A70E-F912C7BB9C5C}"), 103);
				...
				public static PROPERTYKEY ProofInProgress
					=> new(new Guid("{9098F33C-9A7D-48A8-8DE5-2E1227A64E91}"), 100);
				...
				public static PROPERTYKEY SenderAddress
					=> new(new Guid("{0BE1C8E7-1981-4676-AE14-FDD78F05A6E7}"), 100);
				...
				public static PROPERTYKEY SenderName
					=> new(new Guid("{0DA41CFA-D224-4A18-AE2F-596158DB4B3A}"), 100);
				...
				public static PROPERTYKEY Store
					=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 15);
				...
				public static PROPERTYKEY ToAddress
					=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 16);

				/// <summary>
				/// <para>Name:     System.Message.ToDoFlags -- PKEY_Message_ToDoFlags</para>
				/// <para>Description: Flags associated with a message flagged to know if it's still active, if it was custom flagged, etc.</para>
				/// <para>Type:     Int32 -- VT_I4</para>
				/// <para>FormatID: {1F856A9F-6900-4ABA-9505-2D5F1B4D66CB}, 100</para>
				/// </summary>
				public static PROPERTYKEY ToDoFlags
					=> new(new Guid("{1F856A9F-6900-4ABA-9505-2D5F1B4D66CB}"), 100);
				...
				public static PROPERTYKEY ToDoTitle
					=> new(new Guid("{BCCC8A3C-8CEF-42E5-9B1C-C69079398BC7}"), 100);
				...
				public static PROPERTYKEY ToName
					=> new(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 17);
			}
			...
			public static class Music
			{
				...
				public static PROPERTYKEY Composer
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 19);
				...
				/// <para>
				/// Description: This property returns the best representation of Album Artist for a given music file based upon AlbumArtist,
				/// ContributingArtist and compilation info.
				/// </para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {FD122953-FA93-4EF7-92C3-04C946B2F7C8}, 100</para>
				/// </summary>
				public static PROPERTYKEY DisplayArtist
					=> new(new Guid("{FD122953-FA93-4EF7-92C3-04C946B2F7C8}"), 100);
				...
				public static PROPERTYKEY IsCompilation
					=> new(new Guid("{C449D5CB-9EA4-4809-82E8-AF9D59DED6D1}"), 100);
				...
				public static PROPERTYKEY Period
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 31);
				...
				public static PROPERTYKEY SynchronizedLyrics
					=> new(new Guid("{6B223B6A-162E-4AA9-B39F-05D678FC6D77}"), 100);
			...
			public static class Note
			{
				...
				public static PROPERTYKEY Color
					=> new(new Guid("{4776CAFA-BCE4-4CB1-A23E-265E76D8EB11}"), 100);

				/// <summary>
				/// <para>Name:     System.Note.ColorText -- PKEY_Note_ColorText</para>
				/// <para>Description: This is the user-friendly form of System.Note.Color. Not intended to be parsed programmatically.</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {46B4E8DE-CDB2-440D-885C-1658EB65B914}, 100</para>
				/// </summary>
				public static PROPERTYKEY ColorText
					=> new(new Guid("{46B4E8DE-CDB2-440D-885C-1658EB65B914}"), 100);
			}
			...
			public static class Photo
			{
				...
				/// <para>Description: PropertyTagExifAperture. Calculated from PKEY_Photo_ApertureNumerator and PKEY_Photo_ApertureDenominator</para>
				/// <para>Type:     Double -- VT_R8</para>
				...
				public static PROPERTYKEY ApertureDenominator
					=> new(new Guid("{E1A9A38B-6685-46BD-875E-570DC7AD7320}"), 100);
				...
				/// PKEY_Photo_BrightnessDenominator. The units are "APEX", normally in the range of -99.99 to 99.99. If the numerator of the
				/// recorded value is FFFFFFFF.H, "Unknown" should be indicated.
				/// </para>
				/// <para>Type:     Double -- VT_R8</para>
				...
				public static PROPERTYKEY Brightness
					=> new(new Guid("{1A701BF6-478C-4361-83AB-3701BB053C58}"), 100);
				...
				public static PROPERTYKEY BrightnessDenominator
					=> new(new Guid("{6EBE6946-2321-440A-90F0-C043EFD32476}"), 100);
				...
				public static PROPERTYKEY BrightnessNumerator
					=> new(new Guid("{9E7D118F-B314-45A0-8CFB-D654B917C9E9}"), 100);
				...
				/// <para>Description: This indicates the direction of contrast processing applied by the camera when the image was shot.</para>
				/// <para>Type:     UInt32 -- VT_UI4</para>
				/// <para>FormatID: {2A785BA9-8D23-4DED-82E6-60A350C86A10}, 100</para>
				/// </summary>
				public static PROPERTYKEY Contrast
					=> new(new Guid("{2A785BA9-8D23-4DED-82E6-60A350C86A10}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.ContrastText -- PKEY_Photo_ContrastText</para>
				/// <para>Description: This is the user-friendly form of System.Photo.Contrast. Not intended to be parsed programmatically.</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {59DDE9F2-5253-40EA-9A8B-479E96C6249A}, 100</para>
				/// </summary>
				public static PROPERTYKEY ContrastText
					=> new(new Guid("{59DDE9F2-5253-40EA-9A8B-479E96C6249A}"), 100);
				...
				/// <para>Description: PropertyTagExifDigitalZoom. Calculated from PKEY_Photo_DigitalZoomNumerator and PKEY_Photo_DigitalZoomDenominator</para>
				/// <para>Type:     Double -- VT_R8</para>
				/// <para>FormatID: {F85BF840-A925-4BC2-B0C4-8E36B598679E}, 100</para>
				/// </summary>
				public static PROPERTYKEY DigitalZoom
					=> new(new Guid("{F85BF840-A925-4BC2-B0C4-8E36B598679E}"), 100);
				...
				public static PROPERTYKEY DigitalZoomDenominator
					=> new(new Guid("{745BAF0E-E5C1-4CFB-8A1B-D031A0A52393}"), 100);
				...
				public static PROPERTYKEY DigitalZoomNumerator
					=> new(new Guid("{16CBB924-6500-473B-A5BE-F1599BCBE413}"), 100);
				...
				public static PROPERTYKEY EXIFVersion
					=> new(new Guid("{D35F743A-EB2E-47F2-A286-844132CB1427}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.ExposureBias -- PKEY_Photo_ExposureBias</para>
				/// <para>Description: PropertyTagExifExposureBias. Calculated from PKEY_Photo_ExposureBiasNumerator and PKEY_Photo_ExposureBiasDenominator</para>
				/// <para>Type:     Double -- VT_R8</para>
				...
				public static PROPERTYKEY ExposureBiasNumerator
					=> new(new Guid("{738BF284-1D87-420B-92CF-5834BF6EF9ED}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.ExposureIndex -- PKEY_Photo_ExposureIndex</para>
				/// <para>Description: PropertyTagExifExposureIndex. Calculated from PKEY_Photo_ExposureIndexNumerator and PKEY_Photo_ExposureIndexDenominator</para>
				/// <para>Type:     Double -- VT_R8</para>
				/// <para>FormatID: {967B5AF8-995A-46ED-9E11-35B3C5B9782D}, 100</para>
				/// </summary>
				public static PROPERTYKEY ExposureIndex
					=> new(new Guid("{967B5AF8-995A-46ED-9E11-35B3C5B9782D}"), 100);
				...
				public static PROPERTYKEY ExposureIndexDenominator
					=> new(new Guid("{93112F89-C28B-492F-8A9D-4BE2062CEE8A}"), 100);
				...
				public static PROPERTYKEY ExposureIndexNumerator
					=> new(new Guid("{CDEDCF30-8919-44DF-8F4C-4EB2FFDB8D89}"), 100);
				...
				/// <para>Description: This is the user-friendly form of System.Photo.ExposureProgram. Not intended to be parsed programmatically.</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {FEC690B7-5F30-4646-AE47-4CAAFBA884A3}, 100</para>
				/// </summary>
				public static PROPERTYKEY ExposureProgramText
					=> new(new Guid("{FEC690B7-5F30-4646-AE47-4CAAFBA884A3}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.ExposureTime -- PKEY_Photo_ExposureTime</para>
				/// <para>Description: PropertyTagExifExposureTime. Calculated from PKEY_Photo_ExposureTimeNumerator and PKEY_Photo_ExposureTimeDenominator</para>
				/// <para>Type:     Double -- VT_R8</para>
				...
				public static PROPERTYKEY ExposureTimeDenominator
					=> new(new Guid("{55E98597-AD16-42E0-B624-21599A199838}"), 100);
				...
				public static PROPERTYKEY ExposureTimeNumerator
					=> new(new Guid("{257E44E2-9031-4323-AC38-85C552871B2E}"), 100);
				...
				/// <para>Description: PropertyTagExifFlashEnergy. Calculated from PKEY_Photo_FlashEnergyNumerator and PKEY_Photo_FlashEnergyDenominator</para>
				/// <para>Type:     Double -- VT_R8</para>
				...
				public static PROPERTYKEY FlashEnergyDenominator
					=> new(new Guid("{D7B61C70-6323-49CD-A5FC-C84277162C97}"), 100);
				...
				public static PROPERTYKEY FlashEnergyNumerator
					=> new(new Guid("{FCAD3D3D-0858-400F-AAA3-2F66CCE2A6BC}"), 100);
				...
				public static PROPERTYKEY FlashManufacturer
					=> new(new Guid("{AABAF6C9-E0C5-4719-8585-57B103E584FE}"), 100);
				...
				public static PROPERTYKEY FlashModel
					=> new(new Guid("{FE83BB35-4D1A-42E2-916B-06F3E1AF719E}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.FlashText -- PKEY_Photo_FlashText</para>
				/// <para>Description: This is the user-friendly form of System.Photo.Flash. Not intended to be parsed programmatically.</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {6B8B68F6-200B-47EA-8D25-D8050F57339F}, 100</para>
				/// </summary>
				public static PROPERTYKEY FlashText
					=> new(new Guid("{6B8B68F6-200B-47EA-8D25-D8050F57339F}"), 100);
				...
				public static PROPERTYKEY FNumberDenominator
					=> new(new Guid("{E92A2496-223B-4463-A4E3-30EABBA79D80}"), 100);
				...
				public static PROPERTYKEY FNumberNumerator
					=> new(new Guid("{1B97738A-FDFC-462F-9D93-1957E08BE90C}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.FocalLength -- PKEY_Photo_FocalLength</para>
				/// <para>Description: PropertyTagExifFocalLength. Calculated from PKEY_Photo_FocalLengthNumerator and PKEY_Photo_FocalLengthDenominator</para>
				/// <para>Type:     Double -- VT_R8</para>
				...
				public static PROPERTYKEY FocalLengthDenominator
					=> new(new Guid("{305BC615-DCA1-44A5-9FD4-10C0BA79412E}"), 100);
				...
				public static PROPERTYKEY FocalLengthInFilm
					=> new(new Guid("{A0E74609-B84D-4F49-B860-462BD9971F98}"), 100);
				...
				public static PROPERTYKEY FocalLengthNumerator
					=> new(new Guid("{776B6B3B-1E3D-4B0C-9A0E-8FBAF2A8492A}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.FocalPlaneXResolution -- PKEY_Photo_FocalPlaneXResolution</para>
				/// <para>Description: PropertyTagExifFocalXRes. Calculated from PKEY_Photo_FocalPlaneXResolutionNumerator and PKEY_Photo_FocalPlaneXResolutionDenominator.</para>
				/// <para>Type:     Double -- VT_R8</para>
				/// <para>FormatID: {CFC08D97-C6F7-4484-89DD-EBEF4356FE76}, 100</para>
				/// </summary>
				public static PROPERTYKEY FocalPlaneXResolution
					=> new(new Guid("{CFC08D97-C6F7-4484-89DD-EBEF4356FE76}"), 100);
				...
				public static PROPERTYKEY FocalPlaneXResolutionDenominator
					=> new(new Guid("{0933F3F5-4786-4F46-A8E8-D64DD37FA521}"), 100);
				...
				public static PROPERTYKEY FocalPlaneXResolutionNumerator
					=> new(new Guid("{DCCB10AF-B4E2-4B88-95F9-031B4D5AB490}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.FocalPlaneYResolution -- PKEY_Photo_FocalPlaneYResolution</para>
				/// <para>Description: PropertyTagExifFocalYRes. Calculated from PKEY_Photo_FocalPlaneYResolutionNumerator and PKEY_Photo_FocalPlaneYResolutionDenominator.</para>
				/// <para>Type:     Double -- VT_R8</para>
				/// <para>FormatID: {4FFFE4D0-914F-4AC4-8D6F-C9C61DE169B1}, 100</para>
				/// </summary>
				public static PROPERTYKEY FocalPlaneYResolution
					=> new(new Guid("{4FFFE4D0-914F-4AC4-8D6F-C9C61DE169B1}"), 100);
				...
				public static PROPERTYKEY FocalPlaneYResolutionDenominator
					=> new(new Guid("{1D6179A6-A876-4031-B013-3347B2B64DC8}"), 100);
				...
				public static PROPERTYKEY FocalPlaneYResolutionNumerator
					=> new(new Guid("{A2E541C5-4440-4BA8-867E-75CFC06828CD}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.GainControl -- PKEY_Photo_GainControl</para>
				/// <para>
				/// Description: This indicates the degree of overall image gain adjustment. Calculated from PKEY_Photo_GainControlNumerator
				/// and PKEY_Photo_GainControlDenominator.
				/// </para>
				/// <para>Type:     Double -- VT_R8</para>
				...
				public static PROPERTYKEY GainControl
					=> new(new Guid("{FA304789-00C7-4D80-904A-1E4DCC7265AA}"), 100);
				...
				public static PROPERTYKEY GainControlDenominator
					=> new(new Guid("{42864DFD-9DA4-4F77-BDED-4AAD7B256735}"), 100);
				...
				public static PROPERTYKEY GainControlNumerator
					=> new(new Guid("{8E8ECF7C-B7B8-4EB8-A63F-0EE715C96F9E}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.GainControlText -- PKEY_Photo_GainControlText</para>
				/// <para>Description: This is the user-friendly form of System.Photo.GainControl. Not intended to be parsed programmatically.</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {C06238B2-0BF9-4279-A723-25856715CB9D}, 100</para>
				/// </summary>
				public static PROPERTYKEY GainControlText
					=> new(new Guid("{C06238B2-0BF9-4279-A723-25856715CB9D}"), 100);
				...
				public static PROPERTYKEY LensManufacturer
					=> new(new Guid("{E6DDCAF7-29C5-4F0A-9A68-D19412EC7090}"), 100);
				...
				public static PROPERTYKEY LensModel
					=> new(new Guid("{E1277516-2B5F-4869-89B1-2E585BD38B7A}"), 100);
				...
				public static PROPERTYKEY MakerNote
					=> new(new Guid("{FA303353-B659-4052-85E9-BCAC79549B84}"), 100);
				...
				public static PROPERTYKEY MakerNoteOffset
					=> new(new Guid("{813F4124-34E6-4D17-AB3E-6B1F3C2247A1}"), 100);
				...
				public static PROPERTYKEY MaxAperture
					=> new(new Guid("{08F6D7C2-E3F2-44FC-AF1E-5AA5C81A2D3E}"), 100);
				...
				public static PROPERTYKEY MaxApertureDenominator
					=> new(new Guid("{C77724D4-601F-46C5-9B89-C53F93BCEB77}"), 100);
				...
				public static PROPERTYKEY MaxApertureNumerator
					=> new(new Guid("{C107E191-A459-44C5-9AE6-B952AD4B906D}"), 100);
				...
				/// <para>Description: This is the user-friendly form of System.Photo.MeteringMode. Not intended to be parsed programmatically.</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {F628FD8C-7BA8-465A-A65B-C5AA79263A9E}, 100</para>
				/// </summary>
				public static PROPERTYKEY MeteringModeText
					=> new(new Guid("{F628FD8C-7BA8-465A-A65B-C5AA79263A9E}"), 100);
				...
				/// <para>Description: This is the user-friendly form of System.Photo.Orientation. Not intended to be parsed programmatically.</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {A9EA193C-C511-498A-A06B-58E2776DCC28}, 100</para>
				/// </summary>
				public static PROPERTYKEY OrientationText
					=> new(new Guid("{A9EA193C-C511-498A-A06B-58E2776DCC28}"), 100);
				...
				public static PROPERTYKEY PeopleNames
					=> new(new Guid("{E8309B6E-084C-49B4-B1FC-90A80331B638}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.PhotometricInterpretation -- PKEY_Photo_PhotometricInterpretation</para>
				/// <para>Description: This is the pixel composition. In JPEG compressed data, a JPEG marker is used instead of this property.</para>
				/// <para>Type:     UInt16 -- VT_UI2</para>
				/// <para>FormatID: {341796F1-1DF9-4B1C-A564-91BDEFA43877}, 100</para>
				/// </summary>
				public static PROPERTYKEY PhotometricInterpretation
					=> new(new Guid("{341796F1-1DF9-4B1C-A564-91BDEFA43877}"), 100);
				...
				public static PROPERTYKEY PhotometricInterpretationText
					=> new(new Guid("{821437D6-9EAB-4765-A589-3B1CBBD22A61}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.ProgramMode -- PKEY_Photo_ProgramMode</para>
				/// <para>Description: This is the class of the program used by the camera to set exposure when the picture is taken.</para>
				/// <para>Type:     UInt32 -- VT_UI4</para>
				/// <para>FormatID: {6D217F6D-3F6A-4825-B470-5F03CA2FBE9B}, 100</para>
				/// </summary>
				public static PROPERTYKEY ProgramMode
					=> new(new Guid("{6D217F6D-3F6A-4825-B470-5F03CA2FBE9B}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.ProgramModeText -- PKEY_Photo_ProgramModeText</para>
				/// <para>Description: This is the user-friendly form of System.Photo.ProgramMode. Not intended to be parsed programmatically.</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {7FE3AA27-2648-42F3-89B0-454E5CB150C3}, 100</para>
				/// </summary>
				public static PROPERTYKEY ProgramModeText
					=> new(new Guid("{7FE3AA27-2648-42F3-89B0-454E5CB150C3}"), 100);
				...
				public static PROPERTYKEY RelatedSoundFile
					=> new(new Guid("{318A6B45-087F-4DC2-B8CC-05359551FC9E}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.Saturation -- PKEY_Photo_Saturation</para>
				/// <para>Description: This indicates the direction of saturation processing applied by the camera when the image was shot.</para>
				/// <para>Type:     UInt32 -- VT_UI4</para>
				/// <para>FormatID: {49237325-A95A-4F67-B211-816B2D45D2E0}, 100</para>
				/// </summary>
				public static PROPERTYKEY Saturation
					=> new(new Guid("{49237325-A95A-4F67-B211-816B2D45D2E0}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.SaturationText -- PKEY_Photo_SaturationText</para>
				/// <para>Description: This is the user-friendly form of System.Photo.Saturation. Not intended to be parsed programmatically.</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {61478C08-B600-4A84-BBE4-E99C45F0A072}, 100</para>
				/// </summary>
				public static PROPERTYKEY SaturationText
					=> new(new Guid("{61478C08-B600-4A84-BBE4-E99C45F0A072}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.Sharpness -- PKEY_Photo_Sharpness</para>
				/// <para>Description: This indicates the direction of sharpness processing applied by the camera when the image was shot.</para>
				/// <para>Type:     UInt32 -- VT_UI4</para>
				/// <para>FormatID: {FC6976DB-8349-4970-AE97-B3C5316A08F0}, 100</para>
				/// </summary>
				public static PROPERTYKEY Sharpness
					=> new(new Guid("{FC6976DB-8349-4970-AE97-B3C5316A08F0}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.SharpnessText -- PKEY_Photo_SharpnessText</para>
				/// <para>Description: This is the user-friendly form of System.Photo.Sharpness. Not intended to be parsed programmatically.</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {51EC3F47-DD50-421D-8769-334F50424B1E}, 100</para>
				/// </summary>
				public static PROPERTYKEY SharpnessText
					=> new(new Guid("{51EC3F47-DD50-421D-8769-334F50424B1E}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.ShutterSpeed -- PKEY_Photo_ShutterSpeed</para>
				/// <para>Description: PropertyTagExifShutterSpeed. Calculated from PKEY_Photo_ShutterSpeedNumerator and PKEY_Photo_ShutterSpeedDenominator</para>
				/// <para>Type:     Double -- VT_R8</para>
				...
				public static PROPERTYKEY ShutterSpeedDenominator
					=> new(new Guid("{E13D8975-81C7-4948-AE3F-37CAE11E8FF7}"), 100);
				...
				public static PROPERTYKEY ShutterSpeedNumerator
					=> new(new Guid("{16EA4042-D6F4-4BCA-8349-7C78D30FB333}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.SubjectDistance -- PKEY_Photo_SubjectDistance</para>
				/// <para>Description: PropertyTagExifSubjectDist. Calculated from PKEY_Photo_SubjectDistanceNumerator and PKEY_Photo_SubjectDistanceDenominator</para>
				/// <para>Type:     Double -- VT_R8</para>
				...
				public static PROPERTYKEY SubjectDistanceDenominator
					=> new(new Guid("{0C840A88-B043-466D-9766-D4B26DA3FA77}"), 100);
				...
				public static PROPERTYKEY SubjectDistanceNumerator
					=> new(new Guid("{8AF4961C-F526-43E5-AA81-DB768219178D}"), 100);
				...
				public static PROPERTYKEY TagViewAggregate
					=> new(new Guid("{B812F15D-C2D8-4BBF-BACD-79744346113F}"), 100);
				...
				public static PROPERTYKEY TranscodedForSync
					=> new(new Guid("{9A8EBB75-6458-4E82-BACB-35C0095B03BB}"), 100);
				...
				public static PROPERTYKEY WhiteBalance
					=> new(new Guid("{EE3D3D8A-5381-4CFA-B13B-AAF66B5F4EC9}"), 100);

				/// <summary>
				/// <para>Name:     System.Photo.WhiteBalanceText -- PKEY_Photo_WhiteBalanceText</para>
				/// <para>Description: This is the user-friendly form of System.Photo.WhiteBalance. Not intended to be parsed programmatically.</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {6336B95E-C7A7-426D-86FD-7AE3D39C84B4}, 100</para>
				/// </summary>
				public static PROPERTYKEY WhiteBalanceText
					=> new(new Guid("{6336B95E-C7A7-426D-86FD-7AE3D39C84B4}"), 100);
			}
			...
			public static class PropGroup
			{
				...
				public static PROPERTYKEY Advanced
					=> new(new Guid("{900A403B-097B-4B95-8AE2-071FDAEEB118}"), 100);
				...
				public static PROPERTYKEY Audio
					=> new(new Guid("{2804D469-788F-48AA-8570-71B9C187E138}"), 100);
				...
				public static PROPERTYKEY Calendar
					=> new(new Guid("{9973D2B5-BFD8-438A-BA94-5349B293181A}"), 100);
				...
				public static PROPERTYKEY Camera
					=> new(new Guid("{DE00DE32-547E-4981-AD4B-542F2E9007D8}"), 100);
				...
				public static PROPERTYKEY Contact
					=> new(new Guid("{DF975FD3-250A-4004-858F-34E29A3E37AA}"), 100);
				...
				public static PROPERTYKEY Content
					=> new(new Guid("{D0DAB0BA-368A-4050-A882-6C010FD19A4F}"), 100);
				...
				/// </summary>
				public static PROPERTYKEY Description
					=> new(new Guid("{8969B275-9475-4E00-A887-FF93B8B41E44}"), 100);
				...
				public static PROPERTYKEY FileSystem
					=> new(new Guid("{E3A7D2C1-80FC-4B40-8F34-30EA111BDC2E}"), 100);
				...
				public static PROPERTYKEY General
					=> new(new Guid("{CC301630-B192-4C22-B372-9F4C6D338E07}"), 100);
				...
				public static PROPERTYKEY GPS
					=> new(new Guid("{F3713ADA-90E3-4E11-AAE5-FDC17685B9BE}"), 100);
				...
				public static PROPERTYKEY Image
					=> new(new Guid("{E3690A87-0FA8-4A2A-9A9F-FCE8827055AC}"), 100);
				...
				public static PROPERTYKEY Media
					=> new(new Guid("{61872CF7-6B5E-4B4B-AC2D-59DA84459248}"), 100);
				...
				public static PROPERTYKEY MediaAdvanced
					=> new(new Guid("{8859A284-DE7E-4642-99BA-D431D044B1EC}"), 100);
				...
				public static PROPERTYKEY Message
					=> new(new Guid("{7FD7259D-16B4-4135-9F97-7C96ECD2FA9E}"), 100);
				...
				public static PROPERTYKEY Music
					=> new(new Guid("{68DD6094-7216-40F1-A029-43FE7127043F}"), 100);
				...
				public static PROPERTYKEY PhotoAdvanced
					=> new(new Guid("{0CB2BF5A-9EE7-4A86-8222-F01E07FDADAF}"), 100);
				...
				public static PROPERTYKEY RecordedTV
					=> new(new Guid("{E7B33238-6584-4170-A5C0-AC25EFD9DA56}"), 100);
				...
				public static PROPERTYKEY Video
					=> new(new Guid("{BEBE0920-7671-4C54-A3EB-49FDDFC191EE}"), 100);
			}
			...
			public static class PropList
			{
				...
				public static PROPERTYKEY ConflictPrompt
					=> new(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 11);

				/// <summary>
				/// <para>Name:     System.PropList.ContentViewModeForBrowse -- PKEY_PropList_ContentViewModeForBrowse</para>
				/// <para>
				/// Description: The list of properties to show in the content view mode of an item in the context of browsing. Register the
				/// regvalue under the name of "ContentViewModeForBrowse".
				/// </para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {C9944A21-A406-48FE-8225-AEC7E24C211B}, 13</para>
				/// </summary>
				public static PROPERTYKEY ContentViewModeForBrowse
					=> new(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 13);

				/// <summary>
				/// <para>Name:     System.PropList.ContentViewModeForSearch -- PKEY_PropList_ContentViewModeForSearch</para>
				/// <para>
				/// Description: The list of properties to show in the content view mode of an item in the context of searching. Register the
				/// regvalue under the name of "ContentViewModeForSearch".
				/// </para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {C9944A21-A406-48FE-8225-AEC7E24C211B}, 14</para>
				/// </summary>
				public static PROPERTYKEY ContentViewModeForSearch
					=> new(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 14);
				...
				public static PROPERTYKEY ExtendedTileInfo
					=> new(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 9);

				/// <summary>
				/// <para>Name:     System.PropList.FileOperationPrompt -- PKEY_PropList_FileOperationPrompt</para>
				/// <para>
				/// Description: The list of properties to show in the file operation confirmation dialog. Properties with empty values will
				/// not be displayed. If this list is not specified, then the InfoTip property list is used instead. Register under the
				/// regvalue of "FileOperationPrompt".
				/// </para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {C9944A21-A406-48FE-8225-AEC7E24C211B}, 10</para>
				/// </summary>
				public static PROPERTYKEY FileOperationPrompt
					=> new(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 10);

				/// <summary>
				/// <para>Name:     System.PropList.FullDetails -- PKEY_PropList_FullDetails</para>
				/// <para>
				/// Description: The list of all the properties to show in the details page. Property groups can be included in this list in
				/// order to more easily organize the UI. Register under the regvalue of "FullDetails".
				/// </para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {C9944A21-A406-48FE-8225-AEC7E24C211B}, 2</para>
				/// </summary>
				public static PROPERTYKEY FullDetails
					=> new(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 2);
				...
				public static PROPERTYKEY InfoTip
					=> new(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 4);
				...
				/// from a given file, the system will leave these particular properties untouched. Register under the regvalue of "NonPersonal".
				/// </para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {49D1091F-082E-493F-B23F-D2308AA9668C}, 100</para>
				/// </summary>
				public static PROPERTYKEY NonPersonal
					=> new(new Guid("{49D1091F-082E-493F-B23F-D2308AA9668C}"), 100);

				/// <summary>
				/// <para>Name:     System.PropList.PreviewDetails -- PKEY_PropList_PreviewDetails</para>
				/// <para>Description: The list of properties to display in the preview pane. Register under the regvalue of "PreviewDetails".</para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {C9944A21-A406-48FE-8225-AEC7E24C211B}, 8</para>
				/// </summary>
				public static PROPERTYKEY PreviewDetails
					=> new(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 8);
				...
				public static PROPERTYKEY PreviewTitle
					=> new(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 6);
				...
				public static PROPERTYKEY QuickTip
					=> new(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 5);
				...
				public static PROPERTYKEY TileInfo
					=> new(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 3);
			...
			public static class RecordedTV
			{
				...
				public static PROPERTYKEY ChannelNumber
					=> new(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 7);
				...
				public static PROPERTYKEY Credits
					=> new(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 4);
				...
				public static PROPERTYKEY DateContentExpires
					=> new(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 15);
				...
				public static PROPERTYKEY EpisodeName
					=> new(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 2);
				...
				public static PROPERTYKEY IsATSCContent
					=> new(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 16);
				...
				public static PROPERTYKEY IsClosedCaptioningAvailable
					=> new(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 12);
				...
				public static PROPERTYKEY IsDTVContent
					=> new(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 17);
				...
				public static PROPERTYKEY IsHDContent
					=> new(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 18);
				...
				public static PROPERTYKEY IsRepeatBroadcast
					=> new(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 13);
				...
				public static PROPERTYKEY IsSAP
					=> new(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 14);
				...
				public static PROPERTYKEY NetworkAffiliation
					=> new(new Guid("{2C53C813-FB63-4E22-A1AB-0B331CA1E273}"), 100);
				...
				public static PROPERTYKEY OriginalBroadcastDate
					=> new(new Guid("{4684FE97-8765-4842-9C13-F006447B178C}"), 100);
				...
				public static PROPERTYKEY ProgramDescription
					=> new(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 3);
				...
				public static PROPERTYKEY RecordingTime
					=> new(new Guid("{A5477F61-7A82-4ECA-9DDE-98B69B2479B3}"), 100);
				...
				public static PROPERTYKEY StationName
					=> new(new Guid("{1B5439E7-EBA1-4AF8-BDD7-7AF1D4549493}"), 100);
			}
			...
			public static class Search
			{
				...
				public static PROPERTYKEY AutoSummary
					=> new(new Guid("{560C36C0-503A-11CF-BAA1-00004C752A9A}"), 2);
				...
				public static PROPERTYKEY ContainerHash
					=> new(new Guid("{BCEEE283-35DF-4D53-826A-F36A3EEFC6BE}"), 100);

				/// <summary>
				/// <para>Name:     System.Search.Contents -- PKEY_Search_Contents</para>
				/// <para>
				/// Description: The contents of the item. This property is for query restrictions only; it cannot be retrieved in a query
				/// result. The Indexing Service friendly name is 'contents'.
				/// </para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				...
				/// <para>
				/// Description: The entry ID for an item within a given catalog in the Windows Search Index. This value may be recycled, and
				/// therefore is not considered unique over time.
				/// </para>
				/// <para>Type:     Int32 -- VT_I4</para>
				...
				public static PROPERTYKEY ExtendedProperties
					=> new(new Guid("{7B03B546-FA4F-4A52-A2FE-03D5311E5865}"), 100);

				/// <summary>
				/// <para>Name:     System.Search.GatherTime -- PKEY_Search_GatherTime</para>
				/// <para>
				/// Description: The Datetime that the Windows Search Gatherer process last pushed properties of this document to the Windows
				...
				public static PROPERTYKEY GatherTime
					=> new(new Guid("{0B63E350-9CCC-11D0-BCDB-00805FCCCE04}"), 8);

				/// <summary>
				/// <para>Name:     System.Search.HitCount -- PKEY_Search_HitCount</para>
				/// <para>
				/// Description: When using CONTAINS over the Windows Search Index, this is the number of matches of the term. If there are
				/// multiple CONTAINS, an AND computes the min number of hits and an OR the max number of hits.
				/// </para>
				/// <para>Type:     Int32 -- VT_I4</para>
				...
				/// applies to all of it's children, and if this URL is deleted then all of it's children are deleted as well. For example,
				/// this would be emitted as TRUE when emitting the URL of an email so that all attachments are tied to the last modified
				/// time of that email.
				/// </para>
				/// <para>Type:     Boolean -- VT_BOOL</para>
				...
				public static PROPERTYKEY IsClosedDirectory
					=> new(new Guid("{0B63E343-9CCC-11D0-BCDB-00805FCCCE04}"), 23);
				...
				public static PROPERTYKEY IsFullyContained
					=> new(new Guid("{0B63E343-9CCC-11D0-BCDB-00805FCCCE04}"), 24);
				...
				public static PROPERTYKEY QueryFocusedSummary
					=> new(new Guid("{560C36C0-503A-11CF-BAA1-00004C752A9A}"), 3);
				...
				public static PROPERTYKEY QueryFocusedSummaryWithFallback
					=> new(new Guid("{560C36C0-503A-11CF-BAA1-00004C752A9A}"), 4);
				...
				/// </summary>
				public static PROPERTYKEY Store
					=> new(new Guid("{A06992B3-8CAF-4ED7-A547-B259E32AC9FC}"), 100);

				/// <summary>
				/// <para>Name:     System.Search.UrlToIndex -- PKEY_Search_UrlToIndex</para>
				/// <para>
				/// Description: This property should be emitted by a container IFilter for each child URL within the container. The children
				/// will eventually be crawled by the indexer if they are within scope.
				/// </para>
				/// <para>Type:     String -- VT_LPWSTR (For variants: VT_BSTR)</para>
				/// <para>FormatID: {0B63E343-9CCC-11D0-BCDB-00805FCCCE04}, 2</para>
				/// </summary>
				public static PROPERTYKEY UrlToIndex
					=> new(new Guid("{0B63E343-9CCC-11D0-BCDB-00805FCCCE04}"), 2);
				...
				/// modified. This is an optimization for the indexer as it doesn't have to call back into the protocol handler to ask for
				/// this information to determine if the content needs to be indexed again. The property is a vector with two elements, a
				/// VT_LPWSTR with the URL and a VT_FILETIME for the last modified time.
				/// </para>
				...
				public static PROPERTYKEY UrlToIndexWithModificationTime
					=> new(new Guid("{0B63E343-9CCC-11D0-BCDB-00805FCCCE04}"), 12);
			}
			...
			public static class Shell
			{
				...
				public static PROPERTYKEY OmitFromView
					=> new(new Guid("{DE35258C-C695-4CBC-B982-38B0AD24CED0}"), 2);
				...
				public static PROPERTYKEY SFGAOFlagsStrings
					=> new(new Guid("{D6942081-D53B-443D-AD47-5E059D9CD27A}"), 2);
			}
			...
			public static class Software
			{
				...
				public static PROPERTYKEY DateLastUsed
					=> new(new Guid("{841E4F90-FF59-4D16-8947-E81BBFFAB36D}"), 16);
				...
				public static PROPERTYKEY ProductName
					=> new(new Guid("{0CEF7D53-FA64-11D1-A203-0000F81FEDEE}"), 7);
			}
			...
			public static class Sync
			{
				...
				public static PROPERTYKEY Comments
					=> new(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 13);
				...
				public static PROPERTYKEY ConflictDescription
					=> new(new Guid("{CE50C159-2FB8-41FD-BE68-D3E042E274BC}"), 4);
				...
				public static PROPERTYKEY ConflictFirstLocation
					=> new(new Guid("{CE50C159-2FB8-41FD-BE68-D3E042E274BC}"), 6);
				...
				public static PROPERTYKEY ConflictSecondLocation
					=> new(new Guid("{CE50C159-2FB8-41FD-BE68-D3E042E274BC}"), 7);
				...
				public static PROPERTYKEY HandlerCollectionID
					=> new(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 2);
				...
				public static PROPERTYKEY HandlerID
					=> new(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 3);
				...
				public static PROPERTYKEY HandlerName
					=> new(new Guid("{CE50C159-2FB8-41FD-BE68-D3E042E274BC}"), 2);
				...
				public static PROPERTYKEY HandlerType
					=> new(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 8);
				...
				public static PROPERTYKEY HandlerTypeLabel
					=> new(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 9);
				...
				public static PROPERTYKEY ItemID
					=> new(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 6);
				...
				/// </summary>
				public static PROPERTYKEY ItemName
					=> new(new Guid("{CE50C159-2FB8-41FD-BE68-D3E042E274BC}"), 3);
				...
				public static PROPERTYKEY ProgressPercentage
					=> new(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 23);
				...
				public static PROPERTYKEY State
					=> new(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 24);
				...
				/// </summary>
				public static PROPERTYKEY Status
					=> new(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 10);
			}
			...
			public static class Task
			{
				...
				public static PROPERTYKEY BillingInformation
					=> new(new Guid("{D37D52C6-261C-4303-82B3-08B926AC6F12}"), 100);
				...
				public static PROPERTYKEY CompletionStatus
					=> new(new Guid("{084D8A0A-E6D5-40DE-BF1F-C8820E7C877C}"), 100);
				...
				public static PROPERTYKEY Owner
					=> new(new Guid("{08C7CC5F-60F2-4494-AD75-55E3E0B5ADD0}"), 100);
			}
			...
			public static class Video
			{
				...
				public static PROPERTYKEY Director
					=> new(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 20);
				...
				/// <para>Description: Indicates the horizontal portion of the aspect ratio. The X portion of XX:YY, like 16:9.</para>
				/// <para>Type:     UInt32 -- VT_UI4</para>
				...
				/// <para>Description: Indicates the vertical portion of the aspect ratio. The Y portion of XX:YY, like 16:9.</para>
				/// <para>Type:     UInt32 -- VT_UI4</para>
			...
			public static class Volume
			{
				...
				public static PROPERTYKEY IsMappedDrive
					=> new(new Guid("{149C0B69-2C2D-48FC-808F-D318D78C4636}"), 2);
