...
public static partial class UserEnv
{
	...
	// pszUserSid, LPCWSTR pszUserName, PWSTR pszProfilePath, DWORD cchProfilePath );
	[DllImport(Lib.Userenv, SetLastError = false, ExactSpelling = true)]
	...
	// ExpandEnvironmentStringsForUserA( HANDLE hToken, LPCSTR lpSrc, PSTR lpDest, DWORD dwSize );
	[DllImport(Lib.Userenv, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// GetAllUsersProfileDirectoryA( PSTR lpProfileDir, LPDWORD lpcchSize );
	[DllImport(Lib.Userenv, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// GetDefaultUserProfileDirectoryA( PSTR lpProfileDir, LPDWORD lpcchSize );
	[DllImport(Lib.Userenv, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// GetProfilesDirectoryA( PSTR lpProfileDir, LPDWORD lpcchSize );
	[DllImport(Lib.Userenv, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// GetUserProfileDirectoryA( HANDLE hToken, PSTR lpProfileDir, LPDWORD lpcchSize );
	[DllImport(Lib.Userenv, SetLastError = true, CharSet = CharSet.Auto)]
	...
	*
	...
	// PWSTR pszFileName, PRSOPTOKEN pRsopToken, DWORD dwDesiredAccessMask, LPDWORD pdwGrantedAccessMask, LPBOOL pbAccessStatus );
	[DllImport(Lib.Userenv, SetLastError = false, ExactSpelling = true)]
	...
	*/
	...
	// DWORD dwOptions; DWORD dwVersion; PSTR lpDSPath; PSTR lpFileSysPath; PSTR lpDisplayName; CHAR szGPOName[50]; GPO_LINK GPOLink;
	// LPARAM lParam; struct _GROUP_POLICY_OBJECTA *pNext; struct _GROUP_POLICY_OBJECTA *pPrev; PSTR lpExtensions; LPARAM lParam2;
	// PSTR lpLink; } GROUP_POLICY_OBJECTA, *PGROUP_POLICY_OBJECTA;
	[PInvokeData("userenv.h", MSDNShortId = "7275a3cd-6b19-4eb9-9481-b73bd5af5753")]
	...
	// DWORD dwFlags; MIDL_STRING PSTR lpUserName; MIDL_STRING PSTR lpProfilePath; MIDL_STRING PSTR lpDefaultPath; MIDL_STRING PSTR
	// lpServerName; MIDL_STRING PSTR lpPolicyPath; #if ... ULONG_PTR hProfile; #else HANDLE hProfile; #endif } PROFILEINFOA, *LPPROFILEINFOA;
	[PInvokeData("profinfo.h", MSDNShortId = "09dae38c-3b2b-4f12-9c1e-90737cf0c7cc")]
	[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
