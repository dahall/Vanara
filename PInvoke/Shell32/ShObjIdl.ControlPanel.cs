...
namespace Vanara.PInvoke
{
	public static partial class Shell32
	{
		...
		/// <summary>
		/// Exposes methods that retrieve the view state of the Control Panel, the path of individual Control Panel items, and that open either the Control Panel
		/// itself or an individual Control Panel item.
		/// </summary>
		...
		public interface IOpenControlPanel
		{
			...
			/// <param name="pszName">A pointer to the item's canonical name as a Unicode string. This parameter is optional and can be NULL. If the calling application passes NULL, then the Control Panel itself opens. For a complete list of Control Panel item canonical names, see Canonical Names of Control Panel Items.</param>
			/// <param name="page">A pointer to the name of the page within the item to display. This string is appended to the end of the path for Shell folder Control Panel items or appended as a command-line parameter for Control Panel (.cpl) file items. This parameter can be NULL, in which case the first page is shown.</param>
			/// <param name="punkSite">A pointer to the site for navigating in-frame for Shell folder Control Panel items. This parameter can be NULL.</param>
			...
			/// <param name="pszName">A pointer to the item's canonical name or its GUID. This value can be NULL. See Remarks for further details. For a complete list of Control Panel item canonical names, see Canonical Names of Control Panel Items.</param>
