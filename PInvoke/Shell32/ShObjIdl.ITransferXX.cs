...
public static partial class Shell32
{
	...
	public interface ITransferAdviseSink
	{
		...
		// FileFailure( IShellItem *psi, LPCWSTR pszItem, HRESULT hrError, StrPtrUni pszRename, ULONG cchRename );
		[PreserveSig]
	...
	public interface ITransferSource
	{
		...
		// HRESULT GetDefaultDestinationName( IShellItem *psiSource, IShellItem *psiParentDest, StrPtrUni *ppszDestinationName );
		[PreserveSig]
