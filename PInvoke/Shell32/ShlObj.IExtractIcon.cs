...
namespace Vanara.PInvoke
{
	public static partial class Shell32
	{
		...
		/// <summary>
		/// Flags returned by <see cref="IExtractIcon.GetIconLocation(GetIconLocationFlags, StringBuilder, int, out int, out GetIconLocationResultFlags)"/>.
		/// </summary>
		[Flags]
		...
		public interface IExtractIcon
		{
			...
			/// A pointer to a buffer that receives the icon location. The icon location is a null-terminated string that identifies the file
