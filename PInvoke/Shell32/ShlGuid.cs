...
public static partial class Shell32
{
	...
	public static readonly Guid CLSID_ACLCustomMRU = new(0x6935db93, 0x21e8, 0x4ccc, 0xbe, 0xb9, 0x9f, 0xe3, 0xc7, 0x7a, 0x29, 0x7a);

	/// <summary>CLSID_ACLHistory</summary>
	public static readonly Guid CLSID_ACLHistory = new(0x00BB2764, 0x6A77, 0x11D0, 0xA5, 0x35, 0x00, 0xC0, 0x4F, 0xD7, 0xD0, 0x62);

	/// <summary>CLSID_ACListISF</summary>
	public static readonly Guid CLSID_ACListISF = new(0x03C036F1, 0xA186, 0x11D0, 0x82, 0x4A, 0x00, 0xAA, 0x00, 0x5B, 0x43, 0x83);

	/// <summary>CLSID_ACLMRU</summary>
	public static readonly Guid CLSID_ACLMRU = new(0x6756a641, 0xde71, 0x11d0, 0x83, 0x1b, 0x0, 0xaa, 0x0, 0x5b, 0x43, 0x83);

	/// <summary>CLSID_ACLMulti</summary>
	public static readonly Guid CLSID_ACLMulti = new(0x00BB2765, 0x6A77, 0x11D0, 0xA5, 0x35, 0x00, 0xC0, 0x4F, 0xD7, 0xD0, 0x62);

	/// <summary>CLSID_AutoComplete</summary>
	public static readonly Guid CLSID_AutoComplete = new(0x00BB2763, 0x6A77, 0x11D0, 0xA5, 0x35, 0x00, 0xC0, 0x4F, 0xD7, 0xD0, 0x62);

	/// <summary>CLSID_CAnchorBrowsePropertyPage</summary>
	public static readonly Guid CLSID_CAnchorBrowsePropertyPage = new(0x3050f3BB, 0x98b5, 0x11cf, 0xbb, 0x82, 0x00, 0xaa, 0x00, 0xbd, 0xce, 0x0b);

	/// <summary>CLSID_CDocBrowsePropertyPage</summary>
	public static readonly Guid CLSID_CDocBrowsePropertyPage = new(0x3050f3B4, 0x98b5, 0x11cf, 0xbb, 0x82, 0x00, 0xaa, 0x00, 0xbd, 0xce, 0x0b);

	/// <summary>CLSID_CFSIconOverlayManager</summary>
	public static readonly Guid CLSID_CFSIconOverlayManager = new(0x63B51F81, 0xC868, 0x11D0, 0x99, 0x9C, 0x00, 0xC0, 0x4F, 0xD6, 0x55, 0xE1);

	/// <summary>CLSID_CImageBrowsePropertyPage</summary>
	public static readonly Guid CLSID_CImageBrowsePropertyPage = new(0x3050f3B3, 0x98b5, 0x11cf, 0xbb, 0x82, 0x00, 0xaa, 0x00, 0xbd, 0xce, 0x0b);

	/// <summary>CLSID_ControlPanel</summary>
	public static readonly Guid CLSID_ControlPanel = new(0x21EC2020, 0x3AEA, 0x1069, 0xA2, 0xDD, 0x08, 0x00, 0x2B, 0x30, 0x30, 0x9D);

	/// <summary>CLSID_CUrlHistory</summary>
	public static readonly Guid CLSID_CUrlHistory = new(0x3C374A40, 0xBAE4, 0x11CF, 0xBF, 0x7D, 0x00, 0xAA, 0x00, 0x69, 0x46, 0xEE);

	/// <summary>CLSID_CURLSearchHook</summary>
	public static readonly Guid CLSID_CURLSearchHook = new(0xCFBFAE00, 0x17A6, 0x11D0, 0x99, 0xCB, 0x00, 0xC0, 0x4F, 0xD6, 0x44, 0x97);

	/// <summary>CLSID_DarwinAppPublisher</summary>
	public static readonly Guid CLSID_DarwinAppPublisher = new(0xCFCCC7A0, 0xA282, 0x11D1, 0x90, 0x82, 0x00, 0x60, 0x08, 0x05, 0x93, 0x82);

	/// <summary>CLSID_DocHostUIHandler</summary>
	public static readonly Guid CLSID_DocHostUIHandler = new(0x7057e952, 0xbd1b, 0x11d1, 0x89, 0x19, 0x0, 0xc0, 0x4f, 0xc2, 0xc8, 0x36);

	/// <summary>CLSID_DragDropHelper</summary>
	public static readonly Guid CLSID_DragDropHelper = new(0x4657278a, 0x411b, 0x11d2, 0x83, 0x9a, 0x0, 0xc0, 0x4f, 0xd9, 0x18, 0xd0);

	/// <summary>CLSID_FileTypes</summary>
	public static readonly Guid CLSID_FileTypes = new(0xB091E540, 0x83E3, 0x11CF, 0xA7, 0x13, 0x00, 0x20, 0xAF, 0xD7, 0x97, 0x62);

	/// <summary>CLSID_FolderItem</summary>
	public static readonly Guid CLSID_FolderItem = new(0xfef10fa2, 0x355e, 0x4e06, 0x93, 0x81, 0x9b, 0x24, 0xd7, 0xf7, 0xcc, 0x88);

	/// <summary>CLSID_FolderItemsMultiLevel</summary>
	public static readonly Guid CLSID_FolderItemsMultiLevel = new(0x53c74826, 0xab99, 0x4d33, 0xac, 0xa4, 0x31, 0x17, 0xf5, 0x1d, 0x37, 0x88);

	/// <summary>CLSID_FolderShortcut</summary>
	public static readonly Guid CLSID_FolderShortcut = new(0x0AFACED1, 0xE828, 0x11D1, 0x91, 0x87, 0xB5, 0x32, 0xF1, 0xE9, 0x57, 0x5D);

	/// <summary>CLSID_HWShellExecute</summary>
	public static readonly Guid CLSID_HWShellExecute = new(0xffb8655f, 0x81b9, 0x4fce, 0xb8, 0x9c, 0x9a, 0x6b, 0xa7, 0x6d, 0x13, 0xe7);

	/// <summary>CLSID_Internet</summary>
	public static readonly Guid CLSID_Internet = new(0x871C5380, 0x42A0, 0x1069, 0xA2, 0xEA, 0x08, 0x00, 0x2B, 0x30, 0x30, 0x9D);

	/// <summary>CLSID_InternetButtons</summary>
	public static readonly Guid CLSID_InternetButtons = new(0x1E796980, 0x9CC5, 0x11D1, 0xA8, 0x3F, 0x00, 0xC0, 0x4F, 0xC9, 0x9D, 0x61);

	/// <summary>CLSID_ISFBand</summary>
	public static readonly Guid CLSID_ISFBand = new(0xD82BE2B0, 0x5764, 0x11D0, 0xA9, 0x6E, 0x00, 0xC0, 0x4F, 0xD7, 0x05, 0xA2);

	/// <summary>CLSID_LinkColumnProvider</summary>
	public static readonly Guid CLSID_LinkColumnProvider = new(0x24f14f02, 0x7b1c, 0x11d1, 0x83, 0x8f, 0x0, 0x0, 0xf8, 0x4, 0x61, 0xcf);

	/// <summary>CLSID_MenuBand</summary>
	public static readonly Guid CLSID_MenuBand = new(0x5b4dae26, 0xb807, 0x11d0, 0x98, 0x15, 0x0, 0xc0, 0x4f, 0xd9, 0x19, 0x72);

	/// <summary>CLSID_MenuBandSite</summary>
	public static readonly Guid CLSID_MenuBandSite = new(0xe13ef4e4, 0xd2f2, 0x11d0, 0x98, 0x16, 0x0, 0xc0, 0x4f, 0xd9, 0x19, 0x72);

	/// <summary>CLSID_MenuToolbarBase</summary>
	public static readonly Guid CLSID_MenuToolbarBase = new(0x40b96610, 0xb522, 0x11d1, 0xb3, 0xb4, 0x0, 0xaa, 0x0, 0x6e, 0xfd, 0xe7);

	/// <summary>CLSID_MSOButtons</summary>
	public static readonly Guid CLSID_MSOButtons = new(0x178f34b8, 0xa282, 0x11d2, 0x86, 0xc5, 0x0, 0xc0, 0x4f, 0x8e, 0xea, 0x99);

	/// <summary>CLSID_MyComputer</summary>
	public static readonly Guid CLSID_MyComputer = new(0x20D04FE0, 0x3AEA, 0x1069, 0xA2, 0xD8, 0x08, 0x00, 0x2B, 0x30, 0x30, 0x9D);

	/// <summary>CLSID_MyDocuments</summary>
	public static readonly Guid CLSID_MyDocuments = new(0x450d8fba, 0xad25, 0x11d0, 0x98, 0xa8, 0x08, 0x00, 0x36, 0x1b, 0x11, 0x03);

	/// <summary>CLSID_NetworkDomain</summary>
	public static readonly Guid CLSID_NetworkDomain = new(0x46e06680, 0x4bf0, 0x11d1, 0x83, 0xee, 0x00, 0xa0, 0xc9, 0x0d, 0xc8, 0x49);

	/// <summary>CLSID_NetworkServer</summary>
	public static readonly Guid CLSID_NetworkServer = new(0xc0542a90, 0x4bf0, 0x11d1, 0x83, 0xee, 0x00, 0xa0, 0xc9, 0x0d, 0xc8, 0x49);

	/// <summary>CLSID_NetworkShare</summary>
	public static readonly Guid CLSID_NetworkShare = new(0x54a754c0, 0x4bf0, 0x11d1, 0x83, 0xee, 0x00, 0xa0, 0xc9, 0x0d, 0xc8, 0x49);

	/// <summary>CLSID_NewMenu</summary>
	public static readonly Guid CLSID_NewMenu = new(0xd969a300, 0xe7ff, 0x11d0, 0xa9, 0x3b, 0x0, 0xa0, 0xc9, 0xf, 0x27, 0x19);

	/// <summary>CLSID_Printers</summary>
	public static readonly Guid CLSID_Printers = new(0x2227A280, 0x3AEA, 0x1069, 0xA2, 0xDE, 0x08, 0x00, 0x2B, 0x30, 0x30, 0x9D);

	/// <summary>CLSID_ProgressDialog</summary>
	public static readonly Guid CLSID_ProgressDialog = new(0xf8383852, 0xfcd3, 0x11d1, 0xa6, 0xb9, 0x0, 0x60, 0x97, 0xdf, 0x5b, 0xd4);

	/// <summary>CLSID_QueryAssociations</summary>
	public static readonly Guid CLSID_QueryAssociations = new(0xa07034fd, 0x6caa, 0x4954, 0xac, 0x3f, 0x97, 0xa2, 0x72, 0x16, 0xf9, 0x8a);

	/// <summary>CLSID_QuickLinks</summary>
	public static readonly Guid CLSID_QuickLinks = new(0xe5cbf21, 0xd15f, 0x11d0, 0x83, 0x1, 0x0, 0xaa, 0x0, 0x5b, 0x43, 0x83);

	/// <summary>CLSID_RecycleBin</summary>
	public static readonly Guid CLSID_RecycleBin = new(0x645FF040, 0x5081, 0x101B, 0x9F, 0x08, 0x00, 0xAA, 0x00, 0x2F, 0x95, 0x4E);

	/// <summary>CLSID_ShellFldSetExt</summary>
	public static readonly Guid CLSID_ShellFldSetExt = new(0x6D5313C0, 0x8C62, 0x11D1, 0xB2, 0xCD, 0x00, 0x60, 0x97, 0xDF, 0x8C, 0x11);

	/// <summary>CLSID_ShellThumbnailDiskCache</summary>
	public static readonly Guid CLSID_ShellThumbnailDiskCache = new(0x1ebdcf80, 0xa200, 0x11d0, 0xa3, 0xa4, 0x0, 0xc0, 0x4f, 0xd7, 0x6, 0xec);

	/// <summary>CLSID_ToolbarExtButtons</summary>
	public static readonly Guid CLSID_ToolbarExtButtons = new(0x2ce4b5d8, 0xa28f, 0x11d2, 0x86, 0xc5, 0x0, 0xc0, 0x4f, 0x8e, 0xea, 0x99);

	/// <summary>Service ID to find common dialog browser.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SCommDlgBrowser = new(0x80f30233, 0xb7df, 0x11d2, 0xa3, 0x3b, 0x0, 0x60, 0x97, 0xdf, 0x5b, 0xd4);

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SGetViewFromViewDual = new(0x889A935D, 0x971E, 0x4B12, 0xB9, 0x0C, 0x24, 0xDF, 0xC9, 0xE1, 0xE5, 0xE8);
	...
	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SInPlaceBrowser = new(0x1D2AE02B, 0x3655, 0x46CC, 0xB6, 0x3A, 0x28, 0x59, 0x88, 0x15, 0x3B, 0xCA);

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SInternetExplorer = new("0002DF05-0000-0000-C000-000000000046");

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SMenuBandBKContextMenu = new(0x164bbd86, 0x1d0d, 0x4de0, 0x9a, 0x3b, 0xd9, 0x72, 0x96, 0x47, 0xc2, 0xb8);

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SMenuBandBottom = new(0x743ca664, 0xdeb, 0x11d1, 0x98, 0x25, 0x0, 0xc0, 0x4f, 0xd9, 0x19, 0x72);

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SMenuBandBottomSelected = new(0x165ebaf4, 0x6d51, 0x11d2, 0x83, 0xad, 0x0, 0xc0, 0x4f, 0xd9, 0x18, 0xd0);

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SMenuBandChild = new(0xed9cc020, 0x8b9, 0x11d1, 0x98, 0x23, 0x0, 0xc0, 0x4f, 0xd9, 0x19, 0x72);

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SMenuBandContextMenuModifier = new(0x39545874, 0x7162, 0x465e, 0xb7, 0x83, 0x2a, 0xa1, 0x87, 0x4f, 0xef, 0x81);

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SMenuBandParent = new(0x8c278eec, 0x3eab, 0x11d1, 0x8c, 0xb0, 0x0, 0xc0, 0x4f, 0xd9, 0x18, 0xd0);

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SMenuBandTop = new(0x9493a810, 0xec38, 0x11d0, 0xbc, 0x46, 0x0, 0xaa, 0x0, 0x6c, 0xe2, 0xf5);

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SMenuPopup = new(0xD1E7AFEB, 0x6A2E, 0x11d0, 0x8C, 0x78, 0x0, 0xC0, 0x4F, 0xD9, 0x18, 0xB4);

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SProgressUI = new(0xf8383852, 0xfcd3, 0x11d1, 0xa6, 0xb9, 0x0, 0x60, 0x97, 0xdf, 0x5b, 0xd4);

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SSearchBoxInfo = new(0x142daa61, 0x516b, 0x4713, 0xb4, 0x9c, 0xfb, 0x98, 0x5e, 0xf8, 0x29, 0x98);
	...
	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SShellDesktop = new("00021400-0000-0000-C000-000000000046");

	/// <summary>Service ID to find top-level browser.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_STopLevelBrowser = new(0x4C96BE40, 0x915C, 0x11CF, 0x99, 0xD3, 0x00, 0xAA, 0x00, 0x4A, 0xE8, 0x37);

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_STopWindow = new(0x49e1b500, 0x4636, 0x11d3, 0x97, 0xf7, 0x0, 0xc0, 0x4f, 0x45, 0xd0, 0xb3);

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SUrlHistory = new(0x3C374A40, 0xBAE4, 0x11CF, 0xBF, 0x7D, 0x00, 0xAA, 0x00, 0x69, 0x46, 0xEE);

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SWebBrowserApp = new("0002DF05-0000-0000-C000-000000000046");

	/// <summary>Undocumented.</summary>
	[PInvokeData("shlguid.h")]
	public static readonly Guid SID_SWebBrowserEventsService = new("54A8F188-9EBD-4795-AD16-9B4945119636");
