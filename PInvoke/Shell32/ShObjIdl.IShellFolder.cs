...
public static partial class Shell32
{
	...
	public interface IShellFolder
	{
		...
		[PreserveSig]
		HRESULT ParseDisplayName([In, Optional] HWND hwnd, [In, Optional] IBindCtx? pbc, [MarshalAs(UnmanagedType.LPWStr)] string pszDisplayName, out uint pchEaten, out PIDL ppidl, [In, Out, Optional, StructPointer(typeof(SFGAO))] IntPtr pdwAttributes);
	...
	public interface IShellFolder2 : IShellFolder
	{
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/shobjidl_core/nf-shobjidl_core-ishellfolder-parsedisplayname
		[PreserveSig]
		new HRESULT ParseDisplayName([In, Optional] HWND hwnd, [In, Optional] IBindCtx? pbc, [MarshalAs(UnmanagedType.LPWStr)] string pszDisplayName, out uint pchEaten, out PIDL ppidl, [In, Out, Optional, StructPointer(typeof(SFGAO))] IntPtr pdwAttributes);
