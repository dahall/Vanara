...
public static partial class NetApi32
{
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/desktop/api/lmdfs/nf-lmdfs-netdfsadd NET_API_STATUS NET_API_FUNCTION NetDfsAdd( StrPtrUni
	// DfsEntryPath, StrPtrUni ServerName, StrPtrUni ShareName, StrPtrUni Comment, DWORD Flags );
	...
	// NetDfsAddFtRoot( StrPtrUni ServerName, StrPtrUni RootShare, StrPtrUni FtDfsName, StrPtrUni Comment, DWORD Flags );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	...
	// NetDfsAddRootTarget( StrPtrUni pDfsPath, StrPtrUni pTargetPath, ULONG MajorVersion, StrPtrUni pComment, ULONG Flags );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	...
	// NetDfsAddStdRoot( StrPtrUni ServerName, StrPtrUni RootShare, StrPtrUni Comment, DWORD Flags );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	...
	// NET_API_STATUS NetDfsAddStdRootForced( _In_ StrPtrUni ServerName, _In_ StrPtrUni RootShare, _In_opt_ StrPtrUni Comment, _In_ StrPtrUni Store );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/desktop/api/lmdfs/nf-lmdfs-netdfsenum NET_API_STATUS NET_API_FUNCTION NetDfsEnum( StrPtrUni
	...
	// NetDfsGetClientInfo( StrPtrUni DfsEntryPath, StrPtrUni ServerName, StrPtrUni ShareName, DWORD Level, LPBYTE *Buffer );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	...
	// NetDfsGetFtContainerSecurity( StrPtrUni DomainName, SECURITY_INFORMATION SecurityInformation, PSECURITY_DESCRIPTOR
	...
	// StrPtrUni DfsEntryPath, StrPtrUni ServerName, StrPtrUni ShareName, DWORD Level, LPBYTE *Buffer );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	...
	// NetDfsGetSecurity( StrPtrUni DfsEntryPath, SECURITY_INFORMATION SecurityInformation, PSECURITY_DESCRIPTOR *ppSecurityDescriptor,
	...
	// NetDfsGetStdContainerSecurity( StrPtrUni MachineName, SECURITY_INFORMATION SecurityInformation, PSECURITY_DESCRIPTOR
	// *ppSecurityDescriptor, LPDWORD lpcbSecurityDescriptor );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	...
	// NET_API_FUNCTION NetDfsGetSupportedNamespaceVersion( DFS_NAMESPACE_VERSION_ORIGIN Origin, StrPtrUni pName,
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/desktop/api/lmdfs/nf-lmdfs-netdfsmove NET_API_STATUS NET_API_FUNCTION NetDfsMove( StrPtrUni
	// OldDfsEntryPath, StrPtrUni NewDfsEntryPath, ULONG Flags );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	[PInvokeData("lmdfs.h", MSDNShortId = "d9d225ac-26b9-4074-93b6-6294538a3504")]
	...
	// StrPtrUni DfsEntryPath, StrPtrUni ServerName, StrPtrUni ShareName );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	...
	// NetDfsRemoveFtRoot( StrPtrUni ServerName, StrPtrUni RootShare, StrPtrUni FtDfsName, DWORD Flags );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	...
	// NetDfsRemoveFtRootForced( StrPtrUni DomainName, StrPtrUni ServerName, StrPtrUni RootShare, StrPtrUni FtDfsName, DWORD Flags );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	...
	// NetDfsRemoveRootTarget( StrPtrUni pDfsPath, StrPtrUni pTargetPath, ULONG Flags );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	[PInvokeData("lmdfs.h", MSDNShortId = "9a8c78f4-3170-4568-940c-1c51aebad3ae")]
	...
	// NetDfsRemoveStdRoot( StrPtrUni ServerName, StrPtrUni RootShare, DWORD Flags );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	...
	// NetDfsSetClientInfo( StrPtrUni DfsEntryPath, StrPtrUni ServerName, StrPtrUni ShareName, DWORD Level, LPBYTE Buffer );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	...
	// NetDfsSetFtContainerSecurity( StrPtrUni DomainName, SECURITY_INFORMATION SecurityInformation, PSECURITY_DESCRIPTOR
	// pSecurityDescriptor );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	...
	// NetDfsSetSecurity( StrPtrUni DfsEntryPath, SECURITY_INFORMATION SecurityInformation, PSECURITY_DESCRIPTOR pSecurityDescriptor );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	...
	// NetDfsSetStdContainerSecurity( StrPtrUni MachineName, SECURITY_INFORMATION SecurityInformation, PSECURITY_DESCRIPTOR
	// pSecurityDescriptor );
	[DllImport(Lib.NetApi32, SetLastError = false, ExactSpelling = true, CharSet = CharSet.Unicode)]
	...
	// https://docs.microsoft.com/en-us/windows/desktop/api/lmdfs/ns-lmdfs-_dfs_info_1 typedef struct _DFS_INFO_1 { StrPtrUni EntryPath; }
	...
	// https://docs.microsoft.com/en-us/windows/desktop/api/lmdfs/ns-lmdfs-_dfs_info_100 typedef struct _DFS_INFO_100 { StrPtrUni Comment; }
	...
	/// </summary>
	// https://docs.microsoft.com/en-us/windows/desktop/api/lmdfs/ns-lmdfs-_dfs_info_105 typedef struct _DFS_INFO_105 { StrPtrUni Comment;
	...
	/// </summary>
	// https://docs.microsoft.com/en-us/windows/desktop/api/lmdfs/ns-lmdfs-_dfs_info_107 typedef struct _DFS_INFO_107 { StrPtrUni Comment;
	...
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/desktop/api/lmdfs/ns-lmdfs-_dfs_info_2 typedef struct _DFS_INFO_2 { StrPtrUni EntryPath;
	// StrPtrUni Comment; DWORD State; DWORD NumberOfStorages; } DFS_INFO_2, *PDFS_INFO_2, *LPDFS_INFO_2;
	[PInvokeData("lmdfs.h", MSDNShortId = "c5fe27be-fd6e-4cf0-abf6-8363c78edf5b")]
	[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
	...
	// https://docs.microsoft.com/en-us/windows/desktop/api/lmdfs/ns-lmdfs-_dfs_info_200 typedef struct _DFS_INFO_200 { StrPtrUni FtDfsName;
	...
	// https://docs.microsoft.com/en-us/windows/desktop/api/lmdfs/ns-lmdfs-_dfs_info_3 typedef struct _DFS_INFO_3 { StrPtrUni EntryPath;
	// StrPtrUni Comment; DWORD State; DWORD NumberOfStorages; #if ... LPDFS_STORAGE_INFO Storage; #else LPDFS_STORAGE_INFO Storage; #endif
	...
	// StrPtrUni DfsName; } DFS_INFO_300, *PDFS_INFO_300, *LPDFS_INFO_300;
	...
	// https://docs.microsoft.com/en-us/windows/desktop/api/lmdfs/ns-lmdfs-_dfs_info_4 typedef struct _DFS_INFO_4 { StrPtrUni EntryPath;
	// StrPtrUni Comment; DWORD State; ULONG Timeout; GUID Guid; DWORD NumberOfStorages; #if ... LPDFS_STORAGE_INFO Storage; #else
	...
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/desktop/api/lmdfs/ns-lmdfs-_dfs_info_5 typedef struct _DFS_INFO_5 { StrPtrUni EntryPath;
	// StrPtrUni Comment; DWORD State; ULONG Timeout; GUID Guid; ULONG PropertyFlags; ULONG MetadataSize; DWORD NumberOfStorages; }
	...
	// https://docs.microsoft.com/en-us/windows/desktop/api/lmdfs/ns-lmdfs-_dfs_info_6 typedef struct _DFS_INFO_6 { StrPtrUni EntryPath;
	// StrPtrUni Comment; DWORD State; ULONG Timeout; GUID Guid; ULONG PropertyFlags; ULONG MetadataSize; DWORD NumberOfStorages; #if ...
	...
	/// </summary>
	// https://docs.microsoft.com/en-us/windows/desktop/api/lmdfs/ns-lmdfs-_dfs_info_8 typedef struct _DFS_INFO_8 { StrPtrUni EntryPath;
	// StrPtrUni Comment; DWORD State; ULONG Timeout; GUID Guid; ULONG PropertyFlags; ULONG MetadataSize; ULONG SecurityDescriptorLength;
	...
	/// </summary>
	// https://docs.microsoft.com/en-us/windows/desktop/api/lmdfs/ns-lmdfs-_dfs_info_9 typedef struct _DFS_INFO_9 { StrPtrUni EntryPath;
	// StrPtrUni Comment; DWORD State; ULONG Timeout; GUID Guid; ULONG PropertyFlags; ULONG MetadataSize; ULONG SecurityDescriptorLength;
	// #if ... PUCHAR pSecurityDescriptor; ULONG SdLengthReserved; #else PSECURITY_DESCRIPTOR pSecurityDescriptor; #endif DWORD
	...
	// State; StrPtrUni ServerName; StrPtrUni ShareName; } DFS_STORAGE_INFO, *PDFS_STORAGE_INFO, *LPDFS_STORAGE_INFO;
	[PInvokeData("lmdfs.h", MSDNShortId = "f50f32d8-1745-4ff6-97a6-ddd6fff95955")]
	[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
	...
	// State; StrPtrUni ServerName; StrPtrUni ShareName; DFS_TARGET_PRIORITY TargetPriority; } DFS_STORAGE_INFO_1, *PDFS_STORAGE_INFO_1, *LPDFS_STORAGE_INFO_1;
