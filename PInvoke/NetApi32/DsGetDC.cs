...
public static partial class NetApi32
{
	...
	// DsAddressToSiteNamesA( IN LPCSTR ComputerName, IN DWORD EntryCount, IN PSOCKET_ADDRESS SocketAddresses, OUT PSTR **SiteNames );
	...
	// DSGETDCAPI DWORD DsAddressToSiteNamesExW( IN LPCWSTR ComputerName, IN DWORD EntryCount, IN PSOCKET_ADDRESS SocketAddresses, OUT PWSTR **SiteNames, OUT PWSTR **SubnetNames );
	[DllImport(Lib.NetApi32, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// DsDeregisterDnsHostRecordsA( PSTR ServerName, PSTR DnsDomainName, GUID *DomainGuid, GUID *DsaGuid, PSTR DnsHostName );
	[DllImport(Lib.NetApi32, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// DsEnumerateDomainTrustsA( PSTR ServerName, ULONG Flags, PDS_DOMAIN_TRUSTSA *Domains, PULONG DomainCount );
	[DllImport(Lib.NetApi32, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// GetDcContextHandle, OUT PULONG SockAddressCount, OUT LPSOCKET_ADDRESS *SockAddresses, OUT PSTR *DnsHostName );
	[DllImport(Lib.NetApi32, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// DsGetDcSiteCoverageW( IN LPCWSTR ServerName, OUT PULONG EntryCount, OUT PWSTR **SiteNames );
	[DllImport(Lib.NetApi32, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// ComputerName, OUT PSTR *SiteName );
	[DllImport(Lib.NetApi32, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// PSTR NetbiosDomainName; PSTR DnsDomainName; ULONG Flags; ULONG ParentIndex; ULONG TrustType; ULONG TrustAttributes; PSID
