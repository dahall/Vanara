...
public static partial class NetApi32
{
	...
	// JobTime; DWORD DaysOfMonth; UCHAR DaysOfWeek; UCHAR Flags; PWSTR Command; } AT_ENUM, *PAT_ENUM, *LPAT_ENUM;
	...
	// DaysOfMonth; UCHAR DaysOfWeek; UCHAR Flags; PWSTR Command; } AT_INFO, *PAT_INFO, *LPAT_INFO;
	[PInvokeData("lmat.h", MSDNShortId = "eb0bf696-53ca-432a-b04c-5e0b6a61a0fd")]
	[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
