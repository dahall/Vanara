...
namespace Vanara.PInvoke
{
	public static partial class User32_Gdi
	{
		...
		public enum ComboBoxMessage
		{
			...
			CBEM_SETIMAGELIST = User32_Gdi.WindowMessage.WM_USER + 2,
			CBEM_GETIMAGELIST = User32_Gdi.WindowMessage.WM_USER + 3,
			CBEM_DELETEITEM = ComboBoxMessage.CB_DELETESTRING,
			CBEM_GETCOMBOCONTROL = User32_Gdi.WindowMessage.WM_USER + 6,
			CBEM_GETEDITCONTROL = User32_Gdi.WindowMessage.WM_USER + 7,
			CBEM_SETEXSTYLE = User32_Gdi.WindowMessage.WM_USER + 8, // use  SETEXTENDEDSTYLE instead
			CBEM_SETEXTENDEDSTYLE = User32_Gdi.WindowMessage.WM_USER + 14, // lparam == new style, wParam (optional) == mask
			CBEM_GETEXSTYLE = User32_Gdi.WindowMessage.WM_USER + 9, // use GETEXTENDEDSTYLE instead
			CBEM_GETEXTENDEDSTYLE = User32_Gdi.WindowMessage.WM_USER + 9,
			CBEM_SETUNICODEFORMAT = 0x2005,
			CBEM_GETUNICODEFORMAT = 0x2006,
			CBEM_HASEDITCHANGED = User32_Gdi.WindowMessage.WM_USER + 10,
			CBEM_INSERTITEM = User32_Gdi.WindowMessage.WM_USER + 11,
			CBEM_SETITEM = User32_Gdi.WindowMessage.WM_USER + 12,
			CBEM_GETITEM = User32_Gdi.WindowMessage.WM_USER + 13,
		...
		public enum ComboBoxNotification
		{
			...
			/// <term>lParam</term>
			/// <description>
			/// A pointer to an <see cref="User32_Gdi.NMHDR"/> structure that contains information about the notification code.
			/// </description>
			/// </item>
			/// </list>
			/// </summary>
