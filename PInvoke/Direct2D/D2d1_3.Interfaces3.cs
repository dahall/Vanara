...
public static partial class D2d1
{
	...
	public interface ID2D1DeviceContext7 : ID2D1DeviceContext6
	{
		...
		new void GetEffectRequiredInputRectangles(ID2D1Effect renderEffect, [In, Optional] PD2D_RECT_F? renderImageRectangle,
			...
			[In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 4)] D2D_RECT_F[] requiredInputRects, int inputCount);
		...
		void DrawGlyphRunWithColorSupport(D2D_POINT_2F baselineOrigin, in DWRITE_GLYPH_RUN glyphRun,
			[In, Optional, StructPointer(typeof(DWRITE_GLYPH_RUN_DESCRIPTION))] IntPtr glyphRunDescription, [In, Optional] ID2D1Brush? foregroundBrush,
			[In, Optional] ID2D1SvgGlyphStyle? svgGlyphStyle, uint colorPaletteIndex = 0, DWRITE_MEASURING_MODE measuringMode = 0,
	...
	public interface ID2D1Factory3 : ID2D1Factory2
	{
		...
		new void CreateDrawingStateBlock([In, Optional, StructPointer(typeof(D2D1_DRAWING_STATE_DESCRIPTION1))] IntPtr drawingStateDescription,
	...
	public interface ID2D1GradientMesh : ID2D1Resource
	{
		...
		void GetPatches(uint startIndex, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] D2D1_GRADIENT_MESH_PATCH[] patches, uint patchesCount);
	}
	...
	public interface ID2D1ImageSourceFromWic : ID2D1Resource, ID2D1Image, ID2D1ImageSource
	{
		...
		void EnsureCached([In, Optional, StructPointer(typeof(D2D_RECT_U))] IntPtr rectangleToFill);
		...
		void TrimCache([In, Optional, StructPointer(typeof(D2D_RECT_U))] IntPtr rectangleToPreserve);
	...
	public interface ID2D1Ink : ID2D1Resource
	{
		...
		void GetSegments(uint startSegment, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] D2D1_INK_BEZIER_SEGMENT[] segments, int segmentsCount);
		...
		void StreamAsGeometry([In, Optional] ID2D1InkStyle? inkStyle, [In, Optional, StructPointer(typeof(D2D1_MATRIX_3X2_F))] IntPtr worldTransform,
		...
		D2D_RECT_F GetBounds([In, Optional] ID2D1InkStyle? inkStyle, [In, Optional, StructPointer(typeof(D2D1_MATRIX_3X2_F))] IntPtr worldTransform);
	}
	...
	public interface ID2D1SvgGlyphStyle : ID2D1Resource
	{
		...
		void GetStroke([Out, Optional] IntPtr brush, [Out, Optional, StructPointer(typeof(float))] IntPtr strokeWidth,
			[Out, Optional, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] float[]? dashes, uint dashesCount,
			[Out, Optional, StructPointer(typeof(float))] IntPtr dashOffset);
	}
		...
		out float[] dashes, out float dashOffset)
	{
		...
		unsafe
		{
			...
			float s = 0f, o = 0f;
			var d = new float[dc];
			style.GetStroke((IntPtr)(void*)&pb, (IntPtr)(void*)&s, d, dc, (IntPtr)(void*)&o);
