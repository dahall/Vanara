...
public static partial class D2d1
{
	...
	public interface ID2D1Factory
	{
		...
		ID2D1StrokeStyle CreateStrokeStyle(in D2D1_STROKE_STYLE_PROPERTIES strokeStyleProperties, [In, Optional, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] float[]? dashes, uint dashesCount = 0);
		...
		ID2D1DrawingStateBlock CreateDrawingStateBlock([In, Optional, StructPointer(typeof(D2D1_DRAWING_STATE_DESCRIPTION))] IntPtr drawingStateDescription, [In, Optional] IDWriteRenderingParams? textRenderingParams);
