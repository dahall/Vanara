...
public static partial class Kernel32
{
	...
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/api/winbase/nf-winbase-lstrcpyna StrPtrAnsi lstrcpynA( StrPtrAnsi lpDest, LPCSTR
	...
	// QueryFullProcessImageNameA( HANDLE hProcess, DWORD dwFlags, StrPtrAnsi lpExeName, PDWORD lpdwSize );
	[DllImport(Lib.Kernel32, SetLastError = true, CharSet = CharSet.Auto)]
	[PInvokeData("winbase.h", MSDNShortId = "49a9d1aa-30f3-45ea-a4ec-9f55df692b8b")]
	[return: MarshalAs(UnmanagedType.Bool)]
