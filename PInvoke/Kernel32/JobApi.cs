...
public static partial class Kernel32
{
	...
	[return: MarshalAs(UnmanagedType.Bool)]
	public static extern bool QueryInformationJobObject([In] HJOB hJob, JOBOBJECTINFOCLASS JobObjectInfoClass, [In, Optional] IntPtr lpJobObjectInfo,
	...
	[return: MarshalAs(UnmanagedType.Bool)]
	public static extern bool QueryIoRateControlInformationJobObject(HJOB hJob, [Optional, MarshalAs(UnmanagedType.LPWStr)] string? VolumeName, out IntPtr InfoBlocks, out uint InfoBlockCount);
	...
	public readonly struct HJOB : ISyncHandle
	{
		...
		public static HJOB NULL => new(IntPtr.Zero);
		...
		/// <returns>The result of the conversion.</returns>
		public static implicit operator HJOB(IntPtr h) => new(h);
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is HJOB h && handle == h.handle;
