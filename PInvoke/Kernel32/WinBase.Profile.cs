...
namespace Vanara.PInvoke
{
	public static partial class Kernel32
	{
		...
		/// function calculates a checksum and compares it with the checksum calculated by the <c>WritePrivateProfileStruct</c> function when
		...
		/// </param>
		/// <param name="lpKeyName">
		/// The name of the key whose associated string is to be retrieved. If this parameter is <c>NULL</c>, the function copies all keys in
		/// the given section to the supplied buffer. Each string is followed by a <c>null</c> character, and the final string is followed by
		/// a second <c>null</c> character.
		/// </param>
		/// <param name="lpDefault">
		/// <para>
		...
		/// zero. To get extended error information, call <c>GetLastError</c>.
		/// </para>
		/// </returns>
		...
		/// <c>NULL</c>, the entire section, including all entries in the section, is deleted.
		/// </param>
		/// <param name="lpString">
		/// A <c>null</c>-terminated string to be written to the file. If this parameter is <c>NULL</c>, the key pointed to by the lpKeyName
		/// parameter is deleted.
