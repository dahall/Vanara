...
{
	private const string LZobsoleteMsg = "The LZ compression methods have been moved to and enhanced in Vanara.PInvoke.Lz32. These methods from Kernel32 will be removed in a future release.";
