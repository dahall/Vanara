...
public static partial class Kernel32
{
	...
	public readonly struct HPIPE : IKernelHandle
	{
		...
		public static HPIPE NULL => new(IntPtr.Zero);
		...
		/// <returns>The result of the conversion.</returns>
		public static implicit operator HPIPE(IntPtr h) => new(h);
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is HPIPE h && handle == h.handle;
