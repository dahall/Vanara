...
public static partial class Kernel32
{
	...
	[StructLayout(LayoutKind.Sequential)]
	public readonly struct PTP_CLEANUP_GROUP : IHandle
	{
		private readonly IntPtr handle;
		...
		public static PTP_CLEANUP_GROUP NULL => new(IntPtr.Zero);
		...
		/// <returns>The result of the conversion.</returns>
		public static implicit operator PTP_CLEANUP_GROUP(IntPtr h) => new(h);
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is PTP_CLEANUP_GROUP h && handle == h.handle;
	...
	[StructLayout(LayoutKind.Sequential)]
	public readonly struct PTP_IO : IHandle
	{
		private readonly IntPtr handle;
		...
		public static PTP_IO NULL => new(IntPtr.Zero);
		...
		/// <param name="h">The pointer to a handle.</param>
		/// <returns>The result of the conversion.</returns>
		public static implicit operator PTP_IO(IntPtr h) => new(h);
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is PTP_IO h && handle == h.handle;
	...
	[StructLayout(LayoutKind.Sequential)]
	public readonly struct PTP_POOL : IHandle
	{
		private readonly IntPtr handle;
		...
		public static PTP_POOL NULL => new(IntPtr.Zero);
		...
		/// <param name="h">The pointer to a handle.</param>
		/// <returns>The result of the conversion.</returns>
		public static implicit operator PTP_POOL(IntPtr h) => new(h);
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is PTP_POOL h && handle == h.handle;
	...
	[StructLayout(LayoutKind.Sequential)]
	public readonly struct PTP_TIMER : IHandle
	{
		private readonly IntPtr handle;
		...
		public static PTP_TIMER NULL => new(IntPtr.Zero);
		...
		/// <param name="h">The pointer to a handle.</param>
		/// <returns>The result of the conversion.</returns>
		public static implicit operator PTP_TIMER(IntPtr h) => new(h);
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is PTP_TIMER h && handle == h.handle;
	...
	[StructLayout(LayoutKind.Sequential)]
	public readonly struct PTP_WAIT : IHandle
	{
		private readonly IntPtr handle;
		...
		public static PTP_WAIT NULL => new(IntPtr.Zero);
		...
		/// <param name="h">The pointer to a handle.</param>
		/// <returns>The result of the conversion.</returns>
		public static implicit operator PTP_WAIT(IntPtr h) => new(h);
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is PTP_WAIT h && handle == h.handle;
	...
	[StructLayout(LayoutKind.Sequential)]
	public readonly struct PTP_WORK : IHandle
	{
		private readonly IntPtr handle;
		...
		public static PTP_WORK NULL => new(IntPtr.Zero);
		...
		/// <param name="h">The pointer to a handle.</param>
		/// <returns>The result of the conversion.</returns>
		public static implicit operator PTP_WORK(IntPtr h) => new(h);
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is PTP_WORK h && handle == h.handle;
