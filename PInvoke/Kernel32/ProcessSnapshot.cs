...
public static partial class Kernel32
{
	...
	/// <para>The <see cref="CONTEXT_FLAG"/> record flags to capture if CaptureFlags specifies thread contexts.</para>
	/// </param>
	...
	public readonly struct HPSS : IHandle
	{
		...
		public static HPSS NULL => new(IntPtr.Zero);
		...
		/// <returns>The result of the conversion.</returns>
		public static implicit operator HPSS(IntPtr h) => new(h);
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is HPSS h && handle == h.handle;
	...
	[StructLayout(LayoutKind.Sequential)]
	public readonly struct HPSSWALK : IHandle
	{
		private readonly IntPtr handle;
		...
		public static HPSSWALK NULL => new(IntPtr.Zero);
		...
		/// <param name="h">The pointer to a handle.</param>
		/// <returns>The result of the conversion.</returns>
		public static implicit operator HPSSWALK(IntPtr h) => new(h);
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is HPSSWALK h && handle == h.handle;
