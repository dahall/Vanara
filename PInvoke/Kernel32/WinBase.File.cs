...
public static partial class Kernel32
{
	...
	[PInvokeData("WinBase.h", MSDNShortId = "aa363852")]
	[return: MarshalAs(UnmanagedType.Bool)]
	public static extern bool CopyFileEx(string lpExistingFileName, string lpNewFileName, [Optional] CopyProgressRoutine? lpProgressRoutine, [In, Optional] IntPtr lpData, [In, Optional] IntPtr pbCancel, COPY_FILE dwCopyFlags);
	...
	[return: MarshalAs(UnmanagedType.Bool)]
	public static extern bool SetVolumeLabel([Optional] string? lpRootPathName, [Optional] string? lpVolumeName);
