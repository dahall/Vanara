...
public static partial class Kernel32
{
	...
	public readonly struct HTRXN : IKernelHandle
	{
		...
		public static HTRXN NULL => new(IntPtr.Zero);
		...
		/// <returns>The result of the conversion.</returns>
		public static implicit operator HTRXN(IntPtr h) => new(h);
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is HTRXN h && handle == h.handle;
