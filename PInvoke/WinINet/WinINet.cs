...
// XReSharper disable UnusedMember.Global ReSharper disable InconsistentNaming ReSharper disable MemberCanBePrivate.Global ReSharper disable UnusedMember.Local
...
namespace Vanara.PInvoke
{
	public static partial class WinINet
	{
		...
		/// <summary>A <see cref="SafeHandle"/> for HINTERNET.</summary>
		public class SafeInternetHandle : GenericSafeHandle
		{
			/// <summary>Initializes a new instance of the <see cref="SafeInternetHandle"/> class.</summary>
			public SafeInternetHandle() : base(InternetCloseHandle) { }

			/// <summary>Initializes a new instance of the <see cref="SafeInternetHandle"/> class.</summary>
			/// <param name="hInternet">An existing handle.</param>
			/// <param name="owns">if set to <c>true</c> owns and disposes of the handle.</param>
			public SafeInternetHandle(IntPtr hInternet, bool owns = true) : base(hInternet, InternetCloseHandle, owns) { }

			/// <summary>Gets a NULL equivalent for an HINSTANCE.</summary>
			public static SafeInternetHandle Null { get; } = new SafeInternetHandle(IntPtr.Zero, false);

			/// <summary>Performs an implicit conversion from <see cref="IntPtr"/> to <see cref="SafeInternetHandle"/>.</summary>
			/// <param name="hInternet">The HINTERNET handle.</param>
			/// <returns>The result of the conversion.</returns>
			public static implicit operator SafeInternetHandle(IntPtr hInternet) => new SafeInternetHandle(hInternet);
		}
	}
}