...
public static partial class WinINet
{
	...
	public enum InternetOptionFlags : uint
	{
		...
		/// <summary>
		/// Sets a StrPtrUni containing the Enterprise ID (see
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/api/wininet/nf-wininet-createmd5ssohash BOOLAPI CreateMD5SSOHash( StrPtrUni
	// pszChallengeInfo, StrPtrUni pwszRealm, StrPtrUni pwszTarget, PBYTE pbHexHash );
	...
	// lpszUrlName, DWORD dwExpectedFileSize, LPCWSTR lpszFileExtension, StrPtrUni lpszFileName, DWORD dwReserved );
	[DllImport(Lib.WinInet, SetLastError = true, CharSet = CharSet.Auto)]
	...
	/// implementations or services use Microsoft Windows HTTP Services (WinHTTP).
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/api/wininet/nf-wininet-detectautoproxyurl BOOLAPI DetectAutoProxyUrl( StrPtrAnsi
	...
	// HINTERNET hConnect, StrPtrAnsi lpszCurrentDirectory, LPDWORD lpdwCurrentDirectory );
	[DllImport(Lib.WinInet, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// LPCSTR lpszUrl, LPINTERNET_CACHE_ENTRY_INFOA lpCacheEntryInfo, LPDWORD lpcbCacheEntryInfo, StrPtrAnsi lpszRedirectUrl, LPDWORD
	...
	// lpszHost, INTERNET_PORT nServerPort, LPCSTR lpszDisplayString, LPCSTR lpszSelectorString, DWORD dwGopherType, StrPtrAnsi lpszLocator,
	...
	// LPCSTR lpszUrl, StrPtrAnsi lpszBuffer, LPDWORD lpdwBufferLength, DWORD dwFlags );
	[DllImport(Lib.WinInet, SetLastError = true, CharSet = CharSet.Auto)]
	[PInvokeData("wininet.h", MSDNShortId = "3bfde980-e478-4960-b41f-e1c8105ef419")]
	[return: MarshalAs(UnmanagedType.Bool)]
	...
	// InternetConfirmZoneCrossing( HWND hWnd, StrPtrAnsi szUrlPrev, StrPtrAnsi szUrlNew, BOOL bPost );
	...
	// LPURL_COMPONENTSA lpUrlComponents, DWORD dwFlags, StrPtrAnsi lpszUrl, LPDWORD lpdwUrlLength );
	[DllImport(Lib.WinInet, SetLastError = true, CharSet = CharSet.Auto)]
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/api/wininet/nf-wininet-internetdial void InternetDial( HWND hwndParent, StrPtrAnsi
	...
	/// <param name="pszSiteName">An <c>StrPtrAnsi</c> that receives a string specifying a website domain.</param>
	...
	// InternetEnumPerSiteCookieDecisionA( StrPtrAnsi pszSiteName, unsigned long *pcSiteNameSize, unsigned long *pdwDecision, unsigned long
	// dwIndex );
	[DllImport(Lib.WinInet, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// InternetGetConnectedStateEx( LPDWORD lpdwFlags, StrPtrAnsi lpszConnectionName, DWORD dwNameLen, DWORD dwReserved );
	[DllImport(Lib.WinInet, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// lpszUrl, LPCSTR lpszCookieName, StrPtrAnsi lpszCookieData, LPDWORD lpdwSize );
	[DllImport(Lib.WinInet, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// lpszUrl, LPCSTR lpszCookieName, StrPtrAnsi lpszCookieData, LPDWORD lpdwSize, DWORD dwFlags, LPVOID lpReserved );
	[DllImport(Lib.WinInet, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// InternetGetLastResponseInfoA( LPDWORD lpdwError, StrPtrAnsi lpszBuffer, LPDWORD lpdwBufferLength );
	[DllImport(Lib.WinInet, SetLastError = true, CharSet = CharSet.Auto)]
	...
	/// implementations or services use Microsoft Windows HTTP Services (WinHTTP).
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/api/wininet/nf-wininet-internetgoonline BOOLAPI InternetGoOnline( StrPtrAnsi lpszURL,
	...
	// InternetTimeFromSystemTime( const SYSTEMTIME *pst, DWORD dwRFC, StrPtrAnsi lpszTime, DWORD cbTime );
	[DllImport(Lib.WinInet, SetLastError = true, CharSet = CharSet.Auto)]
	[PInvokeData("wininet.h", MSDNShortId = "b52ba402-bad1-4005-b9d0-7630194272d1")]
	[return: MarshalAs(UnmanagedType.Bool)]
	...
	/// An <c>StrPtrUni</c> that points to a buffer containing a <c>LPCWSTR</c> representing a string version of the pdwTemplate or a
	...
	// DWORD dwZone, DWORD dwType, LPDWORD pdwTemplate, StrPtrUni pszBuffer, LPDWORD pdwBufferLength );
	...
	// _INTERNET_CACHE_ENTRY_INFOA { DWORD dwStructSize; StrPtrAnsi lpszSourceUrlName; StrPtrAnsi lpszLocalFileName; DWORD CacheEntryType; DWORD
	// dwUseCount; DWORD dwHitRate; DWORD dwSizeLow; DWORD dwSizeHigh; FILETIME LastModifiedTime; FILETIME ExpireTime; FILETIME
	// LastAccessTime; FILETIME LastSyncTime; StrPtrAnsi lpHeaderInfo; DWORD dwHeaderInfoSize; StrPtrAnsi lpszFileExtension; union { DWORD
	...
	/// must cast them to StrPtrAnsi if Unicode is enabled.
	/// </remarks>
	[PInvokeData("WinInet.h")]
	...
	// union { DWORD dwValue; StrPtrAnsi pszValue; FILETIME ftValue; } Value; } INTERNET_PER_CONN_OPTIONA, *LPINTERNET_PER_CONN_OPTIONA;
	[PInvokeData("wininet.h", MSDNShortId = "NS:wininet.__unnamed_struct_3")]
	[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/api/wininet/ns-wininet-url_componentsa typedef struct { DWORD dwStructSize; StrPtrAnsi
	// lpszScheme; DWORD dwSchemeLength; INTERNET_SCHEME nScheme; StrPtrAnsi lpszHostName; DWORD dwHostNameLength; INTERNET_PORT nPort; StrPtrAnsi
	// lpszUserName; DWORD dwUserNameLength; StrPtrAnsi lpszPassword; DWORD dwPasswordLength; StrPtrAnsi lpszUrlPath; DWORD dwUrlPathLength; StrPtrAnsi
