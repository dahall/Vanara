...
public static partial class AdvApi32
{
	...
	/// </returns>
	// https://docs.microsoft.com/en-us/windows/desktop/api/wincred/nf-wincred-credisprotecteda BOOL CredIsProtectedA( PSTR
	...
	// CRED_MARSHAL_TYPE CredType, PVOID Credential, PSTR *MarshaledCredential );
	[DllImport(Lib.AdvApi32, SetLastError = true, CharSet = CharSet.Auto)]
	...
	/// </para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/desktop/api/wincred/nf-wincred-credprotecta BOOL CredProtectA( BOOL fAsSelf, PSTR
	// pszCredentials, DWORD cchCredentials, PSTR pszProtectedCredentials, DWORD *pcchMaxChars, CRED_PROTECTION_TYPE *ProtectionType );
	[DllImport(Lib.AdvApi32, SetLastError = true, CharSet = CharSet.Auto)]
	...
	/// </list>
	/// </returns>
	// https://docs.microsoft.com/en-us/windows/desktop/api/wincred/nf-wincred-credunprotecta BOOL CredUnprotectA( BOOL fAsSelf, PSTR
	// pszProtectedCredentials, DWORD cchProtectedCredentials, PSTR pszCredentials, DWORD *pcchMaxChars );
	[DllImport(Lib.AdvApi32, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// _CREDENTIAL_TARGET_INFORMATIONA { PSTR TargetName; PSTR NetbiosServerName; PSTR DnsServerName; PSTR NetbiosDomainName; PSTR
	// DnsDomainName; PSTR DnsTreeName; PSTR PackageName; ULONG Flags; DWORD CredTypeCount; LPDWORD CredTypes; }
	...
	// _USERNAME_TARGET_CREDENTIAL_INFO { PWSTR UserName; } USERNAME_TARGET_CREDENTIAL_INFO, *PUSERNAME_TARGET_CREDENTIAL_INFO;
