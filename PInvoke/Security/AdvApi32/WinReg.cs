...
public static partial class AdvApi32
{
	...
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/desktop/api/winreg/nf-winreg-initiatesystemshutdowna BOOL InitiateSystemShutdownA( StrPtrAnsi
	// lpMachineName, StrPtrAnsi lpMessage, DWORD dwTimeout, BOOL bForceAppsClosed, BOOL bRebootAfterShutdown );
	...
	// lpSubKey, DWORD Reserved, StrPtrAnsi lpClass, DWORD dwOptions, REGSAM samDesired, CONST LPSECURITY_ATTRIBUTES lpSecurityAttributes,
	...
	// HKEY hKey, LPCSTR lpSubKey, DWORD Reserved, StrPtrAnsi lpClass, DWORD dwOptions, REGSAM samDesired, CONST LPSECURITY_ATTRIBUTES
	...
	// StrPtrAnsi lpName, DWORD cchName );
	[DllImport(Lib.AdvApi32, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// LSTATUS RegEnumKeyExA( [in] HKEY hKey, [in] DWORD dwIndex, [out] StrPtrAnsi lpName, [in, out] LPDWORD lpcchName, LPDWORD lpReserved, [in, out] StrPtrAnsi lpClass, [in, out, optional] LPDWORD lpcchClass, [out, optional] PFILETIME lpftLastWriteTime );
	...
	// dwIndex, StrPtrAnsi lpValueName, LPDWORD lpcchValueName, LPDWORD lpReserved, LPDWORD lpType, __out_data_source(REGISTRY)LPBYTE lpData,
	// LPDWORD lpcbData );
	[DllImport(Lib.AdvApi32, SetLastError = false, CharSet = CharSet.Auto)]
	...
	/// </returns>
	// https://docs.microsoft.com/en-us/windows/desktop/api/winreg/nf-winreg-regqueryinfokeya LSTATUS RegQueryInfoKeyA( HKEY hKey, StrPtrAnsi
	...
	// LSTATUS RegQueryMultipleValuesA( [in] HKEY hKey, [out] PVALENTA val_list, [in] DWORD num_vals, [out, optional] StrPtrAnsi lpValueBuf, [in, out, optional] LPDWORD ldwTotsize );
	...
	// lpSubKey, __out_data_source(REGISTRY)StrPtrAnsi lpData, PLONG lpcbData );
	[DllImport(Lib.AdvApi32, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// https://docs.microsoft.com/en-us/windows/desktop/api/winreg/ns-winreg-value_enta typedef struct value_entA { StrPtrAnsi ve_valuename;
