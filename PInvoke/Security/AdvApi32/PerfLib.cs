...
public static partial class AdvApi32
{
	...
	public readonly struct HPERFPROV : IHandle
	{
		...
		public static HPERFPROV NULL => new(IntPtr.Zero);
		...
		/// <returns>The result of the conversion.</returns>
		public static implicit operator HPERFPROV(IntPtr h) => new(h);
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is HPERFPROV h && handle == h.handle;
	...
	[StructLayout(LayoutKind.Sequential)]
	public readonly struct HPERFQUERY : IHandle
	{
		private readonly IntPtr handle;
		...
		public static HPERFQUERY NULL => new(IntPtr.Zero);
		...
		/// <param name="h">The pointer to a handle.</param>
		/// <returns>The result of the conversion.</returns>
		public static implicit operator HPERFQUERY(IntPtr h) => new(h);
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is HPERFQUERY h && handle == h.handle;
