...
public static partial class AdvApi32
{
	...
	// LpserviceMainFunctiona; void LpserviceMainFunctiona( DWORD dwNumServicesArgs, PSTR *lpServiceArgVectors ) {...}
	...
	// SC_HANDLE hSCManager, LPCSTR lpServiceName, PSTR lpDisplayName, LPDWORD lpcchBuffer );
	[DllImport(Lib.AdvApi32, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// hSCManager, LPCSTR lpDisplayName, PSTR lpServiceName, LPDWORD lpcchBuffer );
	[DllImport(Lib.AdvApi32, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// PSTR lpServiceName; PSTR lpDisplayName; SERVICE_STATUS ServiceStatus; } ENUM_SERVICE_STATUSA, *LPENUM_SERVICE_STATUSA;
	...
	// _ENUM_SERVICE_STATUS_PROCESSA { PSTR lpServiceName; PSTR lpDisplayName; SERVICE_STATUS_PROCESS ServiceStatusProcess; }
	...
	// _QUERY_SERVICE_LOCK_STATUSW { DWORD fIsLocked; PWSTR lpLockOwner; DWORD dwLockDuration; } QUERY_SERVICE_LOCK_STATUSW, *LPQUERY_SERVICE_LOCK_STATUSW;
	...
	// _SERVICE_CONTROL_STATUS_REASON_PARAMSA { DWORD dwReason; PSTR pszComment; SERVICE_STATUS_PROCESS ServiceStatus; }
	...
	// _SERVICE_FAILURE_ACTIONSA { DWORD dwResetPeriod; PSTR lpRebootMsg; PSTR lpCommand; DWORD cActions; SC_ACTION *lpsaActions; }
	...
	// ServiceStatus; DWORD dwNotificationTriggered; PSTR pszServiceNames; } SERVICE_NOTIFY_2A, *PSERVICE_NOTIFY_2A;
	[PInvokeData("winsvc.h", MSDNShortId = "52ede72e-eb50-48e2-b5c1-125816f6fe57")]
	[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
	...
	// _SERVICE_REQUIRED_PRIVILEGES_INFOA { PSTR pmszRequiredPrivileges; } SERVICE_REQUIRED_PRIVILEGES_INFOA, *LPSERVICE_REQUIRED_PRIVILEGES_INFOA;
	...
	// PSTR lpServiceName; LPSERVICE_MAIN_FUNCTIONA lpServiceProc; } SERVICE_TABLE_ENTRYA, *LPSERVICE_TABLE_ENTRYA;
