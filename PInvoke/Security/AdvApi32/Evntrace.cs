...
public static partial class AdvApi32
{
	...
	public static readonly Guid DefaultTraceSecurityGuid = new(0x0811c1af, 0x7a07, 0x4a06, 0x82, 0xed, 0x86, 0x94, 0x55, 0xcd, 0xf7, 0x13);

	/// <summary/>
	public static readonly Guid Dummy = new(0x3595ab5c, 0x042a, 0x4c8e, 0xb9, 0x42, 0x2d, 0x05, 0x9b, 0xfe, 0xb1, 0xb1);

	/// <summary>Used to report system configuration records</summary>
	public static readonly Guid EventTraceConfigGuid = new(0x01853a65, 0x418f, 0x4f36, 0xae, 0xfc, 0xdc, 0x0f, 0x1d, 0x2f, 0xd2, 0x35);

	/// <summary>EventTraceGuid is used to identify a event tracing session</summary>
	public static readonly Guid EventTraceGuid = new(0x68fdd900, 0x4a3e, 0x11d1, 0x84, 0xf4, 0x00, 0x00, 0xf8, 0x04, 0x64, 0xe3);

	/// <summary>Used for private cross-process logger notifications.</summary>
	public static readonly Guid PrivateLoggerNotificationGuid = new(0x3595ab5c, 0x042a, 0x4c8e, 0xb9, 0x42, 0x2d, 0x05, 0x9b, 0xfe, 0xb1, 0xb1);
	...
	/// <summary>Platform-specific invalid process trace handle value.</summary>
	public static ulong INVALID_PROCESSTRACE_HANDLE =>
		Environment.OSVersion.Version.Major >= 6 && !Environment.Is64BitProcess ? 0x00000000FFFFFFFF : ulong.MaxValue;
	...
	public static extern Win32Error EnableTraceEx(in Guid ProviderId, [Optional] IntPtr SourceId, TRACEHANDLE TraceHandle,
		[MarshalAs(UnmanagedType.Bool)] bool IsEnabled, TRACE_LEVEL Level, [Optional] ulong MatchAnyKeyword, [Optional] ulong MatchAllKeyword, [Optional] uint EnableProperty, [Optional] IntPtr EnableFilterDesc);
	...
	[DllImport(Lib.AdvApi32, SetLastError = false, ExactSpelling = true)]
	[PInvokeData("evntrace.h", MSDNShortId = "1c675bf7-f292-49b1-8b60-720499a497fd")]
	public static extern Win32Error EnableTraceEx(in Guid ProviderId, in Guid SourceId, TRACEHANDLE TraceHandle, [MarshalAs(UnmanagedType.Bool)] bool IsEnabled,
		TRACE_LEVEL Level, ulong MatchAnyKeyword, ulong MatchAllKeyword, uint EnableProperty, in EVENT_FILTER_DESCRIPTOR EnableFilterDesc);
	...
	public static extern Win32Error EnableTraceEx2(TRACEHANDLE TraceHandle, in Guid ProviderId, EVENT_CONTROL_CODE ControlCode, TRACE_LEVEL Level, ulong MatchAnyKeyword,
		ulong MatchAllKeyword, uint Timeout, in ENABLE_TRACE_PARAMETERS EnableParameters);
	...
	[DllImport(Lib.AdvApi32, SetLastError = false, ExactSpelling = true)]
	[PInvokeData("evntrace.h", MSDNShortId = "3aceffb6-614f-4cad-bbec-f181f0cbdbff")]
	public static extern Win32Error EnableTraceEx2(TRACEHANDLE TraceHandle, in Guid ProviderId, EVENT_CONTROL_CODE ControlCode, TRACE_LEVEL Level,
		[Optional] ulong MatchAnyKeyword, [Optional] ulong MatchAllKeyword, [Optional] uint Timeout, [Optional] IntPtr EnableParameters);
	...
	public static Win32Error EnumerateTraceGuids(out TRACE_GUID_PROPERTIES[] GuidPropertiesArray)
	{
		Win32Error res = Win32Error.ERROR_MORE_DATA;
		GuidPropertiesArray = [];
		for (uint count = 1; res == Win32Error.ERROR_MORE_DATA;)
		{
			SafeNativeArray<TRACE_GUID_PROPERTIES> __GuidPropertiesArray = new((int)count);
			var pGuidPropertiesArray = __GuidPropertiesArray.GetPointers();
			res = EnumerateTraceGuids(Marshal.UnsafeAddrOfPinnedArrayElement(pGuidPropertiesArray, 0), count, out count);
			if (res.Succeeded)
			{
				GuidPropertiesArray = __GuidPropertiesArray.AsSpan().ToArray();
				break;
			}
		} 
		return res;
	...
	[DllImport(Lib.AdvApi32, SetLastError = false, ExactSpelling = true)]
	[PInvokeData("evntrace.h", MSDNShortId = "9a9e2f53-9916-4a9c-a08e-c8affd5fc4c9")]
	public static extern Win32Error EnumerateTraceGuids(IntPtr GuidPropertiesArray, uint PropertyArrayCount, out uint GuidCount);
	...
	public static extern Win32Error FlushTrace([Optional] TRACEHANDLE TraceHandle, [Optional] string? InstanceName, ref EVENT_TRACE_PROPERTIES Properties);
	...
	public static extern Win32Error ProcessTrace([In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] TRACEHANDLE[] HandleArray, uint HandleCount,
		[In, Optional] PFILETIME? StartTime, [In, Optional] PFILETIME? EndTime);
	...
	/// <summary>
	/// The <c>QueryAllTraces</c> function retrieves the properties and statistics for all event tracing sessions started on the computer for
	/// which the caller has permissions to query.
	/// </summary>
	/// <param name="PropertyArray">
	/// <para>An array of EVENT_TRACE_PROPERTIES structures with session properties and statistics for the event tracing sessions.</para>
	/// <para>
	/// You only need to set the <c>Wnode.BufferSize</c>, <c>LoggerNameOffset</c> , and <c>LogFileNameOffset</c> members of the
	/// EVENT_TRACE_PROPERTIES structure. The other members should all be set to zero.
	/// </para>
	...
	/// <para>
	/// This function retrieves the trace sessions that the caller has permissions to query. Users running with elevated administrative
	/// privileges, users in the Performance Log Users group, and services running as LocalSystem, LocalService, NetworkService can view all
	/// tracing sessions.
	/// </para>
	/// <para>This function does not return private logging sessions.</para>
	/// <para>To retrieve information for a single session, use the ControlTrace function and set the ControlCode parameter to <c>EVENT_TRACE_CONTROL_QUERY</c>.</para>
	/// </remarks>
	[PInvokeData("evntrace.h", MSDNShortId = "6b6144b0-9152-4b5e-863d-06e823fbe084")]
	public static Win32Error QueryAllTraces(out EVENT_TRACE_PROPERTIES[] PropertyArray)
	{
		var initVal = EVENT_TRACE_PROPERTIES.Create();
		SafeNativeArray<EVENT_TRACE_PROPERTIES> props = new(initVal, 1);
		PropertyArray = [];
		uint count;
		for (Win32Error ret; (ret = QueryAllTraces(props.GetPointers(), (uint)props.Count, out count)).Failed; props = new(initVal, (int)count))
		{
			if (ret != Win32Error.ERROR_MORE_DATA)
				return ret;
		}
		PropertyArray = [.. props.Take((int)count)];
	...
	public static extern Win32Error QueryTrace([Optional] TRACEHANDLE TraceHandle, [Optional] string? InstanceName, ref EVENT_TRACE_PROPERTIES Properties);
	...
	public static extern Win32Error QueryTraceProcessingHandle(TRACEHANDLE ProcessingHandle, ETW_PROCESS_HANDLE_INFO_TYPE InformationClass, [In, Optional] IntPtr InBuffer,
		uint InBufferSize, [Out, Optional] IntPtr OutBuffer, uint OutBufferSize, out uint ReturnLength);
	...
	public static extern Win32Error RegisterTraceGuids([MarshalAs(UnmanagedType.FunctionPtr)] TraceControlCallback RequestAddress, [In, Optional] IntPtr RequestContext,
		in Guid ControlGuid, uint GuidCount, [In, Out, Optional, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] TRACE_GUID_REGISTRATION[]? TraceGuidReg,
		[In, Optional] string? MofImagePath, [In, Optional] string? MofResourceName, out TRACEHANDLE RegistrationHandle);
	...
	public static extern Win32Error StopTrace([Optional] TRACEHANDLE SessionHandle, [Optional] string? SessionName, ref EVENT_TRACE_PROPERTIES Properties);
	...
	public static extern Win32Error TraceEvent(TRACEHANDLE SessionHandle, [In] PEVENT_TRACE_HEADER EventTrace);
	...
	public static extern Win32Error TraceEventInstance(TRACEHANDLE SessionHandle, [In] PEVENT_INSTANCE_HEADER EventTrace, in EVENT_INSTANCE_INFO pInstInfo, in EVENT_INSTANCE_INFO pParentInstInfo);
	...
	/* ***** UNTESTED *****
	/// <summary>
	/// A RegisterTraceGuids-based ("Classic") event provider uses the <c>TraceMessage</c> function to send a message-based (TMF-based WPP)
	/// event to an event tracing session.
	/// </summary>
	/// <param name="SessionHandle">
	/// Handle to the event tracing session that records the event. The provider obtains the handle when it calls the GetTraceLoggerHandle
	/// function in its ControlCallback implementation.
	/// </param>
	/// <param name="MessageFlags">
	/// <para>
	/// Adds additional information to the beginning of the provider-specific data section of the event. The provider-specific data section
	/// of the event will contain data only for those flags that are set. The variable list of argument data will follow this information.
	/// This parameter can be one or more of the following values.
	/// </para>
	/// <list type="bullet">
	/// <item>
	/// <term>
	/// <para><c>TRACE_MESSAGE_COMPONENTID</c></para>
	/// <para>Include the component identifier in the message. The MessageGuid parameter contains the component identifier.</para>
	/// </term>
	/// </item>
	/// <item>
	/// <term>
	/// <para><c>TRACE_MESSAGE_GUID</c></para>
	/// <para>Include the event trace class GUID in the message. The MessageGuid parameter contains the event trace class GUID.</para>
	/// </term>
	/// </item>
	/// <item>
	/// <term>
	/// <para><c>TRACE_MESSAGE_SEQUENCE</c></para>
	/// <para>
	/// Include a sequence number in the message. The sequence number starts at one. To use this flag, the controller must have set the
	/// <c>EVENT_TRACE_USE_GLOBAL_SEQUENCE</c> or <c>EVENT_TRACE_USE_LOCAL_SEQUENCE</c> log file mode when creating the session.
	/// </para>
	/// </term>
	/// </item>
	/// <item>
	/// <term>
	/// <para><c>TRACE_MESSAGE_SYSTEMINFO</c></para>
	/// <para>Include the thread identifier and process identifier in the message.</para>
	/// </term>
	/// </item>
	/// <item>
	/// <term>
	/// <para><c>TRACE_MESSAGE_TIMESTAMP</c></para>
	/// <para>Include a time stamp in the message.</para>
	/// </term>
	/// </item>
	/// </list>
	/// <para><c>TRACE_MESSAGE_COMPONENTID</c> and <c>TRACE_MESSAGE_GUID</c> are mutually exclusive.</para>
	...
	/// <para>
	/// A list of variable arguments to be appended to the message. Use this list to specify your provider-specific event data.
	/// </para>
	/// <para>
	/// The caller must ensure that the sum of the sizes of the arguments + 72 does not exceed the size of the event tracing session's buffer.
	/// </para>
	...
	/// <returns>
	/// <para>If the function succeeds, the return value is ERROR_SUCCESS.</para>
	/// <para>If the function fails, the return value is one of the system error codes. The following are some common errors and their causes.</para>
	/// <list type="bullet">
	/// <item>
	/// <term>
	/// <para><c>ERROR_INVALID_HANDLE</c></para>
	/// <para>Either the LoggerHandle is <c>NULL</c> or specifies the NT Kernel Logger session handle.</para>
	/// </term>
	/// </item>
	/// <item>
	/// <term>
	/// <para><c>ERROR_NOT_ENOUGH_MEMORY</c></para>
	/// <para>
	/// The session ran out of free buffers to write to. This can occur during high event rates because the disk subsystem is overloaded or
	/// the number of buffers is too small. Rather than blocking until more buffers become available, TraceMessage discards the event.
	/// </para>
	/// <para><c>Windows 2000 and Windows XP:</c> Not supported.</para>
	/// </term>
	/// </item>
	/// <item>
	/// <term>
	/// <para><c>ERROR_OUTOFMEMORY</c></para>
	/// <para>
	/// The event is discarded because, although the buffer pool has not reached its maximum size, there is insufficient available memory to
	/// allocate an additional buffer and there is no buffer available to receive the event.
	/// </para>
	/// </term>
	/// </item>
	/// <item>
	/// <term>
	/// <para><c>ERROR_INVALID_PARAMETER</c></para>
	/// <para>MessageFlags contains a value that is not valid.</para>
	/// </term>
	/// </item>
	/// <item>
	/// <term>
	/// <para><c>ERROR_MORE_DATA</c></para>
	/// <para>
	/// Data from a single event cannot span multiple buffers. A trace event is limited to the size of the event tracing session's buffer
	/// minus the size of the EVENT_TRACE_HEADER structure.
	/// </para>
	...
	/// </returns>
	/// <remarks>
	/// <para>TMF-based WPP providers call this function.</para>
	/// <para>
	/// <para>Note</para>
	/// <para>
	/// Most developers will not call this function directly. WPP providers use wrapper functions generated by tracewpp.exe instead of
	/// calling ETW APIs.
	/// </para>
	/// </para>
	/// <para>If you need to access message tracing functionality from a wrapper function, call the TraceMessageVa version of this function.</para>
	/// <para>
	/// Consumers will have to use the EventCallback callback to receive and process the events if the MessageFlags parameter does not
	/// contain the TRACE_MESSAGE_GUID flag. If you do not specify the TRACE_MESSAGE_GUID flag, the consumer will not be able to use the
	/// EventClassCallback because the <c>Header.Guid</c> member of the EVENT_TRACE structure will not contain the event trace class GUID.
	/// </para>
	/// <para>
	/// Note that the members of the EVENT_TRACE and EVENT_TRACE_HEADER structures that correspond to the MessageFlags flags are set only if
	/// the corresponding flag is specified. For example, the <c>ThreadId</c> and <c>ProcessId</c> members of <c>EVENT_TRACE_HEADER</c> are
	/// populated only if you specify the TRACE_MESSAGE_SYSTEMINFO flag.
	/// </para>
	/// </remarks>
	// https://learn.microsoft.com/en-us/windows/win32/api/evntrace/nf-evntrace-tracemessage
	// ULONG TraceMessage( [in] TRACEHANDLE LoggerHandle, [in] ULONG MessageFlags, [in] LPCGUID MessageGuid, [in] USHORT MessageNumber, ... );
	[PInvokeData("evntrace.h", MSDNShortId = "NF:evntrace.TraceMessage")]
	public static Win32Error TraceMessage(TRACEHANDLE SessionHandle, TRACE_MESSAGE MessageFlags, in Guid MessageGuid, ushort MessageNumber, byte[][] MessageArgList)
	{
		unsafe
		{
			IntPtr* ptrs = stackalloc IntPtr[(MessageArgList.Length + 1) * 2];
			for (int i = 0; i < MessageArgList.Length; i++)
			{
				ptrs[i * 2] = GCHandle.Alloc(MessageArgList[i], GCHandleType.Pinned).AddrOfPinnedObject();
				ptrs[i * 2 + 1] = (IntPtr)MessageArgList[i].LongLength;
			}
			try
			{
				return TraceMessageVa(SessionHandle, MessageFlags, MessageGuid, MessageNumber, (IntPtr)(void*)&ptrs);
			}
			finally
			{
				for (int i = 0; i < MessageArgList.Length; i++)
					GCHandle.FromIntPtr(ptrs[i * 2]).Free();
			}
		}
	}
	*/
	...
	public static extern Win32Error TraceQueryInformation(TRACEHANDLE SessionHandle, TRACE_QUERY_INFO_CLASS InformationClass,
		[SizeDef(nameof(InformationLength), SizingMethod.Query, OutVarName = nameof(ReturnLength))] IntPtr TraceInformation, uint InformationLength, out uint ReturnLength);
	...
	public static extern Win32Error TraceSetInformation(TRACEHANDLE SessionHandle, TRACE_QUERY_INFO_CLASS InformationClass, [In, SizeDef(nameof(InformationLength))] IntPtr TraceInformation, uint InformationLength);
	...
	/// <summary>The <c>ENABLE_TRACE_PARAMETERS</c> structure contains information used to enable a provider via EnableTraceEx2.</summary>
	/// <remarks>
	/// <para>The <c>ENABLE_TRACE_PARAMETERS</c> structure is a version-2 structure and replaces the ENABLE_TRACE_PARAMETERS_V1 structure.</para>
	/// <para>
	/// <c>Windows 8.1, Windows Server 2012 R2, and later:</c> Event payload, scope, and stack walk filters can be used by the EnableTraceEx2
	/// function and the <c>ENABLE_TRACE_PARAMETERS</c> and EVENT_FILTER_DESCRIPTOR structures to filter on specific conditions in a logger
	/// session. For more information on event payload filters, see the <c>EnableTraceEx2</c>, TdhCreatePayloadFilter, and
	/// TdhAggregatePayloadFilters functions and the <c>EVENT_FILTER_DESCRIPTOR</c> and PAYLOAD_FILTER_PREDICATE structures.
	/// </para>
	/// <para>
	/// Typically, on 64-bit computers, you cannot capture the kernel stack in certain contexts when page faults are not allowed. To enable
	/// walking the kernel stack on x64, set the Memory Management registry value to 1. The registry value is located under the following
	/// registry key: . This should only be done for temporary diagnosis purposes because it increases memory usage of the system.
	/// </para>
	/// </remarks>
	// https://learn.microsoft.com/en-us/windows/win32/api/evntrace/ns-evntrace-enable_trace_parameters typedef struct
	// _ENABLE_TRACE_PARAMETERS { ULONG Version; ULONG EnableProperty; ULONG ControlFlags; GUID SourceId; PEVENT_FILTER_DESCRIPTOR
	// EnableFilterDesc; ULONG FilterDescCount; } ENABLE_TRACE_PARAMETERS, *PENABLE_TRACE_PARAMETERS;
	[PInvokeData("evntrace.h", MSDNShortId = "NS:evntrace._ENABLE_TRACE_PARAMETERS")]
	[StructLayout(LayoutKind.Sequential)]
	public struct ENABLE_TRACE_PARAMETERS()
	{
		/// <summary>Set to <c>ENABLE_TRACE_PARAMETERS_VERSION_2</c> (2).</summary>
		public uint Version = 2 /*ENABLE_TRACE_PARAMETERS_VERSION_2*/;

		/// <summary>
		/// <para>
		/// Optional settings that ETW can include when writing the event. Some settings write extra data to the extended data item section
		/// of each event. Other settings control which events will be included in the trace. To use these optional settings, specify one or
		/// more of the following flags. Otherwise, set to zero.
		/// </para>
		/// <list type="bullet">
		/// <item>
		/// <term>
		/// <para><c>EVENT_ENABLE_PROPERTY_IGNORE_KEYWORD_0</c></para>
		...
		/// <item>
		/// <term>
		/// <para><c>EVENT_ENABLE_PROPERTY_PROVIDER_GROUP</c></para>
		...
		/// <item>
		/// <term>
		/// <para><c>EVENT_ENABLE_PROPERTY_PROCESS_START_KEY</c></para>
		...
		/// <item>
		/// <term>
		/// <para><c>EVENT_ENABLE_PROPERTY_EVENT_KEY</c></para>
		...
		/// <item>
		/// <term>
		/// <para><c>EVENT_ENABLE_PROPERTY_EXCLUDE_INPRIVATE</c></para>
		...
		/// <item>
		/// <term>
		/// <para><c>EVENT_ENABLE_PROPERTY_SID</c></para>
		...
		/// <item>
		/// <term>
		/// <para><c>EVENT_ENABLE_PROPERTY_TS_ID</c></para>
		...
		/// <item>
		/// <term>
		/// <para><c>EVENT_ENABLE_PROPERTY_STACK_TRACE</c></para>
		...
		/// </list>
		/// </summary>
		public EVENT_ENABLE_PROPERTY EnableProperty;

		/// <summary>Reserved. Set to 0.</summary>
		public uint ControlFlags;

		/// <summary>
		/// A GUID that uniquely identifies the caller that is enabling or disabling the provider. If the provider does not implement
		/// EnableCallback, the GUID is not used.
		/// </summary>
		public Guid SourceId;

		/// <summary>
		/// A pointer to an array of EVENT_FILTER_DESCRIPTOR structures that points to the filter data. The number of elements in the array
		...
		/// </summary>
		[SizeDef(nameof(FilterDescCount))]
		public ManagedArrayPointer<EVENT_FILTER_DESCRIPTOR> EnableFilterDesc;

		/// <summary>
		/// <para>The number of elements (filters) in the EVENT_FILTER_DESCRIPTOR array pointed to by <c>EnableFilterDesc</c> member.</para>
		/// <para>
		/// The <c>FilterDescCount</c> member should match the number of EVENT_FILTER_DESCRIPTOR structures in the array pointed to by the
		/// <c>EnableFilterDesc</c> member.
		/// </para>
		/// </summary>
	...
	public struct ENABLE_TRACE_PARAMETERS_V1()
	{
		...
		/// </para>
		/// </summary>
		public StructPointer<EVENT_FILTER_DESCRIPTOR> EnableFilterDesc;
	}
	...
	public struct TRACE_GUID_PROPERTIES
	{
		...
		private uint _EnableLevel;

		/// <summary>Value passed as the EnableLevel parameter to the EnableTrace function.</summary>
		public TRACE_LEVEL EnableLevel { get => (TRACE_LEVEL)_EnableLevel; set => _EnableLevel = (uint)value; }
	...
	/// <remarks>Initializes a new instance of the <see cref="TRACEHANDLE"/> struct.</remarks>
	/// <param name="preexistingHandle">An <see cref="ulong"/> value that represents the pre-existing handle to use.</param>
	[PInvokeData("evntrace.h")]
	[StructLayout(LayoutKind.Sequential)]
	public readonly struct TRACEHANDLE(ulong preexistingHandle) : IHandle
	{
		...
		public static readonly TRACEHANDLE NULL = new();

		/// <summary>Gets a value indicating whether this instance is invalid.</summary>
		public bool IsInvalid => handle is 0 || handle == INVALID_PROCESSTRACE_HANDLE;
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is TRACEHANDLE h && handle == h.handle;

		/// <inheritdoc/>
		public override int GetHashCode() => handle.GetHashCode();

		IntPtr IHandle.DangerousGetHandle() => new(unchecked((long)handle));
	}
	...
	public class SafeTRACEHANDLE : IDisposable, IHandle
	{
		...
		public SafeTRACEHANDLE(TRACEHANDLE preexistingHandle) => handle = (ulong)preexistingHandle;

		/// <summary>Finalizes an instance of the <see cref="SafeTRACEHANDLE"/> class.</summary>
		~SafeTRACEHANDLE() => Dispose(false);
		...
		/// <summary>Releases the handle.</summary>
		protected virtual void Dispose(bool disposing) => CloseTrace(handle);
