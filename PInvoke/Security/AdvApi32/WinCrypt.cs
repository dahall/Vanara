...
public static partial class AdvApi32
{
	...
	{
		/// <summary>Returns the administrator personal identification number (PIN) in the pbData parameter as a StrPtrAnsi.</summary>
		PP_ADMIN_PIN = 0x1F,
	...
	// DWORD *pdwReserved, DWORD dwFlags, DWORD *pdwProvType, StrPtrAnsi szProvName, DWORD *pcbProvName );
	[DllImport(Lib.AdvApi32, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// dwIndex, DWORD *pdwReserved, DWORD dwFlags, DWORD *pdwProvType, StrPtrAnsi szTypeName, DWORD *pcbTypeName );
	[DllImport(Lib.AdvApi32, SetLastError = true, CharSet = CharSet.Auto)]
	...
	// dwProvType, DWORD *pdwReserved, DWORD dwFlags, StrPtrAnsi pszProvName, DWORD *pcbProvName );
	[DllImport(Lib.AdvApi32, SetLastError = true, CharSet = CharSet.Auto)]
	[PInvokeData("wincrypt.h", MSDNShortId = "5d15641e-1ad7-441d-9423-65fd51de9812")]
	[return: MarshalAs(UnmanagedType.Bool)]
	...
	/// <term>Returns the administrator personal identification number (PIN) in the pbData parameter as a StrPtrAnsi.</term>
	/// </item>
	/// <item>
	...
	// dwVersion; ALG_ID Algid; StrPtrAnsi pszContentEncObjId; CRYPT_DATA_BLOB PubInfo; void *pReserved; } CMS_DH_KEY_INFO, *PCMS_DH_KEY_INFO;
