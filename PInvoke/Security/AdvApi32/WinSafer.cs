...
public static partial class AdvApi32
{
	...
	[StructLayout(LayoutKind.Sequential)]
	public readonly struct SAFER_LEVEL_HANDLE : IHandle
	{
		...
		public static SAFER_LEVEL_HANDLE NULL => new(IntPtr.Zero);
		...
		/// <returns>The result of the conversion.</returns>
		public static implicit operator SAFER_LEVEL_HANDLE(IntPtr h) => new(h);
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is SAFER_LEVEL_HANDLE h && handle == h.handle;
