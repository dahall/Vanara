...
public static partial class AdvApi32
{
	...
	[StructLayout(LayoutKind.Sequential)]
	public readonly struct REGHANDLE : IHandle
	{
		...
		public static REGHANDLE NULL => new(IntPtr.Zero);
		...
		/// <returns>The result of the conversion.</returns>
		public static implicit operator REGHANDLE(IntPtr h) => new(h);
		...
		/// <inheritdoc/>
		public override bool Equals(object? obj) => obj is REGHANDLE h && handle == h.handle;
