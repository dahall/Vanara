...
public static partial class SpellCheck
{
	...
	public interface IOptionDescription
	{
		...
		/// </para>
		/// </remarks>
		// https://learn.microsoft.com/en-us/windows/win32/api/spellcheck/nf-spellcheck-ioptiondescription-get_id HRESULT get_Id( PWSTR
		// *value );
	...
	public interface ISpellChecker
	{
		...
		/// <para>This property is read-only.</para>
		/// </summary>
		// https://learn.microsoft.com/en-us/windows/win32/api/spellcheck/nf-spellcheck-ispellchecker-get_id HRESULT get_Id( PWSTR *value );
		string Id { [return: MarshalAs(UnmanagedType.LPWStr)] get; }
