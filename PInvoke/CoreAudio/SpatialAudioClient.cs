...
{
	/// <summary>
	/// Specifies the type of an ISpatialAudioObject. A spatial audio object can be dynamic, meaning that it's spatial properties can change
	/// over time, or static, which means that its spatial properties are fixed. There are 17 audio channels to which a static spatial audio
	/// object can be assigned, each representing a real or virtualized speaker. The static channel values of the enumeration can be combined
	/// as a mask to assign a spatial audio object to multiple channels. All of the enumeration values except for <c>AudioObjectType_None</c>
	/// and <c>AudioObjectType_Dynamic</c> represent static channels.
	/// </summary>
	...
	public enum AudioObjectType
	{
		...
		/// <summary>
		/// The spatial audio object is assigned the front left channel. The equivalent channel mask of DirectShow's WAVEFORMATEXTENSIBLE
		/// enumeration is SPEAKER_FRONT_LEFT.
		/// </summary>
		AudioObjectType_FrontLeft = 1 << 1,

		/// <summary>
		/// The spatial audio object is assigned the front right channel. The equivalent channel mask of DirectShow's WAVEFORMATEXTENSIBLE
		/// enumeration is SPEAKER_FRONT_RIGHT.
		/// </summary>
		AudioObjectType_FrontRight = 1 << 2,

		/// <summary>
		/// The spatial audio object is assigned the front center channel. The equivalent channel mask of DirectShow's WAVEFORMATEXTENSIBLE
		/// enumeration is SPEAKER_FRONT_CENTER.
		/// </summary>
		AudioObjectType_FrontCenter = 1 << 3,

		/// <summary>
		/// The spatial audio object is assigned the low frequency channel. Because this channel is not spatialized, it does not count toward
		/// the system resource limits for spatialized audio objects. The equivalent channel mask of DirectShow's WAVEFORMATEXTENSIBLE
		/// enumeration is SPEAKER_LOW_FREQUENCY.
		/// </summary>
		...
		/// <summary>
		/// The spatial audio object is assigned the side right channel. The equivalent channel mask of DirectShow's WAVEFORMATEXTENSIBLE
		/// enumeration is SPEAKER_SIDE_RIGHT.
		/// </summary>
		...
		/// <summary>
		/// The spatial audio object is assigned the back right channel. The equivalent channel mask of DirectShow's WAVEFORMATEXTENSIBLE
		/// enumeration is SPEAKER_BACK_RIGHT.
		/// </summary>
		AudioObjectType_BackRight = 1 << 8,

		/// <summary>
		/// The spatial audio object is assigned the top front left channel. The equivalent channel mask of DirectShow's WAVEFORMATEXTENSIBLE
		/// enumeration is SPEAKER_TOP_FRONT_LEFT.
		/// </summary>
		...
		/// <summary>
		/// The spatial audio object is assigned the top back left channel. The equivalent channel mask of DirectShow's WAVEFORMATEXTENSIBLE
		/// enumeration is SPEAKER_TOP_BACK_LEFT.
		/// </summary>
		AudioObjectType_TopBackLeft = 1 << 11,

		/// <summary>
		/// The spatial audio object is assigned the top back right channel. The equivalent channel mask of DirectShow's WAVEFORMATEXTENSIBLE
		/// enumeration is SPEAKER_TOP_BACK_RIGHT.
		/// </summary>
	...
	/// <summary>Specifies audio stream options for calls to ISpatialAudioClient::ActivateSpatialAudioStream (spatialaudioclient.h).</summary>
	/// <remarks>
	/// <para>This enumeration value is used by the version 2 structures for spatial audio activation parameters.</para>
	/// <list type="bullet">
	/// <item>
	/// <term>SpatialAudioObjectRenderStreamActivationParams2</term>
	/// </item>
	/// <item>
	/// <term>SpatialAudioHrtfActivationParams2</term>
	/// </item>
	/// <item>
	/// <term>SpatialAudioObjectRenderStreamForMetadataActivationParams2</term>
	/// </item>
	/// <item>
	/// <term/>
	/// </item>
	/// </list>
	/// </remarks>
	// https://learn.microsoft.com/en-us/windows/win32/api/spatialaudioclient/ne-spatialaudioclient-spatial_audio_stream_options typedef enum
	// SPATIAL_AUDIO_STREAM_OPTIONS { SPATIAL_AUDIO_STREAM_OPTIONS_NONE, SPATIAL_AUDIO_STREAM_OPTIONS_OFFLOAD } ;
	[PInvokeData("spatialaudioclient.h", MSDNShortId = "NE:spatialaudioclient.SPATIAL_AUDIO_STREAM_OPTIONS")]
	[Flags]
	public enum SPATIAL_AUDIO_STREAM_OPTIONS
	{
		...
		/// <summary>
		/// <para>The stream should support audio offloading. For more information, see</para>
		/// <para>ISpatialAudioClient2</para>
		/// <para>.</para>
		/// </summary>
	...
	public interface IAudioFormatEnumerator
	{
		...
		/// <summary>
		/// Gets the format with the specified index in the list. The formats are listed in order of importance. The most preferable format
	...
	/// <summary>
	/// The <c>ISpatialAudioClient</c> interface enables a client to create audio streams that emit audio from a position in 3D space. This
	/// interface is a part of Windows Sonic, Microsoft’s audio platform for more immersive audio which includes integrated spatial sound on
	/// Xbox and Windows.
	/// </summary>
	/// <remarks>
	/// <para>
	...
	public interface ISpatialAudioClient
	{
		...
		/// <param name="type">
		/// A value indicating the static spatial audio channel for which the position is being queried. This method will return E_INVALIDARG
		/// if the value does not represent a static channel, including <c>AudioObjectType_Dynamic</c> and <c>AudioObjectType_None</c>.
		/// </param>
		/// <param name="x">
		...
		/// </param>
		/// <param name="y">
		/// The y coordinate of the static audio channel, in meters, relative to the listener. Positive values are above the listener and
		/// negative values are below.
		/// </param>
		/// <param name="z">
		/// The z coordinate of the static audio channel, in meters, relative to the listener. Positive values are behind the listener and
		...
		/// <returns>
		/// A bitwise combination of values from the AudioObjectType enumeration indicating a subset of static speaker channels. The values
		/// returned will only include the static channel values and will not include <c>AudioObjectType_Dynamic</c>.
		/// </returns>
		...
		/// ISpatialAudioObjectRenderStream::ActivateSpatialAudioObject method to <c>AudioObjectType_Dynamic</c>. The client has a limit of
		/// the maximum number of dynamic spatial audio objects that can be activated at one time. When the capacity of the audio rendering
		/// pipeline changes, the system will dynamically adjust the maximum number of concurrent dynamic spatial audio objects. Before doing
		/// so, the system will call OnAvailableDynamicObjectCountChange to notify clients of the resource limit change.
		/// </para>
		/// <para>
		...
		/// <summary>
		/// Gets an IAudioFormatEnumerator that contains all supported audio formats for spatial audio objects, the first item in the list
		...
		/// <summary>
		/// Gets the maximum possible frame count per processing pass. This method can be used to determine the size of the source buffer
		/// that should be allocated to convey audio data for each processing pass.
		/// </summary>
		/// <param name="objectFormat">
		/// The audio format used to calculate the maximum frame count. This should be the same format specified in the <c>ObjectFormat</c>
		/// field of the SpatialAudioObjectRenderStreamActivationParams passed to ActivateSpatialAudioStream.
		/// </param>
		...
		/// <summary>
		/// When successful, gets a value indicating whether the currently active spatial rendering engine supports the specified spatial
		/// audio render stream.
		/// </summary>
		...
		/// particular metadata format is supported. The following code example demonstrates how to initialize the PROPVARIANT structure to
		/// check for support for an example metadata format.
		/// </para>
		...
		/// The structure defining the activation parameters for the spatial audio stream. The <c>vt</c> field should be set to VT_BLOB and
		/// the <c>blob</c> field should be populated with a SpatialAudioObjectRenderStreamActivationParams or a SpatialAudioObjectRenderStreamForMetadataActivationParams.
		/// </param>
	...
	/// <summary>
	/// The <c>ISpatialAudioClient2</c> interface inherits from ISpatialAudioClient and adds methods to query for support for offloading
	/// large audio buffers.
	/// </summary>
	/// <remarks>
	/// <para>
	/// Audio offloading allows an app to submit a large audio buffer (typically 1 to 2 seconds) the the audio device driver. Without
	/// offload, a typical audio buffer only contains 10ms of data, requiring the app to be awakened around 100 times per second to provide
	/// additional audio data. Using offloaded large buffers can provide battery savings, particularly for the scenario where the user is
	/// listening to audio with the screen off.
	/// </para>
	/// <para>
	...
	/// Determine the maximum number of audio frames supported for offloading by calling GetMaxFrameCountForCategory.
	/// </para>
	/// <para>
	/// <c>ISpatialAudioClient2</c> was introduced in Windows 11 (Windows Build 22000), so your code should handle the case where it is
	/// running on an older version of Windows that doesn't include the interface. The following example illustrates using calling
	/// <c>QueryInterface</c> on <c>ISpatialAudioClient</c> to try to obtain an instance of <c>ISpatialAudioClient2</c> and checking that the
	/// retrieved interface is not null before calling its methods.
	/// </para>
	/// <para>
	/// For UWP apps that do not have access to <c>IMMDevice</c>, you should get an instance of <c>ISpatialAudioClient</c> by calling
	/// ActivateAudioInterfaceAsync. For an example, see the WindowsAudioSession sample.
	/// </para>
	/// </remarks>
	// https://learn.microsoft.com/en-us/windows/win32/api/spatialaudioclient/nn-spatialaudioclient-ispatialaudioclient2
	[PInvokeData("spatialaudioclient.h", MSDNShortId = "NN:spatialaudioclient.ISpatialAudioClient2")]
	[ComImport, Guid("caabe452-a66a-4bee-a93e-e320463f6a53"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	public interface ISpatialAudioClient2 : ISpatialAudioClient
	{
		/// <summary>Gets the position in 3D space of the specified static spatial audio channel.</summary>
		/// <param name="type">
		/// A value indicating the static spatial audio channel for which the position is being queried. This method will return E_INVALIDARG
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/spatialaudioclient/nf-spatialaudioclient-ispatialaudioclient-getstaticobjectposition
		// HRESULT GetStaticObjectPosition( AudioObjectType type, float *x, float *y, float *z );
		new void GetStaticObjectPosition([In] AudioObjectType type, out float x, out float y, out float z);
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/spatialaudioclient/nf-spatialaudioclient-ispatialaudioclient-getnativestaticobjecttypemask
		// HRESULT GetNativeStaticObjectTypeMask( AudioObjectType *mask );
		new AudioObjectType GetNativeStaticObjectTypeMask();
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/spatialaudioclient/nf-spatialaudioclient-ispatialaudioclient-getmaxdynamicobjectcount
		// HRESULT GetMaxDynamicObjectCount( UINT32 *value );
		new uint GetMaxDynamicObjectCount();
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/spatialaudioclient/nf-spatialaudioclient-ispatialaudioclient-getsupportedaudioobjectformatenumerator
		// HRESULT GetSupportedAudioObjectFormatEnumerator( IAudioFormatEnumerator **enumerator );
		new IAudioFormatEnumerator GetSupportedAudioObjectFormatEnumerator();
		...
		// https://docs.microsoft.com/en-us/windows/win32/api/spatialaudioclient/nf-spatialaudioclient-ispatialaudioclient-getmaxframecount
		// HRESULT GetMaxFrameCount( const WAVEFORMATEX *objectFormat, UINT32 *frameCountPerBuffer );
		new uint GetMaxFrameCount(in WAVEFORMATEX objectFormat);
		...
		// HRESULT IsAudioObjectFormatSupported( const WAVEFORMATEX *objectFormat );
		[PreserveSig]
		new HRESULT IsAudioObjectFormatSupported(in WAVEFORMATEX objectFormat);
		...
		/// processing. The method also considers the capabilities of the AUDIO_STREAM_CATEGORY value that will be used, as use of offload is
		/// restricted to only certain <c>AUDIO_STREAM_CATEGORY</c> values.
		/// </summary>
		/// <param name="category">
		/// A value from the AUDIO_STREAM_CATEGORY enumeration specifying the category of audio for which offload support is queried.
		/// </param>
		/// <returns>Receives a boolean value indicating if offloaded audio processing is supported by the audio rendering endpoint.</returns>
		// https://learn.microsoft.com/en-us/windows/win32/api/spatialaudioclient/nf-spatialaudioclient-ispatialaudioclient2-isoffloadcapable
		// HRESULT IsOffloadCapable( [in] AUDIO_STREAM_CATEGORY category, [out] BOOL *isOffloadCapable );
		...
		/// <param name="category">The AUDIO_STREAM_CATEGORY (audiosessiontypes.h) of the audio stream for which support is queried.</param>
		/// <param name="offloadEnabled">
		/// A boolean value specifying whether the returned frame count should be calculated with audio offload support considered. If this
		/// flag is set to true, the returned frame count is what it would be if the stream is activated for offload mode. However, if this
		/// flag is set to true but the audio endpoint does not support offload mode, then the flag has no effect. Use
		/// ISpatialAudioClient2::IsOffloadCapable to check if offload mode is supported.
		/// </param>
		/// <param name="objectFormat">
		/// A pointer to a WAVEFORMATEX (mmeapi.h) structure specifying the format of the audio stream for which support is queried.
		/// </param>
		/// <returns>
		/// Receives a pointer to an <c>INT32</c> indicating the maximum supported frame count for the audio device and the specified input parameters.
		/// </returns>
		/// <remarks>
		/// The value returned by this method can be used to allocate source buffer. This value will change if the endpoint cadence changes.
		/// The caller must specify same AUDIO_STREAM_CATEGORY and WAVEFORMATEX values that will be used when creating the stream. The
		/// offloadEnabled parameter must be set to TRUE if the stream will be created with the SPATIAL_AUDIO_STREAM_OPTIONS_OFFLOAD flag.
		/// </remarks>
		// https://learn.microsoft.com/en-us/windows/win32/api/spatialaudioclient/nf-spatialaudioclient-ispatialaudioclient2-getmaxframecountforcategory
		// HRESULT GetMaxFrameCountForCategory( [in] AUDIO_STREAM_CATEGORY category, [in] BOOL offloadEnabled, [in] const WAVEFORMATEX
		// *objectFormat, [out] UINT32 *frameCountPerBuffer );
		uint GetMaxFrameCountForCategory(AUDIO_STREAM_CATEGORY category, [MarshalAs(UnmanagedType.Bool)] bool offloadEnabled, in WAVEFORMATEX objectFormat);
	}

	/// <summary>
	/// <para>
	/// Represents an object that provides audio data to be rendered from a position in 3D space, relative to the user. Spatial audio objects
	/// can be static or dynamic, which you specify with the type parameter to the
	/// ISpatialAudioObjectRenderStream::ActivateSpatialAudioObject method. Dynamic audio objects can be placed in an arbitrary position in
	/// space and can be moved over time. Static audio objects are assigned to one or more channels, defined in the AudioObjectType
	...
	public interface ISpatialAudioObject : ISpatialAudioObjectBase
	{
		...
		/// <summary>Sets the position in 3D space, relative to the listener, from which the ISpatialAudioObject audio data will be rendered.</summary>
		/// <param name="x">
		...
		/// <term>
		/// The ISpatialAudioObject is not of type AudioObjectType_Dynamic. Set the type of the audio object with the type parameter to the
		/// ISpatialAudioObjectRenderStreamBase::ActivateSpatialAudioObject method.
		/// </term>
		/// </item>
		/// </list>
		/// </returns>
		/// <remarks>
		/// <para>
		/// This method can only be called on a ISpatialAudioObject that is of type <c>AudioObjectType_Dynamic</c>. Set the type of the audio
		/// object with the type parameter to the ISpatialAudioObjectRenderStreamBase::ActivateSpatialAudioObject method.
		/// </para>
		/// <para>
		/// Position values use a right-handed Cartesian coordinate system, where each unit represents 1 meter. The coordinate system is
		/// relative to the listener where the origin (x=0.0, y=0.0, z=0.0) represents the center point between the listener's ears.
		...
		/// </returns>
		/// <remarks>
		/// If <c>SetVolume</c> is never called, the default value of 1.0 is used. After <c>SetVolume</c> is called, the volume that is set
		/// will be used for the audio object until the volume is changed with another call to <c>SetVolume</c>.
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/win32/api/spatialaudioclient/nf-spatialaudioclient-ispatialaudioobject-setvolume HRESULT
	...
	/// Spatial audio objects can be static or dynamic, which you specify with the type parameter to the
	/// ISpatialAudioObjectRenderStream::ActivateSpatialAudioObject method. Dynamic audio objects can be placed in an arbitrary position in
	/// space and can be moved over time. Static audio objects are assigned to one or more channels, defined in the AudioObjectType
	/// enumeration, that each correlate to a fixed speaker location that may be a physical or a virtualized speaker.
	/// </para>
	...
	/// <summary>
	/// <para>
	/// Provides methods for controlling a spatial audio object render stream, including starting, stopping, and resetting the stream. Also
	/// provides methods for activating new ISpatialAudioObject instances and notifying the system when you are beginning and ending the
	/// process of updating activated spatial audio objects and data.
	/// </para>
	/// <para>
	/// This interface is a part of Windows Sonic, Microsoft’s audio platform for more immersive audio which includes integrated spatial
	/// sound on Xbox and Windows.
	...
	public interface ISpatialAudioObjectRenderStream : ISpatialAudioObjectRenderStreamBase
	{
		...
		/// <remarks>
		/// A dynamic ISpatialAudioObject is one that was activated by setting the type parameter to the <c>ActivateSpatialAudioObject</c>
		/// method to <c>AudioObjectType_Dynamic</c>. The client has a limit of the maximum number of dynamic spatial audio objects that can
		/// be activated at one time. After the limit has been reached, attempting to activate additional audio objects will result in this
		/// method returning an SPTLAUDCLNT_E_NO_MORE_OBJECTS error. To avoid this, call Release on each dynamic <c>ISpatialAudioObject</c>
		/// after it is no longer being used to free up the resource so that it can be reallocated. See ISpatialAudioObject::IsActive and
		/// ISpatialAudioObject::SetEndOfStream for more information on the managing the lifetime of spatial audio objects.
		/// </remarks>
	...
	/// resetting the stream. Also provides methods for activating new ISpatialAudioObject instances and notifying the system when you are
	...
	public interface ISpatialAudioObjectRenderStreamNotify
	{
		...
		/// specifies the time after which the change will occur, and specifies the number of dynamic audio objects that will be available
		/// after the change.
		/// </summary>
		...
		/// The time after which the spatial resource limit will change, in 100-nanosecond units. A value of 0 means that the change will
		/// occur immediately.
		/// </param>
		...
		/// the maximum number of dynamic spatial audio objects that can be activated at one time. When the capacity of the audio rendering
		/// pipeline changes, the system will dynamically adjust the maximum number of concurrent dynamic spatial audio objects. Before doing
		/// so, the system will call <c>OnAvailableDynamicObjectCountChange</c> to notify clients of the resource limit change.
		/// </para>
		/// <para>
		/// Call Release on an <c>ISpatialAudioObject</c> when it is no longer being used to free up the resource to create new dynamic
		/// spatial audio objects.
	...
	/// <summary>
	/// Represents optional activation parameters for a spatial audio render stream. Pass this structure to ActivateAudioInterfaceAsync when
	/// activating an ISpatialAudioClient interface.
	/// </summary>
	/// <remarks>
	/// <para>The following example code shows how to initialize this structure.</para>
	/// <para>To access the <c>ActivateAudioIntefaceAsync</c>, you will need to link to mmdevapi.lib.</para>
	/// </remarks>
	// https://docs.microsoft.com/en-us/windows/win32/api/spatialaudioclient/ns-spatialaudioclient-spatialaudioclientactivationparams typedef
	// struct SpatialAudioClientActivationParams { GUID tracingContextId; GUID appId; int majorVersion; int minorVersion1; int minorVersion2;
	// int minorVersion3; } SpatialAudioClientActivationParams;
	...
	// ISpatialAudioObjectRenderStreamNotify *NotifyObject; } SpatialAudioObjectRenderStreamActivationParams;
	...
	/// <summary>
	/// Represents activation parameters for a spatial audio render stream, extending SpatialAudioObjectRenderStreamActivationParams
	/// (spatialaudioclient.h) with the ability to specify stream options. Pass this structure to
	/// ISpatialAudioClient::ActivateSpatialAudioStream when activating a stream.
	/// </summary>
	// https://learn.microsoft.com/en-us/windows/win32/api/spatialaudioclient/ns-spatialaudioclient-spatialaudioobjectrenderstreamactivationparams2
	// typedef struct SpatialAudioObjectRenderStreamActivationParams2 { const WAVEFORMATEX *ObjectFormat; AudioObjectType
	// StaticObjectTypeMask; UINT32 MinDynamicObjectCount; UINT32 MaxDynamicObjectCount; AUDIO_STREAM_CATEGORY Category; HANDLE EventHandle;
	// ISpatialAudioObjectRenderStreamNotify *NotifyObject; SPATIAL_AUDIO_STREAM_OPTIONS Options; } SpatialAudioObjectRenderStreamActivationParams2;
	[PInvokeData("spatialaudioclient.h", MSDNShortId = "NS:spatialaudioclient.SpatialAudioObjectRenderStreamActivationParams2")]
	[StructLayout(LayoutKind.Sequential)]
