...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
	...
	// LPCSTR szDataSource, LPCSTR szMachineName, LPCSTR szObjectName, StrPtrAnsi szDefaultCounterName, LPDWORD pcchBufferSize );
	[DllImport(Lib.Pdh, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// PDH_HLOG hDataSource, LPCSTR szMachineName, LPCSTR szObjectName, StrPtrAnsi szDefaultCounterName, LPDWORD pcchBufferSize );
	[DllImport(Lib.Pdh, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// LPCSTR szDataSource, LPCSTR szMachineName, StrPtrAnsi szDefaultObjectName, LPDWORD pcchBufferSize );
	[DllImport(Lib.Pdh, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// PDH_HLOG hDataSource, LPCSTR szMachineName, StrPtrAnsi szDefaultObjectName, LPDWORD pcchBufferSize );
	[DllImport(Lib.Pdh, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// LPCSTR szMachineName, DWORD dwNameIndex, StrPtrAnsi szNameBuffer, LPDWORD pcchNameBufferSize );
	[DllImport(Lib.Pdh, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// PPDH_COUNTER_PATH_ELEMENTS_A pCounterPathElements, StrPtrAnsi szFullPathBuffer, LPDWORD pcchBufferSize, DWORD dwFlags );
	[DllImport(Lib.Pdh, SetLastError = false, CharSet = CharSet.Auto)]
	[PInvokeData("pdh.h", MSDNShortId = "f2dc5f77-9f9e-4290-95fa-ce2f1e81fc69")]
	...
	// szInstanceString, StrPtrAnsi szInstanceName, LPDWORD pcchInstanceNameLength, StrPtrAnsi szParentName, LPDWORD pcchParentNameLength, LPDWORD
	// lpIndex );
	[DllImport(Lib.Pdh, SetLastError = false, CharSet = CharSet.Auto)]
	...
	// hWndOwner, DWORD dwFlags, StrPtrAnsi szDataSource, LPDWORD pcchBufferLength );
	[DllImport(Lib.Pdh, SetLastError = false, CharSet = CharSet.Auto)]
	[PInvokeData("pdh.h", MSDNShortId = "211d4504-e1f9-48a0-8ddd-613f2f183c59")]
	...
	// bIncludeCostlyObjects : 1; DWORD bShowObjectBrowser : 1; DWORD bReserved : 22; HWND hWndOwner; StrPtrAnsi szDataSource; StrPtrAnsi
	...
	// DWORD dwDefaultDetailLevel; StrPtrAnsi szDialogBoxCaption; } PDH_BROWSE_DLG_CONFIG_A, *PPDH_BROWSE_DLG_CONFIG_A;
	[PInvokeData("pdh.h", MSDNShortId = "8e045e0b-c157-4527-902c-6096c7922642")]
	...
	// bIncludeInstanceIndex : 1; DWORD bSingleCounterPerAdd : 1; DWORD bSingleCounterPerDialog : 1; DWORD bLocalCountersOnly : 1; DWORD
	// bWildCardInstances : 1; DWORD bHideDetailBox : 1; DWORD bInitializePath : 1; DWORD bDisableMachineSelection : 1; DWORD
	// bIncludeCostlyObjects : 1; DWORD bShowObjectBrowser : 1; DWORD bReserved : 22; HWND hWndOwner; PDH_HLOG hDataSource; StrPtrAnsi
	// szReturnPathBuffer; DWORD cchReturnPathLength; CounterPathCallBack pCallBack; DWORD_PTR dwCallBackArg; PDH_STATUS CallBackStatus;
	// DWORD dwDefaultDetailLevel; StrPtrAnsi szDialogBoxCaption; } PDH_BROWSE_DLG_CONFIG_HA, *PPDH_BROWSE_DLG_CONFIG_HA;
	...
	// dwQueryUserData; StrPtrAnsi szFullPath; union { PDH_DATA_ITEM_PATH_ELEMENTS_A DataItemPath; PDH_COUNTER_PATH_ELEMENTS_A CounterPath;
	// struct { StrPtrAnsi szMachineName; StrPtrAnsi szObjectName; StrPtrAnsi szInstanceName; StrPtrAnsi szParentInstance; DWORD dwInstanceIndex; StrPtrAnsi
	// szCounterName; }; }; StrPtrAnsi szExplainText; DWORD DataBuffer[1]; } PDH_COUNTER_INFO_A, *PPDH_COUNTER_INFO_A;
	...
	// _PDH_COUNTER_PATH_ELEMENTS_A { StrPtrAnsi szMachineName; StrPtrAnsi szObjectName; StrPtrAnsi szInstanceName; StrPtrAnsi szParentInstance; DWORD
	// dwInstanceIndex; StrPtrAnsi szCounterName; } PDH_COUNTER_PATH_ELEMENTS_A, *PPDH_COUNTER_PATH_ELEMENTS_A;
	...
	// _PDH_DATA_ITEM_PATH_ELEMENTS_A { StrPtrAnsi szMachineName; GUID ObjectGUID; DWORD dwItemId; StrPtrAnsi szInstanceName; }
	...
	// _PDH_FMT_COUNTERVALUE_ITEM_A { StrPtrAnsi szName; PDH_FMT_COUNTERVALUE FmtValue; } PDH_FMT_COUNTERVALUE_ITEM_A, *PPDH_FMT_COUNTERVALUE_ITEM_A;
	...
	// StrPtrAnsi szName; PDH_RAW_COUNTER RawValue; } PDH_RAW_COUNTER_ITEM_A, *PPDH_RAW_COUNTER_ITEM_A;
	...
	public partial class SafePDH_HLOG
	{
		/// <summary>
