...
public static partial class User32
{
	...
	public enum SPI : uint
	{
		...
		[SPCorrespondingType(typeof(bool), CorrespondingAction.Set, UiParam)]
		SPI_SETBEEP = 0x0002,
		...
		/// </summary>
		[SPCorrespondingType(typeof(int[]), CorrespondingAction.Set)]
		SPI_SETMOUSE = 0x0004,
		...
		/// new value.
		/// </summary>
		[SPCorrespondingType(typeof(int), CorrespondingAction.Set, UiParam)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(uint), CorrespondingAction.Set, UiParam)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(int), CorrespondingAction.GetSet, UiParam)]
		...
		[SPCorrespondingType(typeof(string), CorrespondingAction.Set, UiParam)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(LOGFONT), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(bool), CorrespondingAction.Get), Obsolete]
		...
		/// </summary>
		[SPCorrespondingType(typeof(bool), CorrespondingAction.Set), Obsolete]
		...
		/// </summary>
		[SPCorrespondingType(typeof(NONCLIENTMETRICS), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(NONCLIENTMETRICS), CorrespondingAction.Set)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(MINIMIZEDMETRICS), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(MINIMIZEDMETRICS), CorrespondingAction.Set)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(ICONMETRICS), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(ICONMETRICS), CorrespondingAction.Set)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(RECT), CorrespondingAction.Set)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(RECT), CorrespondingAction.Get)]
		...
		/// </remarks>
		[SPCorrespondingType(typeof(HIGHCONTRAST), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(HIGHCONTRAST), CorrespondingAction.Set)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(ANIMATIONINFO), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(ANIMATIONINFO), CorrespondingAction.Set)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(IntPtr), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(IntPtr), CorrespondingAction.Set)]
		...
		/// </summary>
		[Obsolete, SPCorrespondingType(typeof(uint), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(FILTERKEYS), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(FILTERKEYS), CorrespondingAction.Set)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(TOGGLEKEYS), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(TOGGLEKEYS), CorrespondingAction.Set)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(MOUSEKEYS), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(MOUSEKEYS), CorrespondingAction.Set)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(SOUNDSENTRY), CorrespondingAction.Set)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(STICKYKEYS), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(STICKYKEYS), CorrespondingAction.Set)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(ACCESSTIMEOUT), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(ACCESSTIMEOUT), CorrespondingAction.Set)]
		...
		/// control panel.
		/// </summary>
		[Obsolete, SPCorrespondingType(typeof(SERIALKEYS), CorrespondingAction.Get)]
		...
		/// control panel.
		/// </summary>
		[Obsolete, SPCorrespondingType(typeof(SERIALKEYS), CorrespondingAction.Set)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(SOUNDSENTRY), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(string), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(AUDIODESCRIPTION), CorrespondingAction.Get)]
		...
		/// <para>Windows Server 2003 and Windows XP/2000: This parameter is not supported.</para>
		/// </summary>
		[SPCorrespondingType(typeof(AUDIODESCRIPTION), CorrespondingAction.Set)]
		...
		/// <para><c>Windows Server 2008, Windows Vista, Windows Server 2003 and Windows XP/2000:</c> This parameter is not supported.</para>
		/// </summary>
		[Obsolete, SPCorrespondingType(typeof(uint), CorrespondingAction.Set, UiParam)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(ContactVisualization), CorrespondingAction.Get)]
		...
		/// setting. For more information, see Contact Visualization.
		/// </summary>
		[SPCorrespondingType(typeof(ContactVisualization), CorrespondingAction.Set)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(GestureVisualization), CorrespondingAction.Get)]
		...
		/// setting. For more information, see Gesture Visualization.
		/// </summary>
		[SPCorrespondingType(typeof(GestureVisualization), CorrespondingAction.Set)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(MouseWheelRouting), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(MouseWheelRouting), CorrespondingAction.Set)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(PenVisualization), CorrespondingAction.Get)]
		...
		/// </summary>
		[SPCorrespondingType(typeof(PenVisualization), CorrespondingAction.Set)]
		SPI_SETPENVISUALIZATION = 0x201F,

		/// <summary>Undocumented</summary>
		[SPCorrespondingType(typeof(PenArbitrationType), CorrespondingAction.Get)]
		SPI_GETPENARBITRATIONTYPE = 0x2020,

		/// <summary>Undocumented</summary>
		[SPCorrespondingType(typeof(PenArbitrationType), CorrespondingAction.Set)]
		...
		/// <summary>Undocumented</summary>
		[SPCorrespondingType(typeof(HANDEDNESS), CorrespondingAction.Get)]
		SPI_GETHANDEDNESS = 0x2024,

		/// <summary>Undocumented</summary>
		[SPCorrespondingType(typeof(HANDEDNESS), CorrespondingAction.Set)]
	...
	public static extern LPWSTR MB_GetString(uint wBtn);
	...
	/// <summary>
	/// Displays a modal dialog box that contains a system icon, a set of buttons, and a brief application-specific message, such as status
	/// or error information. The message box returns an integer value that indicates which button the user clicked.
	/// </summary>
	/// <param name="hWnd">
	...
	/// <para>
	/// The message to be displayed. If the string consists of more than one line, you can separate the lines using a carriage return and/or
	...
	/// <description>
	/// The message box contains three push buttons: <c>Cancel</c>, <c>Try Again</c>, <c>Continue</c>. Use this message box type instead of MB_ABORTRETRYIGNORE.
	/// </description>
	/// </item>
	/// <item>
	/// <description><c>MB_HELP</c> 0x00004000L</description>
	/// <description>
	/// Adds a <c>Help</c> button to the message box. When the user clicks the <c>Help</c> button or presses F1, the system sends a WM_HELP
	...
	/// <description>
	/// The user must respond to the message box before continuing work in the window identified by the <c>hWnd</c> parameter. However, the
	/// user can move to the windows of other threads and work in those windows. Depending on the hierarchy of windows in the application,
	/// the user may be able to move to other windows within the thread. All child windows of the parent of the message box are automatically
	/// disabled, but pop-up windows are not. <c>MB_APPLMODAL</c> is the default if neither <c>MB_SYSTEMMODAL</c> nor <c>MB_TASKMODAL</c> is specified.
	/// </description>
	/// </item>
	/// <item>
	...
	/// user of serious, potentially damaging errors that require immediate attention (for example, running out of memory). This flag has no
	/// effect on the user's ability to interact with windows other than those associated with <c>hWnd</c>.
	/// </description>
	/// </item>
	/// <item>
	...
	/// <description>
	/// Same as desktop of the interactive window station. For more information, see Window Stations. If the current input desktop is not the
	/// default desktop, <c>MessageBox</c> does not return until the user switches to the default desktop.
	/// </description>
	/// </item>
	/// <item>
	...
	/// <description>
	/// The caller is a service notifying the user of an event. The function displays a message box on the current active desktop, even if
	/// there is no user logged on to the computer. <c>Terminal Services:</c> If the calling thread has an impersonation token, the function
	/// directs the message box to the session specified in the impersonation token. If this flag is set, the <c>hWnd</c> parameter must be
	/// <c>NULL</c>. This is so that the message box can appear on a desktop other than the desktop corresponding to the <c>hWnd</c>. For
	/// information on security considerations in regard to using this flag, see Interactive Services. In particular, be aware that this flag
	/// can produce interactive content on a locked desktop and should therefore be used for only a very limited set of scenarios, such as
	/// resource exhaustion.
	/// </description>
	/// </item>
	/// </list>
	...
	/// in the default system language. If this parameter is MAKELANGID(LANG_NEUTRAL, SUBLANG_NEUTRAL), the current language associated with
	...
	/// Parameter is in milliseconds so 1000 will be 1 second etc. Messagebox won't time-out if <paramref name="dwMilliseconds"/> is 0.
	/// </param>
	/// <returns>
	/// <para>Type: <c>int</c></para>
	/// <para>
	/// If a message box has a <c>Cancel</c> button, the function returns the <c>IDCANCEL</c> value if either the ESC key is pressed or the
	/// <c>Cancel</c> button is selected. If the message box has no <c>Cancel</c> button, pressing ESC will no effect - unless an MB_OK
	/// button is present. If an MB_OK button is displayed and the user presses ESC, the return value will be <c>IDOK</c>.
	/// </para>
	/// <para>If the function fails, the return value is zero. To get extended error information, call GetLastError.</para>
	/// <para>If the function succeeds, the return value is one of the following menu-item values.</para>
	/// <list type="table">
	...
	/// </returns>
	/// <remarks>
	/// <para>The following system icons can be used in a message box by setting the <c>uType</c> parameter to the corresponding flag value.</para>
	/// <list type="table">
	/// <listheader>
	...
	/// <para>Â</para>
	/// <para>
	/// Adding two right-to-left marks (RLMs), represented by Unicode formatting character U+200F, in the beginning of a MessageBox display
	/// string is interpreted by the MessageBox rendering engine so as to cause the reading order of the MessageBox to be rendered as
	/// right-to-left (RTL).
	/// </para>
	/// <para>
	/// When you use a system-modal message box to indicate that the system is low on memory, the strings pointed to by the <c>lpText</c> and
	/// <c>lpCaption</c> parameters should not be taken from a resource file because an attempt to load the resource may fail.
	/// </para>
	/// <para>
	...
	/// In the following example, the application displays a message box that prompts the user for an action after an error condition has
	/// occurred. The message box displays the message that describes the error condition and how to resolve it. The
	/// <c>MB_CANCELTRYCONTINUE</c> style directs <c>MessageBox</c> to provide three buttons with which the user can choose how to proceed.
	/// The <c>MB_DEFBUTTON2</c> style sets the default focus on the second button of the message box, in this case, the <c>Try Again</c> button.
	/// </para>
	/// <para>The following image shows the output from the preceding code example:</para>
	/// <para>For another message box example, see Displaying a Message Box.</para>
	/// </remarks>
	...
	[PInvokeData("Winuser.h", MSDNShortId = "ms724947")]
	[return: MarshalAs(UnmanagedType.Bool)]
	public static extern bool SystemParametersInfo(SPI uiAction, uint uiParam, StringBuilder pvParam, [Optional] SPIF fWinIni);
	...
	public static bool SystemParametersInfo<T>(SPI uiAction, out T getValue) where T : struct
	{
		...
		uint uv = InteropExtensions.SizeOf(isBool ? typeof(BOOL) : typeof(T));
		using var ptr = new SafeHGlobalHandle((int)uv);
		if (IsSPITypeOrdinal<T>())
			uv = 0;
		else if (typeof(T).GetOrderedFields().FirstOrDefault()?.Name == "cbSize")
			ptr.Write(uv, false, 0);
		getValue = default;
		if (!SystemParametersInfo(uiAction, uv, (IntPtr)ptr, spif))
			return false;
		getValue = isBool ? (T)(object)(bool)ptr.ToStructure<BOOL>() : ptr.ToStructure<T>();
		return true;
	}
	...
	public static bool SystemParametersInfo<T>(SPI uiAction, in T setValue, bool updateUserProfile = false, bool broadcastChange = true) where T : struct
	{
	...
	private static bool IsSPITypeOrdinal<T>() => typeof(T) == typeof(bool) || typeof(T) == typeof(uint) || typeof(T) == typeof(int) || typeof(T).IsEnum;
