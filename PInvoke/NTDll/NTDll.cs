...
namespace Vanara.PInvoke
{
	...
	public static partial class NtDll
	{
		...
		// typedef enum _KEY_INFORMATION_CLASS { KeyBasicInformation , KeyNodeInformation , KeyFullInformation , KeyNameInformation , KeyCachedInformation , KeyFlagsInformation , KeyVirtualizationInformation , KeyHandleTagsInformation , KeyTrustInformation , KeyLayerInformation , MaxKeyInfoClass } KEY_INFORMATION_CLASS;
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows-hardware/drivers/ddi/content/ntifs/nf-ntifs-ntcreatesection
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows-hardware/drivers/ddi/content/wdm/nf-wdm-zwquerykey
		...
		//  public static extern NTSYSAPI NTSTATUS ZwQueryKey(IntPtr KeyHandle, KEY_INFORMATION_CLASS KeyInformationClass, IntPtr KeyInformation, uint Length, ref uint ResultLength);
		public static extern NTStatus NtQueryKey(IntPtr KeyHandle, KEY_INFORMATION_CLASS KeyInformationClass, IntPtr KeyInformation, uint Length, out uint ResultLength);
		...
		// https://docs.microsoft.com/en-us/windows-hardware/drivers/ddi/content/wdm/ns-wdm-_key_basic_information
		...
		// https://docs.microsoft.com/en-us/windows-hardware/drivers/ddi/content/wdm/ns-wdm-_key_full_information
		...
		// https://docs.microsoft.com/en-us/windows-hardware/drivers/ddi/content/ntddk/ns-ntddk-_key_name_information
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows-hardware/drivers/ddi/content/wdm/ns-wdm-_key_node_information
		// typedef struct _KEY_NODE_INFORMATION { LARGE_INTEGER LastWriteTime; ULONG TitleIndex; ULONG ClassOffset; ULONG ClassLength; ULONG NameLength; WCHAR Name[1]; } KEY_NODE_INFORMATION, *PKEY_NODE_INFORMATION;
		...
		// https://docs.microsoft.com/en-us/windows-hardware/drivers/ddi/content/wudfwdm/ns-wudfwdm-_unicode_string
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows-hardware/drivers/ddi/content/ntddk/nf-ntddk-dbgprompt
		// NTSYSAPI ULONG DbgPrompt( PCCH Prompt, PCH Response, ULONG Length );
		...
		// https://docs.microsoft.com/en-us/windows/desktop/DevNotes/ldrfastfailinloadercallout
		...
		[DllImport(Lib.NtDll, SetLastError = false, ExactSpelling = true)]
		[PInvokeData("ntldr.h", MSDNShortId = "c2757aa0-76fa-427a-a4f6-cb26e7f7d0d1")]
		public static extern NTStatus LdrRegisterDllNotification(uint Flags, LdrDllNotification NotificationFunction, [Optional] IntPtr Context, out IntPtr Cookie);
		...
		// https://docs.microsoft.com/en-us/windows/desktop/DevNotes/ldrdllnotification
		// VOID CALLBACK LdrDllNotification( _In_ ULONG NotificationReason, _In_ PCLDR_DLL_NOTIFICATION_DATA NotificationData, _In_opt_ PVOID Context );
		...
		// https://docs.microsoft.com/en-us/windows/desktop/DevNotes/ldrunregisterdllnotification
		...
		// https://docs.microsoft.com/en-us/windows/desktop/api/winternl/nf-winternl-ntclose
		...
		// https://docs.microsoft.com/en-us/windows-hardware/drivers/ddi/content/wdm/nf-wdm-ntcommitcomplete
		// __kernel_entry NTSYSCALLAPI NTSTATUS NtCommitComplete( HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock );
		[DllImport(Lib.NtDll, SetLastError = false, ExactSpelling = true)]
		[PInvokeData("wdm.h", MSDNShortId = "d0b968bc-bbab-4b6f-bb1f-9e36ac7c1e05")]
		public static extern NTStatus NtCommitComplete(IntPtr EnlistmentHandle, ref long TmVirtualClock);
		...
		// https://docs.microsoft.com/en-us/windows-hardware/drivers/ddi/content/wdm/nf-wdm-ntcommitenlistment
		...
		public static extern NTStatus NtCommitEnlistment(IntPtr EnlistmentHandle, ref long TmVirtualClock);
		...
		// https://docs.microsoft.com/en-us/windows-hardware/drivers/ddi/content/wdm/nf-wdm-ntcommittransaction
		...
		// https://docs.microsoft.com/en-us/windows/desktop/SecAuthZ/ntcomparetokens
		...
		/// </para>
		/// <code>typedef struct _SYSTEM_BASIC_INFORMATION {&#xA;    BYTE Reserved1[24];&#xA;    PVOID Reserved2[4];&#xA;    CCHAR NumberOfProcessors;&#xA;} SYSTEM_BASIC_INFORMATION;"</code>
		/// <para>
		...
		/// following layout:
		/// </para>
		/// <code>typedef struct _SYSTEM_CODEINTEGRITY_INFORMATION {&#xA;    ULONG  Length;&#xA;    ULONG  CodeIntegrityOptions;&#xA;} SYSTEM_CODEINTEGRITY_INFORMATION, *PSYSTEM_CODEINTEGRITY_INFORMATION;"</code>
		...
		/// </para>
		/// <code>typedef struct _SYSTEM_EXCEPTION_INFORMATION {&#xA;    BYTE Reserved1[16];&#xA;} SYSTEM_EXCEPTION_INFORMATION;</code>
		...
		/// unpredictable seed for a random number generator. For this purpose, the structure has the following layout:
		/// </para>
		/// <code>typedef struct _SYSTEM_INTERRUPT_INFORMATION {&#xA;    BYTE Reserved1[24];&#xA;} SYSTEM_INTERRUPT_INFORMATION;</code>
		/// <para>Individual members of the structure are reserved for internal use by the operating system.</para>
		/// <para>Use the CryptGenRandom function instead to generate cryptographically random data.</para>
		...
		/// </para>
		/// <code>typedef struct _SYSTEM_KERNEL_VA_SHADOW_INFORMATION {&#xA;    struct {&#xA;        ULONG KvaShadowEnabled:1;&#xA;        ULONG KvaShadowUserGlobal:1;&#xA;        ULONG KvaShadowPcid:1;&#xA;        ULONG KvaShadowInvpcid:1;&#xA;        ULONG Reserved:28;&#xA;    } KvaShadowFlags;&#xA;} SYSTEM_KERNEL_VA_SHADOW_INFORMATION, * PSYSTEM_KERNEL_VA_SHADOW_INFORMATION;</code>
		...
		/// </para>
		/// <code>typedef struct _SYSTEM_LEAP_SECOND_INFORMATION {&#xA;    BOOLEAN Enabled;&#xA;    ULONG Flags;&#xA;} SYSTEM_LEAP_SECOND_INFORMATION</code>
		...
		/// unpredictable seed for a random number generator. For this purpose, the structure has the following layout:
		/// </para>
		/// <code>typedef struct _SYSTEM_LOOKASIDE_INFORMATION {&#xA;    BYTE Reserved1[32];&#xA;} SYSTEM_LOOKASIDE_INFORMATION;</code>
		/// <para>Individual members of the structure are reserved for internal use by the operating system.</para>
		/// <para>Use the CryptGenRandom function instead to generate cryptographically random data.</para>
		...
		/// unpredictable seed for a random number generator. For this purpose, the structure has the following layout:
		/// </para>
		/// <code>typedef struct _SYSTEM_PERFORMANCE_INFORMATION {&#xA;    BYTE Reserved1[312];&#xA;} SYSTEM_PERFORMANCE_INFORMATION;</code>
		/// <para>Individual members of the structure are reserved for internal use by the operating system.</para>
		/// <para>Use the CryptGenRandom function instead to generate cryptographically random data.</para>
		...
		/// </para>
		/// <code>typedef struct _SYSTEM_POLICY_INFORMATION {&#xA;    PVOID Reserved1[2];&#xA;    ULONG Reserved2[3];&#xA;} SYSTEM_POLICY_INFORMATION;</code>
		/// <para>Individual members of the structure are reserved for internal use by the operating system.</para>
		...
		/// <code>typedef struct _SYSTEM_PROCESS_INFORMATION {&#xA;    ULONG NextEntryOffset;&#xA;    ULONG NumberOfThreads;&#xA;    BYTE Reserved1[48];&#xA;    UNICODE_STRING ImageName;&#xA;    KPRIORITY BasePriority;&#xA;    HANDLE UniqueProcessId;&#xA;    PVOID Reserved2;&#xA;    ULONG HandleCount;&#xA;    ULONG SessionId;&#xA;    PVOID Reserved3;&#xA;    SIZE_T PeakVirtualSize;&#xA;    SIZE_T VirtualSize;&#xA;    ULONG Reserved4;&#xA;    SIZE_T PeakWorkingSetSize;&#xA;    SIZE_T WorkingSetSize;&#xA;    PVOID Reserved5;&#xA;    SIZE_T QuotaPagedPoolUsage;&#xA;    PVOID Reserved6;&#xA;    SIZE_T QuotaNonPagedPoolUsage;&#xA;    SIZE_T PagefileUsage;&#xA;    SIZE_T PeakPagefileUsage;&#xA;    SIZE_T PrivatePageCount;&#xA;    LARGE_INTEGER Reserved7[6];&#xA;} SYSTEM_PROCESS_INFORMATION;</code>
		/// <para>
		...
		/// </para>
		/// <code>typedef struct _SYSTEM_THREAD_INFORMATION {&#xA;    LARGE_INTEGER Reserved1[3];&#xA;    ULONG Reserved2;&#xA;    PVOID StartAddress;&#xA;    CLIENT_ID ClientId;&#xA;    KPRIORITY Priority;&#xA;    LONG BasePriority;&#xA;    ULONG Reserved3;&#xA;    ULONG ThreadState;&#xA;    ULONG WaitReason;&#xA;} SYSTEM_THREAD_INFORMATION;</code>
		...
		/// has the following layout:
		/// </para>
		/// <code>typedef struct&#xA;_SYSTEM_PROCESSOR_PERFORMANCE_INFORMATION {&#xA;    LARGE_INTEGER IdleTime;&#xA;    LARGE_INTEGER KernelTime;&#xA;    LARGE_INTEGER UserTime;&#xA;    LARGE_INTEGER Reserved1[2];&#xA;    ULONG Reserved2;&#xA;} SYSTEM_PROCESSOR_PERFORMANCE_INFORMATION;</code>
		...
		/// following layout:
		/// </para>
		/// <code>typedef struct _SYSTEM_REGISTRY_QUOTA_INFORMATION {&#xA;    ULONG RegistryQuotaAllowed;&#xA;    ULONG RegistryQuotaUsed;&#xA;    PVOID Reserved1;&#xA;} SYSTEM_REGISTRY_QUOTA_INFORMATION;</code>
		...
		/// having the following layout:
		/// </para>
		/// <code>typedef struct _SYSTEM_SPECULATION_CONTROL_INFORMATION {&#xA;    struct {&#xA;         ULONG BpbEnabled:1;&#xA;         ULONG BpbDisabledSystemPolicy:1;&#xA;         ULONG BpbDisabledNoHardwareSupport:1;&#xA;         ULONG SpecCtrlEnumerated:1;&#xA;         ULONG SpecCmdEnumerated:1;&#xA;         ULONG IbrsPresent:1;&#xA;         ULONG StibpPresent:1;&#xA;         ULONG SmepPresent:1;&#xA;         ULONG Reserved:24;&#xA;    } SpeculationControlFlags;&#xA;&#xA;} SYSTEM_SPECULATION_CONTROL_INFORMATION, * PSYSTEM_SPECULATION_CONTROL_INFORMATION;</code>
		...
		/// unpredictable seed for a random number generator. For this purpose, the structure has the following layout:
		/// </para>
		/// <code>typedef struct _SYSTEM_TIMEOFDAY_INFORMATION {&#xA;    BYTE Reserved1[48];&#xA;} SYSTEM_TIMEOFDAY_INFORMATION;</code>
		/// <para>Individual members of the structure are reserved for internal use by the operating system.</para>
		/// <para>Use the CryptGenRandom function instead to generate cryptographically random data.</para>
		/// </param>
		...
		/// <param name="SystemInformationClass"><para>
		/// One of the values enumerated in SYSTEM_INFORMATION_CLASS, which indicate the kind of system information to be retrieved. These
		/// include the following values.
		/// </para>
		/// <para>SystemBasicInformation</para>
		...
		/// The requested SystemInformationClass does not match the return type requested.
		/// or
		/// Reported size of object does not match query.
		/// </exception>
