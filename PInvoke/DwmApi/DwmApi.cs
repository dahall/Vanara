...
namespace Vanara.PInvoke
{
	public static partial class DwmApi
	{
		...
		/// <param name="pfIsRemoting">A pointer to a BOOL value that indicates whether the transport supports remoting. TRUE if the transport supports remoting; otherwise, FALSE.</param>
		/// <param name="pfIsConnected">A pointer to a BOOL value that indicates whether the transport is connected. TRUE if the transport is connected; otherwise, FALSE.</param>
		...
		/// <summary>Sets a static, iconic bitmap to display a live preview (also known as a Peek preview) of a window or tab. The taskbar can use this bitmap to show a full-sized preview of a window or tab.</summary>
