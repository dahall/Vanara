...
{
	/// <summary>Use this constant to reset any window part colors to the system default behavior</summary>
	public const uint DWMWA_COLOR_DEFAULT = 0xFFFFFFFF;

	/// <summary>Use this constant to specify that a window part should not be rendered</summary>
