...
public static partial class Crypt32
{
	...
	// PCCERT_CONTEXT pCertContext, DWORD dwType, DWORD dwFlags, void *pvTypePara, StrPtrAnsi pszNameString, DWORD cchNameString );
	...
	// dwCertEncodingType, PCERT_NAME_BLOB pName, DWORD dwStrType, StrPtrAnsi psz, DWORD csz );
	[DllImport(Lib.Crypt32, SetLastError = false, CharSet = CharSet.Auto)]
	[PInvokeData("wincrypt.h", MSDNShortId = "b3d96de8-5cbc-4ccb-b759-6757520bbda3")]
	...
	// dwValueType, PCERT_RDN_VALUE_BLOB pValue, StrPtrAnsi psz, DWORD csz );
	[DllImport(Lib.Crypt32, SetLastError = false, CharSet = CharSet.Auto)]
	[PInvokeData("wincrypt.h", MSDNShortId = "c1e0af19-320e-411e-85bf-c7f01befcac4")]
	...
	// BYTE *pbBinary, DWORD cbBinary, DWORD dwFlags, StrPtrAnsi pszString, DWORD *pcchString );
	[DllImport(Lib.Crypt32, SetLastError = false, CharSet = CharSet.Auto)]
	[PInvokeData("wincrypt.h", MSDNShortId = "e6bdf931-fba3-4a33-b22e-5f818f565842")]
	[return: MarshalAs(UnmanagedType.Bool)]
