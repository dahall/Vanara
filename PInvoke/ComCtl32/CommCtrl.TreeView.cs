...
namespace Vanara.PInvoke
{
	public static partial class ComCtl32
	{
		...
		public static extern IntPtr SendMessage(HWND hWnd, TreeViewMessage Msg, int wParam, TVGETITEMPARTRECTINFO item);
		...
		/// <returns>The return value specifies the result of the message processing; it depends on the message sent.</returns>
		[DllImport(Lib.User32, SetLastError = false, CharSet = CharSet.Auto)]
		public static extern IntPtr SendMessage(HWND hWnd, TreeViewMessage Msg, [MarshalAs(UnmanagedType.Bool)] bool wParam, ref TVHITTESTINFO hitTestInfo);
		...
		/// <returns>The return value specifies the result of the message processing; it depends on the message sent.</returns>
		[DllImport(Lib.User32, SetLastError = false, CharSet = CharSet.Auto)]
		public static extern IntPtr SendMessage(HWND hWnd, TreeViewMessage Msg, int wParam, ref TVINSERTSTRUCT item);
		...
		/// <returns>The return value specifies the result of the message processing; it depends on the message sent.</returns>
		[DllImport(Lib.User32, SetLastError = false, CharSet = CharSet.Auto)]
		public static extern IntPtr SendMessage(HWND hWnd, TreeViewMessage Msg, int wParam, ref TVSORTCB sortInfo);
		...
		/// <returns>The return value specifies the result of the message processing; it depends on the message sent.</returns>
		[DllImport(Lib.User32, SetLastError = false, CharSet = CharSet.Auto)]
		public static extern IntPtr SendMessage(HWND hWnd, TreeViewMessage Msg, int wParam, ref TVITEMEX item);
