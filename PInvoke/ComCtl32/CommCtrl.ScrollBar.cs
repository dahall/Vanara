...
namespace Vanara.PInvoke
{
	public static partial class ComCtl32
	{
		...
		public enum ESB_FLAGS : uint
		{
			...
			/// <summary>Disables the left direction button on the horizontal scroll bar or the up direction button on the vertical scroll bar.</summary>
			ESB_DISABLE_LTUP = ESB_DISABLE_LEFT,
			/// <summary>Disables the right direction button on the horizontal scroll bar.</summary>
			ESB_DISABLE_RIGHT = 0x0002,
			/// <summary>Disables the right direction button on the horizontal scroll bar or the down direction button on the vertical scroll bar.</summary>
