...
namespace Vanara.PInvoke
{
	public static partial class Gdi32
	{
		...
		/// <returns>The return value specifies the value of the desired item. When nIndex is BITSPIXEL and the device has 15bpp or 16bpp, the return value is 16.</returns>
