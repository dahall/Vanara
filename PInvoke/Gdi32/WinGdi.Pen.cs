...
public static partial class Gdi32
{
	...
	public struct EXTLOGPEN
	{
		...
		/// </list>
		/// </summary>
		public ExtPenStyle elpPenStyle;
		...
		const ExtPenStyle PS_STYLE_MASK = (ExtPenStyle)0x0000000F; // Mask for pen style
		const ExtPenStyle PS_ENDCAP_MASK = (ExtPenStyle)0x00000F00; // Mask for end cap style
		const ExtPenStyle PS_JOIN_MASK = (ExtPenStyle)0x0000F000; // Mask for join style
		const ExtPenStyle PS_TYPE_MASK = (ExtPenStyle)0x000F0000; // Mask for pen type

		/// <summary>Gets or sets the style of the pen.</summary>
		public PenStyle Style { get => (PenStyle)(elpPenStyle & PS_STYLE_MASK); set => elpPenStyle = (ExtPenStyle)value | (elpPenStyle & ~PS_STYLE_MASK); }

		/// <summary>Gets or sets the end cap style of the pen.</summary>
		public PenEndCap EndCap { get => (PenEndCap)(elpPenStyle & PS_ENDCAP_MASK); set => elpPenStyle = (ExtPenStyle)value | (elpPenStyle & ~PS_ENDCAP_MASK); }

		/// <summary>Gets or sets the join style for the pen.</summary>
		public PenJoin Join { get => (PenJoin)(elpPenStyle & PS_JOIN_MASK); set => elpPenStyle = (ExtPenStyle)value | (elpPenStyle & ~PS_JOIN_MASK); }

		/// <summary>Gets or sets the pen type.</summary>
		public PenType Type { get => (PenType)(elpPenStyle & PS_TYPE_MASK); set => elpPenStyle = (ExtPenStyle)value | (elpPenStyle & ~PS_TYPE_MASK); }
	}
