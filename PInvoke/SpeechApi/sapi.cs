...
public static partial class SpeechApi
{
	...
	{
		void GetPronunciations([In, MarshalAs(UnmanagedType.LPWStr)] string pszWord, [In] LANGID LangId, [In] uint dwFlags, out SPWORDPRONUNCIATIONLIST pWordPronunciationList);

		void AddPronunciation([In, MarshalAs(UnmanagedType.LPWStr)] string pszWord, [In] LANGID LangId, [In] SPPARTOFSPEECH ePartOfSpeech, [In, MarshalAs(UnmanagedType.LPWStr)] string? pszPronunciation = null);

		void RemovePronunciation([In, MarshalAs(UnmanagedType.LPWStr)] string pszWord, [In] LANGID LangId, [In] SPPARTOFSPEECH ePartOfSpeech, [In, MarshalAs(UnmanagedType.LPWStr)] string? pszPronunciation = null);

		void GetGeneration(out uint pdwGeneration);

		void GetGenerationChange([In] uint dwFlags, out uint pdwGeneration, out SPWORDLIST pWordList);

		void GetWords([In] uint dwFlags, out uint pdwGeneration, out uint pdwCookie, out SPWORDLIST pWordList);
	}
	...
	public interface ISpPhoneConverter : ISpObjectWithToken
	{
		...
		void PhoneToId([In, MarshalAs(UnmanagedType.LPWStr)] string pszPhone, [Out, MarshalAs(UnmanagedType.LPWStr)] StringBuilder pId);

		void IdToPhone([In, MarshalAs(UnmanagedType.LPWStr)] string pId, [Out, MarshalAs(UnmanagedType.LPWStr)] StringBuilder pszPhone);
	}
	...
	{
		void GetLangId(out LANGID pLangID);

		void SetLangId([In] LANGID LangId);

		void SAPI2UPS([In, MarshalAs(UnmanagedType.LPWStr)] string pszSAPIId, [Out, MarshalAs(UnmanagedType.LPWStr)] StringBuilder pszUPSId, [In] uint cMaxLength);

		void UPS2SAPI([In, MarshalAs(UnmanagedType.LPWStr)] string pszUPSId, [Out, MarshalAs(UnmanagedType.LPWStr)] StringBuilder pszSAPIId, [In] uint cMaxLength);

		void GetMaxConvertLength([In] uint cSrcLength, [In, MarshalAs(UnmanagedType.Bool)] bool bSAPI2UPS, out uint pcMaxDestLength);
	}
	...
	public interface ISpPhrase
	{
		...
		void GetText([In] uint ulStart, [In] uint ulCount, [In, MarshalAs(UnmanagedType.Bool)] bool fUseTextReplacements, [MarshalAs(UnmanagedType.LPWStr)] out string ppszCoMemText, [Optional] out byte pbDisplayAttributes);

		void Discard([In] uint dwValueTypes);
	}
	...
	public interface ISpPhraseAlt : ISpPhrase
	{
		...
		new void GetText([In] uint ulStart, [In] uint ulCount, [In, MarshalAs(UnmanagedType.Bool)] bool fUseTextReplacements, [MarshalAs(UnmanagedType.LPWStr)] out string ppszCoMemText, [Optional] out byte pbDisplayAttributes);

		new void Discard([In] uint dwValueTypes);
	...
	public interface ISpRecoResult : ISpPhrase
	{
		...
		void GetAudio([In] uint ulStartElement, [In] uint cElements, [MarshalAs(UnmanagedType.Interface)] out ISpStreamFormat ppStream);
		...
		void GetRecoContext([MarshalAs(UnmanagedType.Interface)] out ISpRecoContext ppRecoContext);
	}
	...
	public interface ISpRecoResult2 : ISpRecoResult
	{
		...
		new void GetAudio([In] uint ulStartElement, [In] uint cElements, [MarshalAs(UnmanagedType.Interface)] out ISpStreamFormat ppStream);
		...
		new void GetRecoContext([MarshalAs(UnmanagedType.Interface)] out ISpRecoContext ppRecoContext);
	...
	public struct SPPHRASE
	{
		...
		public ManagedArrayPointer<SPPHRASEPROPERTY> pProperties;

		public ManagedArrayPointer<SPPHRASEELEMENT> pElements;

		public uint cReplacements;

		public ManagedArrayPointer<SPPHRASEREPLACEMENT> pReplacements;
		...
		public ManagedStructPointer<SPSEMANTICERRORINFO> pSemanticErrorInfo;
	...
	public struct SPPHRASEELEMENT
	{
		...
		[MarshalAs(UnmanagedType.LPWStr)]
		public string? pszPronunciation;
	...
	public struct SPPHRASEPROPERTY
	{
		...
		public ulong ulId { get => union.ulId; set => union.ulId = value; }
		public SPPHRASEPROPERTYUNIONTYPE bType { get => union.bType; set => union.bType = value; }
		public ushort usArrayIndex { get => union.usArrayIndex; set => union.usArrayIndex = value; }
		...
		public ManagedStructPointer<SPPHRASEPROPERTY> pNextSibling;

		public ManagedStructPointer<SPPHRASEPROPERTY> pFirstChild;
	...
	public struct SPPHRASERULE
	{
		...
		public ManagedStructPointer<SPPHRASERULE> pNextSibling;

		public ManagedStructPointer<SPPHRASERULE> pFirstChild;
	...
	{
		public ManagedStructPointer<SPSHORTCUTPAIR> pNextSHORTCUTPAIR;
	...
	public struct SPSHORTCUTPAIRLIST
	{
		...
		public ManagedStructPointer<SPSHORTCUTPAIR> pFirstShortcutPair;
	}
	...
	{
		public ManagedStructPointer<SPWORD> pNextWord;
		...
		[MarshalAs(UnmanagedType.LPWStr)]
		public string pszWord;

		public ManagedStructPointer<SPWORDPRONUNCIATION> pFirstWordPronunciation;
	}
	...
	public struct SPWORDLIST
	{
		...
		public ManagedStructPointer<SPWORD> pFirstWord;
	}

	[StructLayout(LayoutKind.Sequential, Pack = 8, CharSet = CharSet.Unicode)]
	public struct SPWORDPRONUNCIATION
	{
		public ManagedStructPointer<SPWORDPRONUNCIATION> pNextWordPronunciation;
		...
		public AnySizeStructFieldArray<ushort> szPronunciation;
	}
