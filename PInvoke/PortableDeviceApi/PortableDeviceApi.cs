...
public static partial class PortableDeviceApi
{
	...
	public interface IEnumPortableDeviceObjectIDs : Vanara.Collections.ICOMEnum<string>
	{
		...
		/// <param name="pObjIDs">
		/// An array of <c>PWSTR</c> pointers, each specifying a retrieved object ID. The caller must allocate an array of cObjects
		/// PWSTR elements. The caller must free both the array and the returned strings. The strings are freed by calling CoTaskMemFree.
		/// </param>
		...
		// HRESULT Next( [in] ULONG cObjects, [in, out] PWSTR *pObjIDs, [in, out] ULONG *pcFetched );
		[PreserveSig]
	...
	public interface IPortableDeviceContent
	{
		...
		// HRESULT CreateObjectWithPropertiesOnly( IPortableDeviceValues *pValues, [in, out] PWSTR *ppszObjectID );
		[return: MarshalAs(UnmanagedType.LPWStr)]
		...
		// *pdwOptimalWriteBufferSize, [in, out] PWSTR *ppszCookie );
		[return: MarshalAs(UnmanagedType.LPWStr)]
	...
	public interface IPortableDeviceManager
	{
		...
		// HRESULT GetDevices( [in, out] PWSTR *pPnPDeviceIDs, [in, out] DWORD *pcPnPDeviceIDs );
		[PreserveSig]
		...
		// HRESULT GetPrivateDevices( [in, out] PWSTR *pPnPDeviceIDs, [in, out] DWORD *pcPnPDeviceIDs );
		[PreserveSig]
	...
	public interface IPortableDeviceResources
	{
		...
		// *pdwOptimalWriteBufferSize, [out] PWSTR *ppszCookie );
	...
	public interface IPortableDeviceService
	{
		...
		// *pParameters, [out] PWSTR *ppszCookie );
	...
	public interface IPortableDeviceServiceManager
	{
		...
		// HRESULT GetDeviceServices( [in] LPCWSTR pszPnPDeviceID, [in] REFGUID guidServiceCategory, [in, out] PWSTR *pServices, [in,
		...
		// HRESULT GetDeviceForService( [in] LPCWSTR pszPnPServiceID, [out] PWSTR *ppszPnPDeviceID );
		[return: MarshalAs(UnmanagedType.LPWStr)]
