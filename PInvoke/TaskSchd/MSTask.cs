...
public static class MSTask
{
	...
	public interface IEnumWorkItems
	{
		...
		/// <para>
		/// A pointer to an array of pointers ( <c>PWSTR</c>) to <c>null</c>-terminated character strings containing the file names of
		...
		/// </para>
		/// </remarks>
		// https://docs.microsoft.com/en-us/windows/desktop/api/mstask/nf-mstask-ienumworkitems-next HRESULT Next( ULONG celt, PWSTR
