...
public static partial class Vfw32
{
	...
	// wDriverIndex, PSTR lpszName, int cbName, PSTR lpszVer, int cbVer );
	[DllImport(Lib_Avicap32, SetLastError = false, CharSet = CharSet.Auto)]
	...
	public static bool capSetUserData(HWND hwnd, IntPtr lUser) => AVICapSM(hwnd, capMessage.WM_CAP_SET_USER_DATA, IntPtr.Zero, lUser);
