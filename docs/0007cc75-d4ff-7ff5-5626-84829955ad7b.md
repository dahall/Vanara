# TaskDialog.ButtonClicked Event
...
**C#**<br />
``` C#
public event EventHandler<TaskDialog.ButtonClickedEventArgs> ButtonClicked
```

**VB**<br />
``` VB
Public Event ButtonClicked As EventHandler(Of TaskDialog.ButtonClickedEventArgs)
```
