# SplitButton.SplitMenuEventArgs Class
...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/118wxtk3" target="_blank">System.EventArgs</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Vanara.Windows.Forms.SplitButton.SplitMenuEventArgs<br />
...
**VB**<br />
``` VB
Public Class SplitMenuEventArgs
	Inherits EventArgs
```

<br />
The SplitButton.SplitMenuEventArgs type exposes the following members.
...
<a href="#splitbutton.splitmenueventargs-class">Back to Top</a>
