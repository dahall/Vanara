...
Gets the file system path if this item is part of the file system.
...
#### Property Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/s1wwdcbf" target="_blank">String</a><br />The file system path.
