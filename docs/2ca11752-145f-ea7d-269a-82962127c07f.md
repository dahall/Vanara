# ResourceFile.ImageResIndexer(*T*) Class
 

\[Missing <summary> documentation for "T:Vanara.Resources.ResourceFile.ImageResIndexer`1"\]


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;Vanara.Resources.ResourceFile.ImageResIndexer(T)<br />
...
**VB**<br />
``` VB
Public Class ImageResIndexer(Of T)
```

<br />

#### Type Parameters
&nbsp;<dl><dt>T</dt><dd>\[Missing <typeparam name="T"/> documentation for "T:Vanara.Resources.ResourceFile.ImageResIndexer`1"\]</dd></dl>&nbsp;
The ResourceFile.ImageResIndexer(T) type exposes the following members.
...
<a href="#resourcefile.imageresindexer(*t*)-class">Back to Top</a>
