# AuthenticationBuffer.DangerousHandle Property 
 

\[Missing <summary> documentation for "P:Vanara.Security.AuthenticationBuffer.DangerousHandle"\]
...
**VB**<br />
``` VB
Public ReadOnly Property DangerousHandle As IntPtr
	Get
```
