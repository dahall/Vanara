# AccessControlEditorDialog.ShowEffectivePermissionsPage Property 
...
**C#**<br />
``` C#
public bool ShowEffectivePermissionsPage { get; set; }
```

**VB**<br />
``` VB
Public Property ShowEffectivePermissionsPage As Boolean
	Get
	Set
```
