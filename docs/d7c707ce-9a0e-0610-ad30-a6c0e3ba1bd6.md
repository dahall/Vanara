# SafeMemoryHandleExt(*TMem*).ToEnumerable(*T*) Method 
...
**VB**<br />
``` VB
Public Function ToEnumerable(Of T) ( 
	count As Integer,
...
#### Implements
<a href="3b083999-ea4d-1ec0-b008-b4434c953b4b">ISafeMemoryHandle.ToEnumerable(T)(Int32, Int32)</a><br />
