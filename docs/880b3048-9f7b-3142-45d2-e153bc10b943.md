# AccessControlEditorDialog.ShowPermissionsResetButton Property 
...
**C#**<br />
``` C#
public bool ShowPermissionsResetButton { get; set; }
```

**VB**<br />
``` VB
Public Property ShowPermissionsResetButton As Boolean
	Get
	Set
```
