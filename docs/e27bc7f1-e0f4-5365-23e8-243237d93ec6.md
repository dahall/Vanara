# ThemedLabel.GlowingText Property 
 

\[Missing <summary> documentation for "P:Vanara.Windows.Forms.ThemedLabel.GlowingText"\]
...
**VB**<br />
``` VB
Public Property GlowingText As Boolean
	Get
	Set
```
