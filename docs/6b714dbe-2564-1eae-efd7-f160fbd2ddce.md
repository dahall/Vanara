# AccessControlEditorDialog.ElevationRequired Property 
 

When set, this flag displays a shield on the Edit button of the simple and advanced Permissions pages.
...
**VB**<br />
``` VB
Public Property ElevationRequired As Boolean
	Get
	Set
```
