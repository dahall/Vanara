...
public class PropSysTests
{
	...
	public void InitPropVariantFromBooleanVectorTest()
	{
		...
		InitPropVariantFromBooleanVector([true,false,true,true], ref pv);
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_VECTOR | VARTYPE.VT_BOOL));
		Assert.That(pv.GetValue() as IEnumerable<bool>, Is.Not.Null.And.Exactly(4).Items);
	...
	{
		PROPVARIANT_UNMGD pv = new();
		InitPropVariantFromBuffer([1,2,3,4], ref pv);
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_VECTOR | VARTYPE.VT_UI1));
		Assert.That(pv.GetValue() as IEnumerable<byte>, Is.Not.Null.And.Exactly(4).Items);
		PropVariantClear(ref pv);
	}
	...
	public void InitPropVariantFromCLSIDTest()
	{
		PROPVARIANT_UNMGD pv = new();
		var g = Guid.NewGuid();
		InitPropVariantFromCLSID(g, ref pv);
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_CLSID));
		Assert.That(pv.GetValue(), Is.EqualTo(g));
		PropVariantClear(ref pv);
	}
	...
	{
		PROPVARIANT_UNMGD pv = new();
		InitPropVariantFromDoubleVector([1f,2.0,255.3,0.1], ref pv);
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_VECTOR | VARTYPE.VT_R8));
		Assert.That(pv.GetValue() as IEnumerable<double>, Is.Not.Null.And.Exactly(4).Items.And.Contains(0.1));
		PropVariantClear(ref pv);
	}
	...
	public void InitPropVariantFromFileTimeTest()
	{
		...
		InitPropVariantFromFileTime(ft, ref pv);
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_FILETIME));
		Assert.That(pv.GetValue(), Is.EqualTo(ft));
		PropVariantClear(ref pv);
	}
	...
	{
		PROPVARIANT_UNMGD pv = new();
		InitPropVariantFromFileTimeVector([DateTime.Now.ToFileTimeStruct(), DateTime.Today.ToFileTimeStruct()], ref pv);
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_VECTOR | VARTYPE.VT_FILETIME));
		Assert.That(pv.GetValue() as IEnumerable<FILETIME>, Is.Not.Null.And.Exactly(2).Items);
		PropVariantClear(ref pv);
	}
	...
	{
		PROPVARIANT_UNMGD pv = new();
		InitPropVariantFromInt16Vector([1,2,3,4], ref pv);
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_VECTOR | VARTYPE.VT_I2));
		Assert.That(pv.GetValue() as IEnumerable<short>, Is.Not.Null.And.Exactly(4).Items);
		PropVariantClear(ref pv);
	}
	...
	{
		PROPVARIANT_UNMGD pv = new();
		InitPropVariantFromInt32Vector([1,2,3,4], ref pv);
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_VECTOR | VARTYPE.VT_I4));
		Assert.That(pv.GetValue() as IEnumerable<int>, Is.Not.Null.And.Exactly(4).Items);
		PropVariantClear(ref pv);
	}
	...
	{
		PROPVARIANT_UNMGD pv = new();
		InitPropVariantFromInt64Vector([1,2,3,4], ref pv);
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_VECTOR | VARTYPE.VT_I8));
		Assert.That(pv.GetValue() as IEnumerable<long>, Is.Not.Null.And.Exactly(4).Items);
		PropVariantClear(ref pv);
	}
	...
	public void InitPropVariantFromPropVariantVectorElemTest()
	{
		...
		InitPropVariantFromPropVariantVectorElem(pv, 2, ref pvc.GetRefValue());
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_VECTOR | VARTYPE.VT_I4));
		...
		pvc = new PROPVARIANT();
		InitPropVariantFromPropVariantVectorElem(pv, 0, ref pvc.GetRefValue());
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_R4));
	...
	public void InitPropVariantFromStringVectorTest()
	{
		...
		Assert.That(InitPropVariantFromStringVector(a, ref pv), ResultIs.Successful);
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_VECTOR | VARTYPE.VT_LPWSTR));
		Assert.That(pv.GetValue() as IEnumerable<string>, Is.EquivalentTo(a));
	...
	{
		PROPVARIANT_UNMGD pv = new();
		InitPropVariantFromUInt16Vector([1,2,3,4], ref pv);
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_VECTOR | VARTYPE.VT_UI2));
		Assert.That(pv.GetValue() as IEnumerable<ushort>, Is.Not.Null.And.Exactly(4).Items);
		PropVariantClear(ref pv);
	}
	...
	{
		PROPVARIANT_UNMGD pv = new();
		InitPropVariantFromUInt32Vector([1,2,3,4], ref pv);
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_VECTOR | VARTYPE.VT_UI4));
		Assert.That(pv.GetValue() as IEnumerable<uint>, Is.Not.Null.And.Exactly(4).Items);
		PropVariantClear(ref pv);
	}
	...
	{
		PROPVARIANT_UNMGD pv = new();
		InitPropVariantFromUInt64Vector([1,2,3,4], ref pv);
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_VECTOR | VARTYPE.VT_UI8));
		Assert.That(pv.GetValue() as IEnumerable<ulong>, Is.Not.Null.And.Exactly(4).Items);
		PropVariantClear(ref pv);
	}
	...
	{
		using var pv = new PROPVARIANT(4);
		Assert.That(pv.vt, Is.EqualTo(VARTYPE.VT_I4));
	...
	{
		using var pv1 = new PROPVARIANT();
		InitPropVariantFromUInt32Vector([1,2,3,4], ref pv1.GetRefValue());
		using var pv2 = new PROPVARIANT(new uint[] {1,2,3,4});
		var i = pv1.CompareTo(pv2);
	...
	public void PropVariantToBooleanTest()
	{
		...
		hr = PropVariantToBoolean(pv2, out b);
		Assert.That(hr.Succeeded);
		Assert.That(b, Is.EqualTo(true));
	}
	...
	public void PropVariantToBufferTest()
	{
		...
		var oba = new byte[4];
		var hr = PropVariantToBuffer(pv, oba);
		Assert.That(hr.Succeeded);
		Assert.That(oba, Has.Exactly(4).Items.And.All.EqualTo(2));
	}

	private delegate HRESULT P2V<T>(in PROPVARIANT_UNMGD pv, out T val);
	...
	[Test()]
	public void PropVariantToDoubleTest() => P2VTest(PropVariantToDouble, 3.14, 1, 1.0);

	[Test()]
	public void PropVariantToDoubleVectorAllocTest() => P2VATest(PropVariantToDoubleVectorAlloc, new double[] { 2, 2, 2, 2 });
	...
	[Test()]
	public void PropVariantToFileTimeVectorAllocTest() => P2VATest(PropVariantToFileTimeVectorAlloc, [DateTime.Today.ToFileTimeStruct(), DateTime.Now.ToFileTimeStruct(), new DateTime(2000, 1, 1).ToFileTimeStruct()]);
	...
	[Test()]
	public void PropVariantToInt16Test() => P2VTest<short>(PropVariantToInt16, 3, 1.0, 1);

	[Test()]
	public void PropVariantToInt16VectorAllocTest() => P2VATest(PropVariantToInt16VectorAlloc, new short[] { 2, 2, 2, 2 });

	private delegate HRESULT P2VA(in PROPVARIANT_UNMGD pv, out SafeCoTaskMemHandle oba, out uint cnt);

	private static void P2VATest<T>(P2VA func, params T[] arr) where T : struct
	{
	...
	[Test()]
	public void PropVariantToInt32Test() => P2VTest(PropVariantToInt32, 3, 1.0, 1);

	[Test()]
	public void PropVariantToInt32VectorAllocTest() => P2VATest(PropVariantToInt32VectorAlloc, [2, 2, 2, 2]);

	[Test()]
	public void PropVariantToInt64Test() => P2VTest<long>(PropVariantToInt64, 3, 1.0, 1);

	[Test()]
	public void PropVariantToInt64VectorAllocTest() => P2VATest(PropVariantToInt64VectorAlloc, new long[] { 2, 2, 2, 2 });
	...
	[Test()]
	public void PropVariantToUInt16Test() => P2VTest<ushort>(PropVariantToUInt16, 3, 1.0, 1);

	[Test()]
	public void PropVariantToUInt16VectorAllocTest() => P2VATest(PropVariantToUInt16VectorAlloc, new ushort[] { 2, 2, 2, 2 });

	[Test()]
	public void PropVariantToUInt32Test() => P2VTest<uint>(PropVariantToUInt32, 3, 1.0, 1);

	[Test()]
	public void PropVariantToUInt32VectorAllocTest() => P2VATest(PropVariantToUInt32VectorAlloc, new uint[] { 2, 2, 2, 2 });

	[Test()]
	public void PropVariantToUInt64Test() => P2VTest<ulong>(PropVariantToUInt64, 3, 1.0, 1);

	[Test()]
	public void PropVariantToUInt64VectorAllocTest() => P2VATest(PropVariantToUInt64VectorAlloc, new ulong[] { 2, 2, 2, 2 });
